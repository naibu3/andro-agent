...
public final class SnapshotWeakSet<T> {
    ...
    public final void removeIf(Function1<? super T, Boolean> block) {
        ...
        while (true) {
            ...
            FinancialConnectionsGenericInfoScreen financialConnectionsGenericInfoScreen = weakReference != null ? (Object) weakReference.get() : null;
            if (financialConnectionsGenericInfoScreen != null && !block.invoke(financialConnectionsGenericInfoScreen).booleanValue()) {
                if (i2 != i) {
