...
public final class TextStyleKt {
    ...
    public static final int m5648resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6020getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m6021getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m6022getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
        if (!TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6025getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m6023getLtrs_7Xco();
        }
        if (i3 == 2) {
            return TextDirection.INSTANCE.m6024getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
