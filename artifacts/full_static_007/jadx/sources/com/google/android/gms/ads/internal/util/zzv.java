...
public class zzv extends zzu {
    ...
    public final boolean zzd(Activity activity, Configuration configuration) {
        ...
        int iRound = ((int) Math.round(activity.getResources().getDisplayMetrics().density + 0.5d)) * ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzeM)).intValue();
