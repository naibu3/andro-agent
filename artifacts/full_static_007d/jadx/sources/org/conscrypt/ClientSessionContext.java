...
public final class ClientSessionContext extends AbstractSessionContext {
    ...
    private NativeSslSession getSession(String str, int i2) {
        ...
        if (sSLClientSessionCache == null || (sessionData = sSLClientSessionCache.getSessionData(str, i2)) == null || (nativeSslSessionNewInstance = NativeSslSession.newInstance(this, sessionData, str, i2)) == null || !nativeSslSessionNewInstance.isValid()) {
            return null;
        }
