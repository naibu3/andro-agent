...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1087setMinWidth0680j_4(this.minWidth);
        node.m1086setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set(ViewProps.MIN_WIDTH, Dp.m6115boximpl(this.minWidth));
        inspectorInfo.getProperties().set(ViewProps.MIN_HEIGHT, Dp.m6115boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6122equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m6122equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m6123hashCodeimpl(this.minWidth) * 31) + Dp.m6123hashCodeimpl(this.minHeight);
    }
}
