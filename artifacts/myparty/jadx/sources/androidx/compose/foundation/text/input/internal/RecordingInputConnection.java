...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5596getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m5600getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo1513onImeActionKlQnJC8(iM5780getDefaulteUduSuo);
        return true;
    }
