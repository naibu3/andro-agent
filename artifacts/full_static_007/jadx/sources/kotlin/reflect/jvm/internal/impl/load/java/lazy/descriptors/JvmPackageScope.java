...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1496getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo1496getContributedClassifier = this.javaScope.mo1496getContributedClassifier(name, location);
        if (classDescriptorMo1496getContributedClassifier != null) {
            return classDescriptorMo1496getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1496getContributedClassifier(name, location);
