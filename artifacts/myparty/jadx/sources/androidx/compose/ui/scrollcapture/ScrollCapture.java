...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM6273getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m6273getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m6245getXimpl(jM6273getTopLeftnOccac), IntOffset.m6246getYimpl(jM6273getTopLeftnOccac)), composeScrollCaptureCallback);
