...
public final class zzbcu {
    ...
    static /* bridge */ /* synthetic */ void zzh(zzbcu zzbcuVar) {
    ...
    public final void zzl() {
        synchronized (this.zzc) {
            if (this.zze != null && this.zzd == null) {
                zzbcx zzbcxVarZzd = zzd(new zzbcs(this), new zzbct(this));
                this.zzd = zzbcxVarZzd;
                zzbcxVarZzd.checkAvailabilityAndConnect();
            }
        }
    }
