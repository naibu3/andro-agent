...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m5179setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m5175getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m5174getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5055setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m5055setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6292getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4994placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo4994placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5173placeSelfgyyYBs(position);
    ...
    private final void m5173placeSelfgyyYBs(long position) {
        if (!IntOffset.m6244equalsimpl0(getPosition(), position)) {
            m5179setPositiongyyYBs(position);
    ...
    public final void m5177placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m5173placeSelfgyyYBs(IntOffset.m6249plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m5176performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m5178positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long jM6255getZeronOccac = IntOffset.INSTANCE.m6255getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM6255getZeronOccac = IntOffset.m6249plusqkQi6aY(jM6255getZeronOccac, lookaheadDelegate.getPosition());
            }
