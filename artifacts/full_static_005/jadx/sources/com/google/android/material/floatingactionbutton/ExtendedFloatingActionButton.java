...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public void setExtendMotionSpecResource(int id2) {
        setExtendMotionSpec(MotionSpec.createFromResource(getContext(), id2));
    }
    ...
    public void setShrinkMotionSpecResource(int id2) {
        setShrinkMotionSpec(MotionSpec.createFromResource(getContext(), id2));
    }
