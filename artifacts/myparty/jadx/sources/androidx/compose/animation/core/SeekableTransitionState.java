...
public final class SeekableTransitionState<S> extends TransitionState<S> {
    ...
    static final class C02861 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02861(SeekableTransitionState<S> seekableTransitionState, Continuation<? super C02861> continuation) {
            super(continuation);
            this.this$0 = seekableTransitionState;
        }
    ...
    static final class C02871 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02871(SeekableTransitionState<S> seekableTransitionState, Continuation<? super C02871> continuation) {
            super(continuation);
            this.this$0 = seekableTransitionState;
        }
    ...
    */
    ...
    public final Object snapTo(S s, Continuation<? super Unit> continuation) {
        ...
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C02852(this, s, transition, null), continuation, 1, null);
    ...
    static final class C02852 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02852(SeekableTransitionState<S> seekableTransitionState, S s, Transition<S> transition, Continuation<? super C02852> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02852(this.this$0, this.$targetState, this.$transition, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C02852) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object waitForCompositionAfterTargetStateChange(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C02871) {
            ...
            if ((c02871.label & Integer.MIN_VALUE) != 0) {
                ...
                c02871 = new C02871(this, continuation);
            }
        }
        Object obj2 = c02871.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02871.label;
        if (i == 0) {
            ...
            c02871.L$0 = this;
            c02871.L$1 = targetState;
            c02871.label = 1;
            if (Mutex.DefaultImpls.lock$default(mutex, null, c02871, 1, null) != coroutine_suspended) {
                seekableTransitionState = this;
            }
            return coroutine_suspended;
        }
        if (i != 1) {
            ...
            obj = c02871.L$1;
            seekableTransitionState2 = (SeekableTransitionState) c02871.L$0;
            ResultKt.throwOnFailure(obj2);
        ...
        Object obj3 = c02871.L$1;
        seekableTransitionState = (SeekableTransitionState) c02871.L$0;
        ResultKt.throwOnFailure(obj2);
        targetState = obj3;
        ...
        c02871.L$0 = seekableTransitionState;
        c02871.L$1 = targetState;
        c02871.label = 2;
        C02871 c028712 = c02871;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c028712), 1);
        ...
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(c028712);
        }
    ...
    public final Object waitForComposition(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C02861) {
            ...
            if ((c02861.label & Integer.MIN_VALUE) != 0) {
                ...
                c02861 = new C02861(this, continuation);
            }
        }
        Object obj2 = c02861.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02861.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj2);
            ...
            Mutex mutex = this.compositionContinuationMutex;
            c02861.L$0 = this;
            c02861.L$1 = targetState;
            c02861.label = 1;
            if (Mutex.DefaultImpls.lock$default(mutex, null, c02861, 1, null) != coroutine_suspended) {
                seekableTransitionState = this;
            }
            return coroutine_suspended;
        }
        if (i != 1) {
            ...
            obj = c02861.L$1;
            seekableTransitionState2 = (SeekableTransitionState) c02861.L$0;
            ResultKt.throwOnFailure(obj2);
            if (Intrinsics.areEqual(obj2, obj)) {
                seekableTransitionState2.lastFrameTimeNanos = Long.MIN_VALUE;
        ...
        Object obj3 = c02861.L$1;
        seekableTransitionState = (SeekableTransitionState) c02861.L$0;
        ResultKt.throwOnFailure(obj2);
        targetState = obj3;
        c02861.L$0 = seekableTransitionState;
        c02861.L$1 = targetState;
        c02861.label = 2;
        C02861 c028612 = c02861;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c028612), 1);
        cancellableContinuationImpl.initCancellability();
        seekableTransitionState.setCompositionContinuation$animation_core_release(cancellableContinuationImpl);
        Mutex.DefaultImpls.unlock$default(seekableTransitionState.getCompositionContinuationMutex(), null, 1, null);
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(c028612);
        }
        if (result != coroutine_suspended) {
            obj = targetState;
            obj2 = result;
