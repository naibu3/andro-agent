...
final class SunbitUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) SunbitDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_sunbit, R.drawable.stripe_ic_paymentsheet_pm_sunbit_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_sunbit_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
