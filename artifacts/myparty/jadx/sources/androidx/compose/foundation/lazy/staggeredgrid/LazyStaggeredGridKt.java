                    ...
                    if (i9 == 0) {
                        ...
                        if (i11 == 0) {
                            ...
                            if ((i14 & 306783379) == 306783378 || (i13 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
                                ...
                                if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                    ...
                                    PaddingValues paddingValuesM1013PaddingValues0680j_4 = i6 == 0 ? PaddingKt.m1013PaddingValues0680j_4(Dp.m6117constructorimpl(0)) : paddingValues2;
                                    if (i7 != 0) {
                                        z3 = false;
                                    }
                                    if ((i3 & 64) == 0) {
                                    ...
                                    float fM6117constructorimpl2 = i10 == 0 ? Dp.m6117constructorimpl(0) : f;
                                    if (i12 == 0) {
                                        z4 = z7;
                                ...
                                int i17 = i16 & 14;
                                Function0<LazyStaggeredGridItemProvider> function0RememberStaggeredGridItemProviderLambda = LazyStaggeredGridItemProviderKt.rememberStaggeredGridItemProviderLambda(lazyStaggeredGridState, function1, composerStartRestartGroup, ((i13 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i17);
                            ...
                            if (scopeUpdateScopeEndRestartGroup == null) {
                                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
                                    ...
                                    public final void invoke(Composer composer3, int i26) {
                                        LazyStaggeredGridKt.m1221LazyStaggeredGridLJWHXA8(lazyStaggeredGridState, orientation, lazyGridStaggeredGridSlotsProvider, modifier4, paddingValues4, z6, flingBehavior4, z5, f4, f5, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
                                    }
                                });
                                return;
                            }
                        ...
                        if ((i14 & 306783379) == 306783378) {
                            ...
                            if ((i & 1) != 0) {
                                ...
                                int i172 = i16 & 14;
                                Function0<LazyStaggeredGridItemProvider> function0RememberStaggeredGridItemProviderLambda2 = LazyStaggeredGridItemProviderKt.rememberStaggeredGridItemProviderLambda(lazyStaggeredGridState, function1, composerStartRestartGroup, ((i13 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i172);
                                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 773894976, "CC(rememberCoroutineScope)482@20332L144:Effects.kt#9igjgp");
                                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -954367824, "CC(remember):Effects.kt#9igjgp");
                                objRememberedValue = composerStartRestartGroup.rememberedValue();
                                if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                ...
                                boolean z82 = z3;
                                int i232 = i16;
                                Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> function2M1232rememberStaggeredGridMeasurePolicyqKj4JfE2 = LazyStaggeredGridMeasurePolicyKt.m1232rememberStaggeredGridMeasurePolicyqKj4JfE(lazyStaggeredGridState, function0RememberStaggeredGridItemProviderLambda2, paddingValues3, z82, orientation, f3, fM6117constructorimpl, coroutineScope2, lazyGridStaggeredGridSlotsProvider, (GraphicsContext) objConsume3, composerStartRestartGroup, i222);
                                PaddingValues paddingValues52 = paddingValues3;
                                float f62 = f3;
                                float f72 = fM6117constructorimpl;
                                int i242 = i232 >> 12;
                                boolean z92 = z4;
                                Modifier modifierLazyLayoutSemantics2 = LazyLayoutSemanticsKt.lazyLayoutSemantics(modifier3.then(lazyStaggeredGridState.getRemeasurementModifier()).then(lazyStaggeredGridState.getAwaitLayoutModifier()), function0RememberStaggeredGridItemProviderLambda2, LazyStaggeredGridSemanticsKt.rememberLazyStaggeredGridSemanticState(lazyStaggeredGridState, z82, composerStartRestartGroup, (i242 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i172), orientation, z92, z82, composerStartRestartGroup, ((i232 << 6) & 7168) | (i212 & 57344) | (i232 & 458752));
