...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public void setVisibility(int visibility) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    static void copySize(View from, View to) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
