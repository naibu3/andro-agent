    ...
    */
    public final FunctionDescriptor findFunctionDescriptor(String name, String signature) {
        ...
        if (arrayList.size() != 1) {
            ...
            throw new KotlinReflectionInternalError("Function '" + name + "' (JVM signature: " + signature + ") not resolved in " + this + AbstractJsonLexerKt.COLON + (strJoinToString$default.length() == 0 ? " no members found" : "\n" + strJoinToString$default));
        }
