...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m429setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m431sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m6279boximpl(fullSize)).getPackedValue();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m6279boximpl(fullSize)).getPackedValue();
                }
            }
        }
        return fullSize;
    ...
    public final long m433targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m6255getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m6255getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m6279boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo3262alignKFBX0sM = alignment.mo3262alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m6248minusqkQi6aY(jMo3262alignKFBX0sM, alignment2.mo3262alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m6255getZeronOccac();
        }
        return IntOffset.INSTANCE.m6255getZeronOccac();
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jIntSize = IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight());
            this.lookaheadSize = jIntSize;
            m429setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, IntSize.m6287getWidthimpl(jIntSize), IntSize.m6286getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo4993measureBRTryo02 = measurable.mo4993measureBRTryo0(j);
            long jIntSize2 = IntSizeKt.IntSize(placeableMo4993measureBRTryo02.getWidth(), placeableMo4993measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m407isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m6279boximpl(m434invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m434invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m431sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jIntSize2 = stateAnimate3.getValue().getPackedValue();
            }
            long jM6084constrain4WqzIAM = ConstraintsKt.m6084constrain4WqzIAM(j, jIntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long jM6255getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m6236boximpl(m435invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m435invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m433targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m6255getZeronOccac() : stateAnimate2.getValue().getPackedValue();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM6255getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m6236boximpl(m436invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m436invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m432slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m6255getZeronOccac() : stateAnimate.getValue().getPackedValue();
            Alignment alignment2 = this.currentAlignment;
            final long jM6249plusqkQi6aY = IntOffset.m6249plusqkQi6aY(alignment2 != null ? alignment2.mo3262alignKFBX0sM(j2, jM6084constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m6255getZeronOccac(), jM6255getZeronOccac2);
            return MeasureScope.layout$default(measureScope, IntSize.m6287getWidthimpl(jM6084constrain4WqzIAM), IntSize.m6286getHeightimpl(jM6084constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo4993measureBRTryo02, IntOffset.m6245getXimpl(jM6255getZeronOccac) + IntOffset.m6245getXimpl(jM6249plusqkQi6aY), IntOffset.m6246getYimpl(jM6255getZeronOccac) + IntOffset.m6246getYimpl(jM6249plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo4993measureBRTryo03 = measurable.mo4993measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo4993measureBRTryo03.getWidth(), placeableMo4993measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4993measureBRTryo03, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m432slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM6255getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6255getZeronOccac() : slideOffset2.invoke(IntSize.m6279boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long jM6255getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6255getZeronOccac() : slideOffset.invoke(IntSize.m6279boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m6255getZeronOccac();
        }
        if (i == 2) {
            return jM6255getZeronOccac;
        }
        if (i == 3) {
            return jM6255getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }
}
