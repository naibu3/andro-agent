...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public void setCompatElevationResource(int id2) {
        setCompatElevation(getResources().getDimension(id2));
    }
    ...
    public void setCompatHoveredFocusedTranslationZResource(int id2) {
        setCompatHoveredFocusedTranslationZ(getResources().getDimension(id2));
    }
    ...
    public void setCompatPressedTranslationZResource(int id2) {
        setCompatPressedTranslationZ(getResources().getDimension(id2));
    }
    ...
    public void setShowMotionSpecResource(int id2) {
        setShowMotionSpec(MotionSpec.createFromResource(getContext(), id2));
    }
    ...
    public void setHideMotionSpecResource(int id2) {
        setHideMotionSpec(MotionSpec.createFromResource(getContext(), id2));
    }
