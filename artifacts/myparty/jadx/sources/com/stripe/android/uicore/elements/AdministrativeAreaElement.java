...
public final /* data */ class AdministrativeAreaElement extends SectionSingleFieldElement {
    ...
    public static /* synthetic */ AdministrativeAreaElement copy$default(AdministrativeAreaElement administrativeAreaElement, IdentifierSpec identifierSpec, DropdownFieldController dropdownFieldController, int i, Object obj) {
        if ((i & 1) != 0) {
            identifierSpec = administrativeAreaElement.identifier;
        }
        if ((i & 2) != 0) {
            dropdownFieldController = administrativeAreaElement.controller;
        }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.identifier, administrativeAreaElement.identifier) && Intrinsics.areEqual(this.controller, administrativeAreaElement.controller);
    }
