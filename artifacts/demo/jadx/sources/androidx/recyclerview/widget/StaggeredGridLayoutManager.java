...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager3.mLayoutState.mInfinite || !staggeredGridLayoutManager3.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == r9) {
                decoratedMeasurement = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMaxEnd(i3) : nextSpan.getEndLine(i3);
                ...
                minStart = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMinStart(i3) : nextSpan.getStartLine(i3);
            ...
            if (staggeredGridLayoutManager3.mOrientation == 1) {
                span = nextSpan;
                i2 = i6;
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i2, i4, decoratedMeasurement2, i5);
                staggeredGridLayoutManager = this;
            } else {
                span = nextSpan;
                StaggeredGridLayoutManager staggeredGridLayoutManager4 = this;
                staggeredGridLayoutManager4.layoutDecoratedWithMargins(next, i4, i6, i5, decoratedMeasurement2);
                i2 = i6;
