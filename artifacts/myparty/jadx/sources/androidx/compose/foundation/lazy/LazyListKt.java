...
public final class LazyListKt {
            ...
            if ((i4 & 8) == 0) {
                ...
                if ((i4 & 32) != 0) {
                    ...
                    if (i9 != 0) {
                        ...
                        if ((306783379 & i5) != 306783378 || (i16 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
                            int i18 = i6 == 0 ? 0 : i7;
                            ...
                            int i19 = (i5 >> 3) & 14;
                            Function0<LazyListItemProvider> function0RememberLazyListItemProviderLambda = LazyListItemProviderKt.rememberLazyListItemProviderLambda(lazyListState2, function1, composerStartRestartGroup, i19 | ((i16 >> 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                            int i20 = i5 >> 9;
                            LazyLayoutSemanticState lazyLayoutSemanticStateRememberLazyListSemanticState = LazyListSemanticsKt.rememberLazyListSemanticState(lazyListState2, z2, composerStartRestartGroup, i19 | (i20 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                            ...
                            int i21 = i5 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                            int i22 = i5 & 7168;
                            int i23 = i5 >> 6;
                            int i24 = i16 << 21;
                            ...
                            LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsStateRememberLazyListBeyondBoundsState = LazyListBeyondBoundsModifierKt.rememberLazyListBeyondBoundsState(lazyListState2, i18, composerStartRestartGroup, i19 | ((i26 >> 18) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                    ...
                    if ((306783379 & i5) != 306783378) {
                        ...
                        int i192 = (i5 >> 3) & 14;
                        Function0<LazyListItemProvider> function0RememberLazyListItemProviderLambda2 = LazyListItemProviderKt.rememberLazyListItemProviderLambda(lazyListState2, function1, composerStartRestartGroup, i192 | ((i16 >> 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                        int i202 = i5 >> 9;
                        LazyLayoutSemanticState lazyLayoutSemanticStateRememberLazyListSemanticState2 = LazyListSemanticsKt.rememberLazyListSemanticState(lazyListState2, z2, composerStartRestartGroup, i192 | (i202 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                        ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 773894976, "CC(rememberCoroutineScope)482@20332L144:Effects.kt#9igjgp");
                        ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -954367824, "CC(remember):Effects.kt#9igjgp");
                        objRememberedValue = composerStartRestartGroup.rememberedValue();
                        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        ...
                        int i212 = i5 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                        int i222 = i5 & 7168;
                        int i232 = i5 >> 6;
                        int i242 = i16 << 21;
                        ...
                        LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsStateRememberLazyListBeyondBoundsState2 = LazyListBeyondBoundsModifierKt.rememberLazyListBeyondBoundsState(lazyListState2, i18, composerStartRestartGroup, i192 | ((i262 >> 18) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
    ...
    */
    private static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> rememberLazyListMeasurePolicy(final Function0<? extends LazyListItemProvider> function0, final LazyListState lazyListState, final PaddingValues paddingValues, final boolean z, boolean z2, final int i, Alignment.Horizontal horizontal, Alignment.Vertical vertical, Arrangement.Horizontal horizontal2, Arrangement.Vertical vertical2, final CoroutineScope coroutineScope, final GraphicsContext graphicsContext, final boolean z3, Composer composer, int i2, int i3) {
        ...
        boolean z10 = ((((i2 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) ^ 48) > 32 && composer.changed(lazyListState)) || (i2 & 48) == 32) | ((((i2 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(paddingValues)) || (i2 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | ((((i2 & 7168) ^ 3072) > 2048 && composer.changed(z)) || (i2 & 3072) == 2048);
        if (((57344 & i2) ^ 24576) > 16384) {
            ...
            if (((3670016 & i2) ^ 1572864) <= 1048576) {
                ...
                if (((29360128 & i2) ^ 12582912) > 8388608) {
                    ...
                    if (((234881024 & i2) ^ 100663296) <= 67108864) {
                        ...
                        if (((1879048192 & i2) ^ 805306368) > 536870912) {
                            ...
                            zChanged = z9 | z14 | composer.changed(graphicsContext) | ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composer.changed(z3)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
                            ...
                            if (!zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                ...
                                objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                                    ...
                                    public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                                        return m1122invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                                    }

                                    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                                    public final LazyListMeasureResult m1122invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                                        int i4;
                                        int i5;
                                        final int i6;
                                        float spacing;
                                        ...
                                        ObservableScopeInvalidator.m1194attachToScopeimpl(lazyListState.m1137getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                                        boolean z16 = lazyListState.getHasLookaheadPassOccurred() || lazyLayoutMeasureScope.isLookingAhead();
                                        CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, z15 ? Orientation.Vertical : Orientation.Horizontal);
                                        if (z15) {
                                            i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo971calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                                        } else {
                                            i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                                        }
                                        if (z15) {
                                            i5 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo972calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                                        } else {
                                            i5 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                                        }
                                        int i7 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getTop());
                                        int i8 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getBottom());
                                        final int i9 = i7 + i8;
                                        final int i10 = i4 + i5;
                                        boolean z17 = z15;
                                        int i11 = z17 ? i9 : i10;
                                        ...
                                        final long jM6089offsetNN6EwU = ConstraintsKt.m6089offsetNN6EwU(j, -i10, -i9);
                                        final LazyListItemProvider lazyListItemProviderInvoke = function0.invoke();
                                        lazyListItemProviderInvoke.getItemScope().setMaxSize(Constraints.m6070getMaxWidthimpl(jM6089offsetNN6EwU), Constraints.m6069getMaxHeightimpl(jM6089offsetNN6EwU));
                                        if (z15) {
                                        ...
                                        final int i13 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(spacing);
                                        final int itemCount = lazyListItemProviderInvoke.getItemCount();
                                        if (z15) {
                                            iM6070getMaxWidthimpl = Constraints.m6069getMaxHeightimpl(j) - i9;
                                        } else {
                                            iM6070getMaxWidthimpl = Constraints.m6070getMaxWidthimpl(j) - i10;
                                        }
                                        int i14 = iM6070getMaxWidthimpl;
                                        if (!z || i14 > 0) {
                                        ...
                                        LazyListMeasuredItemProvider lazyListMeasuredItemProvider = new LazyListMeasuredItemProvider(jM6089offsetNN6EwU, z19, lazyListItemProviderInvoke, lazyLayoutMeasureScope, itemCount, i13, horizontal8, vertical8, z20, i6, i12, jIntOffset, lazyListState2) { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measuredItemProvider$1
                                            ...
                                            public LazyListMeasuredItem mo1123createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints) {
                                        ...
                                        try {
                                            ...
                                            LazyListMeasureResult lazyListMeasureResultM1127measureLazyListx0Ok8Vo = LazyListMeasureKt.m1127measureLazyListx0Ok8Vo(itemCount, lazyListMeasuredItemProvider, i14, i6, i12, i13, iUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, f, jM6089offsetNN6EwU, z15, listEmptyList, vertical5, horizontal5, z, lazyLayoutMeasureScope, lazyListState.getItemAnimator$foundation_release(), i, listCalculateLazyLayoutPinnedIndices, z16, lazyLayoutMeasureScope.isLookingAhead(), lazyListState.getPostLookaheadLayoutInfo(), coroutineScope, lazyListState.m1138getPlacementScopeInvalidatorzYiylxw$foundation_release(), graphicsContext, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measureResult$1
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(3);
                                                }
                                                ...
                                                public final MeasureResult invoke(int i15, int i16, Function1<? super Placeable.PlacementScope, Unit> function1) {
                                                    return lazyLayoutMeasureScope.layout(ConstraintsKt.m6087constrainWidthK40F9xA(j, i15 + i10), ConstraintsKt.m6086constrainHeightK40F9xA(j, i16 + i9), MapsKt.emptyMap(), function1);
                                                }
                                            });
                                            LazyListState.applyMeasureResult$foundation_release$default(lazyListState, lazyListMeasureResultM1127measureLazyListx0Ok8Vo, lazyLayoutMeasureScope.isLookingAhead(), false, 4, null);
                                            return lazyListMeasureResultM1127measureLazyListx0Ok8Vo;
                                        } catch (Throwable th) {
                                            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                                            throw th;
                                        }
                        ...
                        if (!zChanged) {
                            ...
                            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                                ...
                                public final LazyListMeasureResult m1122invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                                    ...
                                    ObservableScopeInvalidator.m1194attachToScopeimpl(lazyListState.m1137getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                                    boolean z16 = lazyListState.getHasLookaheadPassOccurred() || lazyLayoutMeasureScope.isLookingAhead();
                                    CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, z152 ? Orientation.Vertical : Orientation.Horizontal);
                                    if (z152) {
                                        i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo971calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                                    } else {
                                        i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                                    ...
                                    try {
                                        ...
                                        LazyListMeasureResult lazyListMeasureResultM1127measureLazyListx0Ok8Vo = LazyListMeasureKt.m1127measureLazyListx0Ok8Vo(itemCount, lazyListMeasuredItemProvider, i14, i6, i12, i13, iUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, f, jM6089offsetNN6EwU, z152, listEmptyList, vertical52, horizontal52, z, lazyLayoutMeasureScope, lazyListState.getItemAnimator$foundation_release(), i, listCalculateLazyLayoutPinnedIndices, z16, lazyLayoutMeasureScope.isLookingAhead(), lazyListState.getPostLookaheadLayoutInfo(), coroutineScope, lazyListState.m1138getPlacementScopeInvalidatorzYiylxw$foundation_release(), graphicsContext, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measureResult$1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(3);
                                            }
                    ...
                    zChanged = z9 | z142 | composer.changed(graphicsContext) | ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composer.changed(z3)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
                    objRememberedValue = composer.rememberedValue();
                    if (!zChanged) {
                    }
                ...
                zChanged = z9 | z1422 | composer.changed(graphicsContext) | ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composer.changed(z3)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
                objRememberedValue = composer.rememberedValue();
                if (!zChanged) {
                }
            ...
            zChanged = z9 | z14222 | composer.changed(graphicsContext) | ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composer.changed(z3)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
            objRememberedValue = composer.rememberedValue();
            if (!zChanged) {
            }
        ...
        zChanged = z9 | z142222 | composer.changed(graphicsContext) | ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composer.changed(z3)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
        objRememberedValue = composer.rememberedValue();
        if (!zChanged) {
        }
