...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i2, int i3) throws IllegalBlockSizeException {
        ...
        if (i4 != bArrCopyOf.length) {
            if (this.padding == 3) {
                ...
                System.arraycopy(bArrCopyOf, 0, bArr2, bArrCopyOf.length - i4, i4);
                bArrCopyOf = bArr2;
            } else {
    ...
    public void engineInitInternal(int i2, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        if (i2 == 1 || i2 == 3) {
    ...
    @Override // javax.crypto.CipherSpi
    public int engineDoFinal(byte[] bArr, int i2, int i3, byte[] bArr2, int i4) throws IllegalBlockSizeException, ShortBufferWithoutStackTraceException {
        byte[] bArrEngineDoFinal = engineDoFinal(bArr, i2, i3);
        int length = bArrEngineDoFinal.length + i4;
