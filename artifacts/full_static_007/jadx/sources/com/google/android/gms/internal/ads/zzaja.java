...
final class zzaja {
    ...
    public final long zzd(zzadv zzadvVar, boolean z, boolean z2, int i) throws IOException {
        if (this.zzc == 0) {
            if (!zzadvVar.zzn(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            ((zzadi) zzadvVar).zzn(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
