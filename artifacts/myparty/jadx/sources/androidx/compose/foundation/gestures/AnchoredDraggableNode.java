...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect != null) {
                            ...
                            long jM724reverseIfNeededMKHz9U = anchoredDraggableNode.m724reverseIfNeededMKHz9U(dragDelta.getDelta());
                            int iM4759getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m4759getUserInputWNlRxjI();
                            ...
                            overscrollEffect.mo557applyToScrollRhakbz0(jM724reverseIfNeededMKHz9U, iM4759getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                    return Offset.m3405boximpl(m731invokeMKHz9U(offset.getPackedValue()));
                                }

                                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                                public final long m731invokeMKHz9U(long j) {
                                    float fNewOffsetForDelta$foundation_release = ((AnchoredDraggableNode) anchoredDraggableNode2).state.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m726toFloatk4lQ0M(j));
                                    AnchoredDraggableNode<T> anchoredDraggableNode3 = anchoredDraggableNode2;
                                    long jM727toOffsettuRUvjQ = anchoredDraggableNode3.m727toOffsettuRUvjQ(fNewOffsetForDelta$foundation_release - ((AnchoredDraggableNode) anchoredDraggableNode3).state.requireOffset());
                                    AnchoredDragScope.dragTo$default(anchoredDragScope2, fNewOffsetForDelta$foundation_release, 0.0f, 2, null);
                                    return jM727toOffsettuRUvjQ;
                                }
                            });
                            return;
                        }
                        ...
                        AnchoredDragScope.dragTo$default(anchoredDragScope3, anchoredDraggableState.newOffsetForDelta$foundation_release(anchoredDraggableNode3.m726toFloatk4lQ0M(anchoredDraggableNode3.m724reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                    }
                };
                this.label = 1;
    ...
    public final long m727toOffsettuRUvjQ(float f) {
    ...
    public final long m728toVelocityadjELrA(float f) {
        float f2 = this.orientation == Orientation.Horizontal ? f : 0.0f;
        if (this.orientation != Orientation.Vertical) {
            f = 0.0f;
        }
    ...
    public final float m725toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m6355getYimpl(j) : Velocity.m6354getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m726toFloatk4lQ0M(long j) {
        return this.orientation == Orientation.Vertical ? Offset.m3417getYimpl(j) : Offset.m3416getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-AH228Gc, reason: not valid java name */
    public final long m723reverseIfNeededAH228Gc(long j) {
        return Velocity.m6360timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m724reverseIfNeededMKHz9U(long j) {
        return Offset.m3423timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}
