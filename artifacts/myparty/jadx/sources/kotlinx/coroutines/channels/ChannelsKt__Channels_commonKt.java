...
final /* synthetic */ class ChannelsKt__Channels_commonKt {
    ...
    static final class C12591<E> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
    ...
    */
    public static final <E> Object toList(ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation) {
        ...
        List list2;
        Object objHasNext;
        if (continuation instanceof C12591) {
            c12591 = (C12591) continuation;
            if ((c12591.label & Integer.MIN_VALUE) != 0) {
                c12591.label -= Integer.MIN_VALUE;
            } else {
                c12591 = new C12591(continuation);
            }
        }
        Object obj = c12591.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c12591.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            try {
                ...
                c12591.L$0 = list;
                c12591.L$1 = list2;
                c12591.L$2 = receiveChannel2;
                c12591.L$3 = it;
                c12591.label = 1;
                objHasNext = it.hasNext(c12591);
                if (objHasNext != coroutine_suspended) {
                }
            } catch (Throwable th2) {
                receiveChannel2 = receiveChannel;
            ...
            it = (ChannelIterator) c12591.L$3;
            ReceiveChannel<? extends E> receiveChannel3 = (ReceiveChannel) c12591.L$2;
            List list3 = (List) c12591.L$1;
            list = (List) c12591.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                List list4 = list3;
                if (!((Boolean) obj).booleanValue()) {
