...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m3368customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3338getNextdhqQ8s())) {
            return focusPropertiesFetchFocusProperties$ui_release.getNext();
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3339getPreviousdhqQ8s())) {
        ...
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3335getEnterdhqQ8s())) {
            return focusPropertiesFetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m3325boximpl(i));
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3336getExitdhqQ8s())) {
            return focusPropertiesFetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m3325boximpl(i));
        }
        throw new IllegalStateException("invalid FocusDirection".toString());
    }

    /* renamed from: focusSearch-0X8WOeE, reason: not valid java name */
    public static final Boolean m3369focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int iM3340getRightdhqQ8s;
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3338getNextdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3339getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m3372oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3337getLeftdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3341getUpdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3334getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m3381twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3335getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM3340getRightdhqQ8s = FocusDirection.INSTANCE.m3340getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM3340getRightdhqQ8s = FocusDirection.INSTANCE.m3337getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (focusTargetNodeFindActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m3381twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode, iM3340getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3336getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m3330toStringimpl(i))).toString());
    }
