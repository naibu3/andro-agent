...
public class Nysiis implements StringEncoder {
    ...
    public String nysiis(String str) {
        ...
        String strReplaceFirst = PAT_DT_ETC.matcher(PAT_EE_IE.matcher(PAT_SCH.matcher(PAT_PH_PF.matcher(PAT_K.matcher(PAT_KN.matcher(PAT_MAC.matcher(strClean).replaceFirst("MCC")).replaceFirst("NN")).replaceFirst(Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE)).replaceFirst("FF")).replaceFirst("SSS")).replaceFirst(ChallengeRequestData.YES_VALUE)).replaceFirst("D");
