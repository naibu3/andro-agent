...
public final class DurationKt {
    ...
    private static final long m1582timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1494timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1581timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1493timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:184:0x00dc A[EDGE_INSN: B:184:0x00dc->B:51:0x00dc BREAK  A[LOOP:1: B:38:0x0081->B:49:0x00c1], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:49:0x00c1 A[LOOP:1: B:38:0x0081->B:49:0x00c1, LOOP_END] */
    /*
    ...
    */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result = Duration.INSTANCE.m1558getZEROUwyO8pc();
        String component = "Infinity";
        char cCharAt = str.charAt(0);
        int index2 = cCharAt == '+' || cCharAt == '-' ? 0 + 1 : 0;
        boolean hasSign2 = index2 > 0;
        boolean isNegative3 = hasSign2 && StringsKt.startsWith$default((CharSequence) str, '-', false, 2, (Object) null);
        if (length3 <= index2) {
            throw new IllegalArgumentException("No components");
        }
        if (str.charAt(index2) == 'P') {
            int index3 = index2 + 1;
            if (index3 == length3) {
            ...
            while (index3 < length3) {
                if (str.charAt(index3) == 'T') {
                    ...
                    String str2 = value;
                    if (index4 < 0 || index4 > StringsKt.getLastIndex(str2)) {
                        throw new IllegalArgumentException("Missing unit for value " + component2);
                    }
                    char unitChar = str2.charAt(index4);
                    index3 = index4 + 1;
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        long result2 = Duration.m1492plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring = component2.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                        result = Duration.m1492plusLRDsOJo(result2, toDuration(Double.parseDouble(strSubstring), unit));
                        str = value;
                        isNegative3 = isNegative2;
                        hasSign2 = hasSign;
                        nonDigitSymbols = $this$skipWhile$iv$iv;
                        ...
                        result = Duration.m1492plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(component2), unit));
                        str = value;
                        isNegative3 = isNegative2;
                        hasSign2 = hasSign;
                        nonDigitSymbols = $this$skipWhile$iv$iv;
            ...
            if (!strictIso) {
                ...
                if (StringsKt.regionMatches(value, index2, component3, 0, Math.max(length3 - index2, "Infinity".length()), true)) {
                    result = Duration.INSTANCE.m1556getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index2 < length) {
                        ...
                        String infinityString2 = component3;
                        int i$iv$iv2 = index;
                        while (true) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(component4, "this as java.lang.String…ing(startIndex, endIndex)");
                        ...
                        if (dotIndex2 > 0) {
                            Intrinsics.checkNotNull(component4, str3);
                            ...
                            String str4 = str3;
                            long result3 = Duration.m1492plusLRDsOJo(result, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component4, str4);
                            String strSubstring2 = component4.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                            result = Duration.m1492plusLRDsOJo(result3, toDuration(Double.parseDouble(strSubstring2), unit2));
                            if (index2 < length) {
                            ...
                            allowSpaces2 = allowSpaces;
                            component3 = infinityString2;
                        } else {
                            result = Duration.m1492plusLRDsOJo(result, toDuration(Long.parseLong(component4), unit2));
                            str3 = str3;
                            afterFirst2 = afterFirst;
                            allowSpaces2 = allowSpaces;
                            component3 = infinityString2;
        ...
        return isNegative ? Duration.m1508unaryMinusUwyO8pc(result) : result;
    }
