...
public final class BoletoDefinition implements PaymentMethodDefinition {
    public static final int $stable = 0;
    private static final boolean supportedAsSavedPaymentMethod = false;
    public static final BoletoDefinition INSTANCE = new BoletoDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Boleto;
    ...
    public UiDefinitionFactory uiDefinitionFactory() {
        return BoletoUiDefinitionFactory.INSTANCE;
    }
}
