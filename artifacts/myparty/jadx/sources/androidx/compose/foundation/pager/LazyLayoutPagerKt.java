            ...
            if ((i4 & 8) == 0) {
                ...
                if ((i4 & 64) == 0) {
                    ...
                    if ((i4 & 512) == 0) {
                        ...
                        if ((805306368 & i2) == 0) {
                            i5 |= composerStartRestartGroup.changed(pageSize) ? 536870912 : 268435456;
                        }
                        if ((i4 & 1024) != 0) {
                            i9 = i3 | 6;
                        } else if ((i3 & 6) == 0) {
                            ...
                            if ((i4 & 8192) == 0) {
                                ...
                                if ((i4 & 16384) == 0) {
                                    ...
                                    if ((i5 & 306783379) != 306783378 && (74899 & i11) == 74898 && composerStartRestartGroup.getSkipping()) {
                                        ...
                                        i12 = i6 == 0 ? 0 : i7;
                                        float fM6117constructorimpl = i8 == 0 ? Dp.m6117constructorimpl(0) : f;
                                        ...
                                        int i17 = i5 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                                        boolean z3 = i17 == 32;
                                        ...
                                        int i21 = i19 >> 12;
                                        int i22 = i5;
                                        Function0<PagerLazyLayoutItemProvider> function0RememberPagerItemProviderLambda = rememberPagerItemProviderLambda(pagerState, function4, function1, (Function0) objRememberedValue, composerStartRestartGroup, i20 | (i21 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ((i19 << 3) & 896));
                                        ...
                                        int i26 = i12;
                                        Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> function2M1263rememberPagerMeasurePolicy8u0NR3k = PagerMeasurePolicyKt.m1263rememberPagerMeasurePolicy8u0NR3k(function0RememberPagerItemProviderLambda, pagerState, paddingValues, z, orientation, i26, f3, pageSize, horizontal, vertical, snapPosition, coroutineScope, (Function0) objRememberedValue3, composerStartRestartGroup, (i22 & 65520) | (i24 & 458752) | (i24 & 3670016) | (i24 & 29360128) | (i25 & 234881024) | (i25 & 1879048192), i21 & 14);
                                        pagerState2 = pagerState;
                                        ...
                                        LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsStateRememberPagerBeyondBoundsState = PagerBeyondBoundsModifierKt.rememberPagerBeyondBoundsState(pagerState2, i26, composerStartRestartGroup, ((i22 >> 18) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i20);
                                        ...
                                        nestedScrollConnection2 = nestedScrollConnection;
                                        LazyLayoutKt.LazyLayout(function0RememberPagerItemProviderLambda, NestedScrollModifierKt.nestedScroll$default(modifierDragDirectionDetector, nestedScrollConnection2, null, 2, null), pagerState2.getPrefetchState(), function2M1263rememberPagerMeasurePolicy8u0NR3k, composerStartRestartGroup, 0, 0);
                                        composer2 = composerStartRestartGroup;
                                        if (ComposerKt.isTraceInProgress()) {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        if (pointerInputChange != null) {
                            ...
                            this.$state.m1270setUpDownDifferencek4lQ0M$foundation_release(Offset.m3420minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange2.getPosition()));
                            return Unit.INSTANCE;
                        }
                    }
                    this.$state.m1270setUpDownDifferencek4lQ0M$foundation_release(Offset.INSTANCE.m3432getZeroF1C5BW0());
