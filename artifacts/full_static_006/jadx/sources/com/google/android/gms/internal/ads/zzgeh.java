...
public abstract class zzgeh<V> extends zzggw implements ListenableFuture<V> {
    ...
    /* compiled from: com.google.android.gms:play-services-ads@@23.2.0 */
    abstract class zza {
        /* synthetic */ zza(zzgeg zzgegVar) {
        }

        abstract zzd zza(zzgeh zzgehVar, zzd zzdVar);

        abstract zzk zzb(zzgeh zzgehVar, zzk zzkVar);

        abstract void zzc(zzk zzkVar, @CheckForNull zzk zzkVar2);

        abstract void zzd(zzk zzkVar, Thread thread);

        abstract boolean zze(zzgeh zzgehVar, @CheckForNull zzd zzdVar, zzd zzdVar2);

        abstract boolean zzf(zzgeh zzgehVar, @CheckForNull Object obj, Object obj2);

        abstract boolean zzg(zzgeh zzgehVar, @CheckForNull zzk zzkVar, @CheckForNull zzk zzkVar2);
    }
    ...
    final class zze extends zza {
        ...
        final zzd zza(zzgeh zzgehVar, zzd zzdVar) {
            return this.zzd.getAndSet(zzgehVar, zzdVar);
        }

        @Override // com.google.android.gms.internal.ads.zzgeh.zza
        final zzk zzb(zzgeh zzgehVar, zzk zzkVar) {
        ...
        @Override // com.google.android.gms.internal.ads.zzgeh.zza
        final boolean zze(zzgeh zzgehVar, @CheckForNull zzd zzdVar, zzd zzdVar2) {
            return zzgei.zza(this.zzd, zzgehVar, zzdVar, zzdVar2);
        }

        @Override // com.google.android.gms.internal.ads.zzgeh.zza
        final boolean zzf(zzgeh zzgehVar, @CheckForNull Object obj, Object obj2) {
            return zzgei.zza(this.zze, zzgehVar, obj, obj2);
        }

        @Override // com.google.android.gms.internal.ads.zzgeh.zza
        final boolean zzg(zzgeh zzgehVar, @CheckForNull zzk zzkVar, @CheckForNull zzk zzkVar2) {
    ...
    final class zzf<V> implements Runnable {
        ...
        zzf(zzgeh zzgehVar, ListenableFuture listenableFuture) {
            this.zza = zzgehVar;
    ...
    static {
        ...
        if (th != null) {
            zzggd zzggdVar = zze;
            zzggdVar.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "UnsafeAtomicHelper is broken!", th2);
            zzggdVar.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "SafeAtomicHelper is broken!", th);
        }
        zzbc = new Object();
    }
    ...
    public static Object zze(ListenableFuture listenableFuture) {
        ...
        if (listenableFuture instanceof zzh) {
            Object zzbVar = ((zzgeh) listenableFuture).value;
        ...
        if ((listenableFuture instanceof zzggw) && (thZzl = ((zzggw) listenableFuture).zzl()) != null) {
    ...
    public static void zzx(zzgeh zzgehVar, boolean z) {
        zzd zzdVar = null;
        while (true) {
            for (zzk zzkVarZzb = zzbf.zzb(zzgehVar, zzk.zza); zzkVarZzb != null; zzkVarZzb = zzkVarZzb.next) {
            ...
            zzgehVar.zzb();
            zzd zzdVar2 = zzdVar;
            zzd zzdVarZza = zzbf.zza(zzgehVar, zzd.zza);
            zzd zzdVar3 = zzdVar2;
    ...
    public boolean cancel(boolean z) {
        ...
        zzgeh<V> zzgehVar = this;
        boolean z2 = false;
        while (true) {
            if (zzbf.zzf(zzgehVar, obj, objRequireNonNull)) {
                zzx(zzgehVar, z);
                if (!(obj instanceof zzf)) {
                    break;
                }
                ...
                zzgehVar = (zzgeh) listenableFuture;
                obj = zzgehVar.value;
    ...
    protected final boolean zzs(ListenableFuture listenableFuture) {
        ...
        if (obj == null) {
            ...
            if (zzbf.zzf(this, null, zzfVar)) {
                try {
                    listenableFuture.addListener(zzfVar, zzgfh.INSTANCE);
                } catch (Throwable th) {
                    try {
                        zzcVar = new zzc(th);
