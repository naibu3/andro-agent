...
@Metadata(d1 = {"\u0000\f\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001e\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\b\u0012\u0004\u0012\u0002H\u00010\u0002H\u0086@¢\u0006\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"await", ExifInterface.GPS_DIRECTION_TRUE, "Lcom/google/android/gms/tasks/Task;", "(Lcom/google/android/gms/tasks/Task;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "expo-camera_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
    ...
    public static final <T> Object await(Task<T> task, Continuation<? super T> continuation) {
        ...
        task.addOnFailureListener(new OnFailureListener() { // from class: expo.modules.camera.analyzers.MLKitBarcodeAnalyzerKt$await$2$2
            ...
            public final void onFailure(Exception exception) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation2.resumeWith(Result.m9118constructorimpl(ResultKt.createFailure(exception)));
            }
        });
