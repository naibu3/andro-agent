...
public final class FocusDirection {
    ...
    private static final int Next = m3326constructorimpl(1);
    private static final int Previous = m3326constructorimpl(2);
    private static final int Left = m3326constructorimpl(3);
    private static final int Right = m3326constructorimpl(4);
    private static final int Up = m3326constructorimpl(5);
    private static final int Down = m3326constructorimpl(6);
    private static final int Enter = m3326constructorimpl(7);
    private static final int Exit = m3326constructorimpl(8);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FocusDirection m3325boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m3327equalsimpl(this.value, obj);
    }
    ...
    public static String m3330toStringimpl(int i) {
        if (m3328equalsimpl0(i, Next)) {
            return "Next";
        }
        if (m3328equalsimpl0(i, Previous)) {
            return "Previous";
        }
        if (m3328equalsimpl0(i, Left)) {
            return "Left";
        }
        if (m3328equalsimpl0(i, Right)) {
            return "Right";
        }
        if (m3328equalsimpl0(i, Up)) {
            return "Up";
        }
        if (m3328equalsimpl0(i, Down)) {
            return "Down";
        }
        if (m3328equalsimpl0(i, Enter)) {
            return ReactEditTextInputConnectionWrapper.ENTER_KEY_VALUE;
        }
        if (m3328equalsimpl0(i, Exit)) {
            return "Exit";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3332getEnterdhqQ8s$annotations() {
        }

        /* renamed from: getExit-dhqQ-8s$annotations, reason: not valid java name */
        public static /* synthetic */ void m3333getExitdhqQ8s$annotations() {
        }
        ...
        public final int m3338getNextdhqQ8s() {
            return FocusDirection.Next;
        }

        /* renamed from: getPrevious-dhqQ-8s, reason: not valid java name */
        public final int m3339getPreviousdhqQ8s() {
            return FocusDirection.Previous;
        }

        /* renamed from: getLeft-dhqQ-8s, reason: not valid java name */
        public final int m3337getLeftdhqQ8s() {
            return FocusDirection.Left;
        }

        /* renamed from: getRight-dhqQ-8s, reason: not valid java name */
        public final int m3340getRightdhqQ8s() {
            return FocusDirection.Right;
        }

        /* renamed from: getUp-dhqQ-8s, reason: not valid java name */
        public final int m3341getUpdhqQ8s() {
            return FocusDirection.Up;
        }

        /* renamed from: getDown-dhqQ-8s, reason: not valid java name */
        public final int m3334getDowndhqQ8s() {
            return FocusDirection.Down;
        }

        /* renamed from: getEnter-dhqQ-8s, reason: not valid java name */
        public final int m3335getEnterdhqQ8s() {
            return FocusDirection.Enter;
        }

        /* renamed from: getExit-dhqQ-8s, reason: not valid java name */
        public final int m3336getExitdhqQ8s() {
