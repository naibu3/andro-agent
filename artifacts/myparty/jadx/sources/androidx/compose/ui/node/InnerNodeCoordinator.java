...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo4993measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m5056setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo377measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo4993measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m5174getConstraintsmsEJaDk$ui_release();
        }
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo377measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    */
    public void mo5137hitTestChildYqVAtuI(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        boolean z;
        boolean z2 = false;
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (m5222withinLayerBoundsk4lQ0M(pointerPosition)) {
                ...
                if (isTouchEvent) {
                    float f = m5210distanceInMinimumTouchTargettz77jQw(pointerPosition, m5213getMinimumTouchTargetSizeNHjbRc());
        ...
        if (z2) {
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode.isPlaced()) {
                        hitTestSource.mo5223childHitTestYqVAtuI(layoutNode, pointerPosition, hitTestResult, isTouchEvent, z);
    ...
    static {
        ...
        Paint.mo3536setColor8_81llA(Color.INSTANCE.m3691getRed0d7_KjU());
