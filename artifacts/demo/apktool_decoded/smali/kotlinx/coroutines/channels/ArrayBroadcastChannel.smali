...
.method private final updateHead(Lkotlinx/coroutines/channels/ArrayBroadcastChannel$Subscriber;Lkotlinx/coroutines/channels/ArrayBroadcastChannel$Subscriber;)V
    ...
    invoke-virtual {v2, v0}, Lkotlinx/coroutines/channels/Send;->tryResumeSend(Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;)Lkotlinx/coroutines/internal/Symbol;
    ...
    .local v23, "send":Ljava/lang/Object;
    if-ne v2, v0, :cond_5
    ...
    .end local v4    # "$this$withLock$iv":Ljava/util/concurrent/locks/ReentrantLock;
    .end local v5    # "$i$f$withLock":I
    .end local v23    # "send":Ljava/lang/Object;
    ...
    .end local v21    # "token":Lkotlinx/coroutines/internal/Symbol;
    .local v2, "token":Lkotlinx/coroutines/internal/Symbol;
    .restart local v23    # "send":Ljava/lang/Object;
    :goto_4
    ...
    .local v17, "token":Lkotlinx/coroutines/internal/Symbol;
    .local v21, "wasFull":Z
    int-to-long v2, v0
    ...
    invoke-virtual/range {v23 .. v23}, Lkotlinx/coroutines/channels/Send;->getPollResult()Ljava/lang/Object;
    ...
    .end local v12    # "head":J
    .end local v14    # "targetHead":J
    .end local v17    # "token":Lkotlinx/coroutines/internal/Symbol;
    .end local v21    # "wasFull":Z
    ...
    .end local v4    # "$this$withLock$iv":Ljava/util/concurrent/locks/ReentrantLock;
    .end local v5    # "$i$f$withLock":I
    invoke-virtual/range {v23 .. v23}, Lkotlinx/coroutines/channels/Send;->completeResumeSend()V
    ...
    .end local v3    # "wasFull":Z
    .restart local v17    # "token":Lkotlinx/coroutines/internal/Symbol;
    .local v21, "wasFull":Z
    .restart local v23    # "send":Ljava/lang/Object;
    move/from16 v0, v22
