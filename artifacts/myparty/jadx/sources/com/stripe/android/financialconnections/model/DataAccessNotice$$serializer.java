...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0015\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00070\u0006¢\u0006\u0002\u0010\bJ\u000e\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000bJ\u0016\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0002R\u0011\u0010\u0011\u001a\u00020\u0012¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, d2 = {"com/stripe/android/financialconnections/model/DataAccessNotice.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/stripe/android/financialconnections/model/DataAccessNotice;", "<init>", "()V", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "financial-connections_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@Deprecated(level = DeprecationLevel.HIDDEN, message = "This synthesized declaration should not be used directly")
/* loaded from: classes5.dex */
public /* synthetic */ class DataAccessNotice$$serializer implements GeneratedSerializer<DataAccessNotice> {
    ...
    public final DataAccessNotice deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            DataAccessNoticeBody dataAccessNoticeBody2 = (DataAccessNoticeBody) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 3, DataAccessNoticeBody$$serializer.INSTANCE, null);
            ConnectedAccessNotice connectedAccessNotice2 = (ConnectedAccessNotice) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 4, ConnectedAccessNotice$$serializer.INSTANCE, null);
            String str7 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 5, MarkdownToHtmlSerializer.INSTANCE, null);
            image = image3;
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 1:
                        ...
                        i2 = 6;
                    case 2:
                        str10 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 2, MarkdownToHtmlSerializer.INSTANCE, str10);
                        i3 |= 4;
                    case 3:
                        dataAccessNoticeBody3 = (DataAccessNoticeBody) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 3, DataAccessNoticeBody$$serializer.INSTANCE, dataAccessNoticeBody3);
                        i3 |= 8;
                    case 4:
                        connectedAccessNotice3 = (ConnectedAccessNotice) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 4, ConnectedAccessNotice$$serializer.INSTANCE, connectedAccessNotice3);
                        i3 |= 16;
                    case 5:
                        str11 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 5, MarkdownToHtmlSerializer.INSTANCE, str11);
                        i3 |= 32;
                    case 6:
                        str8 = (String) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, i2, MarkdownToHtmlSerializer.INSTANCE, str8);
                        i3 |= 64;
                    default:
        ...
        return new DataAccessNotice(i, image, str4, str3, dataAccessNoticeBody, connectedAccessNotice, str2, str, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(Encoder encoder, DataAccessNotice value) {
        ...
        DataAccessNotice.write$Self$financial_connections_release(value, compositeEncoderBeginStructure, serialDescriptor);
