...
public class MlKitAnalyzer implements ImageAnalysis.Analyzer {
    private static final Size DEFAULT_SIZE = new Size(480, CropImageOptionsKt.DEGREES_360);
        ...
        if (i > this.mDetectors.size() - 1) {
            ...
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.mlkit.vision.MlKitAnalyzer$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m259x19489dab(map, imageProxy, map2);
                }
            });
            return;
        }
        ...
        try {
            detector.process(image, imageProxy.getImageInfo().getRotationDegrees(), matrix).addOnCompleteListener(this.mExecutor, new OnCompleteListener() { // from class: androidx.camera.mlkit.vision.MlKitAnalyzer$$ExternalSyntheticLambda1
                ...
                public final void onComplete(Task task) {
                    this.f$0.m260xdc35070a(map2, detector, map, imageProxy, i, matrix, task);
                }
            });
        } catch (Exception e) {
    ...
    /* synthetic */ void m259x19489dab(Map map, ImageProxy imageProxy, Map map2) {
    ...
    /* synthetic */ void m260xdc35070a(Map map, Detector detector, Map map2, ImageProxy imageProxy, int i, Matrix matrix, Task task) {
        if (task.isCanceled()) {
