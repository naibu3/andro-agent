...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int iMo706roundToPx0680j_4 = density.mo706roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m2484getRightD9Ej5fM()) + i;
        int maxValue = iMo706roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo706roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo706roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(iMo706roundToPx0680j_4 - maxValue, 0));
    }
}
