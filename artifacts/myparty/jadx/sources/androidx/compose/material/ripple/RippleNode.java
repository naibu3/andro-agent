...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2096addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m3494getZeroNHjbRc();
    ...
    public final long m2108getRippleColor0d7_KjU() {
        return this.color.mo1876invoke0d7_KjU();
    }
    ...
    public void mo702onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m6299toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            fMo712toPx0680j_4 = RippleAnimationKt.m2100getRippleEndRadiuscSwnlzA(densityRequireDensity, this.bounded, this.rippleSize);
        } else {
            fMo712toPx0680j_4 = densityRequireDensity.mo712toPx0680j_4(this.radius);
        }
        this.targetRadius = fMo712toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo2096addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m2113drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2108getRippleColor0d7_KjU());
        }
