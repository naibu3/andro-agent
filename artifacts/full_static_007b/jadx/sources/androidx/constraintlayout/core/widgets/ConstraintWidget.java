                    ...
                    if (z14 && !constraintWidget3.resolvedVertical) {
                        ...
                        if (constraintWidget3.mBaselineDistance > 0 || constraintWidget3.mVisibility == i7) {
                            if (constraintWidget3.mBaseline.mTarget != null) {
                                ...
                                if (z13) {
                                    linearSystem2.addGreaterThan(solverVariableCreateObjectVariable8, linearSystem2.createObjectVariable(constraintWidget3.mBottom), i8, 5);
                                }
                                z15 = false;
                                ...
                                applyConstraints(linearSystem, false, z13, z11, z32, solverVariableCreateObjectVariable9, solverVariableCreateObjectVariable8, dimensionBehaviourArr2[r3], z31, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i9, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[r3], constraintWidget3.mVerticalBiasPercent, z26, dimensionBehaviourArr2[0] == DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z28, i3, i2, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z15);
                            } else {
                                if (constraintWidget3.mVisibility == i7) {
                                ...
                                applyConstraints(linearSystem, false, z13, z11, z322, solverVariableCreateObjectVariable9, solverVariableCreateObjectVariable8, dimensionBehaviourArr22[r3], z31, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i9, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[r3], constraintWidget3.mVerticalBiasPercent, z26, dimensionBehaviourArr22[0] == DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z28, i3, i2, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z15);
                            }
                        } else {
                            z15 = z10;
                            boolean z3222 = constraintWidget3.isTerminalWidget[r3];
                            DimensionBehaviour[] dimensionBehaviourArr222 = constraintWidget3.mListDimensionBehaviors;
                            applyConstraints(linearSystem, false, z13, z11, z3222, solverVariableCreateObjectVariable9, solverVariableCreateObjectVariable8, dimensionBehaviourArr222[r3], z31, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i9, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[r3], constraintWidget3.mVerticalBiasPercent, z26, dimensionBehaviourArr222[0] == DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z28, i3, i2, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z15);
                        }
                    }
                    if (z12) {
    ...
    private void applyConstraints(LinearSystem system, boolean isHorizontal, boolean parentWrapContent, boolean oppositeParentWrapContent, boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean oppositeVariable, boolean inChain, boolean oppositeInChain, boolean inBarrier, int matchConstraintDefault, int oppositeMatchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (!applyPosition || inChain) {
            ...
            if (numConnections4 < 2 && parentWrapContent && isTerminal4) {
                ...
                int i3 = (isHorizontal || constraintWidget4.mBaseline.mTarget == null) ? 1 : i2;
