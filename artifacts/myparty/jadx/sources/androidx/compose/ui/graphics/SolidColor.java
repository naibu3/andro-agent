...
public final class SolidColor extends Brush {
    ...
    public void mo3604applyToPq9zytI(long size, Paint p, float alpha) {
        long jM3656copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            jM3656copywmQWz5c$default = Color.m3656copywmQWz5c$default(j, Color.m3659getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            jM3656copywmQWz5c$default = this.value;
        }
        p.mo3536setColor8_81llA(jM3656copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m3658equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m3665toStringimpl(this.value)) + ')';
    }
}
