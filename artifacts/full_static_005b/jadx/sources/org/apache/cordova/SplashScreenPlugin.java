...
public class SplashScreenPlugin extends CordovaPlugin {
    ...
    private void setupSplashScreen(SplashScreen splashScreen) {
        splashScreen.setKeepOnScreenCondition(new SplashScreen.KeepOnScreenCondition() { // from class: org.apache.cordova.SplashScreenPlugin$$ExternalSyntheticLambda0
            ...
            public final boolean shouldKeepOnScreen() {
                return this.f$0.m1855lambda$setupSplashScreen$0$orgapachecordovaSplashScreenPlugin();
            }
        });
        if (this.autoHide && this.delayTime != -1) {
            new Handler(this.f9cordova.getContext().getMainLooper()).postDelayed(new Runnable() { // from class: org.apache.cordova.SplashScreenPlugin$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m1856lambda$setupSplashScreen$1$orgapachecordovaSplashScreenPlugin();
                }
            }, this.delayTime);
        }
        if (this.isFadeEnabled) {
    ...
    /* synthetic */ boolean m1855lambda$setupSplashScreen$0$orgapachecordovaSplashScreenPlugin() {
    ...
    /* synthetic */ void m1856lambda$setupSplashScreen$1$orgapachecordovaSplashScreenPlugin() {
        this.keepOnScreen = false;
    }
