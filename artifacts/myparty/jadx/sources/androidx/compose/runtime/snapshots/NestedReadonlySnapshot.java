...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(int i, SnapshotIdSet snapshotIdSet, Function1<Object, Unit> function1, Snapshot snapshot) {
        ...
        snapshot.mo3244nestedActivated$runtime_release(this);
    }
    ...
    public void dispose() {
        ...
        this.parent.mo3245nestedDeactivated$runtime_release(this);
        super.dispose();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* renamed from: recordModified$runtime_release, reason: merged with bridge method [inline-methods] */
    public Void mo3246recordModified$runtime_release(StateObject state) {
    ...
    public Void mo3245nestedDeactivated$runtime_release(Snapshot snapshot) {
    ...
    public Void mo3244nestedActivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
}
