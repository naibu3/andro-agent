...
final class AlmaUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) AlmaDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_alma, R.drawable.stripe_ic_paymentsheet_pm_alma_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_alma_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
