...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5100calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo5100calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM3416getXimpl = Offset.m3417getYimpl(jOffset);
        } else {
            fM3416getXimpl = Offset.m3416getXimpl(jOffset);
        }
        int iRound = Math.round(fM3416getXimpl);
