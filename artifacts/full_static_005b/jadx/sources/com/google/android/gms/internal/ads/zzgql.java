...
public final class zzgql implements zzgqq {
    ...
    private zzgql(String str, zzgze zzgzeVar, zzhac zzhacVar, zzgwg zzgwgVar, zzgxn zzgxnVar, @Nullable Integer num) {
        this.zza = str;
        this.zzb = zzgzeVar;
        this.zzc = zzhacVar;
        this.zzd = zzgwgVar;
    ...
    public static zzgql zza(String str, zzhac zzhacVar, zzgwg zzgwgVar, zzgxn zzgxnVar, @Nullable Integer num) throws GeneralSecurityException {
