...
public final class InputChipDefaults {
    ...
    public final SelectableChipColors m2336inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        long jM3692getTransparent0d7_KjU2 = (i3 & 16) != 0 ? Color.INSTANCE.m3692getTransparent0d7_KjU() : j5;
        long jM3656copywmQWz5c$default = (i3 & 32) != 0 ? Color.m3656copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long jM3656copywmQWz5c$default2 = (i3 & 64) != 0 ? Color.m3656copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long jM3656copywmQWz5c$default3 = (i3 & 128) != 0 ? Color.m3656copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j8;
        long color4 = (i3 & 256) != 0 ? ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getSelectedContainerColor(), composer, 6) : j9;
        long jM3656copywmQWz5c$default4 = (i3 & 512) != 0 ? Color.m3656copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j10;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(jM3692getTransparent0d7_KjU, color, color2, color3, jM3692getTransparent0d7_KjU2, jM3656copywmQWz5c$default, jM3656copywmQWz5c$default2, jM3656copywmQWz5c$default3, color4, jM3656copywmQWz5c$default4, color5, color6, color7, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m2337inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = InputChipTokens.INSTANCE.m2846getContainerElevationD9Ej5fM();
        }
        float f7 = f;
        float f8 = (i2 & 2) != 0 ? f7 : f2;
        float f9 = (i2 & 4) != 0 ? f7 : f3;
        float f10 = (i2 & 8) != 0 ? f7 : f4;
        float fM2848getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2848getDraggedContainerElevationD9Ej5fM() : f5;
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(f7, f8, f9, f10, fM2848getDraggedContainerElevationD9Ej5fM, f11, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m2335inputChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long jM3656copywmQWz5c$default = (i2 & 4) != 0 ? Color.m3656copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM3692getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.INSTANCE.m3692getTransparent0d7_KjU() : j4;
        float fM2852getUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2852getUnselectedOutlineWidthD9Ej5fM() : f;
        float fM2850getSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? InputChipTokens.INSTANCE.m2850getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-324924235, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipBorder (Chip.kt:1120)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, jM3692getTransparent0d7_KjU, jM3656copywmQWz5c$default, jM3692getTransparent0d7_KjU2, fM2852getUnselectedOutlineWidthD9Ej5fM, fM2850getSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
