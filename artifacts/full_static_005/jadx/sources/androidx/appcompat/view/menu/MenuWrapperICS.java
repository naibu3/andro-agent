...
public class MenuWrapperICS extends BaseMenuWrapper implements Menu {
    ...
    public void removeItem(int id2) {
        internalRemoveItem(id2);
        this.mWrappedObject.removeItem(id2);
    }
    ...
    public MenuItem findItem(int id2) {
        return getMenuItemWrapper(this.mWrappedObject.findItem(id2));
    }
    ...
    public boolean performIdentifierAction(int id2, int flags) {
        return this.mWrappedObject.performIdentifierAction(id2, flags);
    }
