...
public final class UMathKt {
    ...
    private static final int m10342minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m10321minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m10343mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m10329minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m10340maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m10309maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m10341maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m10317maxOfeb3DHEI(j, j2);
    }
}
