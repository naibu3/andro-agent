...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int i) {
        if (i == 1) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3339getPreviousdhqQ8s());
        }
        if (i == 2) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3338getNextdhqQ8s());
        }
        if (i == 17) {
    ...
    public static final Integer m3342toAndroidFocusDirection3ESFkO8(int i) {
        ...
        return FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3339getPreviousdhqQ8s()) ? 1 : null;
    }
