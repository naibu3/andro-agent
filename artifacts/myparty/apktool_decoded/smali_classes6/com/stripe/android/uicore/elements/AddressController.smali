...
# direct methods
.method public static synthetic $r8$lambda$bRgP_gWelpUmlMVsRvE9KEHKmbg(Ljava/util/List;)Lkotlinx/coroutines/flow/StateFlow;
    .locals 0

    invoke-static {p0}, Lcom/stripe/android/uicore/elements/AddressController;->error$lambda$2(Ljava/util/List;)Lkotlinx/coroutines/flow/StateFlow;
...
.method public constructor <init>(Lkotlinx/coroutines/flow/StateFlow;)V
    ...
    iput-object p1, p0, Lcom/stripe/android/uicore/elements/AddressController;->error:Lkotlinx/coroutines/flow/StateFlow;

    return-void
.end method

.method private static final error$lambda$2(Ljava/util/List;)Lkotlinx/coroutines/flow/StateFlow;
    .locals 2
    ...
    .line 25
    invoke-interface {v1}, Lcom/stripe/android/uicore/elements/SectionFieldElement;->sectionFieldErrorController()Lcom/stripe/android/uicore/elements/SectionFieldErrorController;
    ...
    .line 64
    new-instance v1, Lcom/stripe/android/uicore/elements/AddressController$error$lambda$2$$inlined$combineAsStateFlow$1;

    invoke-direct {v1, p0}, Lcom/stripe/android/uicore/elements/AddressController$error$lambda$2$$inlined$combineAsStateFlow$1;-><init>([Lkotlinx/coroutines/flow/Flow;)V
    ...
    .line 65
    :goto_1
    new-instance v1, Lcom/stripe/android/uicore/elements/AddressController$error$lambda$2$$inlined$combineAsStateFlow$2;

    invoke-direct {v1, v0}, Lcom/stripe/android/uicore/elements/AddressController$error$lambda$2$$inlined$combineAsStateFlow$2;-><init>(Ljava/util/List;)V
...
.method public ComposeUI(ZLcom/stripe/android/uicore/elements/SectionFieldElement;Landroidx/compose/ui/Modifier;Ljava/util/Set;Lcom/stripe/android/uicore/elements/IdentifierSpec;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "com.stripe.android.uicore.elements.AddressController.ComposeUI (AddressController.kt:37)"
...
.method public getError()Lkotlinx/coroutines/flow/StateFlow;
    ...
    .line 23
    iget-object v0, p0, Lcom/stripe/android/uicore/elements/AddressController;->error:Lkotlinx/coroutines/flow/StateFlow;
...
.method public final getFieldsFlowable()Lkotlinx/coroutines/flow/StateFlow;
    ...
    .line 18
    iget-object v0, p0, Lcom/stripe/android/uicore/elements/AddressController;->fieldsFlowable:Lkotlinx/coroutines/flow/StateFlow;
