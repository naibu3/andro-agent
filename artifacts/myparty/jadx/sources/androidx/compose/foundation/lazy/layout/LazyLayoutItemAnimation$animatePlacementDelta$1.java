    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.this$0.placementDeltaAnimation.isRunning()) {
                ...
                this.label = 1;
                if (this.this$0.placementDeltaAnimation.snapTo(IntOffset.m6236boximpl(this.$totalDelta), this) == coroutine_suspended) {
                }
            } else {
                final long jM6248minusqkQi6aY = IntOffset.m6248minusqkQi6aY(((IntOffset) this.this$0.placementDeltaAnimation.getValue()).getPackedValue(), this.$totalDelta);
                Animatable animatable = this.this$0.placementDeltaAnimation;
                IntOffset intOffsetM6236boximpl = IntOffset.m6236boximpl(jM6248minusqkQi6aY);
        ...
        final long jM6248minusqkQi6aY2 = IntOffset.m6248minusqkQi6aY(((IntOffset) this.this$0.placementDeltaAnimation.getValue()).getPackedValue(), this.$totalDelta);
        Animatable animatable2 = this.this$0.placementDeltaAnimation;
        IntOffset intOffsetM6236boximpl2 = IntOffset.m6236boximpl(jM6248minusqkQi6aY2);
