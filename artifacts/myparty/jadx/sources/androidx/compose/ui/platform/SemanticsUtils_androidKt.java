...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m5385toLegacyClassNameV4PA4sw(int i) {
        if (Role.m5408equalsimpl0(i, Role.INSTANCE.m5412getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m5408equalsimpl0(i, Role.INSTANCE.m5413getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m5408equalsimpl0(i, Role.INSTANCE.m5416getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m5408equalsimpl0(i, Role.INSTANCE.m5415getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m5408equalsimpl0(i, Role.INSTANCE.m5414getDropdownListo7Vup1c())) {
