...
public final class DragGestureDetectorCopyKt {
    ...
    */
    public static final Object m2267awaitHorizontalPointerSlopOrCancellationgDDlDlE(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        ...
        if (i4 == 0) {
            ...
            if (m2269isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
                return null;
            }
            float fM2270pointerSlopE8SPZFQ = m2270pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private static final Object m2268awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        PointerEventPass pointerEventPass;
        Object obj;
        Object obj2;
        long id = j;
        PointerEventPass pointerEventPass2 = null;
        if (m2269isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), id)) {
            return null;
        }
        float fM2270pointerSlopE8SPZFQ = m2270pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    obj = changes.get(i3);
                    pointerEventPass = pointerEventPass2;
                    if (PointerId.m4846equalsimpl0(((PointerInputChange) obj).getId(), id)) {
                        break;
                    }
                    i3++;
                    pointerEventPass2 = pointerEventPass;
                ...
                if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
                    ...
                    fFloatValue += function1.invoke(Offset.m3405boximpl(pointerInputChange.getPosition())).floatValue() - function1.invoke(Offset.m3405boximpl(pointerInputChange.getPreviousPosition())).floatValue();
                    if (Math.abs(fFloatValue) >= fM2270pointerSlopE8SPZFQ) {
                        break;
                    }
    ...
    private static final boolean m2269isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        PointerInputChange pointerInputChange;
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        boolean z = false;
    ...
    public static final float m2270pointerSlopE8SPZFQ(ViewConfiguration pointerSlop, int i) {
        Intrinsics.checkNotNullParameter(pointerSlop, "$this$pointerSlop");
        return PointerType.m4936equalsimpl0(i, PointerType.INSTANCE.m4941getMouseT8wyACA()) ? pointerSlop.getTouchSlop() * mouseToTouchSlopRatio : pointerSlop.getTouchSlop();
    }
