...
public final class zzbug extends zzbuj {
    ...
    public final void zzb() throws JSONException {
        ...
        builderZzK.setPositiveButton(resourcesZze != null ? resourcesZze.getString(R.string.s3) : HttpHeaders.ACCEPT, new zzbue(this, str, lastPathSegment));
        builderZzK.setNegativeButton(resourcesZze != null ? resourcesZze.getString(R.string.s4) : "Decline", new zzbuf(this));
