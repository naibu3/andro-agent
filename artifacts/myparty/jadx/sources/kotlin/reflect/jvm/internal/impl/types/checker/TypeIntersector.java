    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo10410getSupertypes = simpleType.getConstructor().mo10410getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo10410getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo10410getSupertypes;
