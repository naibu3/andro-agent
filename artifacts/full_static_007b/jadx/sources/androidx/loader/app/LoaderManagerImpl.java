...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        LoaderInfo(int id2, Bundle args, Loader<D> loader, Loader<D> priorLoader) {
            this.mId = id2;
            this.mArgs = args;
            this.mLoader = loader;
            this.mPriorLoader = priorLoader;
            loader.registerListener(id2, this);
        }
    ...
    static class LoaderViewModel extends ViewModel {
        ...
        void putLoader(int id2, LoaderInfo info) {
    ...
    private <D> Loader<D> createAndInstallLoader(int id2, Bundle args, LoaderManager.LoaderCallbacks<D> callback, Loader<D> priorLoader) throws Throwable {
        try {
            ...
            LoaderInfo<D> info = new LoaderInfo<>(id2, args, loader, priorLoader);
            try {
                if (DEBUG) {
    ...
    public <D> Loader<D> initLoader(int id2, Bundle args, LoaderManager.LoaderCallbacks<D> callback) {
        ...
        if (info == null) {
            return createAndInstallLoader(id2, args, callback, null);
        }
        if (DEBUG) {
    ...
    @Override // androidx.loader.app.LoaderManager
    public <D> Loader<D> restartLoader(int id2, Bundle args, LoaderManager.LoaderCallbacks<D> callback) {
        if (this.mLoaderViewModel.isCreatingLoader()) {
            throw new IllegalStateException("Called while creating a loader");
        }
        if (Looper.getMainLooper() != Looper.myLooper()) {
        ...
        return createAndInstallLoader(id2, args, callback, priorLoader);
    }
    ...
    public void destroyLoader(int id2) {
        ...
        if (DEBUG) {
            Log.v(TAG, "destroyLoader in " + this + " of " + id2);
        }
