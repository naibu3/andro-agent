...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM130constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM130constructorimpl = Result.m130constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM130constructorimpl = Result.m130constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m133exceptionOrNullimpl(objM130constructorimpl) == null) {
            obj2 = objM130constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM130constructorimpl2 = Result.m130constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM130constructorimpl2 = Result.m130constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m133exceptionOrNullimpl(objM130constructorimpl2) == null) {
            obj = objM130constructorimpl2;
        }
