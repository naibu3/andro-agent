...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m9290boximpl(ULong.m9296constructorimpl(getMostSignificantBits())), ULong.m9290boximpl(ULong.m9296constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m10621toUByteArrayTcUX1vc() {
        return UByteArray.m9193constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m9296constructorimpl(j) ^ Long.MIN_VALUE, ULong.m9296constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m9296constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m9296constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m10623fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m10622fromUByteArrayGBYM_sE(byte[] ubyteArray) {
