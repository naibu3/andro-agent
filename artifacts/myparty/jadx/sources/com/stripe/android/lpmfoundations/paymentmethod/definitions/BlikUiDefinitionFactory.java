...
final class BlikUiDefinitionFactory implements UiDefinitionFactory.Simple {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod() {
        return new SupportedPaymentMethod((PaymentMethodDefinition) BlikDefinition.INSTANCE, (SharedDataSpec) null, R.string.stripe_paymentsheet_payment_method_blik, R.drawable.stripe_ic_paymentsheet_pm_blik, (Integer) null, false, (ResolvableString) null, (Integer) null, 226, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, UiDefinitionFactory.Arguments arguments) {
        ...
        return new FormElementsBuilder(arguments).element(SectionElement.Companion.wrap$default(SectionElement.INSTANCE, new BlikElement(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0), (ResolvableString) null, 2, (Object) null)).build();
    }
}
