...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m4797constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m4927constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4803calculatePointerEventType7fucELk();
    }
    ...
    public final void m4807setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m4803calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m4822getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m4817getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m4818getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m4823getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.INSTANCE.m4819getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m4821getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m4820getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            long jM4862getIdJ3iCeTQ = pointerInputChange.getId();
            long uptimeMillis = pointerInputChange.getUptimeMillis();
            long jM4864getPositionF1C5BW0 = pointerInputChange.getPosition();
            long jM4864getPositionF1C5BW02 = pointerInputChange.getPosition();
            boolean pressed = pointerInputChange.getPressed();
            float pressure = pointerInputChange.getPressure();
            int iM4867getTypeT8wyACA = pointerInputChange.getType();
            InternalPointerEvent internalPointerEvent = this.internalPointerEvent;
            ArrayList arrayList3 = arrayList;
            int i2 = size;
            arrayList2.add(new PointerInputEventData(jM4862getIdJ3iCeTQ, uptimeMillis, jM4864getPositionF1C5BW0, jM4864getPositionF1C5BW02, pressed, pressure, iM4867getTypeT8wyACA, internalPointerEvent != null && internalPointerEvent.m4793activeHoverEvent0FcD4WY(pointerInputChange.getId()), null, 0L, 0L, 1792, null));
            i++;
