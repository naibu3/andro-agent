    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo10409getDeclarationDescriptor();
                classDescriptor = classifierDescriptorMo10409getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo10409getDeclarationDescriptor : null;
