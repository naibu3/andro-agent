...
public final class ContentDataType {
    ...
    private static final int Text = m3275constructorimpl(1);
    private static final int List = m3275constructorimpl(3);
    private static final int Date = m3275constructorimpl(4);
    private static final int Toggle = m3275constructorimpl(2);
    private static final int None = m3275constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ContentDataType m3274boximpl(int i) {
        return new ContentDataType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3275constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3276equalsimpl(int i, Object obj) {
        return (obj instanceof ContentDataType) && i == ((ContentDataType) obj).m3280unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3277equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3278hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3279toStringimpl(int i) {
        return "ContentDataType(dataType=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m3276equalsimpl(this.dataType, obj);
    }

    public int hashCode() {
        return m3278hashCodeimpl(this.dataType);
    }

    public String toString() {
        return m3279toStringimpl(this.dataType);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m3280unboximpl() {
