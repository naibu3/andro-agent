...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1451minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1448plusLRDsOJo(Duration.m1508unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1455compareToLRDsOJo($this.mo1447minusUwyO8pc(other), Duration.INSTANCE.m1558getZEROUwyO8pc());
        }
    }
}
