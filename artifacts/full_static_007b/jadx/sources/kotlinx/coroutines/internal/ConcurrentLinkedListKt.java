...
public final class ConcurrentLinkedListKt {
    ...
    private static final <S extends Segment<S>> Object findSegmentInternal(S s, long id2, Function2<? super Long, ? super S, ? extends S> function2) {
        Segment cur = s;
        while (true) {
            if (cur.getId() < id2 || cur.getRemoved()) {
