...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m5321invokeZmokQxo(keyEvent.m4711unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m5321invokeZmokQxo(android.view.KeyEvent keyEvent) {
                final FocusDirection focusDirectionMo5283getFocusDirectionP8AzH3I = this.this$0.mo5283getFocusDirectionP8AzH3I(keyEvent);
                if (focusDirectionMo5283getFocusDirectionP8AzH3I != null && KeyEventType.m4715equalsimpl0(KeyEvent_androidKt.m4723getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4719getKeyDownCS__XNY())) {
                    Rect rectOnFetchFocusRect = this.this$0.onFetchFocusRect();
                    Boolean boolMo3348focusSearchULY8qGw = this.this$0.getFocusOwner().mo3348focusSearchULY8qGw(focusDirectionMo5283getFocusDirectionP8AzH3I.getValue(), rectOnFetchFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                        {
                            super(1);
                        }
                        ...
                        public final Boolean invoke(FocusTargetNode focusTargetNode) {
                            Boolean boolM3367requestFocusMxy_nc0 = FocusTransactionsKt.m3367requestFocusMxy_nc0(focusTargetNode, focusDirectionMo5283getFocusDirectionP8AzH3I.getValue());
                            return Boolean.valueOf(boolM3367requestFocusMxy_nc0 != null ? boolM3367requestFocusMxy_nc0.booleanValue() : true);
                        }
                    });
                    if (boolMo3348focusSearchULY8qGw != null ? boolMo3348focusSearchULY8qGw.booleanValue() : true) {
                        return true;
                    }
                    if (!FocusOwnerImplKt.m3354is1dFocusSearch3ESFkO8(focusDirectionMo5283getFocusDirectionP8AzH3I.getValue())) {
                        return false;
                    }
                    Integer numM3342toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3342toAndroidFocusDirection3ESFkO8(focusDirectionMo5283getFocusDirectionP8AzH3I.getValue());
                    if (numM3342toAndroidFocusDirection3ESFkO8 == null) {
                        throw new IllegalStateException("Invalid focus direction".toString());
                    }
                    int iIntValue = numM3342toAndroidFocusDirection3ESFkO8.intValue();
                    ...
                    if (androidRect != null) {
                        ...
                        if ((viewFindNextNonChildView == null || !FocusInteropUtils_androidKt.requestInteropFocus(viewFindNextNonChildView, Integer.valueOf(iIntValue), androidRect)) && this.this$0.getFocusOwner().mo3345clearFocusI7lrPNg(false, true, false, focusDirectionMo5283getFocusDirectionP8AzH3I.getValue())) {
                            Boolean boolMo3348focusSearchULY8qGw2 = this.this$0.getFocusOwner().mo3348focusSearchULY8qGw(focusDirectionMo5283getFocusDirectionP8AzH3I.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                                {
                                    super(1);
                                }
                            ...
                            return Boolean.valueOf(boolMo3348focusSearchULY8qGw2 != null ? boolMo3348focusSearchULY8qGw2.booleanValue() : true);
                        }
                        return true;
                    }
        ...
        float[] fArrM3888constructorimpl$default = Matrix.m3888constructorimpl$default(null, 1, null);
        this.tmpMatrix = fArrM3888constructorimpl$default;
        this.viewToWindowMatrix = Matrix.m3888constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m3888constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m3430getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m3265constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m4405getTouchaOaMEAU() : InputMode.INSTANCE.m4404getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m5317invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m5317invokeiuPiT84(int i) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m4400equalsimpl0(i, InputMode.INSTANCE.m4405getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else {
                    zRequestFocusFromTouch = InputMode.m4400equalsimpl0(i, InputMode.INSTANCE.m4404getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
                }
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(fArrM3888constructorimpl$default, objArr == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    public void setCoroutineContext(CoroutineContext coroutineContext) {
        ...
        while (layoutNodeRequireLayoutNode != null) {
            ...
            if ((child.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                while (child != null) {
    ...
    public final boolean m5312onMoveFocusInChildren3ESFkO8(int focusDirection) {
        View viewFindNextFocusFromRect;
        if (FocusDirection.m3328equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3335getEnterdhqQ8s()) || FocusDirection.m3328equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3336getExitdhqQ8s())) {
            return false;
        }
        Integer numM3342toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3342toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM3342toAndroidFocusDirection3ESFkO8 == null) {
            throw new IllegalStateException("Invalid focus direction".toString());
        }
        int iIntValue = numM3342toAndroidFocusDirection3ESFkO8.intValue();
    ...
    public static final void touchModeChangeListener$lambda$6(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m4408setInputModeiuPiT84(z ? InputMode.INSTANCE.m4405getTouchaOaMEAU() : InputMode.INSTANCE.m4404getKeyboardaOaMEAU());
    }
    ...
    */
    public Object textInputSession(Function2<? super PlatformTextInputSessionScope, ? super Continuation<?>, ? extends Object> function2, Continuation<?> continuation) {
        C06201 c06201;
        if (continuation instanceof C06201) {
            c06201 = (C06201) continuation;
            if ((c06201.label & Integer.MIN_VALUE) != 0) {
                c06201.label -= Integer.MIN_VALUE;
            } else {
                c06201 = new C06201(continuation);
            }
        }
        Object obj = c06201.result;
        ...
        if (i == 0) {
            ...
            c06201.label = 1;
            if (SessionMutex.m3272withSessionCancellingPreviousimpl(atomicReference, function1, function2, c06201) == coroutine_suspended) {
    ...
    public static final void sendHoverExitEvent$lambda$8(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m5315sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public View focusSearch(View focused, int direction) {
        if (focused != null) {
            ...
            if (Intrinsics.areEqual((Object) getFocusOwner().mo3348focusSearchULY8qGw(focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3334getDowndhqQ8s(), rectCalculateBoundingRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.focusSearch.1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return true;
                }
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3335getEnterdhqQ8s();
        Boolean boolMo3348focusSearchULY8qGw = getFocusOwner().mo3348focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocus.1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                Boolean boolM3367requestFocusMxy_nc0 = FocusTransactionsKt.m3367requestFocusMxy_nc0(focusTargetNode, value);
                return Boolean.valueOf(boolM3367requestFocusMxy_nc0 != null ? boolM3367requestFocusMxy_nc0.booleanValue() : false);
            }
        });
        if (boolMo3348focusSearchULY8qGw != null) {
            return boolMo3348focusSearchULY8qGw.booleanValue();
        }
        return false;
    }
    ...
    public final boolean m5313onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM3342toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (numM3342toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3342toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM3342toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo5285sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo3346dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m3344dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m5394setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4927constructorimpl(event.getMetaState()));
            return FocusOwner.m3344dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m4706constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo3347dispatchKeyEventYhN2O0w(KeyEvent.m4706constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo3346dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m4706constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m5316startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                LayoutNode layoutNodeFindClosestParentNode = SemanticsNodeKt.findClosestParentNode(layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                    ...
                    public final Boolean invoke(LayoutNode layoutNode2) {
                        return Boolean.valueOf(layoutNode2.getNodes().m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(8)));
                    }
                });
    ...
    public void mo5284measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m5182measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM5310convertMeasureSpecI7RO_PI = m5310convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM9296constructorimpl = (int) ULong.m9296constructorimpl(jM5310convertMeasureSpecI7RO_PI >>> 32);
            int iM9296constructorimpl2 = (int) ULong.m9296constructorimpl(jM5310convertMeasureSpecI7RO_PI & 4294967295L);
            long jM5310convertMeasureSpecI7RO_PI2 = m5310convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jM6078fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m6078fitPrioritizingHeightZbe2FdA(iM9296constructorimpl, iM9296constructorimpl2, (int) ULong.m9296constructorimpl(jM5310convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m9296constructorimpl(4294967295L & jM5310convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean zM6063equalsimpl0 = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m6058boximpl(jM6078fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    zM6063equalsimpl0 = Constraints.m6063equalsimpl0(constraints.getValue(), jM6078fitPrioritizingHeightZbe2FdA);
                }
                if (!zM6063equalsimpl0) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m5183updateRootConstraintsBRTryo0(jM6078fitPrioritizingHeightZbe2FdA);
    ...
    private final int m5308component1VKZWuLQ(long j) {
        return (int) ULong.m9296constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m5309component2VKZWuLQ(long j) {
        return (int) ULong.m9296constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m5314packZIaKswc(int a2, int b) {
        return ULong.m9296constructorimpl(ULong.m9296constructorimpl(b) | ULong.m9296constructorimpl(ULong.m9296constructorimpl(a2) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m5310convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m5314packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m5314packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m5314packZIaKswc(size, size);
        }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int iM6245getXimpl = IntOffset.m6245getXimpl(j);
        int iM6246getYimpl = IntOffset.m6246getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM6245getXimpl != i || iM6246getYimpl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (iM6245getXimpl != Integer.MAX_VALUE && iM6246getYimpl != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo5283getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long jM4722getKeyZmokQxo = KeyEvent_androidKt.m4722getKeyZmokQxo(keyEvent);
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4650getTabEK5gGoQ())) {
            return FocusDirection.m3325boximpl(KeyEvent_androidKt.m4728isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m3339getPreviousdhqQ8s() : FocusDirection.INSTANCE.m3338getNextdhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4491getDirectionRightEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3340getRightdhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4490getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3337getLeftdhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4492getDirectionUpEK5gGoQ()) ? true : Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4603getPageUpEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3341getUpdhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4487getDirectionDownEK5gGoQ()) ? true : Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4602getPageDownEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3334getDowndhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4486getDirectionCenterEK5gGoQ()) ? true : Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4500getEnterEK5gGoQ()) ? true : Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4592getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3335getEnterdhqQ8s());
        }
        if (Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4429getBackEK5gGoQ()) ? true : Key.m4414equalsimpl0(jM4722getKeyZmokQxo, Key.INSTANCE.m4503getEscapeEK5gGoQ())) {
            return FocusDirection.m3325boximpl(FocusDirection.INSTANCE.m3336getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m4408setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m4405getTouchaOaMEAU() : InputMode.INSTANCE.m4404getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : ProcessResult.m4953getDispatchedToAPointerInputModifierimpl(m5311handleMotionEvent8iAsVTc(motionEvent));
        }
        return super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM5311handleMotionEvent8iAsVTc = m5311handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m4952getAnyMovementConsumedimpl(iM5311handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m4953getDispatchedToAPointerInputModifierimpl(iM5311handleMotionEvent8iAsVTc);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final int m5311handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                int iM5315sendMotionEvent8iAsVTc = m5315sendMotionEvent8iAsVTc(motionEvent);
                Trace.endSection();
                androidComposeView.forceUseMatrixCache = false;
                return iM5315sendMotionEvent8iAsVTc;
            } catch (Throwable th2) {
                th = th2;
            }
        } catch (Throwable th3) {
    ...
    private final int m5315sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m5394setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4927constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (pointerInputEventConvertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m4881getPositionF1C5BW0();
            }
            int iM4886processBIzXfog = this.pointerInputEventProcessor.m4886processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked == 0 || actionMasked == 5) && !ProcessResult.m4953getDispatchedToAPointerInputModifierimpl(iM4886processBIzXfog)) {
                this.motionEventAdapter.endStream(motionEvent.getPointerId(motionEvent.getActionIndex()));
            }
            return iM4886processBIzXfog;
        }
        this.pointerInputEventProcessor.processCancel();
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo4946localToScreenMKHz9U = mo4946localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m3416getXimpl(jMo4946localToScreenMKHz9U);
            pointerCoords.y = Offset.m3417getYimpl(jMo4946localToScreenMKHz9U);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m4886processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, true);
        motionEventObtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m5326canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m5326canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo4946localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long jM3894mapMKHz9U = Matrix.m3894mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m3416getXimpl(jM3894mapMKHz9U) + Offset.m3416getXimpl(this.windowPosition), Offset.m3417getYimpl(jM3894mapMKHz9U) + Offset.m3417getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo4945localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m3905timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m5331preTranslatecG2Xzmc(localTransform, Offset.m3416getXimpl(this.windowPosition), Offset.m3417getYimpl(this.windowPosition), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo4947screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m3894mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m3416getXimpl(positionOnScreen) - Offset.m3416getXimpl(this.windowPosition), Offset.m3417getYimpl(positionOnScreen) - Offset.m3417getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long jM3894mapMKHz9U = Matrix.m3894mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m3416getXimpl(jM3894mapMKHz9U), motionEvent.getRawY() - Offset.m3417getYimpl(jM3894mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo5332calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m5358invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m3269getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo5281calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m3894mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo5282calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m3894mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        return ProcessResult.m4953getDispatchedToAPointerInputModifierimpl(m5311handleMotionEvent8iAsVTc(event));
    }
