...
public final class CancelAuthorizationSession {
    ...
    /* renamed from: com.stripe.android.financialconnections.domain.CancelAuthorizationSession$invoke$1, reason: invalid class name */
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return CancelAuthorizationSession.this.invoke(null, this);
        }
    }

    @Inject
    public CancelAuthorizationSession(NativeAuthFlowCoordinator coordinator, FinancialConnectionsManifestRepository repository, FinancialConnectionsSheetConfiguration configuration) {
    ...
    */
    public final Object invoke(String str, Continuation<? super FinancialConnectionsAuthorizationSession> continuation) {
        ...
        Object objCancelAuthorizationSession = anonymousClass1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = anonymousClass1.label;
        if (i == 0) {
            ResultKt.throwOnFailure(objCancelAuthorizationSession);
            ...
            objCancelAuthorizationSession = financialConnectionsManifestRepository.cancelAuthorizationSession(financialConnectionsSessionClientSecret, str, anonymousClass1);
            if (objCancelAuthorizationSession != coroutine_suspended) {
        ...
        cancelAuthorizationSession = (CancelAuthorizationSession) anonymousClass1.L$0;
        ResultKt.throwOnFailure(objCancelAuthorizationSession);
        MutableSharedFlow<NativeAuthFlowCoordinator.Message> mutableSharedFlowInvoke = cancelAuthorizationSession.coordinator.invoke();
        ...
        anonymousClass1.L$0 = objCancelAuthorizationSession;
        anonymousClass1.label = 2;
        return mutableSharedFlowInvoke.emit(clearPartnerWebAuth, anonymousClass1) == coroutine_suspended ? coroutine_suspended : objCancelAuthorizationSession;
    }
}
