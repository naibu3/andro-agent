...
public final class AndroidContentCaptureManager implements ContentCaptureManager, DefaultLifecycleObserver, View.OnAttachStateChangeListener {
    ...
    */
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode semanticsNode) {
        ...
        String strM5385toLegacyClassNameV4PA4sw;
        ...
        if (role != null && (strM5385toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m5385toLegacyClassNameV4PA4sw(role.getValue())) != null) {
            viewStructureCompatNewVirtualViewStructure.setClassName(strM5385toLegacyClassNameV4PA4sw);
        }
        TextLayoutResult textLayoutResult = SemanticsUtils_androidKt.getTextLayoutResult(unmergedConfig$ui_release);
        if (textLayoutResult != null) {
            TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
            viewStructureCompatNewVirtualViewStructure.setTextStyle(TextUnit.m6310getValueimpl(layoutInput.getStyle().m5633getFontSizeXSAIIZE()) * layoutInput.getDensity().getDensity() * layoutInput.getDensity().getFontScale(), 0, 0, 0);
        }
