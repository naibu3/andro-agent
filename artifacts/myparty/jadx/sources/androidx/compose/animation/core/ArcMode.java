...
public final class ArcMode {
    ...
    private static final int ArcAbove = m483constructorimpl(5);
    private static final int ArcBelow = m483constructorimpl(4);
    private static final int ArcLinear = m483constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ArcMode m482boximpl(int i) {
    ...
    public static boolean m484equalsimpl(int i, Object obj) {
        return (obj instanceof ArcMode) && i == ((ArcMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m485equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m484equalsimpl(this.value, obj);
    }
