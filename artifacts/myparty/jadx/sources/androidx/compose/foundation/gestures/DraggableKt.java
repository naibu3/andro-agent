...
public final class DraggableKt {
    ...
    public static final float m785toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3417getYimpl(j) : Offset.m3416getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m786toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6355getYimpl(j) : Velocity.m6354getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m787toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6354getXimpl(j)) ? 0.0f : Velocity.m6354getXimpl(j), Float.isNaN(Velocity.m6355getYimpl(j)) ? 0.0f : Velocity.m6355getYimpl(j));
    }
}
