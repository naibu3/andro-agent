...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        motionSpec.getTiming(PaymentSheetAppearanceKeys.SCALE).apply(objectAnimatorOfFloat2);
        ...
        motionSpec.getTiming(PaymentSheetAppearanceKeys.SCALE).apply(objectAnimatorOfFloat3);
