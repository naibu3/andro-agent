...
public abstract class DispatchedTask<T> extends Task {
    ...
    */
    public final void run() {
        ...
        Object objM214constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m214constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m214constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m214constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    objM214constructorimpl2 = Result.m214constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM214constructorimpl2 = Result.m214constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m217exceptionOrNullimpl(objM214constructorimpl2));
            } finally {
            ...
            try {
                ...
                objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m217exceptionOrNullimpl(objM214constructorimpl));
        }
    }
