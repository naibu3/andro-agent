...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C03231 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03231(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C03231) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        */
        ...
        public static final <T> Flow<T> m1772catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
