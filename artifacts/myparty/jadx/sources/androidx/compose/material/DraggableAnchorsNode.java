...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo430measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!measureScope.isLookingAhead() || !this.didLookahead) {
            Pair<? extends DraggableAnchors<T>, ? extends T> pairInvoke = this.anchors.invoke(IntSize.m6279boximpl(IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight())), Constraints.m6058boximpl(j));
        ...
        return MeasureScope.layout$default(measureScope, placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.DraggableAnchorsNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.place$default(placementScope, placeableMo4993measureBRTryo0, MathKt.roundToInt(f), MathKt.roundToInt(fRequireOffset), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
