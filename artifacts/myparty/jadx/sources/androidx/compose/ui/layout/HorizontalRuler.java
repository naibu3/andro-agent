...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3417getYimpl(targetCoordinates.mo5002localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m6287getWidthimpl(sourceCoordinates.mo5001getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
