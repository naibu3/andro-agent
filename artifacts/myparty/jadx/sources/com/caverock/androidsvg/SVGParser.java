...
class SVGParser {
    ...
    private static class FontSizeKeywords {
        ...
        static {
            ...
            map.put(Constants.ScionAnalytics.PARAM_MEDIUM, new SVG.Length(12.0f, SVG.Unit.pt));
    ...
    */
    ...
    static class TextScanner {
        ...
        String nextToken() {
            return nextToken(CardNumberConfig.SEPARATOR, false);
        }
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (qName.equals("xml:space")) {
                String strTrim = attributes.getValue(i).trim();
                if (com.facebook.hermes.intl.Constants.COLLATION_DEFAULT.equals(strTrim)) {
