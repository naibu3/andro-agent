...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo10410getSupertypes() {
    ...
    public static final List refine$lambda$6$lambda$5(NewCapturedTypeConstructor newCapturedTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
        List<UnwrappedType> listMo10410getSupertypes = newCapturedTypeConstructor.mo10410getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo10410getSupertypes, 10));
        Iterator<T> it = listMo10410getSupertypes.iterator();
        while (it.hasNext()) {
