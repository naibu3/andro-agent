...
final class zzcgt extends zzgv implements zzhz {
    ...
    zzcgt(String str, zzie zzieVar, int i, int i2, long j, long j2) {
        super(true);
        zzeq.zzc(str);
        this.zze = str;
        this.zzf = new zzhy();
    ...
    final HttpURLConnection zzk(long j, long j2, int i) throws IOException {
        ...
        try {
            ...
            try {
                ...
                zzl();
                throw new zzhv("Unable to connect to ".concat(String.valueOf(string2)), e2, this.zzg, 2000, i);
            }
        } catch (IOException e3) {
            throw new zzhv("Unable to connect to ".concat(String.valueOf(string)), e3, this.zzg, 2000, i);
        }
    }
}
