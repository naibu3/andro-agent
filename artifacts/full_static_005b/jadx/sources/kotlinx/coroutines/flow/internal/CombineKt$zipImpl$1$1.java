...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C00731 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    Object objMo1736receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        objMo1736receiveCatchingJP2dKIU = this.$second.mo1736receiveCatchingJP2dKIU(this);
                        if (objMo1736receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        objMo1736receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    FlowCollector flowCollector3 = this.$this_unsafeFlow;
                    if (objMo1736receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM1746exceptionOrNullimpl = ChannelResult.m1746exceptionOrNullimpl(objMo1736receiveCatchingJP2dKIU);
                        if (thM1746exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw thM1746exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (objMo1736receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo1736receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, objMo1736receiveCatchingJP2dKIU, this);
            ...
            */
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    C00731 c00731 = new C00731(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c00731, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
