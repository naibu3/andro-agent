...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo10409getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo10409getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = kotlinType.getConstructor().mo10409getDeclarationDescriptor();
        if (classifierDescriptorMo10409getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo10409getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = kotlinType.getConstructor().mo10409getDeclarationDescriptor();
        return (classifierDescriptorMo10409getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo10409getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
