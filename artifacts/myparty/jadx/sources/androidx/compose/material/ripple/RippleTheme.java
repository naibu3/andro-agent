...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final long m2111defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
        ...
        public final RippleAlpha m2110defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m3709luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
