...
public final class PagerSnapLayoutInfoProviderKt {
    ...
    public static final float dragGestureDelta(PagerState pagerState) {
        if (pagerState.getLayoutInfo().getOrientation() == Orientation.Horizontal) {
            return Offset.m3416getXimpl(pagerState.m1268getUpDownDifferenceF1C5BW0$foundation_release());
        }
        return Offset.m3417getYimpl(pagerState.m1268getUpDownDifferenceF1C5BW0$foundation_release());
    }
    ...
    */
    public static final float calculateFinalSnappingBound(PagerState pagerState, LayoutDirection layoutDirection, float f, float f2, float f3, float f4) {
        ...
        if (FinalSnappingItem.m859equalsimpl0(iCalculateFinalSnappingItem, FinalSnappingItem.INSTANCE.m863getClosestItembbeMdSM())) {
        ...
        if (!FinalSnappingItem.m859equalsimpl0(iCalculateFinalSnappingItem, FinalSnappingItem.INSTANCE.m864getNextItembbeMdSM())) {
            if (!FinalSnappingItem.m859equalsimpl0(iCalculateFinalSnappingItem, FinalSnappingItem.INSTANCE.m865getPreviousItembbeMdSM())) {
                return 0.0f;
            }
        }
    }
