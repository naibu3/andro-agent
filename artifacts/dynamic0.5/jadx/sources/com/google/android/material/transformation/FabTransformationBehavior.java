...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    protected AnimatorSet onCreateExpandedStateChangeAnimation(View dependency, View child, boolean expanded, boolean isAnimating) {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            ...
            expanded2 = expanded;
            isAnimating2 = isAnimating;
            fabTransformationBehavior.createElevationAnimation(dependency2, child2, expanded2, isAnimating2, spec, animations, listeners);
        }
        RectF childBounds = fabTransformationBehavior.tmpRectF1;
        fabTransformationBehavior.createTranslationAnimation(dependency2, child2, expanded2, isAnimating2, spec, animations, listeners, childBounds);
        boolean isAnimating3 = isAnimating2;
        float childWidth = childBounds.width();
        float childHeight = childBounds.height();
        createDependencyTranslationAnimation(dependency2, child2, expanded2, spec, animations);
        createIconFadeAnimation(dependency2, child2, expanded2, isAnimating3, spec, animations, listeners);
        createExpansionAnimation(dependency2, child2, expanded2, isAnimating3, spec, childWidth, childHeight, animations, listeners);
        createColorAnimation(dependency2, child2, expanded2, isAnimating3, spec, animations, listeners);
        createChildrenFadeAnimation(dependency2, child2, expanded2, isAnimating3, spec, animations, listeners);
