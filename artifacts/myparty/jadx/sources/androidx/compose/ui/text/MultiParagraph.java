...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        ...
        this.maxLines = i;
        if (Constraints.m6072getMinWidthimpl(j) != 0 || Constraints.m6071getMinHeightimpl(j) != 0) {
        ...
        while (i3 < size) {
            ...
            if (Constraints.m6065getHasBoundedHeightimpl(j)) {
                iM6069getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m6069getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), 0);
            } else {
                iM6069getMaxHeightimpl = Constraints.m6069getMaxHeightimpl(j);
            }
            Paragraph paragraphM5486Paragraph_EkL_Y = ParagraphKt.m5486Paragraph_EkL_Y(intrinsics, ConstraintsKt.Constraints$default(0, iM6070getMaxWidthimpl, 0, iM6069getMaxHeightimpl, 5, null), this.maxLines - i2, z);
            float height = f + paragraphM5486Paragraph_EkL_Y.getHeight();
            int lineCount = i2 + paragraphM5486Paragraph_EkL_Y.getLineCount();
            arrayList.add(new ParagraphInfo(paragraphM5486Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i2, lineCount, f, height));
            if (paragraphM5486Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i3 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text_release()))) {
                z2 = true;
                i2 = lineCount;
                f = height;
                break;
        ...
        this.width = Constraints.m6070getMaxWidthimpl(j);
    ...
    public static /* synthetic */ void m5465paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.INSTANCE.m3693getUnspecified0d7_KjU();
        }
        multiParagraph.m5472paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m5472paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        while (i < size) {
            ...
            long j = color;
            paragraphInfo.getParagraph().mo5439paintRPmYEkk(canvas2, j, shadow, decoration);
    ...
    public final void m5471paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            paragraphInfo.getParagraph().mo5438paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
    ...
    public static /* synthetic */ void m5466painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = Float.NaN;
        }
        multiParagraph.m5473painthn5TExg(canvas, brush, f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.INSTANCE.m4215getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public final void m5473painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m5856drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m5474findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph.getPathForRange.2
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                Path.m3927addPathUv8p0NA$default(Path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(start), paragraphInfo.toLocalIndex(end))), 0L, 2, null);
            }
        });
        return Path;
    }
    ...
    public final int m5468getOffsetForPositionk4lQ0M(long position) {
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m3417getYimpl(position)));
        if (paragraphInfo.getLength() == 0) {
            return paragraphInfo.getStartIndex();
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo5435getOffsetForPositionk4lQ0M(paragraphInfo.m5483toLocalMKHz9U(position)));
    }

    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m5469getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(iFindParagraphByY).getBottom() >= rect.getBottom() || iFindParagraphByY == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m5481toGlobalxdX6G0$default(paragraphInfo, paragraphInfo.getParagraph().mo5436getRangeForRect86BmAI(paragraphInfo.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int iFindParagraphByY2 = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long jM5607getZerod9O1mEE = TextRange.INSTANCE.m5607getZerod9O1mEE();
        while (TextRange.m5595equalsimpl0(jM5607getZerod9O1mEE, TextRange.INSTANCE.m5607getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo2 = this.paragraphInfoList.get(iFindParagraphByY);
            jM5607getZerod9O1mEE = ParagraphInfo.m5481toGlobalxdX6G0$default(paragraphInfo2, paragraphInfo2.getParagraph().mo5436getRangeForRect86BmAI(paragraphInfo2.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY++;
        }
        if (TextRange.m5595equalsimpl0(jM5607getZerod9O1mEE, TextRange.INSTANCE.m5607getZerod9O1mEE())) {
            return TextRange.INSTANCE.m5607getZerod9O1mEE();
        }
        long jM5607getZerod9O1mEE2 = TextRange.INSTANCE.m5607getZerod9O1mEE();
        while (TextRange.m5595equalsimpl0(jM5607getZerod9O1mEE2, TextRange.INSTANCE.m5607getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo3 = this.paragraphInfoList.get(iFindParagraphByY2);
            jM5607getZerod9O1mEE2 = ParagraphInfo.m5481toGlobalxdX6G0$default(paragraphInfo3, paragraphInfo3.getParagraph().mo5436getRangeForRect86BmAI(paragraphInfo3.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY2--;
        }
        return TextRange.m5595equalsimpl0(jM5607getZerod9O1mEE2, TextRange.INSTANCE.m5607getZerod9O1mEE()) ? jM5607getZerod9O1mEE : TextRangeKt.TextRange(TextRange.m5602getStartimpl(jM5607getZerod9O1mEE), TextRange.m5597getEndimpl(jM5607getZerod9O1mEE2));
    }
    ...
    public final float[] m5467fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m5600getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m5599getMaximpl(range));
        final Ref.IntRef intRef = new Ref.IntRef();
        intRef.element = arrayStart;
        final Ref.FloatRef floatRef = new Ref.FloatRef();
        MultiParagraphKt.m5474findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$fillBoundingBoxes$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                ...
                long jTextRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphInfo.getStartIndex() > TextRange.m5600getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m5600getMinimpl(j)), paragraphInfo.toLocalIndex(paragraphInfo.getEndIndex() < TextRange.m5599getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m5599getMaximpl(j)));
                paragraphInfo.getParagraph().mo5433fillBoundingBoxes8ffj60Q(jTextRange, fArr, intRef2.element);
                int iM5598getLengthimpl = intRef2.element + (TextRange.m5598getLengthimpl(jTextRange) * 4);
                for (int i = intRef2.element; i < iM5598getLengthimpl; i += 4) {
                    int i2 = i + 1;
                    fArr[i2] = fArr[i2] + floatRef2.element;
                    int i3 = i + 3;
                    fArr[i3] = fArr[i3] + floatRef2.element;
                }
                intRef2.element = iM5598getLengthimpl;
    ...
    public final long m5470getWordBoundaryjx7JFs(int offset) {
        int iFindParagraphByIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            iFindParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(iFindParagraphByIndex);
        return paragraphInfo.m5482toGlobalxdX6G0(paragraphInfo.getParagraph().mo5437getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(offset)), false);
    }
