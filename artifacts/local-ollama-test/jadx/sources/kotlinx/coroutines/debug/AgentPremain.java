...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM130constructorimpl = Result.m130constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM130constructorimpl = Result.m130constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m136isFailureimpl(objM130constructorimpl) ? null : objM130constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1658installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1658installSignalHandler$lambda1(Signal it) {
