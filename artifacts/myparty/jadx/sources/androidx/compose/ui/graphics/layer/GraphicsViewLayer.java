...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3432getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m4330applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4330applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m4295getOffscreenke2Ky5w());
        } else {
            m4330applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4289equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4295getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m3568equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m3599getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo4325setPivotOffsetk4lQ0M(long j) {
        ...
        if (OffsetKt.m3437isUnspecifiedk4lQ0M(j)) {
            ...
            this.viewLayer.setPivotX(IntSize.m6287getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m6286getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m3416getXimpl(j));
        this.viewLayer.setPivotY(Offset.m3417getYimpl(j));
    }
    ...
    public void mo4321setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m3711toArgb8_81llA(j));
        }
    }
    ...
    public void mo4327setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m3711toArgb8_81llA(j));
        }
    }
    ...
    public void mo4326setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m6285equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m6287getWidthimpl(size) + x, IntSize.m6286getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6287getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6286getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas canvasBeginRecording = picture.beginRecording(IntSize.m6287getWidthimpl(this.size), IntSize.m6286getHeightimpl(this.size));
                try {
