...
public final class StackTraceHelper {
    ...
    public final StackFrame[] convertJsStackTrace(JSONArray stack) throws JSONException {
        if (stack == null) {
            return new StackFrame[0];
        }
    ...
    public final StackFrame[] convertJsStackTrace(String stack) throws NumberFormatException {
        List listEmptyList;
        StackFrameImpl stackFrameImpl;
