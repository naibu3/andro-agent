...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1349getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return ((int) (this.step ^ (this.step >>> 32))) + (((((int) ULong.m304constructorimpl(this.first ^ ULong.m304constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m304constructorimpl(this.last ^ ULong.m304constructorimpl(this.last >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m350toStringimpl(this.first)).append("..").append((Object) ULong.m350toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m350toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m350toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1375fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
