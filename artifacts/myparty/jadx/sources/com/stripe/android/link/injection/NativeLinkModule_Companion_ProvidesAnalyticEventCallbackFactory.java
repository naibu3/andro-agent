...
public final class NativeLinkModule_Companion_ProvidesAnalyticEventCallbackFactory implements Factory<AnalyticEventCallback> {
    ...
    public static NativeLinkModule_Companion_ProvidesAnalyticEventCallbackFactory create(javax.inject.Provider<String> provider) {
        return new NativeLinkModule_Companion_ProvidesAnalyticEventCallbackFactory(Providers.asDaggerProvider(provider));
    }
    ...
    public static AnalyticEventCallback providesAnalyticEventCallback(String str) {
        return NativeLinkModule.INSTANCE.providesAnalyticEventCallback(str);
    }
}
