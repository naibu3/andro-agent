...
public final class PlatformTextInputModifierNodeKt {
    ...
    */
    public static final Object establishTextInputSession(PlatformTextInputModifierNode platformTextInputModifierNode, Function2<? super PlatformTextInputSessionScope, ? super Continuation<?>, ? extends Object> function2, Continuation<?> continuation) {
        C06231 c06231;
        if (continuation instanceof C06231) {
            c06231 = (C06231) continuation;
            if ((c06231.label & Integer.MIN_VALUE) != 0) {
                c06231.label -= Integer.MIN_VALUE;
            } else {
                c06231 = new C06231(continuation);
            }
        }
        Object obj = c06231.result;
        ...
        if (i == 0) {
            ...
            c06231.label = 1;
            if (interceptedTextInputSession(ownerRequireOwner, chainedPlatformTextInputInterceptor, function2, c06231) == coroutine_suspended) {
