...
final class SkipToLookaheadNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m464setLookaheadConstraints_Sx5XlM(Constraints constraints) {
    ...
    public MeasureResult mo430measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        if (measureScope.isLookingAhead()) {
            this.lookaheadConstraints = Constraints.m6058boximpl(j);
        }
        Constraints constraints = this.lookaheadConstraints;
        Intrinsics.checkNotNull(constraints);
        final Placeable placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(constraints.getValue());
        final long jIntSize = IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight());
        final long jM6084constrain4WqzIAM = ConstraintsKt.m6084constrain4WqzIAM(j, jIntSize);
        return MeasureScope.layout$default(measureScope, IntSize.m6287getWidthimpl(jM6084constrain4WqzIAM), IntSize.m6286getHeightimpl(jM6084constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (IntSize.m6287getWidthimpl(jIntSize) == 0 || IntSize.m6286getHeightimpl(jIntSize) == 0) {
                    jScaleFactor = ScaleFactorKt.ScaleFactor(1.0f, 1.0f);
                } else {
                    jScaleFactor = contentScale.mo4984computeScaleFactorH7hwNQA(IntSizeKt.m6299toSizeozmzZPI(jIntSize), IntSizeKt.m6299toSizeozmzZPI(jM6084constrain4WqzIAM));
                }
                long jMo3262alignKFBX0sM = scaleToBounds.getAlignment().mo3262alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(IntSize.m6287getWidthimpl(jIntSize) * ScaleFactor.m5082getScaleXimpl(jScaleFactor)), MathKt.roundToInt(IntSize.m6286getHeightimpl(jIntSize) * ScaleFactor.m5083getScaleYimpl(jScaleFactor))), jM6084constrain4WqzIAM, measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo4993measureBRTryo0, IntOffset.m6245getXimpl(jMo3262alignKFBX0sM), IntOffset.m6246getYimpl(jMo3262alignKFBX0sM), 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        graphicsLayerScope.setScaleX(ScaleFactor.m5082getScaleXimpl(jScaleFactor));
                        graphicsLayerScope.setScaleY(ScaleFactor.m5083getScaleYimpl(jScaleFactor));
                        graphicsLayerScope.mo3850setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                    }
                }, 4, (Object) null);
            }
        }, 4, null);
