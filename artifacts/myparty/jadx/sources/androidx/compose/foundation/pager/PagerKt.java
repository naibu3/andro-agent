            ...
            if (i6 == 0) {
                ...
                if (i7 != 0) {
                    ...
                    if (i8 == 0) {
                        ...
                        i19 = i4 & 4096;
                        if (i19 != 0) {
                            i20 = i28 | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT;
                        } else {
                            int i29 = i28;
                        ...
                        if ((i4 & 8192) == 0) {
                            ...
                            if ((i15 & 306783379) == 306783378 || (i20 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
                                ...
                                if ((i2 & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                    ...
                                    PaddingValues paddingValuesM1013PaddingValues0680j_4 = i6 == 0 ? PaddingKt.m1013PaddingValues0680j_4(Dp.m6117constructorimpl(0)) : paddingValues;
                                    PageSize pageSize5 = i7 == 0 ? PageSize.Fill.INSTANCE : pageSize2;
                                    int i30 = i8 == 0 ? 0 : i9;
                                    float fM6117constructorimpl = i10 == 0 ? Dp.m6117constructorimpl(0) : f2;
                                    if (i11 != 0) {
                                    ...
                                    if ((i4 & 128) == 0) {
                                        ...
                                        i22 = i20;
                                        TargetedFlingBehavior targetedFlingBehaviorFlingBehavior = PagerDefaults.INSTANCE.flingBehavior(pagerState2, null, null, null, 0.0f, composerStartRestartGroup, (i15 & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 30);
                                        i15 &= -29360129;
                                ...
                                int i32 = i25 >> 6;
                                int i33 = ((i25 >> 3) & 14) | 24576 | ((i25 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i25 & 896) | ((i25 >> 18) & 7168) | (i32 & 458752) | (i32 & 3670016);
                                int i34 = i25 << 9;
                                int i35 = i33 | (i34 & 29360128) | (i34 & 234881024) | ((i25 << 18) & 1879048192);
                                int i36 = ((i31 >> 3) & 14) | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT | ((i31 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ((i25 >> 9) & 7168);
                                int i37 = i31 << 6;
                                int i38 = i36 | (i37 & 57344) | (i37 & 458752);
                                Modifier modifier7 = modifier4;
                                LazyLayoutPagerKt.m1253PageruYRUAWA(modifier7, pagerState2, paddingValues2, z4, orientation, targetedFlingBehavior3, z5, i24, f3, pageSize3, nestedScrollConnection2, function12, centerHorizontally, vertical2, snapPosition2, function4, composer2, i35, i38, 0);
                                if (ComposerKt.isTraceInProgress()) {
                            ...
                            if (scopeUpdateScopeEndRestartGroup == null) {
                                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$1
                                    ...
                                    public final void invoke(Composer composer3, int i39) {
                                        PagerKt.m1257HorizontalPageroI3XNZo(pagerState, modifier5, paddingValues3, pageSize4, i9, f4, vertical3, targetedFlingBehavior4, z7, z6, function12, nestedScrollConnection3, snapPosition3, function4, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
                                    }
                                });
                                return;
                            }
                        ...
                        if ((i15 & 306783379) == 306783378) {
                            ...
                            if ((i2 & 1) != 0) {
                                ...
                                int i322 = i25 >> 6;
                                int i332 = ((i25 >> 3) & 14) | 24576 | ((i25 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i25 & 896) | ((i25 >> 18) & 7168) | (i322 & 458752) | (i322 & 3670016);
                                int i342 = i25 << 9;
                                int i352 = i332 | (i342 & 29360128) | (i342 & 234881024) | ((i25 << 18) & 1879048192);
                                int i362 = ((i312 >> 3) & 14) | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT | ((i312 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ((i25 >> 9) & 7168);
                                int i372 = i312 << 6;
                                int i382 = i362 | (i372 & 57344) | (i372 & 458752);
                                Modifier modifier72 = modifier4;
                                LazyLayoutPagerKt.m1253PageruYRUAWA(modifier72, pagerState2, paddingValues2, z4, orientation2, targetedFlingBehavior3, z5, i24, f3, pageSize3, nestedScrollConnection2, function12, centerHorizontally2, vertical2, snapPosition2, function4, composer2, i352, i382, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                }
                                pageSize4 = pageSize3;
                                nestedScrollConnection3 = nestedScrollConnection2;
                    ...
                    if (i8 == 0) {
                        ...
                        if ((i4 & 8192) == 0) {
                            ...
                            if ((i15 & 306783379) == 306783378 || (i20 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
                                ...
                                int i34 = i25 << 9;
                                int i35 = i33 | (i34 & 29360128) | (i34 & 234881024) | ((i25 << 18) & 1879048192);
                                int i36 = ((i31 >> 3) & 14) | 3072 | ((i31 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ((i25 >> 12) & 896);
                                int i37 = i31 << 6;
                                int i38 = i36 | (i37 & 57344) | (i37 & 458752);
                                Modifier modifier7 = modifier4;
                                LazyLayoutPagerKt.m1253PageruYRUAWA(modifier7, pagerState2, paddingValues2, z4, orientation, targetedFlingBehavior3, z5, i24, f3, pageSize3, nestedScrollConnection2, function12, horizontal2, centerVertically, snapPosition2, function4, composer2, i35, i38, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                                pageSize4 = pageSize3;
                            ...
                            if (scopeUpdateScopeEndRestartGroup == null) {
                                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$1
                                    ...
                                    public final void invoke(Composer composer3, int i39) {
                                        PagerKt.m1258VerticalPageroI3XNZo(pagerState, modifier5, paddingValues3, pageSize4, i9, f4, horizontal3, targetedFlingBehavior4, z6, z7, function12, nestedScrollConnection3, snapPosition3, function4, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
                                    }
                                });
                                return;
                            }
                        ...
                        if ((i15 & 306783379) == 306783378) {
                            ...
                            if ((i2 & 1) != 0) {
                                ...
                                int i342 = i25 << 9;
                                int i352 = i332 | (i342 & 29360128) | (i342 & 234881024) | ((i25 << 18) & 1879048192);
                                int i362 = ((i312 >> 3) & 14) | 3072 | ((i312 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ((i25 >> 12) & 896);
                                int i372 = i312 << 6;
                                int i382 = i362 | (i372 & 57344) | (i372 & 458752);
                                Modifier modifier72 = modifier4;
                                LazyLayoutPagerKt.m1253PageruYRUAWA(modifier72, pagerState2, paddingValues2, z4, orientation2, targetedFlingBehavior3, z5, i24, f3, pageSize3, nestedScrollConnection2, function12, horizontal2, centerVertically2, snapPosition2, function4, composer2, i352, i382, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                }
                                pageSize4 = pageSize3;
                                snapPosition3 = snapPosition2;
