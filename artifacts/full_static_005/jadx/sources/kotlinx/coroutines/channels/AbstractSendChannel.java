...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1589trySendJP2dKIU(E element) {
        ...
        if (result == AbstractChannelKt.OFFER_FAILED) {
            ...
            return closedForSend == null ? ChannelResult.INSTANCE.m1608failurePtdJZtk() : ChannelResult.INSTANCE.m1607closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1607closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
