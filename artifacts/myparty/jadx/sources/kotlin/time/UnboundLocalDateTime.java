...
final class UnboundLocalDateTime {
    ...
    public String toString() {
        return "UnboundLocalDateTime(" + this.year + '-' + this.month + '-' + this.day + CardNumberConfig.SEPARATOR + this.hour + AbstractJsonLexerKt.COLON + this.minute + AbstractJsonLexerKt.COLON + this.second + FilenameUtils.EXTENSION_SEPARATOR + this.nanosecond + ')';
    }
