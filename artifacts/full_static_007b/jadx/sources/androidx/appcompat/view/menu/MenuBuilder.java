...
public class MenuBuilder implements SupportMenu {
    ...
    private void dispatchSaveInstanceState(Bundle outState) {
        ...
        while (it.hasNext()) {
            ...
            if (presenter == null) {
                ...
                if (id2 > 0 && (state = presenter.onSaveInstanceState()) != null) {
    ...
    private void dispatchRestoreInstanceState(Bundle state) {
        ...
        while (it.hasNext()) {
            ...
            if (presenter == null) {
                ...
                int id2 = presenter.getId();
                if (id2 > 0 && (parcel = presenterStates.get(id2)) != null) {
    ...
    protected MenuItem addInternal(int group, int id2, int categoryOrder, CharSequence title) {
        int ordering = getOrdering(categoryOrder);
        MenuItemImpl item = createNewMenuItem(group, id2, categoryOrder, ordering, title, this.mDefaultShowAsAction);
    ...
    public MenuItem add(int group, int id2, int categoryOrder, CharSequence title) {
        return addInternal(group, id2, categoryOrder, title);
    }

    @Override // android.view.Menu
    public MenuItem add(int group, int id2, int categoryOrder, int title) {
        return addInternal(group, id2, categoryOrder, this.mResources.getString(title));
    }
    ...
    public SubMenu addSubMenu(int group, int id2, int categoryOrder, CharSequence title) {
        MenuItemImpl item = (MenuItemImpl) addInternal(group, id2, categoryOrder, title);
    ...
    public SubMenu addSubMenu(int group, int id2, int categoryOrder, int title) {
        return addSubMenu(group, id2, categoryOrder, this.mResources.getString(title));
    }
    ...
    public int addIntentOptions(int group, int id2, int categoryOrder, ComponentName caller, Intent[] specifics, Intent intent, int flags, MenuItem[] outSpecificItems) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            MenuItem item = add(group, id2, categoryOrder, ri.loadLabel(pm)).setIcon(ri.loadIcon(pm)).setIntent(rintent);
    ...
    public void removeItem(int id2) {
        removeItemAtInt(findItemIndex(id2), true);
    }
    ...
    public MenuItem findItem(int id2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (item.hasSubMenu() && (possibleItem = item.getSubMenu().findItem(id2)) != null) {
                return possibleItem;
            }
        }
        return null;
    ...
    */
    ...
    public boolean performIdentifierAction(int id2, int flags) {
        return performItemAction(findItem(id2), flags);
    }
