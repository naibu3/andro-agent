...
final class zzhai extends zzham {
    ...
    /* synthetic */ zzhai(InputStream inputStream, int i, zzhah zzhahVar) {
        super(null);
    ...
    public final zzhac zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (iZzj <= i - i2 && iZzj > 0) {
            zzhac zzhacVarZzv = zzhac.zzv(this.zzf, i2, iZzj);
            this.zzi += iZzj;
            return zzhacVarZzv;
        }
        if (iZzj == 0) {
        ...
        if (bArrZzP != null) {
            return zzhac.zzv(bArrZzP, 0, bArrZzP.length);
        }
        int i3 = this.zzi;
        int i4 = this.zzg;
        int i5 = i4 - i3;
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzi;
            if (iZzj <= i - i2) {
                String str = new String(this.zzf, i2, iZzj, zzhcb.zzb);
                this.zzi += iZzj;
                return str;
            }
        }
        ...
        if (iZzj > this.zzg) {
            return new String(zzO(iZzj, false), zzhcb.zzb);
        }
        zzM(iZzj);
        String str2 = new String(this.zzf, this.zzi, iZzj, zzhcb.zzb);
        this.zzi += iZzj;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzhff.zzh(bArrZzO, i, iZzj);
    }
