...
public final class CompositionImpl implements ControlledComposition, ReusableComposition, RecomposeScopeOwner, CompositionServices {
    ...
    public CompositionImpl(CompositionContext compositionContext, Applier<?> applier, CoroutineContext coroutineContext) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m3114getLambda1$runtime_release();
    }
    ...
    public void dispose() {
        synchronized (this.lock) {
            ...
            if (!this.disposed) {
                this.disposed = true;
                this.composable = ComposableSingletons$CompositionKt.INSTANCE.m3115getLambda2$runtime_release();
    ...
    public void recordReadOf(Object value) {
        ...
        if (value instanceof StateObjectImpl) {
            ...
            ((StateObjectImpl) value).m3261recordReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(1));
        }
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                if (stateObject instanceof StateObjectImpl) {
                                    ...
                                    i3 = i6;
                                    ((StateObjectImpl) stateObject).m3261recordReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(i2));
                                } else {
                                    i3 = i6;
                                }
