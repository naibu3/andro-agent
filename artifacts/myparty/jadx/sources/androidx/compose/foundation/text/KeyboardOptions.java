...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m5839getPasswordPjHm6EE(), 0, (PlatformImeOptions) (null == true ? 1 : 0), (Boolean) (null == true ? 1 : 0), (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        int iM5815getUnspecifiedIUNYP9k = (i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5815getUnspecifiedIUNYP9k() : i;
        Boolean bool3 = (i4 & 2) != 0 ? null : bool;
        int iM5842getUnspecifiedPjHm6EE = (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5842getUnspecifiedPjHm6EE() : i2;
        int iM5788getUnspecifiedeUduSuo = (i4 & 8) != 0 ? ImeAction.INSTANCE.m5788getUnspecifiedeUduSuo() : i3;
        PlatformImeOptions platformImeOptions2 = (i4 & 16) != 0 ? null : platformImeOptions;
        Boolean bool4 = (i4 & 32) != 0 ? null : bool2;
        this(iM5815getUnspecifiedIUNYP9k, bool3, iM5842getUnspecifiedPjHm6EE, iM5788getUnspecifiedeUduSuo, platformImeOptions2, bool4, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5815getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5842getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m5788getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5815getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5842getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m5780getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5813getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5841getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m5780getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1343getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM5800boximpl = KeyboardCapitalization.m5800boximpl(this.capitalization);
        if (KeyboardCapitalization.m5803equalsimpl0(keyboardCapitalizationM5800boximpl.getValue(), KeyboardCapitalization.INSTANCE.m5815getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM5800boximpl = null;
        }
        return keyboardCapitalizationM5800boximpl != null ? keyboardCapitalizationM5800boximpl.getValue() : KeyboardCapitalization.INSTANCE.m5813getNoneIUNYP9k();
    }

    /* renamed from: getKeyboardTypeOrDefault-PjHm6EE, reason: not valid java name */
    private final int m1344getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM5817boximpl = KeyboardType.m5817boximpl(this.keyboardType);
        if (KeyboardType.m5820equalsimpl0(keyboardTypeM5817boximpl.getValue(), KeyboardType.INSTANCE.m5842getUnspecifiedPjHm6EE())) {
            keyboardTypeM5817boximpl = null;
        }
        return keyboardTypeM5817boximpl != null ? keyboardTypeM5817boximpl.getValue() : KeyboardType.INSTANCE.m5841getTextPjHm6EE();
    }

    /* renamed from: getImeActionOrDefault-eUduSuo$foundation_release, reason: not valid java name */
    public final int m1351getImeActionOrDefaulteUduSuo$foundation_release() {
        ImeAction imeActionM5764boximpl = ImeAction.m5764boximpl(this.imeAction);
        if (ImeAction.m5767equalsimpl0(imeActionM5764boximpl.getValue(), ImeAction.INSTANCE.m5788getUnspecifiedeUduSuo())) {
            imeActionM5764boximpl = null;
        }
        return imeActionM5764boximpl != null ? imeActionM5764boximpl.getValue() : ImeAction.INSTANCE.m5780getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m5803equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m5815getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m5820equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m5842getUnspecifiedPjHm6EE()) && ImeAction.m5767equalsimpl0(this.imeAction, ImeAction.INSTANCE.m5788getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation_release(boolean singleLine) {
        return new ImeOptions(singleLine, m1343getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m1344getKeyboardTypeOrDefaultPjHm6EE(), m1351getImeActionOrDefaulteUduSuo$foundation_release(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1340copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        ...
        return keyboardOptions2.m1346copyINvB4aQ(i7, bool4, i6, i5, platformImeOptions2, bool3, localeList2);
    }

    /* renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m1346copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    /* renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1341copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        return keyboardOptions.m1347copyINvB4aQ(i, z, i5, i3, platformImeOptions2, bool2, localeList2);
    }
    ...
    /* renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1347copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1342copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        PlatformImeOptions platformImeOptions2 = platformImeOptions;
        int i5 = i2;
        return keyboardOptions.m1348copyij11fho(i, z, i5, i3, platformImeOptions2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1348copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m1339copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1345copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m1345copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m5803equalsimpl0(this.capitalization, keyboardOptions.capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, keyboardOptions.autoCorrectEnabled) && KeyboardType.m5820equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m5767equalsimpl0(this.imeAction, keyboardOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, keyboardOptions.platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, keyboardOptions.showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, keyboardOptions.hintLocales);
    }

    public int hashCode() {
        int iM5804hashCodeimpl = KeyboardCapitalization.m5804hashCodeimpl(this.capitalization) * 31;
        Boolean bool = this.autoCorrectEnabled;
        int iHashCode = (((((iM5804hashCodeimpl + (bool != null ? bool.hashCode() : 0)) * 31) + KeyboardType.m5821hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5768hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m5805toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m5822toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m5769toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation_release(KeyboardOptions other) {
        ...
        if (keyboardCapitalizationM5800boximpl != null) {
            value = keyboardCapitalizationM5800boximpl.getValue();
        } else {
        ...
        if (keyboardTypeM5817boximpl != null) {
            value2 = keyboardTypeM5817boximpl.getValue();
        } else {
            value2 = other.keyboardType;
        }
        int i2 = value2;
        ImeAction imeActionM5764boximpl = ImeAction.m5764boximpl(this.imeAction);
        ImeAction imeAction = ImeAction.m5767equalsimpl0(imeActionM5764boximpl.getValue(), ImeAction.INSTANCE.m5788getUnspecifiedeUduSuo()) ? null : imeActionM5764boximpl;
        if (imeAction != null) {
