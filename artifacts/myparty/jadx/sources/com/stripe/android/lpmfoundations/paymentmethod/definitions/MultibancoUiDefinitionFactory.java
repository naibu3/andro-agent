...
final class MultibancoUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) MultibancoDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_multibanco, R.drawable.stripe_ic_paymentsheet_pm_multibanco_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_multibanco_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
