...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo377measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6068getHasFixedWidthimpl(j) ? Constraints.m6070getMaxWidthimpl(j) : 0, Constraints.m6067getHasFixedHeightimpl(j) ? Constraints.m6069getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
