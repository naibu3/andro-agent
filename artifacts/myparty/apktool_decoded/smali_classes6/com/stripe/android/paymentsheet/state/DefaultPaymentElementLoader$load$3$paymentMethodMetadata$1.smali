...
# direct methods
.method constructor <init>(Lkotlinx/coroutines/Deferred;Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader;Lcom/stripe/android/common/model/CommonConfiguration;Lcom/stripe/android/model/ElementsSession;Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$CustomerInfo;ZLkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->this$0:Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader;

    iput-object p3, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$configuration:Lcom/stripe/android/common/model/CommonConfiguration;

    iput-object p4, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$elementsSession:Lcom/stripe/android/model/ElementsSession;

    iput-object p5, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$customerInfo:Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$CustomerInfo;

    iput-boolean p6, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$isGooglePayReady:Z
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->this$0:Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader;
    ...
    iget-object v4, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$elementsSession:Lcom/stripe/android/model/ElementsSession;

    iget-object v5, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$customerInfo:Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$CustomerInfo;

    iget-boolean v6, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$isGooglePayReady:Z

    move-object v7, p2

    invoke-direct/range {v0 .. v7}, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;-><init>(Lkotlinx/coroutines/Deferred;Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader;Lcom/stripe/android/common/model/CommonConfiguration;Lcom/stripe/android/model/ElementsSession;Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$CustomerInfo;ZLkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast p1, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;

    sget-object p2, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v4, Lcom/stripe/android/paymentsheet/state/LinkState;
    ...
    .line 203
    iget-object v1, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$configuration:Lcom/stripe/android/common/model/CommonConfiguration;
    ...
    .line 205
    iget-object v3, p0, Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$load$3$paymentMethodMetadata$1;->$customerInfo:Lcom/stripe/android/paymentsheet/state/DefaultPaymentElementLoader$CustomerInfo;
