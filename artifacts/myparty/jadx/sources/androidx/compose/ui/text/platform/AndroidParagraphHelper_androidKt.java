...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatchM5454boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m5454boximpl(paragraphStyle.getEmojiSupportMatch());
            strProcess = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, emojiSupportMatchM5454boximpl == null ? 0 : EmojiSupportMatch.m5457equalsimpl0(emojiSupportMatchM5454boximpl.getValue(), EmojiSupportMatch.INSTANCE.m5461getAll_3YsG6Y()));
            Intrinsics.checkNotNull(strProcess);
        } else {
            strProcess = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6328isUnspecifiedR2X_6o(textStyle.m5641getLineHeightXSAIIZE())) {
            return strProcess;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m5884setLineHeightr9BaKPg(spannable, textStyle.m5641getLineHeightXSAIIZE(), f, density);
            f2 = f;
            density2 = density;
        } else {
            ...
            f2 = f;
            density2 = density;
            SpannableExtensions_androidKt.m5883setLineHeightKmRG4DE(spannable, textStyle.m5641getLineHeightXSAIIZE(), f2, density2, lineHeightStyle);
        }
