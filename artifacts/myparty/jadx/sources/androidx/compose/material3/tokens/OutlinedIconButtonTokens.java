...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6117constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6117constructorimpl((float) 24.0d);
    ...
    public final float m2909getContainerSizeD9Ej5fM() {
    ...
    public final float m2910getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2911getUnselectedOutlineWidthD9Ej5fM() {
