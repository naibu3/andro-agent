...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1661updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        ...
        if (TextOverflow.m6048equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1649updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1649updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
            ...
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode.applySemantics.1
                ...
                */
                public final Boolean invoke(List<TextLayoutResult> list) {
                    TextLayoutResult textLayoutResultM5572copyO0kMr_c$default;
                    ...
                    if (layoutOrNull != null) {
                        ...
                        textLayoutResultM5572copyO0kMr_c$default = TextLayoutResult.m5572copyO0kMr_c$default(layoutOrNull, new TextLayoutInput(text, TextStyle.m5622mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo1876invoke0d7_KjU() : Color.INSTANCE.m3693getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null), layoutOrNull.getLayoutInput().getPlaceholders(), layoutOrNull.getLayoutInput().getMaxLines(), layoutOrNull.getLayoutInput().getSoftWrap(), layoutOrNull.getLayoutInput().getOverflow(), layoutOrNull.getLayoutInput().getDensity(), layoutOrNull.getLayoutInput().getLayoutDirection(), layoutOrNull.getLayoutInput().getFontFamilyResolver(), layoutOrNull.getLayoutInput().getConstraints(), (DefaultConstructorMarker) null), 0L, 2, null);
                        if (textLayoutResultM5572copyO0kMr_c$default != null) {
                            list.add(textLayoutResultM5572copyO0kMr_c$default);
                        } else {
                            textLayoutResultM5572copyO0kMr_c$default = null;
                        }
                    }
                    return Boolean.valueOf(textLayoutResultM5572copyO0kMr_c$default != null);
                }
            };
    ...
    public final MeasureResult m1660measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo430measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM1648layoutWithConstraintsK40F9xA = layoutCache.m1648layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM1648layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(Constraints.INSTANCE.m6079fitPrioritizingWidthZbe2FdA(IntSize.m6287getWidthimpl(textLayoutResult.getSize()), IntSize.m6287getWidthimpl(textLayoutResult.getSize()), IntSize.m6286getHeightimpl(textLayoutResult.getSize()), IntSize.m6286getHeightimpl(textLayoutResult.getSize())));
        int iM6287getWidthimpl = IntSize.m6287getWidthimpl(textLayoutResult.getSize());
        int iM6286getHeightimpl = IntSize.m6286getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6287getWidthimpl, iM6286getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        boolean z = true;
        boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m6048equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6057getVisiblegIe3tQ8());
        if (z2) {
        ...
        try {
            ...
            if (brush != null) {
                MultiParagraph.m5466painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ColorProducer colorProducer = this.overrideColor;
                long jMo1876invoke0d7_KjU = colorProducer != null ? colorProducer.mo1876invoke0d7_KjU() : Color.INSTANCE.m3693getUnspecified0d7_KjU();
                if (jMo1876invoke0d7_KjU == 16) {
                    if (this.style.m5632getColor0d7_KjU() != 16) {
                        jMo1876invoke0d7_KjU = this.style.m5632getColor0d7_KjU();
                    } else {
                        jMo1876invoke0d7_KjU = Color.INSTANCE.m3683getBlack0d7_KjU();
                    }
                }
                multiParagraph.m5471paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m3693getUnspecified0d7_KjU() : jMo1876invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m4215getDefaultBlendMode0nO6VwU() : 0);
            }
            if (z2) {
                canvas.restore();
            }
