...
public final class NestedScrollDispatcher {
    ...
    public final long m4743dispatchPreScrollOzD1aCk(long available, int source) {
        NestedScrollConnection parent$ui_release = getParent$ui_release();
        return parent$ui_release != null ? parent$ui_release.mo1096onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m3432getZeroF1C5BW0();
    }

    /* renamed from: dispatchPostScroll-DzOQY0M, reason: not valid java name */
    public final long m4741dispatchPostScrollDzOQY0M(long consumed, long available, int source) {
        NestedScrollConnection parent$ui_release = getParent$ui_release();
        return parent$ui_release != null ? parent$ui_release.mo822onPostScrollDzOQY0M(consumed, available, source) : Offset.INSTANCE.m3432getZeroF1C5BW0();
    }
    ...
    */
    public final Object m4742dispatchPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        Object objMo1095onPreFlingQWom1Mo = nestedScrollDispatcher$dispatchPreFling$1.result;
        ...
        if (i == 0) {
            ...
            objMo1095onPreFlingQWom1Mo = parent$ui_release.mo1095onPreFlingQWom1Mo(j, nestedScrollDispatcher$dispatchPreFling$1);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m4740dispatchPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object objMo821onPostFlingRZ2iAVY = nestedScrollDispatcher$dispatchPostFling$12.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ...
        if (i == 0) {
            ...
            objMo821onPostFlingRZ2iAVY = parent$ui_release.mo821onPostFlingRZ2iAVY(j, j2, nestedScrollDispatcher$dispatchPostFling$12);
