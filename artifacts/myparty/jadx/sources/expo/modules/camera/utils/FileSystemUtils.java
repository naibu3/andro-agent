...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0005J\u001e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\u00052\u0006\u0010\n\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\bJ\u001e\u0010\f\u001a\u00020\u00052\u0006\u0010\t\u001a\u00020\u00052\u0006\u0010\n\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\b¨\u0006\r"}, d2 = {"Lexpo/modules/camera/utils/FileSystemUtils;", "", "<init>", "()V", "ensureDirExists", "Ljava/io/File;", "dir", "generateOutputPath", "", "internalDirectory", "dirName", ShareConstants.MEDIA_EXTENSION, "generateOutputFile", "expo-camera_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class FileSystemUtils {
    ...
    public final String generateOutputPath(File internalDirectory, String dirName, String extension) throws IOException {
        ...
        File file = new File(internalDirectory + File.separator + dirName);
        ensureDirExists(file);
        String string = UUID.randomUUID().toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return file + File.separator + string + extension;
    }
    ...
    public final File generateOutputFile(File internalDirectory, String dirName, String extension) throws IOException {
        ...
        String string = UUID.randomUUID().toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return new File(file + File.separator + string + extension);
    }
}
