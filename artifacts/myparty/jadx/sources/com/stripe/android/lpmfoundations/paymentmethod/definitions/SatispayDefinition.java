...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÁ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\u0011\u001a\u00020\tH\u0016J\u0010\u0010\u0012\u001a\u00020\t2\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\u0016H\u0016R\u0014\u0010\u0004\u001a\u00020\u0005X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0014\u0010\b\u001a\u00020\tX\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0014\u0010\f\u001a\u00020\tX\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000b¨\u0006\u0017"}, d2 = {"Lcom/stripe/android/lpmfoundations/paymentmethod/definitions/SatispayDefinition;", "Lcom/stripe/android/lpmfoundations/paymentmethod/PaymentMethodDefinition;", "<init>", "()V", "type", "Lcom/stripe/android/model/PaymentMethod$Type;", "getType", "()Lcom/stripe/android/model/PaymentMethod$Type;", "supportedAsSavedPaymentMethod", "", "getSupportedAsSavedPaymentMethod", "()Z", "supportsTermDisplayConfiguration", "getSupportsTermDisplayConfiguration", "requirementsToBeUsedAsNewPaymentMethod", "", "Lcom/stripe/android/lpmfoundations/paymentmethod/AddPaymentMethodRequirement;", "hasIntentToSetup", "requiresMandate", "metadata", "Lcom/stripe/android/lpmfoundations/paymentmethod/PaymentMethodMetadata;", "uiDefinitionFactory", "Lcom/stripe/android/lpmfoundations/paymentmethod/UiDefinitionFactory;", "paymentsheet_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class SatispayDefinition implements PaymentMethodDefinition {
    public static final int $stable = 0;
    private static final boolean supportedAsSavedPaymentMethod = false;
    public static final SatispayDefinition INSTANCE = new SatispayDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Satispay;
    private static final boolean supportsTermDisplayConfiguration = true;

    private SatispayDefinition() {
    }
    ...
    public boolean getSupportsTermDisplayConfiguration() {
        return supportsTermDisplayConfiguration;
    }
    ...
    public boolean requiresMandate(PaymentMethodMetadata metadata) {
        ...
        return metadata.hasIntentToSetup(getType().code) && metadata.mandateAllowed(getType());
    }

    @Override // com.stripe.android.lpmfoundations.paymentmethod.PaymentMethodDefinition
    public UiDefinitionFactory uiDefinitionFactory() {
        return SatispayUiDefinitionFactory.INSTANCE;
    }
}
