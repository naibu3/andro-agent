...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m3711toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m3711toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m4043getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m4044getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo5344setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public boolean mo5276isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM3416getXimpl && fM3416getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM3417getYimpl && fM3417getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo5279resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m4043getPivotFractionXimpl(this.transformOrigin) * iM6287getWidthimpl);
        this.renderNode.setPivotY(TransformOrigin.m4044getPivotFractionYimpl(this.transformOrigin) * iM6286getHeightimpl);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM6287getWidthimpl, this.renderNode.getTop() + iM6286getHeightimpl)) {
            this.renderNode.setOutline(this.outlineResolver.getAndroidOutline());
            invalidate();
            this.matrixCache.invalidate();
        }
    ...
    public void mo5278movegyyYBs(long position) {
        ...
        if (left == iM6245getXimpl && top == iM6246getYimpl) {
            return;
        }
        if (left != iM6245getXimpl) {
            this.renderNode.offsetLeftAndRight(iM6245getXimpl - left);
        }
        if (top != iM6246getYimpl) {
            this.renderNode.offsetTopAndBottom(iM6246getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo3512concat58bKbWc(this.matrixCache.m5361calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo5277mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5360calculateInverseMatrixbWbORWo = this.matrixCache.m5360calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m3894mapMKHz9U(this.matrixCache.m5361calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m3896mapimpl(this.matrixCache.m5361calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void mo5280transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3905timesAssign58bKbWc(matrix, this.matrixCache.m5361calculateMatrixGrdbGEg(this.renderNode));
    }
