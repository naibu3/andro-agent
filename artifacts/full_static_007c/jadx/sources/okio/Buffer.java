...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00c1 A[EDGE_INSN: B:45:0x00c1->B:38:0x00c1 BREAK  A[LOOP:0: B:5:0x0011->B:47:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        do {
            ...
            while (pos$iv < limit$iv) {
                ...
                if (b$iv >= b && b$iv <= ((byte) 57)) {
                    ...
                    byte b2 = (byte) 97;
                    if (b$iv >= b2 && b$iv <= ((byte) LocationRequestCompat.QUALITY_BALANCED_POWER_ACCURACY)) {
                        digit$iv = (b$iv - b2) + 10;
                    } else {
                        byte b3 = (byte) 65;
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        if (size() - fromIndex$iv < fromIndex$iv) {
            ...
            while (offset$iv2 < toIndex$iv) {
                int $i$f$commonIndexOf2 = $i$f$commonIndexOf;
                ...
                for (int pos$iv = (int) ((s$iv2.pos + fromIndex$iv2) - offset$iv2); pos$iv < limit$iv; pos$iv++) {
                ...
                $i$f$commonIndexOf = $i$f$commonIndexOf2;
    ...
    public long indexOf(ByteString bytes, long fromIndex) throws IOException {
        ...
        if (size() - fromIndex$iv$iv < fromIndex$iv$iv) {
            ...
            while (offset$iv2 < resultLimit$iv) {
                byte[] data$iv = s$iv2.data;
                int $i$f$commonIndexOf = segmentLimit$iv;
                int $i$f$commonIndexOf2 = s$iv2.limit;
                long fromIndex$iv2 = fromIndex$iv;
                long b$iv$iv = (s$iv2.pos + resultLimit$iv) - offset$iv2;
                long fromIndex$iv$iv2 = fromIndex$iv$iv;
                int a$iv$iv = (int) Math.min($i$f$commonIndexOf2, b$iv$iv);
                for (int pos$iv = (int) ((s$iv2.pos + fromIndex$iv2) - offset$iv2); pos$iv < a$iv$iv; pos$iv++) {
                ...
                Intrinsics.checkNotNull(segment2);
                s$iv2 = segment2;
                segmentLimit$iv = $i$f$commonIndexOf;
        ...
        long offset$iv$iv3 = bytesSize$iv2;
        long resultLimit$iv2 = (size() - offset$iv$iv3) + 1;
        while (offset$iv4 < resultLimit$iv2) {
            byte[] data$iv2 = s$iv4.data;
            int a$iv$iv2 = s$iv4.limit;
            Segment s$iv5 = s$iv3;
            long b$iv$iv2 = (s$iv4.pos + resultLimit$iv2) - offset$iv4;
            long offset$iv5 = offset$iv3;
            int $i$f$minOf = (int) Math.min(a$iv$iv2, b$iv$iv2);
            for (int pos$iv2 = (int) ((s$iv4.pos + fromIndex$iv) - offset$iv4); pos$iv2 < $i$f$minOf; pos$iv2++) {
    ...
    public long indexOfElement(ByteString targetBytes, long fromIndex) {
        ...
        if (size() - fromIndex$iv < fromIndex$iv) {
            ...
            if (targetBytes2.size() == 2) {
                ...
                byte[] targetByteArray$iv = targetBytes2.internalArray$okio();
                while (offset$iv2 < size()) {
                    byte[] data$iv2 = s$iv2.data;
                    int pos$iv2 = (int) ((s$iv2.pos + fromIndex$iv) - offset$iv2);
                    int limit$iv2 = s$iv2.limit;
                    while (pos$iv2 < limit$iv2) {
                        byte b$iv2 = data$iv2[pos$iv2];
                        int limit$iv3 = limit$iv2;
                        int limit$iv4 = targetByteArray$iv.length;
        ...
        if (targetBytes2.size() == 2) {
            ...
            while (offset$iv4 < size()) {
                byte[] data$iv3 = s$iv4.data;
                int limit$iv5 = s$iv4.limit;
                for (int pos$iv3 = (int) ((s$iv4.pos + fromIndex$iv) - offset$iv4); pos$iv3 < limit$iv5; pos$iv3++) {
                    int b$iv3 = data$iv3[pos$iv3];
                    if (b$iv3 == b0$iv2 || b$iv3 == b1$iv2) {
                        int pos$iv4 = pos$iv3;
                        int pos$iv5 = s$iv4.pos;
                        return (pos$iv4 - pos$iv5) + offset$iv4;
                    }
                }
                int pos$iv6 = s$iv4.limit;
                offset$iv4 += pos$iv6 - s$iv4.pos;
            ...
            while (offset$iv4 < size()) {
                ...
                int pos$iv7 = (int) ((s$iv4.pos + fromIndex$iv) - offset$iv4);
                int limit$iv6 = s$iv4.limit;
                while (pos$iv7 < limit$iv6) {
                    byte b$iv4 = data$iv4[pos$iv7];
                    int limit$iv7 = limit$iv6;
                    int limit$iv8 = targetByteArray$iv3.length;
                    byte[] targetByteArray$iv4 = targetByteArray$iv3;
                    int i3 = 0;
                    while (i3 < limit$iv8) {
                        int i4 = i3;
                        byte t$iv2 = targetByteArray$iv4[i4];
                        if (b$iv4 == t$iv2) {
                            return (pos$iv7 - s$iv4.pos) + offset$iv4;
                        }
                        i3 = i4 + 1;
                    }
                    pos$iv7++;
                ...
                byte[] targetByteArray$iv5 = targetByteArray$iv3;
                offset$iv4 += s$iv4.limit - s$iv4.pos;
                fromIndex$iv = offset$iv4;
    ...
    public final byte m1829deprecated_getByte(long index) {
