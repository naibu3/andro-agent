...
public final class ResourcesCompat {
    ...
    public static Drawable getDrawable(Resources res, int id2, Resources.Theme theme) throws Resources.NotFoundException {
        return Api21Impl.getDrawable(res, id2, theme);
    }

    public static Drawable getDrawableForDensity(Resources res, int id2, int density, Resources.Theme theme) throws Resources.NotFoundException {
        return Api21Impl.getDrawableForDensity(res, id2, density, theme);
    }

    public static int getColor(Resources res, int id2, Resources.Theme theme) throws Resources.NotFoundException {
        return Api23Impl.getColor(res, id2, theme);
    }

    public static ColorStateList getColorStateList(Resources res, int id2, Resources.Theme theme) throws Resources.NotFoundException {
        ColorStateListCacheKey key = new ColorStateListCacheKey(res, theme);
        ColorStateList csl = getCachedColorStateList(key, id2);
        if (csl != null) {
            return csl;
        }
        ColorStateList csl2 = inflateColorStateList(res, id2, theme);
        if (csl2 != null) {
            addColorStateListToCache(key, id2, csl2, theme);
            return csl2;
        }
    ...
    public static float getFloat(Resources res, int id2) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.getFloat(res, id2);
        }
        TypedValue value = getTypedValue();
    ...
    public static Typeface getFont(Context context, int id2) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, id2, new TypedValue(), 0, null, null, false, false);
    }

    public static Typeface getCachedFont(Context context, int id2) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, id2, new TypedValue(), 0, null, null, false, true);
    }
    ...
    public static void getFont(Context context, int id2, FontCallback fontCallback, Handler handler) throws Resources.NotFoundException {
        Preconditions.checkNotNull(fontCallback);
        if (context.isRestricted()) {
            fontCallback.callbackFailAsync(-4, handler);
        } else {
            loadFont(context, id2, new TypedValue(), 0, fontCallback, handler, false, false);
        }
    }

    public static Typeface getFont(Context context, int id2, TypedValue value, int style, FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, id2, value, style, fontCallback, null, true, false);
    }

    private static Typeface loadFont(Context context, int id2, TypedValue value, int style, FontCallback fontCallback, Handler handler, boolean isRequestFromLayoutInflator, boolean isCachedOnly) throws Resources.NotFoundException {
        Resources resources = context.getResources();
        resources.getValue(id2, value, true);
        Typeface typeface = loadFont(context, resources, value, id2, style, fontCallback, handler, isRequestFromLayoutInflator, isCachedOnly);
    ...
    static class Api29Impl {
        ...
        static float getFloat(Resources res, int id2) {
    ...
    static class Api23Impl {
        ...
        static ColorStateList getColorStateList(Resources res, int id2, Resources.Theme theme) {
            return res.getColorStateList(id2, theme);
        }

        static int getColor(Resources resources, int id2, Resources.Theme theme) {
            return resources.getColor(id2, theme);
        }
    }
    ...
    static class Api21Impl {
        ...
        static Drawable getDrawable(Resources resources, int id2, Resources.Theme theme) {
            return resources.getDrawable(id2, theme);
        }

        static Drawable getDrawableForDensity(Resources resources, int id2, int density, Resources.Theme theme) {
            return resources.getDrawableForDensity(id2, density, theme);
        }
    }
    ...
    static class Api15Impl {
        ...
        static Drawable getDrawableForDensity(Resources resources, int id2, int density) {
            return resources.getDrawableForDensity(id2, density);
        }
    }
