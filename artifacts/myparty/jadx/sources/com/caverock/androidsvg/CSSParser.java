...
class CSSParser {
    ...
    static class Selector {
        ...
        public String toString() {
            ...
            while (it.hasNext()) {
                sb.append(it.next()).append(CardNumberConfig.SEPARATOR);
            }
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            switch (AnonymousClass1.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[pseudoClassIdentsFromString.ordinal()]) {
                ...
                case 12:
                    ...
                    pseudoClassAnPlusB = new PseudoClassAnPlusB(anPlusBNextAnPlusB.f251a, anPlusBNextAnPlusB.b, z, z2, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                    pseudoClassOnlyChild = pseudoClassAnPlusB;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
    ...
    private static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            int i5 = this.b;
            return (i3 - i5) % i4 == 0 && (Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.b) == Integer.signum(this.f252a));
        }

        public String toString() {
            String str = this.isFromStart ? "" : "last-";
            return this.isOfType ? String.format("nth-%schild(%dn%+d of type <%s>)", str, Integer.valueOf(this.f252a), Integer.valueOf(this.b), this.nodeName) : String.format("nth-%schild(%dn%+d)", str, Integer.valueOf(this.f252a), Integer.valueOf(this.b));
        }
    }
