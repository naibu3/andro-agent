...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\b\b\u0086\u0081\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00000\u0002B\u0011\b\u0002\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0006\u0010\u000b\u001a\u00020\u0004R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bj\u0002\b\tj\u0002\b\n¨\u0006\f"}, d2 = {"Lexpo/modules/camera/PictureFormat;", "Lexpo/modules/kotlin/types/Enumerable;", "", "value", "", "<init>", "(Ljava/lang/String;ILjava/lang/String;)V", "getValue", "()Ljava/lang/String;", "JPEG", "PNG", "toExtension", "expo-camera_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class PictureFormat implements Enumerable {
    ...
    public static EnumEntries<PictureFormat> getEntries() {
        return $ENTRIES;
    }

    private PictureFormat(String str, int i, String str2) {
        this.value = str2;
    }
    ...
    static {
        ...
        $ENTRIES = EnumEntriesKt.enumEntries(pictureFormatArr$values);
    }
