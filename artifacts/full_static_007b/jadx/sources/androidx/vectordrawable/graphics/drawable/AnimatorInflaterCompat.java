...
public class AnimatorInflaterCompat {
    ...
    public static Animator loadAnimator(Context context, int id2) throws Resources.NotFoundException {
        Animator objectAnimator = AnimatorInflater.loadAnimator(context, id2);
        return objectAnimator;
    }

    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, int id2) throws Resources.NotFoundException {
        return loadAnimator(context, resources, theme, id2, 1.0f);
    }

    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, int id2, float pathErrorScale) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                Resources.NotFoundException rnf2 = new Resources.NotFoundException("Can't load animation resource ID #0x" + Integer.toHexString(id2));
                rnf2.initCause(ex2);
                throw rnf2;
            }
        } finally {
