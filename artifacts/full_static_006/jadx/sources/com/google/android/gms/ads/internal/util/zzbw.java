...
public final class zzbw {
    ...
    public static String zzm(zzfgy zzfgyVar) throws JSONException, IOException {
        if (zzfgyVar == null) {
            return null;
        }
    ...
    private static void zzo(JsonWriter jsonWriter, Object obj) throws JSONException, IOException {
        if (obj == null) {
