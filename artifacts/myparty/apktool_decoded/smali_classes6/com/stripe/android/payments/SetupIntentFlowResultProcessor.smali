...
.method protected cancelStripeIntentSource-BWLJW6A(Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-interface {p4, p1, p3, p2, v0}, Lcom/stripe/android/networking/StripeRepository;->cancelSetupIntentSource-BWLJW6A(Ljava/lang/String;Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method protected refreshStripeIntent-BWLJW6A(Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of p3, p4, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;

    if-eqz p3, :cond_0

    move-object p3, p4

    check-cast p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;

    iget v0, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->label:I
    ...
    iget p4, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->label:I

    sub-int/2addr p4, v1

    iput p4, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->label:I

    goto :goto_0

    :cond_0
    new-instance p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;

    invoke-direct {p3, p0, p4}, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;-><init>(Lcom/stripe/android/payments/SetupIntentFlowResultProcessor;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p4, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->result:Ljava/lang/Object;
    ...
    .line 377
    iget v1, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->label:I
    ...
    iput v2, p3, Lcom/stripe/android/payments/SetupIntentFlowResultProcessor$refreshStripeIntent$1;->label:I

    invoke-interface {p4, p1, p2, p3}, Lcom/stripe/android/networking/StripeRepository;->refreshSetupIntent-0E7RQCE(Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method protected retrieveStripeIntent-BWLJW6A(Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-interface {p4, p1, p2, p3, v0}, Lcom/stripe/android/networking/StripeRepository;->retrieveSetupIntent-BWLJW6A(Ljava/lang/String;Lcom/stripe/android/core/networking/ApiRequest$Options;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
