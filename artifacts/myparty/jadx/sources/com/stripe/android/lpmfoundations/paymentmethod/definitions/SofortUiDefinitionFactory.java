...
final class SofortUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) SofortDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_sofort, R.drawable.stripe_ic_paymentsheet_pm_klarna, (Integer) null, false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        if (metadata.hasIntentToSetup(SofortDefinition.INSTANCE.getType().code)) {
