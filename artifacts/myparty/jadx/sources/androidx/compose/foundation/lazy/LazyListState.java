...
public final class LazyListState implements ScrollableState {
        ...
        this.prefetchScope = new LazyListPrefetchScope() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchScope$1
            ...
            public LazyLayoutPrefetchState.PrefetchHandle schedulePrefetch(int index) {
                ...
                try {
                    ...
                    return this.this$0.getPrefetchState().m1192schedulePrefetch0kLqBqw(index, childConstraints);
                } catch (Throwable th) {
                    companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                    throw th;
                }
    ...
    public final MutableState<Unit> m1137getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    public Object scroll(MutatePriority mutatePriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        if (i == 0) {
            ...
            c03781.L$0 = this;
            c03781.L$1 = mutatePriority;
            c03781.L$2 = function2;
            c03781.label = 1;
        ...
        function2 = (Function2) c03781.L$2;
        mutatePriority = (MutatePriority) c03781.L$1;
        lazyListState = (LazyListState) c03781.L$0;
        ResultKt.throwOnFailure(obj);
    ...
    public final MutableState<Unit> m1138getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    private final void updateScrollDeltaForPostLookahead(float delta, Density density, CoroutineScope coroutineScope) {
        if (delta <= density.mo712toPx0680j_4(LazyListStateKt.DeltaThresholdForScrollAnimation)) {
            return;
        }
        Snapshot.Companion companion = Snapshot.INSTANCE;
        Snapshot currentThreadSnapshot = companion.getCurrentThreadSnapshot();
