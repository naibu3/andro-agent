...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public void popBackStack(int id2, int flags) {
        ...
        enqueueAction(new PopBackStackState(null, id2, flags), false);
    }
    ...
    public boolean popBackStackImmediate(int id2, int flags) {
        ...
        return popBackStackImmediate(null, id2, flags);
    }
    ...
    private boolean popBackStackImmediate(String name, int id2, int flags) {
        ...
        if (fragment != null && id2 < 0 && name == null) {
            FragmentManager childManager = fragment.getChildFragmentManager();
            if (childManager.popBackStackImmediate()) {
                return true;
            }
        }
        boolean executePop = popBackStackState(this.mTmpRecords, this.mTmpIsPop, name, id2, flags);
        if (executePop) {
            ...
            if (name != null || id2 >= 0) {
                ...
                if ((flags & 1) != 0) {
                    ...
                    while (index >= 0) {
                        ...
                        if ((name == null || !name.equals(bss2.getName())) && (id2 < 0 || id2 != bss2.mIndex)) {
                            break;
                        }
                        index--;
                    }
