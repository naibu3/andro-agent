...
public final class zzex implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzex(Handler handler, zzew zzewVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzey {
        ...
        zzez.zza(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzez.zza(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        zzez.zza(zEglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]));
        ...
        zzez.zza(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzez.zza(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzez.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
