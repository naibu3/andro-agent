...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\u00020\u0001B*\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0002\u0010\u0007J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\f\u001a\u00020\rH\u0016J(\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00030\u000f2\u0006\u0010\u0010\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\nH\u0001ø\u0001\u0000¢\u0006\u0004\b\u0012\u0010\u0013R\u0019\u0010\u0005\u001a\u00020\u0003X\u0082\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0004\n\u0002\u0010\bR\u0019\u0010\u0006\u001a\u00020\u0003X\u0082\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0004\n\u0002\u0010\bR\u0019\u0010\u0002\u001a\u00020\u0003X\u0082\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0004\n\u0002\u0010\bR\u0019\u0010\u0004\u001a\u00020\u0003X\u0082\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0004\n\u0002\u0010\b\u0082\u0002\u000f\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u0014"}, d2 = {"Landroidx/compose/material3/RadioButtonColors;", "", PaymentSheetAppearanceKeys.SELECTED_COLOR, "Landroidx/compose/ui/graphics/Color;", PaymentSheetAppearanceKeys.UNSELECTED_COLOR, "disabledSelectedColor", "disabledUnselectedColor", "(JJJJLkotlin/jvm/internal/DefaultConstructorMarker;)V", "J", "equals", "", "other", "hashCode", "", "radioColor", "Landroidx/compose/runtime/State;", ViewProps.ENABLED, "selected", "radioColor$material3_release", "(ZZLandroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;", "material3_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m452animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer2, 48, 4);
            composer2.endReplaceableGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceableGroup(-1943770035);
            ComposerKt.sourceInformation(composer2, "195@8215L28");
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m3658equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m3658equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m3658equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m3664hashCodeimpl(this.selectedColor) * 31) + Color.m3664hashCodeimpl(this.unselectedColor)) * 31) + Color.m3664hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m3664hashCodeimpl(this.disabledUnselectedColor);
    }
}
