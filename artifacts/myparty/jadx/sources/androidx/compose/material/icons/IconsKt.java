...
public final class IconsKt {
    ...
    public static final ImageVector materialIcon(String str, boolean z, Function1<? super ImageVector.Builder, ImageVector.Builder> function1) {
        return function1.invoke(new ImageVector.Builder(str, Dp.m6117constructorimpl(24.0f), Dp.m6117constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, z, 96, null)).build();
    }
    ...
    public static /* synthetic */ ImageVector materialIcon$default(String str, boolean z, Function1 function1, int i, Object obj) {
        ...
        return ((ImageVector.Builder) function1.invoke(new ImageVector.Builder(str, Dp.m6117constructorimpl(24.0f), Dp.m6117constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, z, 96, null))).build();
    }

    /* renamed from: materialPath-YwgOQQI$default, reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m2080materialPathYwgOQQI$default(ImageVector.Builder builder, float f, float f2, int i, Function1 function1, int i2, Object obj) {
    ...
    public static final ImageVector.Builder m2079materialPathYwgOQQI(ImageVector.Builder builder, float f, float f2, int i, Function1<? super PathBuilder, Unit> function1) {
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3683getBlack0d7_KjU(), null);
        int iM4010getButtKaPHkGw = StrokeCap.INSTANCE.m4010getButtKaPHkGw();
        int iM4020getBevelLxFBmk8 = StrokeJoin.INSTANCE.m4020getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
