...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public void setStatusBarBackground(Drawable bg) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public void setStatusBarBackgroundResource(int resId) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        setStatusBarBackground(resId != 0 ? ContextCompat.getDrawable(getContext(), resId) : null);
    }

    public void setStatusBarBackgroundColor(int color) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            if (childCount3 == 8) {
                ...
                if (keylineWidthUsed2 < 0 || widthMode == 0) {
                    ...
                    if (b == null) {
                        ...
                        boolean zOnMeasureChild = b.onMeasureChild(this, child2, keylineWidthUsed3, childHeightMeasureSpec, childState2, 0);
                        child = child2;
