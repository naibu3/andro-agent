...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compare(ULong.m9296constructorimpl(ULong.m9296constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m9296constructorimpl(ULong.m9296constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
            dropDeletes();
        } else {
