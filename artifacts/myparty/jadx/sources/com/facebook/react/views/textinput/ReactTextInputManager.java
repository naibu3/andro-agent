...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    */
    ...
    public final void setSelectionHandleColor(ReactEditText view, Integer color) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        int i;
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public final void setCursorColor(ReactEditText view, Integer color) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Intrinsics.checkNotNullParameter(view, "view");
        if (Build.VERSION.SDK_INT >= 29) {
