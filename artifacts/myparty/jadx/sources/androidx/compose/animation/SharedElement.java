...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m3456Recttz77jQw(sharedElementInternalState.m445calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m446getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m444onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM3405boximpl = rect != null ? Offset.m3405boximpl(rect.m3451getTopLeftF1C5BW0()) : null;
            if (offsetM3405boximpl == null ? false : Offset.m3413equalsimpl0(offsetM3405boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM3473boximpl = rect2 != null ? Size.m3473boximpl(rect2.m3449getSizeNHjbRc()) : null;
                if (sizeM3473boximpl == null ? false : Size.m3481equalsimpl0(sizeM3473boximpl.getPackedValue(), lookaheadSize)) {
                    return;
                }
            }
            Rect rectM3456Recttz77jQw = RectKt.m3456Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(rectM3456Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, rectM3456Recttz77jQw);
            }
        }
    }
