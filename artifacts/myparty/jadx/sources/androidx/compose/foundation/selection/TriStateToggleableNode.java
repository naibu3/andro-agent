...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m1285updateQzZPfjk(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> onClick) {
        if (this.state != state) {
            this.state = state;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m616updateQzZPfjk(interactionSource, indicationNodeFactory, enabled, (String) null, role, onClick);
    }
