        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i4 == 0) {
                ...
                this.I$1 = b;
                this.label = 1;
                holder = channel.mo10646receiveCatchingJP2dKIU(this);
            ...
            if (i4 != 1) {
                ...
                if (holder != coroutine_suspended) {
                    ...
                    objArr2 = objArr;
                    bArr2 = bArr3;
                    indexedValue = (IndexedValue) ChannelResult.m10659getOrNullimpl(holder);
                    ...
                    while (true) {
                        ...
                        if (bArr2[index] != i3) {
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m10659getOrNullimpl(channel.mo10647tryReceivePtdJZtk());
                            if (indexedValue == null) {
                                if (i2 == 0) {
                                }
                            }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                try {
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        if (this.$flows[this.$i].collect(new C02421(this.$resultChannel, this.$i), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
            ...
            static final class C02421<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

                C02421(Channel<IndexedValue<Object>> channel, int i) {
                    this.$resultChannel = channel;
                    this.$i = i;
                }
