...
public final class zzcbz {
    ...
    public final Bundle zzb(Context context, String str) {
        ...
        synchronized (this.zzj) {
            ...
            int identifier = contextZza.getResources().getIdentifier("Theme.Translucent", "style", ApiHeadersProvider.ANDROID_PLATFORM);
            boolean z = false;
            if (identifier == 0) {
    ...
    public final void zzg(com.google.android.gms.ads.internal.client.zzl zzlVar, long j) {
        ...
        synchronized (this.zzj) {
            ...
            if (this.zzb == -1) {
                if (jCurrentTimeMillis - jZzd > ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzaU)).longValue()) {
                    this.zzd = -1;
                } else {
