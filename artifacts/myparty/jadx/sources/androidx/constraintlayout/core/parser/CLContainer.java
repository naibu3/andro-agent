...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo6379clone() {
        CLContainer cLContainer = (CLContainer) super.mo6379clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo6379clone = it.next().mo6379clone();
            cLElementMo6379clone.setContainer(cLContainer);
            arrayList.add(cLElementMo6379clone);
        }
