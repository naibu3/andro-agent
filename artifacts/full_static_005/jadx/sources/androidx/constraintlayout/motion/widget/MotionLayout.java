    ...
    */
    public void transitionToState(int id2, int screenWidth, int screenHeight, int duration) {
        ...
        if (motionScene == null || motionScene.mStateSet == null) {
            ...
            if (i2 == -1) {
                ...
                this.mInTransition = true;
                this.mModel.initFrom(this.mLayoutWidget, null, this.mScene.getConstraintSet(id3));
                rebuildScene();
                this.mModel.build();
    ...
    class Model {
        ...
        public void build() {
            ...
            for (int i = 0; i < n; i++) {
                ...
                int id2 = v.getId();
                ids[i] = id2;
                controllers2.put(id2, motionController);
    ...
    private void checkStructure(int csetId, ConstraintSet set) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ConstraintSet.Constraint c = set.getConstraint(id2);
            if (c == null) {
    ...
    public ConstraintSet cloneConstraintSet(int id2) {
        ...
        ConstraintSet orig = motionScene.getConstraintSet(id2);
