...
public final class PagerMeasurePolicyKt {
    ...
    */
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m1263rememberPagerMeasurePolicy8u0NR3k(final Function0<PagerLazyLayoutItemProvider> function0, final PagerState pagerState, final PaddingValues paddingValues, final boolean z, Orientation orientation, int i, float f, PageSize pageSize, Alignment.Horizontal horizontal, Alignment.Vertical vertical, SnapPosition snapPosition, final CoroutineScope coroutineScope, final Function0<Integer> function02, Composer composer, int i2, int i3) {
        ...
        boolean z9 = ((((i2 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) ^ 48) > 32 && composer.changed(pagerState)) || (i2 & 48) == 32) | ((((i2 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(paddingValues)) || (i2 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | ((((i2 & 7168) ^ 3072) > 2048 && composer.changed(z)) || (i2 & 3072) == 2048);
        if (((57344 & i2) ^ 24576) > 16384) {
            ...
            if (((234881024 & i2) ^ 100663296) <= 67108864) {
                ...
                if (((1879048192 & i2) ^ 805306368) > 536870912) {
                    ...
                    if (((3670016 & i2) ^ 1572864) <= 1048576) {
                        ...
                        if (((29360128 & i2) ^ 12582912) > 8388608) {
                            ...
                            if (((i3 & 14) ^ 6) <= 4) {
                                ...
                                boolean z15 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z14 | z7;
                                    ...
                                    if (!zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                        ...
                                        objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                                            ...
                                            public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                                                return m1264invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                                            }

                                            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                                            public final PagerMeasureResult m1264invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                                                int i6;
                                                int i7;
                                                int i8;
                                                int iM6070getMaxWidthimpl;
                                                long jIntOffset;
                                                ObservableScopeInvalidator.m1194attachToScopeimpl(pagerState.m1265getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                                                boolean z16 = orientation3 == Orientation.Vertical;
                                                CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, z16 ? Orientation.Vertical : Orientation.Horizontal);
                                                if (z16) {
                                                    i6 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo971calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                                                } else {
                                                    i6 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                                                }
                                                if (z16) {
                                                    i7 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo972calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                                                } else {
                                                    i7 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                                                }
                                                int i9 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getTop());
                                                int i10 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getBottom());
                                                ...
                                                int i15 = i14 - i8;
                                                long jM6089offsetNN6EwU = ConstraintsKt.m6089offsetNN6EwU(j, -i13, -i11);
                                                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                                                pagerState.setDensity$foundation_release(lazyLayoutMeasureScope2);
                                                int i16 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(f3);
                                                if (z16) {
                                                    iM6070getMaxWidthimpl = Constraints.m6069getMaxHeightimpl(j) - i11;
                                                } else {
                                                    iM6070getMaxWidthimpl = Constraints.m6070getMaxWidthimpl(j) - i13;
                                                }
                                                if (!z || iM6070getMaxWidthimpl > 0) {
                                                    jIntOffset = IntOffsetKt.IntOffset(i6, i9);
                                                } else {
                                                    if (!z16) {
                                                        i6 += iM6070getMaxWidthimpl;
                                                    }
                                                    if (z16) {
                                                        i9 += iM6070getMaxWidthimpl;
                                                    }
                                                    jIntOffset = IntOffsetKt.IntOffset(i6, i9);
                                                }
                                                long j2 = jIntOffset;
                                                int iCoerceAtLeast = RangesKt.coerceAtLeast(pageSize3.calculateMainAxisPageSize(lazyLayoutMeasureScope2, iM6070getMaxWidthimpl, i16), 0);
                                                pagerState.m1269setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, orientation3 == Orientation.Vertical ? Constraints.m6070getMaxWidthimpl(jM6089offsetNN6EwU) : iCoerceAtLeast, 0, orientation3 != Orientation.Vertical ? Constraints.m6069getMaxHeightimpl(jM6089offsetNN6EwU) : iCoerceAtLeast, 5, null));
                                                ...
                                                try {
                                                    ...
                                                    int iCurrentPageOffset = PagerKt.currentPageOffset(snapPosition4, iM6070getMaxWidthimpl, iCoerceAtLeast, i16, i8, i15, pagerState2.getCurrentPage(), pagerState2.getCurrentPageOffsetFraction(), pagerState2.getPageCount());
                                                    Unit unit = Unit.INSTANCE;
                                                    companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                                                    int i17 = iM6070getMaxWidthimpl;
                                                    int i18 = i8;
                                                    PagerMeasureResult pagerMeasureResultM1262measurePagerbmk8ZPk = PagerMeasureKt.m1262measurePagerbmk8ZPk(lazyLayoutMeasureScope, function02.invoke().intValue(), pagerLazyLayoutItemProviderInvoke, i17, i18, i15, i16, iMatchScrollPositionWithKey$foundation_release, iCurrentPageOffset, jM6089offsetNN6EwU, orientation3, vertical3, horizontal3, z, j2, iCoerceAtLeast, i5, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(pagerLazyLayoutItemProviderInvoke, pagerState.getPinnedPages(), pagerState.getBeyondBoundsInfo()), snapPosition3, pagerState.m1266getPlacementScopeInvalidatorzYiylxw$foundation_release(), coroutineScope, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1$measureResult$1
                                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                        {
                                                            super(3);
                                                        }
                                                        ...
                                                        public final MeasureResult invoke(int i19, int i20, Function1<? super Placeable.PlacementScope, Unit> function1) {
                                                            return lazyLayoutMeasureScope.layout(ConstraintsKt.m6087constrainWidthK40F9xA(j, i19 + i13), ConstraintsKt.m6086constrainHeightK40F9xA(j, i20 + i11), MapsKt.emptyMap(), function1);
                                                        }
                                                    });
                                                    PagerState.applyMeasureResult$foundation_release$default(pagerState, pagerMeasureResultM1262measurePagerbmk8ZPk, false, 2, null);
                                                    return pagerMeasureResultM1262measurePagerbmk8ZPk;
                                                } catch (Throwable th) {
                                                    companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                                                    throw th;
                                                }
                                ...
                                if (!zChanged) {
                                    ...
                                    objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                                        ...
                                        public final PagerMeasureResult m1264invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                                            ...
                                            LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                                            pagerState.setDensity$foundation_release(lazyLayoutMeasureScope2);
                                            int i16 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(f32);
                                            if (z16) {
                                                iM6070getMaxWidthimpl = Constraints.m6069getMaxHeightimpl(j) - i11;
                                            } else {
                                                iM6070getMaxWidthimpl = Constraints.m6070getMaxWidthimpl(j) - i13;
                                            ...
                                            long j2 = jIntOffset;
                                            int iCoerceAtLeast = RangesKt.coerceAtLeast(pageSize32.calculateMainAxisPageSize(lazyLayoutMeasureScope2, iM6070getMaxWidthimpl, i16), 0);
                                            pagerState.m1269setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, orientation32 == Orientation.Vertical ? Constraints.m6070getMaxWidthimpl(jM6089offsetNN6EwU) : iCoerceAtLeast, 0, orientation32 != Orientation.Vertical ? Constraints.m6069getMaxHeightimpl(jM6089offsetNN6EwU) : iCoerceAtLeast, 5, null));
                                            PagerLazyLayoutItemProvider pagerLazyLayoutItemProviderInvoke = function0.invoke();
                                            Snapshot.Companion companion = Snapshot.INSTANCE;
                                            PagerState pagerState2 = pagerState;
                                            ...
                                            try {
                                                ...
                                                int i17 = iM6070getMaxWidthimpl;
                                                int i18 = i8;
                                                PagerMeasureResult pagerMeasureResultM1262measurePagerbmk8ZPk = PagerMeasureKt.m1262measurePagerbmk8ZPk(lazyLayoutMeasureScope, function02.invoke().intValue(), pagerLazyLayoutItemProviderInvoke, i17, i18, i15, i16, iMatchScrollPositionWithKey$foundation_release, iCurrentPageOffset, jM6089offsetNN6EwU, orientation32, vertical32, horizontal32, z, j2, iCoerceAtLeast, i52, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(pagerLazyLayoutItemProviderInvoke, pagerState.getPinnedPages(), pagerState.getBeyondBoundsInfo()), snapPosition32, pagerState.m1266getPlacementScopeInvalidatorzYiylxw$foundation_release(), coroutineScope, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1$measureResult$1
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(3);
                                                    }
                            ...
                            boolean z152 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z14 | z7;
                            if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
                            }
                            if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
                            }
                        ...
                        boolean z1522 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z142 | z7;
                        if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
                        }
                        if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
                        }
                    ...
                    boolean z15222 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z1422 | z7;
                    if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
                    }
                    if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
                    }
                ...
                boolean z152222 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z14222 | z7;
                if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
                }
                if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
                }
            ...
            boolean z1522222 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z142222 | z7;
            if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
            }
            if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
            }
        ...
        boolean z15222222 = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function02)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | z1422222 | z7;
        if (((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072) {
        }
        if ((i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) != 131072) {
        }
