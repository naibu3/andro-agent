...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5035roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo705roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5036roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo706roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5037toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo707toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5038toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo708toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5039toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo709toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5040toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo710toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5041toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo711toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5042toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo712toPx0680j_4(f);
        }
        ...
        public static long m5043toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo713toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5044toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo714toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5045toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo715toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5046toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo716toSpkPz2Gy4(i);
        }
