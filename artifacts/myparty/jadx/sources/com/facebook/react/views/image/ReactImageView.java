...
public final class ReactImageView extends GenericDraweeView {
    ...
    public final void setSource(ReadableArray sources) {
        ...
        if (sources == null || sources.size() == 0) {
            ...
            if (sources.size() == 1) {
                ...
                ImageSource imageSource = new ImageSource(context2, map.getString(ShareConstants.MEDIA_URI), AudioStats.AUDIO_AMPLITUDE_NONE, AudioStats.AUDIO_AMPLITUDE_NONE, imageCacheControlComputeCacheControl, 12, null);
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (map2 != null) {
                        ...
                        ImageSource imageSource2 = new ImageSource(context4, map2.getString(ShareConstants.MEDIA_URI), map2.getDouble("width"), map2.getDouble("height"), imageCacheControlComputeCacheControl2);
    ...
    */
    ...
    public final void maybeUpdateView() throws NumberFormatException {
        if (this.isDirty) {
    ...
    private final void maybeUpdateViewFromRequest(boolean doResize) throws NumberFormatException {
        ImageSource imageSource = this.imageSource;
        if (imageSource == null) {
            return;
        }
    ...
    @VisibleForTesting
    public final void setControllerListener(ControllerListener<ImageInfo> controllerListener) throws NumberFormatException {
    ...
    @Override // android.view.View
    protected void onSizeChanged(int w, int h, int oldw, int oldh) throws NumberFormatException {
    ...
    private final class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap source, PlatformBitmapFactory bitmapFactory) {
            ...
            try {
                ...
                CloseableReference<Bitmap> closeableReferenceMo6624clone = closeableReferenceCreateBitmap.mo6624clone();
                Intrinsics.checkNotNullExpressionValue(closeableReferenceMo6624clone, "clone(...)");
                return closeableReferenceMo6624clone;
            } finally {
