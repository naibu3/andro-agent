...
public final class TapGestureDetectorKt {
    ...
    static final class C03452 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C03452(Continuation<? super C03452> continuation) {
            super(continuation);
        }
    ...
    static final class C03442 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: Code restructure failed: missing block: B:67:0x021f, code lost:
                ...
                if (r2.withTimeout(r4, new androidx.compose.foundation.gestures.TapGestureDetectorKt.C03442.AnonymousClass1.AnonymousClass9(r18.$$this$coroutineScope, r18.$onDoubleTap, r18.$onTap, r11, r18.$pressScope, null), r18) == r1) goto L78;
             */
                ...
                switch (this.label) {
                    case 0:
                        ...
                        if (objAwaitFirstDown$default != coroutine_suspended) {
                            ...
                            BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, null, new C00291(this.$pressScope, null), 3, null);
                            if (this.$onPress != TapGestureDetectorKt.NoPressGesture) {
                                BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, null, new C00302(this.$onPress, this.$pressScope, pointerInputChange, null), 3, null);
                            }
                            ...
                            try {
                                ...
                                if (function1 != null) {
                                    function1.invoke(Offset.m3405boximpl(pointerInputChange.getPosition()));
                                }
                                    ...
                                    if (this.$onDoubleTap != null) {
                                        ...
                                        if (objAwaitSecondDown != coroutine_suspended) {
                                            ...
                                            if (pointerInputChange3 == null) {
                                                ...
                                                if (function14 != null) {
                                                    function14.invoke(Offset.m3405boximpl(((PointerInputChange) objectRef3.element).getPosition()));
                                                }
                                            }
                                        }
                                    } else {
                                        ...
                                        if (function15 != null) {
                                            function15.invoke(Offset.m3405boximpl(((PointerInputChange) objectRef.element).getPosition()));
                                        }
                                    }
                                }
                                return Unit.INSTANCE;
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            function12 = this.$onTap;
                            if (function12 != null) {
                                function12.invoke(Offset.m3405boximpl(((PointerInputChange) objectRef4.element).getPosition()));
                            }
                            function13 = this.$onLongPress;
                            if (function13 != null) {
                                function13.invoke(Offset.m3405boximpl(pointerInputChange4.getPosition()));
                            }
                            this.L$0 = null;
                            this.L$1 = null;
                            this.L$2 = null;
            ...
            static final class C00302 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        Offset offsetM3405boximpl = Offset.m3405boximpl(this.$down.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, offsetM3405boximpl, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
            ...
            static final class AnonymousClass8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                        PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                        Offset offsetM3405boximpl = Offset.m3405boximpl(this.$secondDown.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, offsetM3405boximpl, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
            ...
            static final class AnonymousClass9 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (pointerInputChange == null) {
                        ...
                        function1.invoke(Offset.m3405boximpl(this.$upOrCancel.element.getPosition()));
                        return Unit.INSTANCE;
                    }
                    pointerInputChange.consume();
                    BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, null, new C00311(this.$pressScope, null), 3, null);
                    this.$onDoubleTap.invoke(Offset.m3405boximpl(pointerInputChange.getPosition()));
                    return Unit.INSTANCE;
                }
    ...
    */
    ...
    static final class C03422 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super PointerInputChange>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03422(PointerInputChange pointerInputChange, Continuation<? super C03422> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03422 c03422 = new C03422(this.$firstUp, continuation);
            c03422.L$0 = obj;
            return c03422;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super PointerInputChange> continuation) {
            return ((C03422) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r12) {
            ...
            L49:
                ...
                return r12
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.TapGestureDetectorKt.C03422.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final Object awaitSecondDown(AwaitPointerEventScope awaitPointerEventScope, PointerInputChange pointerInputChange, Continuation<? super PointerInputChange> continuation) {
        return awaitPointerEventScope.withTimeoutOrNull(awaitPointerEventScope.getViewConfiguration().getDoubleTapTimeoutMillis(), new C03422(pointerInputChange, null), continuation);
    }
        ...
        static final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            */
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.$onPress != TapGestureDetectorKt.NoPressGesture) {
                    BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, null, new C00282(this.$onPress, this.$pressScope, pointerInputChange2, null), 3, null);
                }
                this.L$0 = null;
                this.label = 2;
    ...
    */
    public static final Object awaitFirstDown(AwaitPointerEventScope awaitPointerEventScope, boolean z, PointerEventPass pointerEventPass, Continuation<? super PointerInputChange> continuation) {
        ...
        Object objAwaitPointerEvent = anonymousClass2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = anonymousClass2.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objAwaitPointerEvent);
            anonymousClass2.L$0 = awaitPointerEventScope;
            anonymousClass2.L$1 = pointerEventPass;
            anonymousClass2.Z$0 = z;
            anonymousClass2.label = 1;
            objAwaitPointerEvent = awaitPointerEventScope.awaitPointerEvent(pointerEventPass, anonymousClass2);
        ...
        PointerEventPass pointerEventPass2 = (PointerEventPass) anonymousClass2.L$1;
        AwaitPointerEventScope awaitPointerEventScope2 = (AwaitPointerEventScope) anonymousClass2.L$0;
        ResultKt.throwOnFailure(objAwaitPointerEvent);
        z = z2;
        awaitPointerEventScope = awaitPointerEventScope2;
    ...
    */
    public static final Object waitForUpOrCancellation(AwaitPointerEventScope awaitPointerEventScope, PointerEventPass pointerEventPass, Continuation<? super PointerInputChange> continuation) {
        ...
        if (continuation instanceof C03452) {
            c03452 = (C03452) continuation;
            if ((c03452.label & Integer.MIN_VALUE) != 0) {
                c03452.label -= Integer.MIN_VALUE;
            } else {
                c03452 = new C03452(continuation);
            }
        }
        Object objAwaitPointerEvent2 = c03452.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c03452.label;
        if (i2 == 0) {
            ...
            c034522.L$0 = awaitPointerEventScope2;
            c034522.L$1 = pointerEventPass2;
            c034522.label = 1;
            objAwaitPointerEvent = awaitPointerEventScope2.awaitPointerEvent(pointerEventPass2, c034522);
            if (objAwaitPointerEvent != coroutine_suspended) {
            }
            return coroutine_suspended;
        }
        if (i2 == 1) {
            pointerEventPass3 = (PointerEventPass) c03452.L$1;
            awaitPointerEventScope3 = (AwaitPointerEventScope) c03452.L$0;
            ResultKt.throwOnFailure(objAwaitPointerEvent2);
            ...
            for (i = 0; i < size; i++) {
                if (!PointerEventKt.changedToUp(changes3.get(i))) {
                    ...
                    for (int i4 = 0; i4 < size3; i4++) {
                        ...
                        if (pointerInputChange.isConsumed() || PointerEventKt.m4809isOutOfBoundsjwHxaWs(pointerInputChange, awaitPointerEventScope3.mo4775getSizeYbymL2g(), awaitPointerEventScope3.mo4774getExtendedTouchPaddingNHjbRc())) {
                            break;
                        }
                    }
                    PointerEventPass pointerEventPass5 = PointerEventPass.Final;
                    c03452.L$0 = awaitPointerEventScope3;
                    c03452.L$1 = pointerEventPass3;
                    c03452.label = 2;
                    objAwaitPointerEvent2 = awaitPointerEventScope3.awaitPointerEvent(pointerEventPass5, c03452);
                }
            }
