...
final class zzhff {
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzhcd {
        ...
        if (byteBuffer.hasArray()) {
            return zzhfcVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? zzhfd.zzd(byteBuffer, i, i2) : zzhfc.zzd(byteBuffer, i, i2);
    }
