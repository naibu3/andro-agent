...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo1096onPreScrollOzD1aCk(long available, int source) {
        ...
        if (NestedScrollSource.m4747equalsimpl0(source, NestedScrollSource.INSTANCE.m4759getUserInputWNlRxjI()) && Offset.m3417getYimpl(available) < 0.0f) {
            return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3417getYimpl(available))).floatValue());
        }
        return Offset.INSTANCE.m3432getZeroF1C5BW0();
    }
    ...
    */
    public Object mo1095onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        if (i == 0) {
            ...
            Float fBoxFloat = Boxing.boxFloat(Velocity.m6355getYimpl(j));
        ...
        return Velocity.m6345boximpl(VelocityKt.Velocity(f, ((Number) objInvoke).floatValue()));
    }
}
