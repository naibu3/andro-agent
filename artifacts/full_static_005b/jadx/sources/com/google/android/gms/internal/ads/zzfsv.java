...
final class zzfsv implements zzfrh {
    ...
    zzfsv(Object obj, zzfsw zzfswVar, zzfth zzfthVar, zzfre zzfreVar) {
        this.zza = obj;
        this.zzb = zzfswVar;
        this.zzc = zzfthVar;
        this.zzd = zzfreVar;
    ...
    private static String zzi(byte[] bArr) {
        ...
        zzavkVarZza.zzb(zzauz.DG);
        zzavkVarZza.zza(zzhac.zzv(bArr, 0, bArr.length));
        return Base64.encodeToString(((zzavl) zzavkVarZza.zzbr()).zzaV(), 11);
    }
    ...
    public final synchronized void zzg() throws zzftf {
        try {
            ...
            throw new zzftf(2003, e);
        }
    }

    final synchronized boolean zzh() throws zzftf {
        try {
        } catch (Exception e) {
            throw new zzftf(2001, e);
        }
