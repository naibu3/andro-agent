...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m9211boximpl(m10356nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m9217constructorimpl(i3);
    ...
    public int m10356nextpVg5ArA() {
        ...
        this.next = UInt.m9217constructorimpl(this.step + i);
        return i;
    }
}
