...
public final class BacsDebitAccountNumberConfig implements TextFieldConfig {
    ...
    private final ResolvableString label = ResolvableStringUtilsKt.resolvableString$default(R.string.stripe_bacs_account_number, new Object[0], null, 4, null);
    private final int keyboard = androidx.compose.ui.text.input.KeyboardType.INSTANCE.m5838getNumberPasswordPjHm6EE();
    private final VisualTransformation visualTransformation = VisualTransformation.INSTANCE.getNone();
    ...
    public TextFieldState determineState(String input) {
        ...
        if (input.length() < 8) {
            return new TextFieldStateConstants.Error.Incomplete(R.string.stripe_bacs_account_number_incomplete);
        }
    ...
    public String filter(String userTyped) throws IOException {
        ...
        return StringsKt.take(sb.toString(), 8);
    }
}
