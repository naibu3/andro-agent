...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo430measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m6072getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6070getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m6071getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6069getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo4993measureBRTryo0.getWidth(), Constraints.m6072getMinWidthimpl(j), Constraints.m6070getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo4993measureBRTryo0.getHeight(), Constraints.m6071getMinHeightimpl(j), Constraints.m6069getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5057place70tqf50$default(placementScope, placeableMo4993measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m6279boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo4993measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo4993measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
