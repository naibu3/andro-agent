...
final /* synthetic */ class FlowKt__CountKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {13}, m = NewHtcHomeBadger.COUNT, n = {ContextChain.TAG_INFRA}, s = {"L$0"})
    ...
    /* compiled from: Count.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {25}, m = NewHtcHomeBadger.COUNT, n = {ContextChain.TAG_INFRA}, s = {"L$0"})
