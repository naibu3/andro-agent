...
final class ExtensionsInfo {
    ...
    ExtensionsInfo(CameraProvider cameraProvider, Context context) {
        ...
        this.mVendorExtenderFactory = new VendorExtenderFactory() { // from class: androidx.camera.extensions.ExtensionsInfo$$ExternalSyntheticLambda0
            ...
            public final VendorExtender createVendorExtender(int i, boolean z) {
                return this.f$0.getVendorExtender(i, z);
            }
        };
    }
    ...
    Range<Long> getEstimatedCaptureLatencyRange(CameraSelector cameraSelector, int i, Size size) {
        ...
        try {
            VendorExtender vendorExtenderCreateVendorExtender = this.mVendorExtenderFactory.createVendorExtender(i, this.mShouldUseCamera2Extensions);
    ...
    private CameraFilter getFilter(int i) {
        return new ExtensionCameraFilter(getExtendedCameraConfigProviderId(i), this.mVendorExtenderFactory.createVendorExtender(i, this.mShouldUseCamera2Extensions));
    }
        ...
        if (ExtendedCameraConfigProviderStore.getConfigProvider(identifierCreate) == CameraConfigProvider.EMPTY) {
            ExtendedCameraConfigProviderStore.addConfig(identifierCreate, new CameraConfigProvider() { // from class: androidx.camera.extensions.ExtensionsInfo$$ExternalSyntheticLambda1
                ...
                public final CameraConfig getConfig(CameraInfo cameraInfo, Context context) {
                    return this.f$0.m248x2cd47cb7(i, identifierCreate, cameraInfo, context);
                }
            });
        }
    }

    /* renamed from: lambda$injectExtensionCameraConfig$0$androidx-camera-extensions-ExtensionsInfo, reason: not valid java name */
    /* synthetic */ CameraConfig m248x2cd47cb7(int i, Identifier identifier, CameraInfo cameraInfo, Context context) {
        VendorExtender vendorExtenderCreateVendorExtender = this.mVendorExtenderFactory.createVendorExtender(i, this.mShouldUseCamera2Extensions);
        vendorExtenderCreateVendorExtender.init(cameraInfo);
    ...
    VendorExtender getVendorExtender(int i, boolean z) {
        if (z) {
            if (Build.VERSION.SDK_INT >= 33) {
                return new Camera2ExtensionsVendorExtender(i, (Camera2ExtensionsInfo) Objects.requireNonNull(this.mCamera2ExtensionsInfo));
            }
