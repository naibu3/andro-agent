...
public final class e {
    ...
    public final String toString() {
        ...
        sb.append(i3 >= 30 ? D.a.b(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY"));
        ...
        sb.append("; uniqueId: ");
        sb.append(i3 >= 33 ? D.c.c(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY"));
        sb.append("; checkable: ");
        ...
        sb.append(i3 >= 34 ? AbstractC0029x.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.CONTAINER_TITLE_KEY"));
        ...
        sb.append(i3 >= 33 ? D.c.d(accessibilityNodeInfo) : c(8388608));
        sb.append("; accessibilityDataSensitive: ");
        sb.append(i3 >= 34 ? AbstractC0029x.g(accessibilityNodeInfo) : c(64));
        sb.append("; [");
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            String strB = b(((AccessibilityNodeInfo.AccessibilityAction) dVar.f460a).getId());
