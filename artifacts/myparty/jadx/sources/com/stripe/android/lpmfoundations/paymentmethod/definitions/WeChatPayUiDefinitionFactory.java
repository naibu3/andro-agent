...
final class WeChatPayUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) WeChatPayDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_wechat, R.drawable.stripe_ic_paymentsheet_pm_wechat_pay, (Integer) null, false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
