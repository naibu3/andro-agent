...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m932copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m934copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m934copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m6063equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m6073hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m6075toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo927getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo931getMinWidthD9Ej5fM() {
        return this.density.mo709toDpu2uoSUM(Constraints.m6072getMinWidthimpl(mo927getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo929getMaxWidthD9Ej5fM() {
        return Constraints.m6066getHasBoundedWidthimpl(mo927getConstraintsmsEJaDk()) ? this.density.mo709toDpu2uoSUM(Constraints.m6070getMaxWidthimpl(mo927getConstraintsmsEJaDk())) : Dp.INSTANCE.m6136getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo930getMinHeightD9Ej5fM() {
        return this.density.mo709toDpu2uoSUM(Constraints.m6071getMinHeightimpl(mo927getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo928getMaxHeightD9Ej5fM() {
        return Constraints.m6065getHasBoundedHeightimpl(mo927getConstraintsmsEJaDk()) ? this.density.mo709toDpu2uoSUM(Constraints.m6069getMaxHeightimpl(mo927getConstraintsmsEJaDk())) : Dp.INSTANCE.m6136getInfinityD9Ej5fM();
    }
}
