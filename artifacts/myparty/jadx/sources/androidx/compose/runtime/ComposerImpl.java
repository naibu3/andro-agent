...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m3117startBaiHCIY(key, null, GroupKind.INSTANCE.m3127getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m3117startBaiHCIY(-127, null, GroupKind.INSTANCE.m3127getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m3117startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m3127getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m3117startBaiHCIY(125, null, GroupKind.INSTANCE.m3128getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m3117startBaiHCIY(125, null, GroupKind.INSTANCE.m3129getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m3117startBaiHCIY(key, null, GroupKind.INSTANCE.m3127getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProvider(ProvidedValue<?> value) {
        ...
        m3117startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3127getGroupULZAiWs(), persistentCompositionLocalMapCurrentCompositionLocalScope);
    }
    ...
    public void startProviders(ProvidedValue<?>[] values) {
        ...
        m3117startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3127getGroupULZAiWs(), persistentCompositionLocalMapUpdateProviderMapGroup);
    }
    ...
    */
    private final void m3117startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        int iHashCode;
        int iRotateLeft;
        ...
        if (empty == null) {
            if (data != null && key == 207 && !Intrinsics.areEqual(data, Composer.INSTANCE.getEmpty())) {
                ...
                boolean z = kind == GroupKind.INSTANCE.m3127getGroupULZAiWs();
                ...
                boolean z2 = kind == GroupKind.INSTANCE.m3128getNodeULZAiWs() && this.reusing;
                if (this.pending == null) {
        ...
        if (kind == GroupKind.INSTANCE.m3127getGroupULZAiWs()) {
        }
    ...
    */
    ...
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m3117startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3127getGroupULZAiWs(), locals);
            this.providerCache = null;
