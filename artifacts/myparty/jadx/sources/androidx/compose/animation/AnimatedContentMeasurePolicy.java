    ...
    public MeasureResult mo377measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i2] = placeableMo4993measureBRTryo0;
                jM6292getZeroYbymL2g = jIntSize;
            }
            i2++;
        }
        int size3 = list.size();
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            if (placeableArr[i3] == null) {
                placeableArr[i3] = measurable2.mo4993measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = IntSize.m6287getWidthimpl(jM6292getZeroYbymL2g);
        } else {
            if (size == 0) {
                placeable2 = null;
            } else {
            ...
            if (placeable2 == null) {
                ...
                if (measureScope.isLookingAhead()) {
                    ...
                    height = IntSize.m6286getHeightimpl(jM6292getZeroYbymL2g);
                }
                final int i4 = height;
                if (!measureScope.isLookingAhead()) {
                    this.rootScope.m402setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(i, i4));
                }
                return MeasureScope.layout$default(measureScope, i, i4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        ...
                        while (i7 < length) {
                            ...
                            if (placeable5 != null) {
                                long jMo3262alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3262alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i5, i6), LayoutDirection.Ltr);
                                placementScope2 = placementScope;
                                Placeable.PlacementScope.place$default(placementScope2, placeable5, IntOffset.m6245getXimpl(jMo3262alignKFBX0sM), IntOffset.m6246getYimpl(jMo3262alignKFBX0sM), 0.0f, 4, null);
                            } else {
                                placementScope2 = placementScope;
                            }
                            i7++;
