    ...
    */
        ...
        if (this.mScene == null || this.mScene.mStateSet == null) {
            ...
            if (stagger != 0.0f) {
                ...
                for (int i6 = 0; i6 < n; i6++) {
                    MotionController f = this.mFrameArrayList.get(getChildAt(i6));
                    float x = f.getFinalX();
                    float y = f.getFinalY();
                ...
                for (int i7 = 0; i7 < n; i7++) {
                    MotionController f2 = this.mFrameArrayList.get(getChildAt(i7));
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = sbAppend.append(((int) (r3 + 0.5d)) / 100.0f).toString();
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = sbAppend2.append(((int) (r3 + 0.5d)) / 100.0f).toString();
