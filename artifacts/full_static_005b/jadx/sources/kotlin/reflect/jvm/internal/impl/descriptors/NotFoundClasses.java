    ...
    public static final class MockClassDescriptor extends ClassDescriptorBase {
        ...
        public MockClassDescriptor(StorageManager storageManager, DeclarationDescriptor container, Name name, boolean z, int i) {
            ...
            while (it.hasNext()) {
                ...
                arrayList.add(TypeParameterDescriptorImpl.createWithDefaultBound(this, Annotations.Companion.getEMPTY(), false, Variance.INVARIANT, Name.identifier(RequestConfiguration.MAX_AD_CONTENT_RATING_T + iNextInt), iNextInt, storageManager));
            }
