...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    private static final int asciiLetterToLowerCaseCode$StringsKt__StringNumberConversionsJVMKt(char c) {
        return c | CardNumberConfig.SEPARATOR;
    }
    ...
    private static final boolean isHexLetter$StringsKt__StringNumberConversionsJVMKt(char c) {
        return (((c | CardNumberConfig.SEPARATOR) + (-97)) & 65535) < 6;
    }
    ...
    */
    private static final boolean isValidFloat$StringsKt__StringNumberConversionsJVMKt(String str) {
        ...
        if (str.charAt(i2) != '0') {
            ...
            if ((str.charAt(i3) | CardNumberConfig.SEPARATOR) == 120) {
                int i4 = i2 + 2;
                int i5 = i4;
                while (true) {
                    if (i5 > length) {
                    ...
                    z = z5;
                    if (((str.charAt(i5) - '0') & 65535) >= 10 && (((r15 | CardNumberConfig.SEPARATOR) - 97) & 65535) >= 6) {
                        break;
                    }
                    i5++;
                    z5 = z;
                ...
                if (i5 <= length) {
                    if (str.charAt(i5) == '.') {
                        ...
                        while (i7 <= length) {
                            char c2 = c;
                            if (((str.charAt(i7) - '0') & 65535) >= 10 && (((r15 | CardNumberConfig.SEPARATOR) - 97) & 65535) >= 6) {
                                break;
                            }
                            i7++;
                            c = c2;
        ...
        int i10 = i2 + 1;
        int iCharAt = str.charAt(i2) | CardNumberConfig.SEPARATOR;
        ...
        int iCharAt2 = str.charAt(i10) | CardNumberConfig.SEPARATOR;
