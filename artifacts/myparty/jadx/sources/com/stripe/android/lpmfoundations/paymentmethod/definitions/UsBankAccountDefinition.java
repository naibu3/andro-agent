...
public final class UsBankAccountDefinition implements PaymentMethodDefinition {
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.FinancialConnectionsSdk, AddPaymentMethodRequirement.ValidUsBankVerificationMethod, AddPaymentMethodRequirement.MerchantSupportsDelayedPaymentMethods});
    }
