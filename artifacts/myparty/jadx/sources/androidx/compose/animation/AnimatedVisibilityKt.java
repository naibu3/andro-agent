                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((74899 & i3) != 74898 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.updateTransition(Boolean.valueOf(z2), str4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 9) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.1
                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((599185 & i3) != 599184 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.updateTransition(Boolean.valueOf(z2), str4, composerStartRestartGroup, (i8 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.3
                                public final Boolean invoke(boolean z3) {
                                    return Boolean.valueOf(z3);
                                }
                    ...
                    if ((599185 & i3) != 599184) {
                        ...
                        AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.updateTransition(Boolean.valueOf(z2), str4, composerStartRestartGroup, (i82 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.3
                            public final Boolean invoke(boolean z3) {
                                return Boolean.valueOf(z3);
                            }
                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((599185 & i3) != 599184 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            Modifier modifier4 = companion;
                            EnterTransition enterTransition3 = enterTransitionPlus;
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.updateTransition(Boolean.valueOf(z2), str4, composerStartRestartGroup, (i8 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.5
                                public final Boolean invoke(boolean z3) {
                                    return Boolean.valueOf(z3);
                                }
                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((74899 & i3) != 74898 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            Modifier modifier4 = companion;
                            EnterTransition enterTransition4 = enterTransitionPlus;
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.rememberTransition(mutableTransitionState, str4, composerStartRestartGroup, MutableTransitionState.$stable | (i3 & 14) | ((i3 >> 9) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.7
                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((599185 & i3) != 599184 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            Modifier modifier4 = companion;
                            EnterTransition enterTransition3 = enterTransitionPlus;
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.rememberTransition(mutableTransitionState, str4, composerStartRestartGroup, MutableTransitionState.$stable | (i8 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.9
                                public final Boolean invoke(boolean z) {
                                    return Boolean.valueOf(z);
                                }
                    ...
                    if ((599185 & i3) != 599184) {
                        ...
                        Modifier modifier42 = companion;
                        EnterTransition enterTransition32 = enterTransitionPlus;
                        AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.rememberTransition(mutableTransitionState, str4, composerStartRestartGroup, MutableTransitionState.$stable | (i82 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.9
                            public final Boolean invoke(boolean z) {
                                return Boolean.valueOf(z);
                            }
                ...
                if (i5 != 0) {
                    ...
                    if (i6 != 0) {
                        ...
                        if ((599185 & i3) != 599184 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            Modifier modifier4 = companion;
                            EnterTransition enterTransition3 = enterTransitionPlus;
                            AnimatedVisibilityImpl(androidx.compose.animation.core.TransitionKt.rememberTransition(mutableTransitionState, str4, composerStartRestartGroup, MutableTransitionState.$stable | (i8 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0), new Function1<Boolean, Boolean>() { // from class: androidx.compose.animation.AnimatedVisibilityKt.AnimatedVisibility.11
                                public final Boolean invoke(boolean z) {
                                    return Boolean.valueOf(z);
                                }
            ...
            if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                        return m406invoke3p2s80s(measureScope, measurable, constraints.getValue());
                    }

                    /* renamed from: invoke-3p2s80s, reason: not valid java name */
                    public final MeasureResult m406invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                        long jIntSize;
                        ...
                        if (measureScope.isLookingAhead() && !function1.invoke(transition.getTargetState()).booleanValue()) {
                            jIntSize = IntSize.INSTANCE.m6292getZeroYbymL2g();
                        } else {
                            jIntSize = IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight());
                        }
                        return MeasureScope.layout$default(measureScope, IntSize.m6287getWidthimpl(jIntSize), IntSize.m6286getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                Placeable.PlacementScope.place$default(placementScope, placeableMo4993measureBRTryo0, 0, 0, 0.0f, 4, null);
                            }
                        }, 4, null);
                    }
                };
        ...
        if ((4793491 & i7) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function1.invoke(transition.getTargetState()).booleanValue() || function1.invoke(transition.getCurrentState()).booleanValue() || transition.isSeeking() || transition.getHasInitialValueAnimations()) {
                ...
                if (!getExitFinished(transitionCreateChildTransitionInternal) || !AnimatedEnterExitImpl$lambda$4(stateProduceState)) {
                    ...
                    Modifier modifierCreateModifier = EnterExitTransitionKt.createModifier(transitionCreateChildTransitionInternal, enterTransition2, exitTransition2, null, "Built-in", composerStartRestartGroup, (i13 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | 24576 | (i13 & 896), 4);
                    ...
                    if (onLookaheadMeasured2 != null) {
                        ...
                        if (z3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue3 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$2$1
                                ...
                                @Override // kotlin.jvm.functions.Function3
                                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                                    return m405invoke3p2s80s(measureScope, measurable, constraints.getValue());
                                }

                                /* renamed from: invoke-3p2s80s, reason: not valid java name */
                                public final MeasureResult m405invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                                    final Placeable placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(j);
                                    OnLookaheadMeasured onLookaheadMeasured4 = onLookaheadMeasured2;
                                    if (measureScope.isLookingAhead()) {
                                        onLookaheadMeasured4.m437invokeozmzZPI(IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight()));
                                    }
                                    return MeasureScope.layout$default(measureScope, placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$2$1$1$1
                                        {
                                            super(1);
                                        }
                    ...
                    Updater.m3157setimpl(composerM3150constructorimpl, animatedEnterExitMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                    ...
                    function3.invoke(animatedVisibilityScopeImpl, composer2, Integer.valueOf((i7 >> 18) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS));
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
