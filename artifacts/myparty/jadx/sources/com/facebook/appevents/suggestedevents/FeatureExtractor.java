...
public final class FeatureExtractor {
    ...
    private final float[] parseFeatures(JSONObject node) {
        ...
        try {
            ...
            if (matchIndicators(new String[]{"$", CreateFinancialConnectionsSessionForDeferredPaymentParams.PARAM_AMOUNT, "price", "total"}, strArr)) {
                fArr[0] = fArr[0] + 1.0f;
            }
            ...
            if (StringsKt.contains$default((CharSequence) lowerCase3, (CharSequence) PaymentSheetAppearanceKeys.RADIO, false, 2, (Object) null) && StringsKt.contains$default((CharSequence) lowerCase3, (CharSequence) "button", false, 2, (Object) null)) {
