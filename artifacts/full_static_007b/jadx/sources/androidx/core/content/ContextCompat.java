...
public class ContextCompat {
    ...
    public static Drawable getDrawable(Context context, int id2) {
        return Api21Impl.getDrawable(context, id2);
    }

    public static ColorStateList getColorStateList(Context context, int id2) {
        return ResourcesCompat.getColorStateList(context.getResources(), id2, context.getTheme());
    }

    public static int getColor(Context context, int id2) {
        return Api23Impl.getColor(context, id2);
    }
    ...
    static class Api21Impl {
        ...
        static Drawable getDrawable(Context obj, int id2) {
            return obj.getDrawable(id2);
        }
    ...
    static class Api23Impl {
        ...
        static int getColor(Context obj, int id2) {
            return obj.getColor(id2);
        }
