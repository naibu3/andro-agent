...
public class InputImage implements MLTaskInput {
    ...
    public static InputImage fromFilePath(Context context, Uri uri) throws IllegalAccessException, NoSuchMethodException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
