...
public final class LazyStaggeredGridMeasureKt {
    ...
    public static final LazyStaggeredGridMeasureResult m1231measureStaggeredGridXtK8cYQ(LazyLayoutMeasureScope lazyLayoutMeasureScope, LazyStaggeredGridState lazyStaggeredGridState, List<Integer> list, LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, LazyStaggeredGridSlots lazyStaggeredGridSlots, long j, boolean z, boolean z2, long j2, int i, int i2, int i3, int i4, CoroutineScope coroutineScope, GraphicsContext graphicsContext) {
        ...
        if (iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length != lazyStaggeredGridMeasureContext.getLaneCount()) {
            ...
            int i6 = 0;
            while (i6 < laneCount) {
                if (i6 >= iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (iM1230maxInRangejy6DScQ = iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                    iM1230maxInRangejy6DScQ = i6 == 0 ? 0 : m1230maxInRangejy6DScQ(iArr, SpanRange.m1241constructorimpl(0, i6)) + 1;
                }
                iArr[i6] = iM1230maxInRangejy6DScQ;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:173:0x0347, code lost:
        ...
        r46 = r1;
        r45 = r2;
        r1 = r0.m1226getSpanRangelOCCd4c(r0.getItemProvider(), r5, r4);
        r4 = r0.getLaneInfo();
        r9 = r12;
        r26 = r13;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:180:0x0375, code lost:
        ...
        r4.setLane(r5, r15);
        r4 = r0.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(r5, r1);
        r1 = m1230maxInRangejy6DScQ(r8, r1);
     */
    ...
    */
    private static final LazyStaggeredGridMeasureResult measure(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, int i, int[] iArr, int[] iArr2, boolean z) {
        ...
        int[] iArr9;
        boolean z2;
        int iM6087constrainWidthK40F9xA;
        ...
        if (itemCount <= 0 || lazyStaggeredGridMeasureContext2.getLaneCount() == 0) {
            int iM6072getMinWidthimpl = Constraints.m6072getMinWidthimpl(lazyStaggeredGridMeasureContext.getConstraints());
            int iM6071getMinHeightimpl = Constraints.m6071getMinHeightimpl(lazyStaggeredGridMeasureContext.getConstraints());
            lazyStaggeredGridMeasureContext.getState().getItemAnimator$foundation_release().onMeasured(0, iM6072getMinWidthimpl, iM6071getMinHeightimpl, new ArrayList(), lazyStaggeredGridMeasureContext.getMeasuredItemProvider().getKeyIndexMap(), lazyStaggeredGridMeasureContext.getMeasuredItemProvider(), lazyStaggeredGridMeasureContext.getIsVertical(), false, lazyStaggeredGridMeasureContext.getLaneCount(), false, 0, 0, lazyStaggeredGridMeasureContext.getCoroutineScope(), lazyStaggeredGridMeasureContext.getGraphicsContext());
            long jM1185getMinSizeToFitDisappearingItemsYbymL2g = lazyStaggeredGridMeasureContext.getState().getItemAnimator$foundation_release().m1185getMinSizeToFitDisappearingItemsYbymL2g();
            if (!IntSize.m6285equalsimpl0(jM1185getMinSizeToFitDisappearingItemsYbymL2g, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
                iM6072getMinWidthimpl = ConstraintsKt.m6087constrainWidthK40F9xA(lazyStaggeredGridMeasureContext.getConstraints(), IntSize.m6287getWidthimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g));
                iM6071getMinHeightimpl = ConstraintsKt.m6086constrainHeightK40F9xA(lazyStaggeredGridMeasureContext.getConstraints(), IntSize.m6286getHeightimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g));
            }
            return new LazyStaggeredGridMeasureResult(iArr, iArr2, 0.0f, MeasureScope.layout$default(measureScope, iM6072getMinWidthimpl, iM6071getMinHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$1
            ...
            }, 4, null), false, lazyStaggeredGridMeasureContext.getIsVertical(), false, lazyStaggeredGridMeasureContext.getResolvedSlots(), lazyStaggeredGridMeasureContext.getItemProvider().getSpanProvider(), measureScope, itemCount, CollectionsKt.emptyList(), IntSizeKt.IntSize(Constraints.m6072getMinWidthimpl(lazyStaggeredGridMeasureContext.getConstraints()), Constraints.m6071getMinHeightimpl(lazyStaggeredGridMeasureContext.getConstraints())), -lazyStaggeredGridMeasureContext.getBeforeContentPadding(), lazyStaggeredGridMeasureContext.getMainAxisAvailableSize() + lazyStaggeredGridMeasureContext.getAfterContentPadding(), lazyStaggeredGridMeasureContext.getBeforeContentPadding(), lazyStaggeredGridMeasureContext.getAfterContentPadding(), lazyStaggeredGridMeasureContext.getMainAxisSpacing(), lazyStaggeredGridMeasureContext.getCoroutineScope(), null);
        }
        ...
        while (true) {
            ...
            long jM1226getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext2.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext2.getItemProvider(), iFindPreviousItemIndex, iIndexOf);
            int i23 = (int) (jM1226getSpanRangelOCCd4c & 4294967295L);
            boolean z10 = z9;
            int i24 = (int) (jM1226getSpanRangelOCCd4c >> 32);
            int i25 = i23 - i24;
            lazyStaggeredGridMeasureContext2.getLaneInfo().setLane(iFindPreviousItemIndex, i25 != 1 ? -2 : i24);
            LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext2.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iFindPreviousItemIndex, jM1226getSpanRangelOCCd4c);
            int iM1230maxInRangejy6DScQ = m1230maxInRangejy6DScQ(iArrCopyOf2, jM1226getSpanRangelOCCd4c);
            ...
            while (i24 < i23) {
                ...
                int mainAxisSizeWithSpacings = iM1230maxInRangejy6DScQ + lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ.getMainAxisSizeWithSpacings() + (gaps2 == null ? 0 : gaps2[i24]);
        ...
        for (int i32 = -1; iIndexOfMinValue$default != i32 && laneCount2 < lazyStaggeredGridMeasureContext2.getLaneCount(); i32 = -1) {
            ...
            laneCount2++;
            if (i33 >= 0) {
                long jM1226getSpanRangelOCCd4c2 = lazyStaggeredGridMeasureContext2.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext2.getItemProvider(), i33, iIndexOfMinValue$default);
                ArrayDeque[] arrayDequeArr2 = arrayDequeArr;
                LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2 = lazyStaggeredGridMeasureContext2.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(i33, jM1226getSpanRangelOCCd4c2);
                String str2 = str;
                int[] iArr14 = iArrCopyOf;
                int[] iArr15 = iArrCopyOf2;
                int i34 = (int) (jM1226getSpanRangelOCCd4c2 & 4294967295L);
                int i35 = i3;
                int i36 = itemCount;
                int i37 = (int) (jM1226getSpanRangelOCCd4c2 >> 32);
                int i38 = i34 - i37;
                lazyStaggeredGridMeasureContext2.getLaneInfo().setLane(i33, i38 != 1 ? -2 : i37);
                int iM1230maxInRangejy6DScQ2 = m1230maxInRangejy6DScQ(iArr13, jM1226getSpanRangelOCCd4c2);
                for (int i39 = i37; i39 < i34; i39++) {
                    iArr13[i39] = lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2.getMainAxisSizeWithSpacings() + iM1230maxInRangejy6DScQ2;
                    iArrCopyOf3[i39] = i33;
                    arrayDequeArr2[i39].addLast(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2);
                }
                if (iM1230maxInRangejy6DScQ2 >= mainAxisSpacing || iArr13[i37] > mainAxisSpacing) {
                    z8 = z13;
                } else {
                    lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2.setVisible(false);
                    z8 = true;
                }
        ...
        loop9: while (true) {
            ...
            int i48 = laneCount;
            long jM1226getSpanRangelOCCd4c3 = lazyStaggeredGridMeasureContext2.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext2.getItemProvider(), iMaxOrThrow, iIndexOfMinValue$default2);
            int i49 = (int) (jM1226getSpanRangelOCCd4c3 & 4294967295L);
            int i50 = (int) (jM1226getSpanRangelOCCd4c3 >> 32);
            int i51 = i49 - i50;
            lazyStaggeredGridMeasureContext2.getLaneInfo().setLane(iMaxOrThrow, i51 != 1 ? -2 : i50);
            LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ3 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iMaxOrThrow, jM1226getSpanRangelOCCd4c3);
            int iM1230maxInRangejy6DScQ3 = m1230maxInRangejy6DScQ(iArr20, jM1226getSpanRangelOCCd4c3);
            if (i51 != 1) {
            ...
            for (int i52 = i50; i52 < i49; i52++) {
                if (gaps != null) {
                    gaps[i52] = iM1230maxInRangejy6DScQ3 - iArr20[i52];
                }
                iArr19[i52] = iMaxOrThrow;
                iArr20[i52] = iM1230maxInRangejy6DScQ3 + lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ3.getMainAxisSizeWithSpacings();
                arrayDequeArr3[i52].addLast(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ3);
            }
            lazyStaggeredGridMeasureContext.getLaneInfo().setGaps(iMaxOrThrow, gaps);
            if (iM1230maxInRangejy6DScQ3 < mainAxisSpacing && iArr20[i50] <= mainAxisSpacing) {
                lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ3.setVisible(false);
            }
        ...
        if (lazyStaggeredGridMeasureContext2.getIsVertical()) {
            iM6087constrainWidthK40F9xA = Constraints.m6070getMaxWidthimpl(lazyStaggeredGridMeasureContext2.getConstraints());
        } else {
            iM6087constrainWidthK40F9xA = ConstraintsKt.m6087constrainWidthK40F9xA(lazyStaggeredGridMeasureContext2.getConstraints(), ArraysKt.maxOrThrow(iArr6) + beforeContentPadding);
        }
        int i62 = iM6087constrainWidthK40F9xA;
        if (lazyStaggeredGridMeasureContext2.getIsVertical()) {
            iM6069getMaxHeightimpl = ConstraintsKt.m6086constrainHeightK40F9xA(lazyStaggeredGridMeasureContext2.getConstraints(), ArraysKt.maxOrThrow(iArr6) + beforeContentPadding);
        } else {
            iM6069getMaxHeightimpl = Constraints.m6069getMaxHeightimpl(lazyStaggeredGridMeasureContext2.getConstraints());
        }
        int i63 = iM6069getMaxHeightimpl;
        ...
        if (size2 >= 0) {
            ...
            while (true) {
                ...
                if (z7) {
                    ...
                    i16 = laneCount;
                    long jM1226getSpanRangelOCCd4c4 = lazyStaggeredGridMeasureContext2.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext2.getItemProvider(), iIntValue, 0);
                    ArrayList arrayList = list3 == null ? new ArrayList() : list3;
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ4 = lazyStaggeredGridMeasureContext2.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iIntValue, jM1226getSpanRangelOCCd4c4);
                    mainAxisSizeWithSpacings3 -= lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ4.getMainAxisSizeWithSpacings();
                    lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ4.position(mainAxisSizeWithSpacings3, 0, iMin);
                    arrayList.add(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ4);
        ...
        while (i68 < size3) {
            ...
            if (iIntValue2 >= i4) {
                ...
                if (z6) {
                    ...
                    list2 = listEmptyList;
                    i15 = size3;
                    long jM1226getSpanRangelOCCd4c5 = lazyStaggeredGridMeasureContext2.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext2.getItemProvider(), iIntValue2, 0);
                    if (arrayListEmptyList == null) {
                        arrayListEmptyList = new ArrayList();
                    }
                    iArr10 = iArr4;
                    List list4 = arrayListEmptyList;
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ5 = lazyStaggeredGridMeasureContext2.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iIntValue2, jM1226getSpanRangelOCCd4c5);
                    lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ5.position(mainAxisSizeWithSpacings4, 0, iMin);
                    mainAxisSizeWithSpacings4 += lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ5.getMainAxisSizeWithSpacings();
                    list4.add(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ5);
        ...
        long jM1185getMinSizeToFitDisappearingItemsYbymL2g2 = lazyStaggeredGridMeasureContext2.getState().getItemAnimator$foundation_release().m1185getMinSizeToFitDisappearingItemsYbymL2g();
        if (IntSize.m6285equalsimpl0(jM1185getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
            i13 = i63;
            i14 = i62;
        } else {
            int i70 = lazyStaggeredGridMeasureContext2.getIsVertical() ? i63 : i62;
            int iM6087constrainWidthK40F9xA2 = ConstraintsKt.m6087constrainWidthK40F9xA(lazyStaggeredGridMeasureContext2.getConstraints(), Math.max(i62, IntSize.m6287getWidthimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
            int iM6086constrainHeightK40F9xA = ConstraintsKt.m6086constrainHeightK40F9xA(lazyStaggeredGridMeasureContext2.getConstraints(), Math.max(i63, IntSize.m6286getHeightimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
            int i71 = lazyStaggeredGridMeasureContext2.getIsVertical() ? iM6086constrainHeightK40F9xA : iM6087constrainWidthK40F9xA2;
            if (i71 != i70) {
            ...
            i14 = iM6087constrainWidthK40F9xA2;
            i13 = iM6086constrainHeightK40F9xA;
        }
        int i73 = i7;
        int i74 = 0;
        while (true) {
        ...
        return new LazyStaggeredGridMeasureResult(iArr22, iArr3, scrollToBeConsumed, MeasureScope.layout$default(lazyLayoutMeasureScope, i14, i13, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$33
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                ObservableScopeInvalidator.m1194attachToScopeimpl(lazyStaggeredGridMeasureContext2.getState().m1239getPlacementScopeInvalidatorzYiylxw$foundation_release());
            }
            ...
            for (ArrayDeque<LazyStaggeredGridMeasuredItem> arrayDeque2 : arrayDequeArr) {
                if (!arrayDeque2.isEmpty()) {
                    ...
                    if (lazyStaggeredGridMeasuredItemRemoveFirst.getLane() == i2) {
                        long jM1241constructorimpl = SpanRange.m1241constructorimpl(lazyStaggeredGridMeasuredItemRemoveFirst.getLane(), lazyStaggeredGridMeasuredItemRemoveFirst.getSpan());
                        int iM1230maxInRangejy6DScQ = m1230maxInRangejy6DScQ(iArr, jM1241constructorimpl);
                        lazyStaggeredGridMeasuredItemRemoveFirst.position(iM1230maxInRangejy6DScQ, lazyStaggeredGridMeasureContext.getResolvedSlots().getPositions()[i2], i);
                        arrayList.add(lazyStaggeredGridMeasuredItemRemoveFirst);
                        int i5 = (int) (jM1241constructorimpl & 4294967295L);
                        for (int i6 = (int) (jM1241constructorimpl >> 32); i6 < i5; i6++) {
                            iArr[i6] = lazyStaggeredGridMeasuredItemRemoveFirst.getMainAxisSizeWithSpacings() + iM1230maxInRangejy6DScQ;
                        }
                    }
                }
            }
        ...
        if (z) {
            ...
            if (size >= 0) {
                while (true) {
                    ...
                    if (function12.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                        long jM1226getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue, 0);
                        if (arrayList == null) {
                            arrayList = new ArrayList();
                        }
                        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iIntValue, jM1226getSpanRangelOCCd4c);
                        function1.invoke(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ);
                        arrayList.add(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ);
                    }
                    if (i < 0) {
                        break;
                    }
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (function12.invoke(Integer.valueOf(iIntValue2)).booleanValue()) {
                    long jM1226getSpanRangelOCCd4c2 = lazyStaggeredGridMeasureContext.m1226getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                    if (arrayList == null) {
                        arrayList = new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m1235getAndMeasurejy6DScQ(iIntValue2, jM1226getSpanRangelOCCd4c2);
                    function1.invoke(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2);
                    arrayList.add(lazyStaggeredGridMeasuredItemM1235getAndMeasurejy6DScQ2);
                }
            }
        }
    ...
    private static final void m1229forEachnIS5qE8(long j, Function1<? super Integer, Unit> function1) {
    ...
    private static final int m1230maxInRangejy6DScQ(int[] iArr, long j) {
        int i = (int) (j & 4294967295L);
