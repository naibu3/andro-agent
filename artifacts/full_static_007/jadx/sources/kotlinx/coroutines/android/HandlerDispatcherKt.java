...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM214constructorimpl = Result.m214constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m220isFailureimpl(objM214constructorimpl) ? null : objM214constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1788dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
