...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m5812getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, WebSocketProtocol.PAYLOAD_SHORT, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i = 0; i < changes.getChangeCount(); i++) {
            long jMo1446getRangejx7JFs = changes.mo1446getRangejx7JFs(i);
            changes.mo1445getOriginalRangejx7JFs(i);
            if (!TextRange.m5596getCollapsedimpl(jMo1446getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m5600getMinimpl(jMo1446getRangejx7JFs), TextRange.m5599getMaximpl(jMo1446getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m5609substringFDrldGo(textFieldBuffer.asCharSequence(), jMo1446getRangejx7JFs), this.locale));
            }
        }
    }
