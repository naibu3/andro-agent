...
public final class LongSparseArrayKt {
    ...
    public static final class C06371<T> implements Iterator<T>, KMappedMarker {
        ...
        C06371(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C06371(longSparseArray);
    }
