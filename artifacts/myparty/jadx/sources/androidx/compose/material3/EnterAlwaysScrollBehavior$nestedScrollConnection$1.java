...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo822onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if ((this.this$0.getState().getHeightOffset() == 0.0f || this.this$0.getState().getHeightOffset() == this.this$0.getState().getHeightOffsetLimit()) && Offset.m3417getYimpl(consumed) == 0.0f && Offset.m3417getYimpl(available) > 0.0f) {
    ...
    */
    public Object mo821onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object objMo821onPostFlingRZ2iAVY = enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12.result;
        ...
        if (i == 0) {
            ...
            objMo821onPostFlingRZ2iAVY = super.mo821onPostFlingRZ2iAVY(j, j2, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
        ...
        objMo821onPostFlingRZ2iAVY = AppBarKt.settleAppBar(state, fM6355getYimpl, flingAnimationSpec, snapAnimationSpec, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
        if (objMo821onPostFlingRZ2iAVY != coroutine_suspended) {
            j4 = packedValue;
            return Velocity.m6345boximpl(Velocity.m6358plusAH228Gc(j4, ((Velocity) objMo821onPostFlingRZ2iAVY).getPackedValue()));
        }
