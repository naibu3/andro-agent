...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m4010getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m4021getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m4284getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m4285getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4006equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4016equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int iHashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4007hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4017hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iHashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4008toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m4018toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
