...
public final class RealConnectionPool {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: okhttp3.internal.connection.RealConnectionPool$$ExternalSyntheticLambda0
        ...
        public final void run() throws IOException {
            this.f$0.m1809lambda$new$0$okhttp3internalconnectionRealConnectionPool();
        }
    };
    ...
    /* synthetic */ void m1809lambda$new$0$okhttp3internalconnectionRealConnectionPool() throws IOException {
        while (true) {
