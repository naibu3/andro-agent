...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode$default(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContentOnReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m676getDragAndDropkB6V9T0(), null, 8, null));
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1542invokek4lQ0M(offset.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1542invokek4lQ0M(long j) {
            long jM1563fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1563fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), j);
            this.this$0.getTextFieldState().m1573selectCharsIn5zctL8(TextRangeKt.TextRange(TextLayoutState.m1553getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), jM1563fromWindowToDecorationUv8p0NA, false, 2, null)));
            this.this$0.getTextFieldSelectionState().m1610updateHandleDraggingUv8p0NA(Handle.Cursor, jM1563fromWindowToDecorationUv8p0NA);
        }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m5820equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m5839getPasswordPjHm6EE()) && !KeyboardType.m5820equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m5838getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m5432setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m5602getStartimpl(selection2) && i2 == TextRange.m5597getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1574selectUntransformedCharsIn5zctL8(jTextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1573selectCharsIn5zctL8(jTextRange);
                }
                return true;
            }
        }, 1, null);
        final int iM1351getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1351getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m5427onImeAction9UiTYpY$default(semanticsPropertyReceiver, iM1351getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1541onImeActionPerformedKlQnJC8(iM1351getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C04271(null), 3, null);
        } else {
            if (isFocused()) {
                return;
            }
    ...
    static final class C04271 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C04271(continuation);
        }
    ...
    public void mo548onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo548onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputNode.mo548onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo549onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1474onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo547onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1473onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.this$0;
                textFieldDecoratorModifierNode.m1541onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.getKeyboardOptions().m1351getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C04291(ReceiveContentConfigurationKt.getReceiveContentConfiguration(this), null), 3, null);
        }
    }
    ...
    static final class C04291 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04291(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C04291> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C04291(this.$receiveContentConfiguration, continuation);
        }
        ...
        static final class C00561 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            ...
            /* synthetic */ class C00571 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1543invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1543invokeKlQnJC8(int i) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1541onImeActionPerformedKlQnJC8(i);
                }
            }
        }
    }
    ...
    public final void m1541onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5784getNoneeUduSuo()) || ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5780getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            this.keyboardActionScope.mo1337defaultKeyboardActionKlQnJC8(imeAction);
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo1337defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
