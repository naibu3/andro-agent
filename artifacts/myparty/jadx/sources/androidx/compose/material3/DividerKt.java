...
public final class DividerKt {
    ...
    public static final void m2266Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = DividerDefaults.INSTANCE.m2265getThicknessD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
            ...
            if (Dp.m6122equalsimpl0(f, Dp.INSTANCE.m6135getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 2023513938, "C:CompositionLocal.kt#9igjgp");
                Object objConsume = composerStartRestartGroup.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                fM6117constructorimpl = Dp.m6117constructorimpl(1.0f / ((Density) objConsume).getDensity());
            } else {
                fM6117constructorimpl = f;
            }
            composerStartRestartGroup.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m575backgroundbw27NRU$default(SizeKt.m1051height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), fM6117constructorimpl), j3, null, 2, null), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer2, int i6) {
                DividerKt.m2266Divider9IZ8Weo(modifier2, f2, j2, composer2, i | 1, i2);
            }
        });
    }
}
