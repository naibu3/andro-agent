...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m3888constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m3897resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo5009transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m3527setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1479buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m3453translatek4lQ0M(textLayoutNodeCoordinates.mo5002localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m3432getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m3453translatek4lQ0M(textLayoutNodeCoordinates.mo5002localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m3432getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
