...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int iRound = Math.round(Offset.m3416getXimpl(jPositionInRoot));
        int iRound2 = Math.round(Offset.m3417getYimpl(jPositionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.INSTANCE.m4759getUserInputWNlRxjI();
        }
        return NestedScrollSource.INSTANCE.m4758getSideEffectWNlRxjI();
    }
}
