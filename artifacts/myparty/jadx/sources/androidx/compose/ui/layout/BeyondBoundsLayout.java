...
public interface BeyondBoundsLayout {
    ...
    <T> T mo1173layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m4971constructorimpl(1);
        private static final int After = m4971constructorimpl(2);
        private static final int Left = m4971constructorimpl(3);
        private static final int Right = m4971constructorimpl(4);
        private static final int Above = m4971constructorimpl(5);
        private static final int Below = m4971constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m4970boximpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m4979getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m4978getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m4981getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m4982getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m4977getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m4980getBelowhoxUOeE() {
        ...
        public static String m4975toStringimpl(int i) {
            return m4973equalsimpl0(i, Before) ? "Before" : m4973equalsimpl0(i, After) ? "After" : m4973equalsimpl0(i, Left) ? "Left" : m4973equalsimpl0(i, Right) ? "Right" : m4973equalsimpl0(i, Above) ? "Above" : m4973equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
