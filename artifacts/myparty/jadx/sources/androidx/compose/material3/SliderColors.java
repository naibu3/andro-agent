...
public final class SliderColors {
    ...
    public final State<Color> thumbColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3647boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m3658equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m3658equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m3658equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m3658equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m3658equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m3658equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m3658equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m3658equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m3658equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3664hashCodeimpl(this.thumbColor) * 31) + Color.m3664hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3664hashCodeimpl(this.activeTickColor)) * 31) + Color.m3664hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3664hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3664hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3664hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.disabledInactiveTickColor);
    }
}
