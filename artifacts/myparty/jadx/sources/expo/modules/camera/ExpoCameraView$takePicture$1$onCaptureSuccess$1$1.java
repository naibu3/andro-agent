...
@DebugMetadata(c = "expo.modules.camera.ExpoCameraView$takePicture$1$onCaptureSuccess$1$1", f = "ExpoCameraView.kt", i = {}, l = {306}, m = "invokeSuspend", n = {}, s = {})
...
final class ExpoCameraView$takePicture$1$onCaptureSuccess$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    ExpoCameraView$takePicture$1$onCaptureSuccess$1$1(ExpoCameraView expoCameraView, byte[] bArr, Promise promise, PictureOptions pictureOptions, RuntimeContext runtimeContext, File file, Continuation<? super ExpoCameraView$takePicture$1$onCaptureSuccess$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ExpoCameraView$takePicture$1$onCaptureSuccess$1$1(this.this$0, this.$data, this.$promise, this.$options, this.$runtimeContext, this.$it, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (new ResolveTakenPicture(bArr, promise, pictureOptions, z, runtimeContext, file, new PictureSavedDelegate() { // from class: expo.modules.camera.ExpoCameraView$takePicture$1$onCaptureSuccess$1$1$$ExternalSyntheticLambda0
