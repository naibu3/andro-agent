...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo377measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m5150measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m5150measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo5149getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m6225getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        ...
        if (!this.nodes.m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int iM5228constructorimpl = NodeKind.m5228constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & iM5228constructorimpl) != 0) {
    ...
    */
    public final void attach$ui_release(Owner owner) {
        ...
        if (this.nodes.m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(8))) {
        ...
        if (this.isVirtualLookaheadRoot) {
            ...
            if (this.lookaheadRoot == null && this.nodes.m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(512))) {
                setLookaheadRoot(this);
            }
        }
        if (!getIsDeactivated()) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM5212getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m5212getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m6068getHasFixedWidthimpl(jM5212getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m6067getHasFixedHeightimpl(jM5212getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5151maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5152maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5153minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5154minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m5154minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m5153minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m5152maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m5151maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setDensity(Density density) {
        ...
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m5228constructorimpl(16) & head.getKindSet()) != 0) {
    ...
    public void setLayoutDirection(LayoutDirection layoutDirection) {
        if (this.layoutDirection != layoutDirection) {
            ...
            if ((nodeChain.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                    if ((head.getKindSet() & iM5228constructorimpl) != 0) {
                    ...
                    if ((head.getAggregateChildKindSet() & iM5228constructorimpl) == 0) {
                        return;
                    }
                }
            }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM5228constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
    ...
    public static /* synthetic */ void m5141hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        ...
        layoutNode.m5145hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z2);
    }
    ...
    public final void m5145hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5215hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), NodeCoordinator.m5199fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitTestResult, isTouchEvent, isInLayer);
    }
    ...
    public static /* synthetic */ void m5142hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        ...
        layoutNode.m5146hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z, z2);
    }
    ...
    public final void m5146hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5215hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), NodeCoordinator.m5199fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m5228constructorimpl(1024) | NodeKind.m5228constructorimpl(2048) | NodeKind.m5228constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m5228constructorimpl(1024) & head.getKindSet()) != 0) | ((NodeKind.m5228constructorimpl(2048) & head.getKindSet()) != 0) | ((NodeKind.m5228constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM5228constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m5115requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m5228constructorimpl(256)));
                        } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release = delegatingNodePop.getDelegate();
                            int i = 0;
                            delegatingNodePop = delegatingNodePop;
    ...
    public final boolean m5147lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        ...
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m5166remeasureBRTryo0(constraints.getValue());
    }
    ...
    public final boolean m5148remeasure_Sx5XlM$ui_release(Constraints constraints) {
        ...
        return getMeasurePassDelegate$ui_release().m5170remeasureBRTryo0(constraints.getValue());
    }
                ...
                if ((head.getKindSet() & iM5228constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m5115requireCoordinator64DMado((LayoutModifierNode) delegatingNodePop, NodeKind.m5228constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM5161getLastConstraintsDWUhwKw = layoutNode.layoutDelegate.m5161getLastConstraintsDWUhwKw();
        if (constraintsM5161getLastConstraintsDWUhwKw != null) {
            Owner owner = layoutNode.owner;
            if (owner != null) {
                owner.mo5284measureAndLayout0kLqBqw(this, constraintsM5161getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM5237getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM5228constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(4)) && !this.nodes.m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m5228constructorimpl(2) & head.getKindSet()) != 0 && DelegatableNodeKt.m5115requireCoordinator64DMado(head, NodeKind.m5228constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m5228constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
