        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(rigidTypeMarkerPop)) {
                ...
                if (none == null) {
                    ...
                    while (it.hasNext()) {
                        RigidTypeMarker rigidTypeMarkerMo10413transformType = none.mo10413transformType(typeCheckerState, it.next());
                        if ((typeSystemContext.isClassType(rigidTypeMarkerMo10413transformType) && !typeSystemContext.isMarkedNullable(rigidTypeMarkerMo10413transformType)) || typeSystemContext.isDefinitelyNotNullType(rigidTypeMarkerMo10413transformType)) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(rigidTypeMarkerPop)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(rigidTypeMarkerPop)).iterator();
                    while (it.hasNext()) {
                        RigidTypeMarker rigidTypeMarkerMo10413transformType = supertypesPolicy.mo10413transformType(state, it.next());
                        if (INSTANCE.isApplicableAsEndNode(state, rigidTypeMarkerMo10413transformType, end)) {
                            state.clear();
                            return true;
                        }
                        supertypesDeque.add(rigidTypeMarkerMo10413transformType);
