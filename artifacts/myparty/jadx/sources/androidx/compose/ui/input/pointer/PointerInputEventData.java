...
public final /* data */ class PointerInputEventData {
    ...
    public static /* synthetic */ PointerInputEventData m4871copyrc8HELY$default(PointerInputEventData pointerInputEventData, long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, Object obj) {
        long j7;
        long j8;
        long j9;
        long j10;
        ...
        return pointerInputEventData.m4878copyrc8HELY(j7, j12, j13, j14, z3, f2, i3, z4, list2, j10, j9);
    }
    ...
    public final PointerInputEventData m4878copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean activeHover, List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m4846equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m3413equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m3413equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m4936equalsimpl0(this.type, pointerInputEventData.type) && this.activeHover == pointerInputEventData.activeHover && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m3413equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m3413equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m4847hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m3418hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m3418hashCodeimpl(this.position)) * 31) + Boolean.hashCode(this.down)) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m4937hashCodeimpl(this.type)) * 31) + Boolean.hashCode(this.activeHover)) * 31) + this.historical.hashCode()) * 31) + Offset.m3418hashCodeimpl(this.scrollDelta)) * 31) + Offset.m3418hashCodeimpl(this.originalEventPosition);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("PointerInputEventData(id=");
        sb.append((Object) PointerId.m4848toStringimpl(this.id)).append(", uptime=").append(this.uptime).append(", positionOnScreen=").append((Object) Offset.m3424toStringimpl(this.positionOnScreen)).append(", position=").append((Object) Offset.m3424toStringimpl(this.position)).append(", down=").append(this.down).append(", pressure=").append(this.pressure).append(", type=").append((Object) PointerType.m4938toStringimpl(this.type)).append(", activeHover=").append(this.activeHover).append(", historical=").append(this.historical).append(", scrollDelta=").append((Object) Offset.m3424toStringimpl(this.scrollDelta)).append(", originalEventPosition=").append((Object) Offset.m3424toStringimpl(this.originalEventPosition)).append(')');
        return sb.toString();
    }
    ...
    public final long m4879getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m4882getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m4881getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m4884getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m3432getZeroF1C5BW0() : j5, (i2 & 1024) != 0 ? Offset.INSTANCE.m3432getZeroF1C5BW0() : j6, null);
    }
    ...
    public final long m4883getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m4880getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
