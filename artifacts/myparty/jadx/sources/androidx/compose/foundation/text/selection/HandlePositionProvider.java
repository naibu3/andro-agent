...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3432getZeroF1C5BW0();
    ...
    public long mo684calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long jMo1310provideF1C5BW0 = this.positionProvider.mo1310provideF1C5BW0();
        if (!OffsetKt.m3435isSpecifiedk4lQ0M(jMo1310provideF1C5BW0)) {
            jMo1310provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = jMo1310provideF1C5BW0;
        return IntOffset.m6249plusqkQi6aY(IntOffset.m6249plusqkQi6aY(anchorBounds.m6273getTopLeftnOccac(), IntOffsetKt.m6261roundk4lQ0M(jMo1310provideF1C5BW0)), this.handleReferencePoint.mo3262alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6292getZeroYbymL2g(), layoutDirection));
    }
}
