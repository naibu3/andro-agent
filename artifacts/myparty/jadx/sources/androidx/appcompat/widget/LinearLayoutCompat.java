...
public class LinearLayoutCompat extends ViewGroup {
                            ...
                            if (f7 > 0.0f) {
                                ...
                                if (layoutParams3.height == 0) {
                                    ...
                                    if (i32 == 1073741824) {
                                        ...
                                        virtualChildAt3.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(i37, BasicMeasure.EXACTLY));
                                    }
                    ...
                    if (z7 && i32 != 1073741824) {
                        for (int i40 = 0; i40 < i3; i40++) {
                            ...
                            if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((LayoutParams) virtualChildAt4.getLayoutParams()).weight > 0.0f) {
                                virtualChildAt4.measure(View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredWidth(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(i28, BasicMeasure.EXACTLY));
                            }
                        }
                    }
                }
        ...
        while (true) {
            ...
            if (virtualChildAt == null) {
                ...
                if (!z12 || (baseline2 = view.getBaseline()) == -1) {
                    ...
                    int i25 = ((((layoutParams.gravity < 0 ? this.mGravity : layoutParams.gravity) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) >> 4) & (-2)) >> 1;
                    z4 = z3;
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (z11) {
                        ...
                        if (z13 && (baseline = virtualChildAt3.getBaseline()) != i10) {
                            int i36 = ((((layoutParams3.gravity >= 0 ? this.mGravity : layoutParams3.gravity) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) >> 4) & (-2)) >> 1;
                    ...
                    if (z13) {
                        int i362 = ((((layoutParams3.gravity >= 0 ? this.mGravity : layoutParams3.gravity) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) >> 4) & (-2)) >> 1;
    ...
    */
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        int i10 = i9 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
    ...
    */
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int i14 = i13 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
