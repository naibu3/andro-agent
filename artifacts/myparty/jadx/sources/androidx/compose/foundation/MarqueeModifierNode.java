...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m646boximpl(i2), null, 2, null);
    ...
    public final int m660getAnimationModeZbEOnfQ() {
    ...
    public final void m661setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m646boximpl(i));
    }
    ...
    public final void m662updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m661setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m6122equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m6087constrainWidthK40F9xA(j, placeableMo4993measureBRTryo0.getWidth()));
        setContentWidth(placeableMo4993measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), placeableMo4993measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo4993measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, (Function1) null, 12, (Object) null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float fM3482getHeightimpl = Size.m3482getHeightimpl(contentDrawScope2.mo4213getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo4137clipRectN_I0leg(fFloatValue, 0.0f, containerWidth, fM3482getHeightimpl, iM3646getIntersectrtfAjoo);
            if (z) {
            ...
            if (i == 0) {
                ...
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m649equalsimpl0(marqueeModifierNode.m660getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m654getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
            ...
            */
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    if (f2 != null) {
                        AnimationSpec animationSpecM582createMarqueeAnimationSpecZ4HSEVQ = BasicMarqueeKt.m582createMarqueeAnimationSpecZ4HSEVQ(this.this$0.iterations, f2.floatValue(), this.this$0.initialDelayMillis, this.this$0.delayMillis, this.this$0.velocity, DelegatableNodeKt.requireDensity(this.this$0));
                        this.L$0 = f2;
                        this.L$1 = animationSpecM582createMarqueeAnimationSpecZ4HSEVQ;
                        this.label = 1;
                        if (this.this$0.offset.snapTo(Boxing.boxFloat(0.0f), this) != coroutine_suspended) {
                            f = f2;
                            animationSpec = animationSpecM582createMarqueeAnimationSpecZ4HSEVQ;
                        }
                        return coroutine_suspended;
                    }
                    return Unit.INSTANCE;
