    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1495getSupertypes = capturedTypeConstructorImpl.mo1495getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1495getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1495getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1495getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1495getSupertypes2, 10));
            Iterator<T> it2 = collectionMo1495getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1495getSupertypes3 = intersectionTypeConstructor.mo1495getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1495getSupertypes3, 10));
        Iterator<T> it3 = collectionMo1495getSupertypes3.iterator();
        while (it3.hasNext()) {
