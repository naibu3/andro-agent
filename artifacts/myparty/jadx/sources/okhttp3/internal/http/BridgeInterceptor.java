...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (!listLoadForRequest.isEmpty()) {
            builderNewBuilder.header(RequestHeadersFactory.FraudDetection.HEADER_COOKIE, cookieHeader(listLoadForRequest));
        }
        if (request.header(NetworkConstantsKt.HEADER_USER_AGENT) == null) {
            builderNewBuilder.header(NetworkConstantsKt.HEADER_USER_AGENT, Util.userAgent);
        }
