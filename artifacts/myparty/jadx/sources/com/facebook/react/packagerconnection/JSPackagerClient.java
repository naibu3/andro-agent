...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    public JSPackagerClient(String clientId, PackagerConnectionSettings settings, Map<String, ? extends RequestHandler> requestHandlers, ReconnectingWebSocket.ConnectionCallback connectionCallback) {
        ...
        String string = new Uri.Builder().scheme("ws").encodedAuthority(settings.getDebugServerHost()).appendPath("message").appendQueryParameter(DeviceRequestsHelper.DEVICE_INFO_DEVICE, AndroidInfoHelpers.getFriendlyDeviceName()).appendQueryParameter(Stripe3ds2AuthParams.FIELD_APP, settings.getPackageName()).appendQueryParameter("clientid", clientId).build().toString();
    ...
    private final void abortOnMessage(Object id, String reason) throws JSONException {
        if (id != null) {
    ...
    /* compiled from: JSPackagerClient.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0082\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0003H\u0016J\u0010\u0010\t\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0003H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/facebook/react/packagerconnection/JSPackagerClient$ResponderImpl;", "Lcom/facebook/react/packagerconnection/Responder;", "id", "", "<init>", "(Lcom/facebook/react/packagerconnection/JSPackagerClient;Ljava/lang/Object;)V", "respond", "", FinancialConnectionsSheetNativeActivity.EXTRA_RESULT, "error", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    private final class ResponderImpl implements Responder {
        ...
        public void respond(Object result) throws JSONException {
            Intrinsics.checkNotNullParameter(result, "result");
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, 2);
                jSONObject.put("id", this.id);
                jSONObject.put(FinancialConnectionsSheetNativeActivity.EXTRA_RESULT, result);
        ...
        @Override // com.facebook.react.packagerconnection.Responder
        public void error(Object error) throws JSONException {
