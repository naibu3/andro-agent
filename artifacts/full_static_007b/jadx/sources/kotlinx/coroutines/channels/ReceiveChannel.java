...
public interface ReceiveChannel<E> {
    ...
    Object mo1587receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1588tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1588tryReceivePtdJZtk = receiveChannel.mo1588tryReceivePtdJZtk();
            if (ChannelResult.m1604isSuccessimpl(objMo1588tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1600getOrThrowimpl(objMo1588tryReceivePtdJZtk);
            }
            Throwable thM1598exceptionOrNullimpl = ChannelResult.m1598exceptionOrNullimpl(objMo1588tryReceivePtdJZtk);
            if (thM1598exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1598exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1587receiveCatchingJP2dKIU = receiveChannel.mo1587receiveCatchingJP2dKIU(anonymousClass12);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1587receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1599getOrNullimpl(objMo1587receiveCatchingJP2dKIU);
        }
