    ...
    public static Map<Integer, Integer> quantize(int[] inputPixels, int[] startingClusters, int maxColors) {
        ...
        while (true) {
            ...
            while (i12 < pointCount) {
                ...
                double d = componentASums[clusterIndex];
                double d2 = point2[0];
                ...
                double d4 = componentBSums2[clusterIndex];
                double d5 = point2[1];
                double d6 = count;
                Double.isNaN(d6);
                componentBSums2[clusterIndex] = d4 + (d5 * d6);
                double d7 = componentCSums2[clusterIndex];
                double d8 = point2[2];
                double d9 = count;
                Double.isNaN(d9);
                componentCSums2[clusterIndex] = d7 + (d8 * d9);
                i12++;
                pixelCountSums2 = pixelCountSums3;
                componentASums = componentASums2;
            }
            int[] pixelCountSums4 = pixelCountSums2;
            double[] componentASums3 = componentASums;
            int i13 = 0;
            while (i13 < clusterCount) {
                int count2 = pixelCountSums4[i13];
                if (count2 == 0) {
                    clusters[i13] = new double[]{0.0d, 0.0d, 0.0d};
                    componentBSums = componentBSums2;
                    componentCSums = componentCSums2;
                } else {
                    double d10 = componentASums3[i13];
                    componentBSums = componentBSums2;
                    componentCSums = componentCSums2;
                    double d11 = count2;
                    Double.isNaN(d11);
                    double a = d10 / d11;
                    double d12 = componentBSums[i13];
                    double d13 = count2;
                    Double.isNaN(d13);
                    double b = d12 / d13;
                    double d14 = componentCSums[i13];
                    double b2 = count2;
                    Double.isNaN(b2);
                    double c = d14 / b2;
                    clusters[i13][0] = a;
            ...
            points = points3;
            pixels = pixels3;
            pixelCountSums2 = pixelCountSums4;
        }
