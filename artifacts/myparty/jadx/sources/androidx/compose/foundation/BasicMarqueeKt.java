...
public final class BasicMarqueeKt {
    ...
    public static final AnimationSpec<Float> m582createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(density.mo712toPx0680j_4(f2)), f, i3);
        long jM513constructorimpl$default = StartOffset.m513constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m478infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, jM513constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m480repeatable91I0pcU$default(i, tweenSpecVelocityBasedTween, null, jM513constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m578MarqueeSpacing0680j_4(final float f) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$1(float f, Density density, int i, int i2) {
        return density.mo706roundToPx0680j_4(f);
    }
}
