...
public final class UtilKt {
            ...
            if (Intrinsics.areEqual(JvmClassMappingKt.getJavaClass(JvmClassMappingKt.getAnnotationClass((Annotation) it.next())).getSimpleName(), "Container")) {
                ...
                for (Annotation annotation : list2) {
                    ...
                    if (Intrinsics.areEqual(javaClass.getSimpleName(), "Container") && javaClass.getAnnotation(RepeatableContainer.class) != null) {
                        Object objInvoke = javaClass.getDeclaredMethod(AppMeasurementSdk.ConditionalUserProperty.VALUE, new Class[0]).invoke(annotation, new Object[0]);
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1494getDeclarationDescriptor();
    ...
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) throws NegativeArraySizeException {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = type2.getConstructor().mo1494getDeclarationDescriptor();
                ClassDescriptor classDescriptor = classifierDescriptorMo1494getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1494getDeclarationDescriptor : null;
                if (classDescriptor == null) {
