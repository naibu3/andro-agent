...
public abstract class zzbhu extends zzbae implements zzbhv {
    ...
    public static zzbhv zzg(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzbhv ? (zzbhv) iInterfaceQueryLocalInterface : new zzbht(iBinder);
    }
    ...
    protected final boolean zzdF(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 1) {
            ...
            zzbaf.zzf(parcel2, iObjectWrapperZzf);
        } else if (i == 2) {
            Uri uriZze = zze();
            parcel2.writeNoException();
            zzbaf.zze(parcel2, uriZze);
        } else if (i == 3) {
            double dZzb = zzb();
            parcel2.writeNoException();
