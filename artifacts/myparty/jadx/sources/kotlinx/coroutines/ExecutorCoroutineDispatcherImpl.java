...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo10706dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo10706dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo10707scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long j;
        Executor executor = getExecutor();
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo10707scheduleResumeAfterDelay(j, continuation);
        }
    }
