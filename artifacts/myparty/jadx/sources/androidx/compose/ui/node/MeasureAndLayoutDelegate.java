...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m5183updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m6058boximpl(constraints);
    ...
    private final boolean m5180doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM5143lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM5143lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m5147lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM5143lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m5143lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM5143lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot() == null) {
                ...
                return zM5143lookaheadRemeasure_Sx5XlM$ui_release$default;
            }
    ...
    private final boolean m5181doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM5144remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM5144remeasure_Sx5XlM$ui_release$default = layoutNode.m5148remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM5144remeasure_Sx5XlM$ui_release$default = LayoutNode.m5144remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM5144remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return zM5144remeasure_Sx5XlM$ui_release$default;
            }
    ...
    public final void m5182measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m5180doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6058boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m5181doRemeasuresdFAvZA(layoutNode, Constraints.m6058boximpl(constraints));
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        boolean zM5180doLookaheadRemeasuresdFAvZA;
        LayoutNode parent$ui_release;
        if (layoutNode.getIsDeactivated()) {
            return false;
        }
        ...
        if (affectsLookahead) {
            zM5180doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m5180doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            if (relayoutNeeded && ((zM5180doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true))) {
                layoutNode.lookaheadReplace$ui_release();
            }
        } else {
            boolean zM5181doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m5181doRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            zM5180doLookaheadRemeasuresdFAvZA = zM5181doRemeasuresdFAvZA;
        }
        drainPostponedMeasureRequests();
        return zM5180doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5180doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5181doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
