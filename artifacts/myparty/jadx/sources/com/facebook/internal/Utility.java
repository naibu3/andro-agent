...
public final class Utility {
    ...
    private final void refreshPeriodicExtendedDeviceInfo(Context appContext) {
        if (timestampOfLastCheck == -1 || System.currentTimeMillis() - timestampOfLastCheck >= StripeCustomerAdapter.CACHED_CUSTOMER_MAX_AGE_MILLIS) {
