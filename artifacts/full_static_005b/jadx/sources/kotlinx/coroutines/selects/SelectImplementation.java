...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C03421 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03421(SelectImplementation<R> selectImplementation, Continuation<? super C03421> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        Object objInvokeBlock = c03421.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c03421.label;
        try {
            if (i == 0) {
                ...
                c03421.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c03421);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c03421 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c03421);
            }
            throw th;
        }
    }
