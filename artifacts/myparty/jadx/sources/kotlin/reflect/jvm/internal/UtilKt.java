...
public final class UtilKt {
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof KClassValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo10409getDeclarationDescriptor();
    ...
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) throws NegativeArraySizeException {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = type2.getConstructor().mo10409getDeclarationDescriptor();
                ClassDescriptor classDescriptor = classifierDescriptorMo10409getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo10409getDeclarationDescriptor : null;
                if (classDescriptor == null) {
