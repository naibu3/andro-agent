...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1628constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1627boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m1629constructorimpl(long j) {
        return j;
    }
    ...
    public boolean equals(Object obj) {
        return m1631equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1635hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1630constructorimpl(Density density) {
        return m1628constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1636toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1636toStringimpl(long j) {
        return "InlineDensity(density=" + m1633getDensityimpl(j) + ", fontScale=" + m1634getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1638getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1628constructorimpl(float f, float f2) {
        return m1629constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m1633getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m1634getFontScaleimpl(long j) {
