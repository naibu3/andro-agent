...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2115setColorDxMtmZc(long color, float alpha) {
        long jM2114calculateRippleColor5vOe2sY = m2114calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m3658equalsimpl0(color2.m3667unboximpl(), jM2114calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3647boximpl(jM2114calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3711toArgb8_81llA(jM2114calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2114calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m3656copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
