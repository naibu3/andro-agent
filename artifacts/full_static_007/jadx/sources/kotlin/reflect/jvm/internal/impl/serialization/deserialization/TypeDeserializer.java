...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo1494getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo1494getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo1494getDeclarationDescriptor, list);
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = type.getConstructor().mo1494getDeclarationDescriptor();
        FqName fqNameSafe = classifierDescriptorMo1494getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo1494getDeclarationDescriptor) : null;
