...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m6117constructorimpl(2500);
    private static final float BoundDistance = Dp.m6117constructorimpl(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final float MinimumDistance = Dp.m6117constructorimpl(50);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            float fMo712toPx0680j_4;
            float fMo712toPx0680j_42;
            float fMo712toPx0680j_43;
            ...
            if (i2 == 0) {
                ...
                if (((float) i3) >= 0.0f) {
                    try {
                        fMo712toPx0680j_4 = this.$density.mo712toPx0680j_4(LazyAnimateScrollKt.TargetDistance);
                        fMo712toPx0680j_42 = this.$density.mo712toPx0680j_4(LazyAnimateScrollKt.BoundDistance);
                        fMo712toPx0680j_43 = this.$density.mo712toPx0680j_4(LazyAnimateScrollKt.MinimumDistance);
                    ...
                    intRef2.element = 1;
                    f2 = fMo712toPx0680j_42;
                    booleanRef2 = booleanRef;
                    intRef = intRef2;
                    f3 = fMo712toPx0680j_4;
                    scrollScope = scrollScope3;
                    f4 = fMo712toPx0680j_43;
                    i = i4;
                ...
                Function1<AnimationScope<Float, AnimationVector1D>, Unit> function1 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyAnimateScrollKt.animateScrollToItem.2.3
                    ...
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                        ...
                        if (!LazyAnimateScrollKt.isItemVisible(lazyLayoutAnimateScrollScope, i5)) {
                            ...
                            if (!LazyAnimateScrollKt.isItemVisible(lazyLayoutAnimateScrollScope, i5) && !AnonymousClass2.invokeSuspend$isOvershot(z3, lazyLayoutAnimateScrollScope, i5, i7)) {
                                if (f10 != fScrollBy) {
                                    animationScope.cancelAnimation();
                        ...
                        if (AnonymousClass2.invokeSuspend$isOvershot(z3, lazyLayoutAnimateScrollScope, i5, i7)) {
                    ...
                    Function1<AnimationScope<Float, AnimationVector1D>, Unit> function12 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyAnimateScrollKt.animateScrollToItem.2.3
                        ...
                        public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                            ...
                            if (!LazyAnimateScrollKt.isItemVisible(lazyLayoutAnimateScrollScope2, i52)) {
                                ...
                                if (!LazyAnimateScrollKt.isItemVisible(lazyLayoutAnimateScrollScope2, i52) && !AnonymousClass2.invokeSuspend$isOvershot(z3, lazyLayoutAnimateScrollScope2, i52, i72)) {
                                    if (f102 != fScrollBy) {
                                        animationScope.cancelAnimation();
                                        booleanRef2.element = false;
                                        return;
                            ...
                            if (AnonymousClass2.invokeSuspend$isOvershot(z3, lazyLayoutAnimateScrollScope2, i52, i72)) {
