...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4993measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM6070getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM6070getMaxWidthimpl, iMinIntrinsicHeight);
    }
