...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5602getStartimpl(textUndoOperation.getPreSelection()), TextRange.m5597getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1482getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1481getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m5602getStartimpl(textUndoOperation.getPostSelection()), TextRange.m5597getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1482getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1481getCompositionMzsxiRA(), null, 8, null), true);
    }
}
