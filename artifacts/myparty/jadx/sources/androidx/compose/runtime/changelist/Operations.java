...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        pushOp(operation);
        args.invoke(WriteScope.m3232boximpl(WriteScope.m3233constructorimpl(this)));
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & this.pushedIntMask) != 0) {
                ...
                sb.append(operation.mo3162intParamNamew8GmfQM(Operation.IntParameter.m3190constructorimpl(i2)));
                i++;
            }
        }
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) != 0) {
                ...
                sb2.append(operation.mo3163objectParamName31yXWZQ(Operation.ObjectParameter.m3201constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m3232boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Operations m3233constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3234equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).getStack());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3235equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3237hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3240toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m3234equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m3237hashCodeimpl(this.stack);
        }

        public String toString() {
            return m3240toStringimpl(this.stack);
        }
        ...
        public static final Operation m3236getOperationimpl(Operations operations) {
            return operations.peekOperation();
        }

        /* renamed from: setInt-A6tL2VI, reason: not valid java name */
        public static final void m3238setIntA6tL2VI(Operations operations, int i, int i2) {
            int i3 = 1 << i;
            if (!((operations.pushedIntMask & i3) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m3236getOperationimpl(operations).mo3162intParamNamew8GmfQM(i));
            }
            operations.pushedIntMask |= i3;
            operations.intArgs[operations.m3230topIntIndexOfw8GmfQM(i)] = i2;
        }

        /* renamed from: setObject-DKhxnng, reason: not valid java name */
        public static final <T> void m3239setObjectDKhxnng(Operations operations, int i, T t) {
            int i2 = 1 << i;
            if (!((operations.pushedObjectMask & i2) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m3236getOperationimpl(operations).mo3163objectParamName31yXWZQ(i));
            }
            operations.pushedObjectMask |= i2;
            operations.objectArgs[operations.m3231topObjectIndexOf31yXWZQ(i)] = t;
        }
    }
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public int mo3226getIntw8GmfQM(int parameter) {
            return Operations.this.intArgs[this.intIdx + parameter];
        }

        @Override // androidx.compose.runtime.changelist.OperationArgContainer
        /* renamed from: getObject-31yXWZQ */
        public <T> T mo3227getObject31yXWZQ(int parameter) {
    ...
    private final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        for (int i = 0; i < ints; i++) {
            int iM3190constructorimpl = Operation.IntParameter.m3190constructorimpl(i);
            String strMo3162intParamNamew8GmfQM = operation.mo3162intParamNamew8GmfQM(iM3190constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            sb.append(strIndent);
            sb.append(strMo3162intParamNamew8GmfQM);
            sb.append(" = ");
            sb.append(opIterator.mo3226getIntw8GmfQM(iM3190constructorimpl));
        }
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int iM3201constructorimpl = Operation.ObjectParameter.m3201constructorimpl(i2);
            String strMo3163objectParamName31yXWZQ = operation.mo3163objectParamName31yXWZQ(iM3201constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append('\\n')");
            sb.append(strIndent);
            sb.append(strMo3163objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo3227getObject31yXWZQ(iM3201constructorimpl), strIndent));
        }
        Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append('\\n')");
        sb.append(str);
        sb.append(")");
