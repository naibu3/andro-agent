...
final class AndroidFlingSpline {
    ...
    public final long m890flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m892constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m891boximpl(long j) {
        ...
        public static int m897hashCodeimpl(long j) {
        ...
        public int hashCode() {
            return m897hashCodeimpl(this.packedValue);
        }
        ...
        public static final float m895getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m896getVelocityCoefficientimpl(long j) {
