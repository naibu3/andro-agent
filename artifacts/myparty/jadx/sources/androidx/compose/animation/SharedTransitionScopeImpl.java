...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    public long mo448localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return this.$$delegate_0.mo448localLookaheadPositionOfauaQtc(layoutCoordinates, layoutCoordinates2, j, z);
    }
    ...
    */
    ...
    private static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public Path getClipPath(SharedTransitionScope.SharedContentState state, Rect bounds, LayoutDirection layoutDirection, Density density) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo623createOutlinePq9zytI(bounds.m3449getSizeNHjbRc(), layoutDirection, density));
            this.path.mo3552translatek4lQ0M(bounds.m3451getTopLeftF1C5BW0());
            return this.path;
        }
    }
}
