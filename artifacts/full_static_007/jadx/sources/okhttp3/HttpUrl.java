...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) throws NumberFormatException, EOFException {
    ...
    */
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, @Nullable Charset charset) throws EOFException {
        int iCharCount = i;
        while (iCharCount < i2) {
    ...
    static void canonicalize(Buffer buffer, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, @Nullable Charset charset) throws EOFException {
        Buffer buffer2 = null;
        while (i < i2) {
            int iCodePointAt = str.codePointAt(i);
