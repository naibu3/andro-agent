...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM5600getMinimpl = composition != null ? TextRange.m5600getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m5600getMinimpl(state.getSelection()), TextRange.m5599getMaximpl(state.getSelection()), iM5600getMinimpl, composition2 != null ? TextRange.m5599getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5596getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5600getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM5780getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5780getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5782getGoeUduSuo();
                    break;
                case 3:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5786getSearcheUduSuo();
                    break;
                case 4:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5787getSendeUduSuo();
                    break;
                case 5:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5783getNexteUduSuo();
                    break;
                case 6:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5781getDoneeUduSuo();
                    break;
                case 7:
                    iM5780getDefaulteUduSuo = ImeAction.INSTANCE.m5785getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo5799onImeActionKlQnJC8(iM5780getDefaulteUduSuo);
        return true;
    }
