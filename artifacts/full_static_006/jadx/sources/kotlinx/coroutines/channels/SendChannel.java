...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1752isSuccessimpl(objMo1732trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1746exceptionOrNullimpl = ChannelResult.m1746exceptionOrNullimpl(objMo1732trySendJP2dKIU);
