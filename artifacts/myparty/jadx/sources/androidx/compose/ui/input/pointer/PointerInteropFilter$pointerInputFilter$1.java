...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    public void mo4888onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        long jMo5004localToRootMKHz9U = layoutCoordinates$ui_release.mo5004localToRootMKHz9U(Offset.INSTANCE.m3432getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m4923toCancelMotionEventScoped4ec7I(pointerEvent, jMo5004localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long jMo5004localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo5004localToRootMKHz9U(Offset.INSTANCE.m3432getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m4924toMotionEventScoped4ec7I(pointerEvent, jMo5004localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
