...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m5578measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            textStyle = TextStyle.INSTANCE.getDefault();
        }
        return textMeasurer.m5580measurexDpz5zY(annotatedString, textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m6055getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.defaultDensity : density, (i3 & 512) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m5580measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m5573copyO0kMr_c(textLayoutInput, ConstraintsKt.m6084constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public static /* synthetic */ TextLayoutResult m5577measurewNUYSr0$default(TextMeasurer textMeasurer, String str, TextStyle textStyle, int i, boolean z, int i2, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            textStyle = TextStyle.INSTANCE.getDefault();
        }
        TextStyle textStyle2 = textStyle;
        if ((i3 & 4) != 0) {
            i = TextOverflow.INSTANCE.m6055getClipgIe3tQ8();
        }
        return textMeasurer.m5579measurewNUYSr0(str, textStyle2, i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 64) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 128) != 0 ? textMeasurer.defaultDensity : density, (i3 & 256) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 512) != 0 ? false : z2);
    }

    /* renamed from: measure-wNUYSr0, reason: not valid java name */
    public final TextLayoutResult m5579measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        return m5578measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int iM6072getMinWidthimpl = Constraints.m6072getMinWidthimpl(textLayoutInput.getConstraints());
            int iM6070getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m6048equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6056getEllipsisgIe3tQ8())) && Constraints.m6066getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m6070getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m6048equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6056getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (iM6072getMinWidthimpl != iM6070getMaxWidthimpl) {
                iM6070getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), iM6072getMinWidthimpl, iM6070getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, Constraints.INSTANCE.m6079fitPrioritizingWidthZbe2FdA(0, iM6070getMaxWidthimpl, 0, Constraints.m6069getMaxHeightimpl(textLayoutInput.getConstraints())), maxLines, TextOverflow.m6048equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m6056getEllipsisgIe3tQ8()), null), ConstraintsKt.m6084constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r5.getWidth()), (int) Math.ceil(r5.getHeight()))), null);
        }
    }
}
