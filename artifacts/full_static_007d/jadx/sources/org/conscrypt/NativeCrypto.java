...
public final class NativeCrypto {
    ...
    static {
        ...
        if (e == null) {
            ...
            for (int i3 = EXTENSION_TYPE_NON_CRITICAL; i3 < length; i3 += 2) {
                String strCipherSuiteToJava = cipherSuiteToJava(strArr2[i3]);
                SUPPORTED_TLS_1_2_CIPHER_SUITES[i3 / 2] = strCipherSuiteToJava;
            ...
            HAS_AES_HARDWARE = EVP_has_aes_hardware() == 1 ? true : EXTENSION_TYPE_NON_CRITICAL;
        } else {
    ...
    private static int X509_NAME_hash(X500Principal x500Principal, String str) {
        try {
            ...
            return ((bArrDigest[3] & 255) << 24) | (bArrDigest[EXTENSION_TYPE_NON_CRITICAL] & 255) | ((bArrDigest[1] & 255) << 8) | ((bArrDigest[2] & 255) << 16);
