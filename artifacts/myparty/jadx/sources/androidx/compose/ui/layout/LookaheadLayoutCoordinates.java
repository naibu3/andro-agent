...
public final class LookaheadLayoutCoordinates implements LayoutCoordinates {
    ...
    public long mo5001getSizeYbymL2g() {
    ...
    private final long m5020getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3420minusMKHz9U(mo5002localPositionOfR5De75A(rootLookaheadDelegate.getCoordinates(), Offset.INSTANCE.m3432getZeroF1C5BW0()), getCoordinator().mo5002localPositionOfR5De75A(rootLookaheadDelegate.getCoordinator(), Offset.INSTANCE.m3432getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo5007screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.m3421plusMKHz9U(getCoordinator().mo5007screenToLocalMKHz9U(relativeToScreen), m5020getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo5005localToScreenMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5005localToScreenMKHz9U(Offset.m3421plusMKHz9U(relativeToLocal, m5020getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo5010windowToLocalMKHz9U(long relativeToWindow) {
        return Offset.m3421plusMKHz9U(getCoordinator().mo5010windowToLocalMKHz9U(relativeToWindow), m5020getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo5006localToWindowMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5006localToWindowMKHz9U(Offset.m3421plusMKHz9U(relativeToLocal, m5020getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo5004localToRootMKHz9U(long relativeToLocal) {
        return getCoordinator().mo5004localToRootMKHz9U(Offset.m3421plusMKHz9U(relativeToLocal, m5020getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo5003localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            if (lookaheadDelegate2 != null) {
                long jM6248minusqkQi6aY = IntOffset.m6248minusqkQi6aY(IntOffset.m6249plusqkQi6aY(lookaheadDelegate.m5178positionIniSbpLlY$ui_release(lookaheadDelegate2, !includeMotionFrameOfReference), IntOffsetKt.m6261roundk4lQ0M(relativeToSource)), this.lookaheadDelegate.m5178positionIniSbpLlY$ui_release(lookaheadDelegate2, !includeMotionFrameOfReference));
                return OffsetKt.Offset(IntOffset.m6245getXimpl(jM6248minusqkQi6aY), IntOffset.m6246getYimpl(jM6248minusqkQi6aY));
            }
            LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate);
            long jM6249plusqkQi6aY = IntOffset.m6249plusqkQi6aY(IntOffset.m6249plusqkQi6aY(lookaheadDelegate.m5178positionIniSbpLlY$ui_release(rootLookaheadDelegate, !includeMotionFrameOfReference), rootLookaheadDelegate.getPosition()), IntOffsetKt.m6261roundk4lQ0M(relativeToSource));
            LookaheadDelegate rootLookaheadDelegate2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
            long jM6248minusqkQi6aY2 = IntOffset.m6248minusqkQi6aY(jM6249plusqkQi6aY, IntOffset.m6249plusqkQi6aY(this.lookaheadDelegate.m5178positionIniSbpLlY$ui_release(rootLookaheadDelegate2, !includeMotionFrameOfReference), rootLookaheadDelegate2.getPosition()));
            long jOffset = OffsetKt.Offset(IntOffset.m6245getXimpl(jM6248minusqkQi6aY2), IntOffset.m6246getYimpl(jM6248minusqkQi6aY2));
            ...
            return wrappedBy.mo5003localPositionOfS_NoaFU(wrappedBy2, jOffset, includeMotionFrameOfReference);
        }
        LookaheadDelegate rootLookaheadDelegate3 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m3421plusMKHz9U(mo5003localPositionOfS_NoaFU(rootLookaheadDelegate3.getLookaheadLayoutCoordinates(), relativeToSource, includeMotionFrameOfReference), rootLookaheadDelegate3.getCoordinator().getCoordinates().mo5003localPositionOfS_NoaFU(sourceCoordinates, Offset.INSTANCE.m3432getZeroF1C5BW0(), includeMotionFrameOfReference));
    }
    ...
    public void mo5008transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        getCoordinator().mo5008transformFromEL8BTi8(sourceCoordinates, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformToScreen-58bKbWc */
    public void mo5009transformToScreen58bKbWc(float[] matrix) {
        getCoordinator().mo5009transformToScreen58bKbWc(matrix);
    }
