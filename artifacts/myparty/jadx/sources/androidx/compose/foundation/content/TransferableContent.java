...
public final class TransferableContent {
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m669constructorimpl(0);
        private static final int DragAndDrop = m669constructorimpl(1);
        private static final int Clipboard = m669constructorimpl(2);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Source m668boximpl(int i) {
            return new Source(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m669constructorimpl(int i) {
            return i;
        }
        ...
        public static String m673toStringimpl(int i) {
            return m671equalsimpl0(i, Keyboard) ? "Source.Keyboard" : m671equalsimpl0(i, DragAndDrop) ? "Source.DragAndDrop" : m671equalsimpl0(i, Clipboard) ? "Source.Clipboard" : "Invalid (" + i + ')';
        }
    }
}
