...
public final class Node extends NodeParent {
    ...
    public boolean buildCache(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (i5 < size) {
            ...
            if (this.pointerIds.contains(jKeyAt)) {
                ...
                if (Offset.m3419isValidimpl(previousPosition) && Offset.m3419isValidimpl(position)) {
                    ...
                    while (i7 < size2) {
                        ...
                        if (Offset.m3419isValidimpl(position2)) {
                            long uptimeMillis = historicalChange.getUptimeMillis();
                            i3 = i6;
                            LayoutCoordinates layoutCoordinates = this.coordinates;
                            Intrinsics.checkNotNull(layoutCoordinates);
                            arrayList.add(new HistoricalChange(uptimeMillis, layoutCoordinates.mo5002localPositionOfR5De75A(parentCoordinates, position2), historicalChange.getOriginalEventPosition(), null));
                        } else {
                            i3 = i6;
                        }
                        i7 = i9 + 1;
                    ...
                    long jMo5002localPositionOfR5De75A = layoutCoordinates2.mo5002localPositionOfR5De75A(parentCoordinates, previousPosition);
                    LayoutCoordinates layoutCoordinates3 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates3);
                    longSparseArray.put(jKeyAt, PointerInputChange.m4853copyOHpmEuE$default(pointerInputChangeValueAt, 0L, 0L, layoutCoordinates3.mo5002localPositionOfR5De75A(parentCoordinates, position), false, 0L, jMo5002localPositionOfR5De75A, false, 0, arrayList, 0L, 731, null));
                } else {
                    z2 = zBuildCache;
                    i = size;
                    i2 = i6;
        ...
        while (true) {
            ...
            if (!changes.containsKey(this.pointerIds.m4959get_I2yYro(size3))) {
        ...
        while (true) {
            ...
            if (internalPointerEvent.m4793activeHoverEvent0FcD4WY(pointerInputChange2.getId())) {
        ...
        if (pointerInputChange3 != null) {
            if (!isInBounds) {
                ...
                if (!this.isIn && (pointerInputChange3.getPressed() || pointerInputChange3.getPreviousPressed())) {
                    ...
                    this.isIn = !PointerEventKt.m4808isOutOfBoundsO0kMr_c(pointerInputChange3, r3.mo5001getSizeYbymL2g());
                }
            }
            if (this.isIn != this.wasIn && (PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4819getMove7fucELk()) || PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4817getEnter7fucELk()) || PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4818getExit7fucELk()))) {
                if (this.isIn) {
                    iM4818getExit7fucELk = PointerEventType.INSTANCE.m4817getEnter7fucELk();
                } else {
                    iM4818getExit7fucELk = PointerEventType.INSTANCE.m4818getExit7fucELk();
                }
                pointerEvent.m4807setTypeEhbLWgg$ui_release(iM4818getExit7fucELk);
            } else if (PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4817getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                pointerEvent.m4807setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m4819getMove7fucELk());
            } else if (PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4818getExit7fucELk()) && this.isIn && pointerInputChange3.getPressed()) {
                pointerEvent.m4807setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m4819getMove7fucELk());
            }
        } else {
            z = false;
        }
        boolean z8 = (z6 || !PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4819getMove7fucELk()) || hasPositionChanged(this.pointerEvent, pointerEvent)) ? z7 : z;
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m3413equalsimpl0(oldEvent.getChanges().get(i).getPosition(), newEvent.getChanges().get(i).getPosition())) {
                return true;
            }
        }
        return false;
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean zM4793activeHoverEvent0FcD4WY = internalPointerEvent.m4793activeHoverEvent0FcD4WY(pointerInputChange.getId());
            boolean z = this.isIn;
            if ((!pressed && !zM4793activeHoverEvent0FcD4WY) || (!pressed && !z)) {
                this.pointerIds.m4960remove0FcD4WY(pointerInputChange.getId());
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4818getExit7fucELk());
    }
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (delegatingNodePop != 0) {
            if (delegatingNodePop instanceof PointerInputModifierNode) {
                ((PointerInputModifierNode) delegatingNodePop).mo548onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Initial, jMo5001getSizeYbymL2g);
            } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                Modifier.Node delegate = delegatingNodePop.getDelegate();
                int i = 0;
                delegatingNodePop = delegatingNodePop;
        ...
        if (this.modifierNode.getIsAttached()) {
            ...
            int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(16);
            MutableVector mutableVector2 = null;
            while (delegatingNodePop2 != 0) {
                if (delegatingNodePop2 instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNodePop2).mo548onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Main, jMo5001getSizeYbymL2g);
                } else if ((delegatingNodePop2.getKindSet() & iM5228constructorimpl2) != 0 && (delegatingNodePop2 instanceof DelegatingNode)) {
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.getIsAttached()) {
            ...
            while (delegatingNodePop != 0) {
                if (delegatingNodePop instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNodePop).mo548onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, jMo5001getSizeYbymL2g);
                } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                    Modifier.Node delegate = delegatingNodePop.getDelegate();
                    int i2 = 0;
                    delegatingNodePop = delegatingNodePop;
