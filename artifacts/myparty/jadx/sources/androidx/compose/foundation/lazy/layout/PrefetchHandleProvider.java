...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1205schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m1204createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m6074isZeroimpl(this.constraints)) {
                ...
                try {
                    m1206performMeasureBRTryo0(this.constraints);
        ...
        private final void m1206performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo5019premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m6075toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
