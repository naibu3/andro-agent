...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3746getAutoNrFUSI();
    private long size = Size.INSTANCE.m3493getUnspecifiedNHjbRc();
    ...
    public void mo3847setAmbientShadowColor8_81llA(long j) {
        if (Color.m3658equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo3849setSpotShadowColor8_81llA(long j) {
        if (Color.m3658equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo3850setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m4042equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo3848setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3742equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m3969setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3847setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3849setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3850setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4048getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3848setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3746getAutoNrFUSI());
        m3969setSizeuvyYCjk(Size.INSTANCE.m3493getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo623createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
