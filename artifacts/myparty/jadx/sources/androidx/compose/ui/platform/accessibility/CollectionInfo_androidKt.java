    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m3405boximpl(OffsetKt.Offset(Math.abs(Offset.m3416getXimpl(semanticsNode4.getBoundsInRoot().m3446getCenterF1C5BW0()) - Offset.m3416getXimpl(semanticsNode3.getBoundsInRoot().m3446getCenterF1C5BW0())), Math.abs(Offset.m3417getYimpl(semanticsNode4.getBoundsInRoot().m3446getCenterF1C5BW0()) - Offset.m3417getYimpl(semanticsNode3.getBoundsInRoot().m3446getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m3405boximpl(Offset.m3421plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m3417getYimpl(packedValue) < Offset.m3416getXimpl(packedValue);
    }
