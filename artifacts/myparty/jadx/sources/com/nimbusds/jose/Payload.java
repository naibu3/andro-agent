...
public final class Payload implements Serializable {
    ...
    public Payload(Map<String, Object> map) {
        ...
        mapNewJSONObject.putAll((Map) Objects.requireNonNull(map, "The JSON object must not be null"));
        this.string = null;
        this.bytes = null;
        this.base64URL = null;
        this.jwsObject = null;
    ...
    public Payload(Base64URL base64URL) {
        ...
        this.string = null;
        this.bytes = null;
        this.base64URL = (Base64URL) Objects.requireNonNull(base64URL, "The Base64URL-encoded object must not be null");
        this.jwsObject = null;
        this.signedJWT = null;
