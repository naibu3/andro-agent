...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        AccessibilityActionCompat(Object action, int id2, CharSequence label, AccessibilityViewCommand command, Class<? extends AccessibilityViewCommand.CommandArguments> viewCommandArgumentClass) {
            this.mId = id2;
            this.mCommand = command;
            if (action == null) {
                this.mAction = new AccessibilityNodeInfo.AccessibilityAction(id2, label);
            } else {
                this.mAction = action;
            }
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (spans != null && spans.length > 0) {
                ...
                for (int i = 0; spans != null && i < spans.length; i++) {
                    int id2 = idForClickableSpan(spans[i], tagSpans);
                    tagSpans.put(id2, new WeakReference<>(spans[i]));
                    addSpanLocationToExtras(spans[i], (Spanned) text, id2);
                }
            }
        }
    }
    ...
    private void addSpanLocationToExtras(ClickableSpan span, Spanned spanned, int id2) {
        ...
        extrasIntList(SPANS_ID_KEY).add(Integer.valueOf(id2));
    }
