...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        s$iv = SegmentOrClosed.m1684constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    s$iv = SegmentOrClosed.m1684constructorimpl(cur$iv$iv);
                    curTail = curTail2;
                    break;
                }
            }
            if (!SegmentOrClosed.m1689isClosedimpl(s$iv)) {
                Segment to$iv$iv = SegmentOrClosed.m1687getSegmentimpl(s$iv);
                while (true) {
                    z = false;
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1687getSegmentimpl(s$iv);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (value$iv != null) {
            return value$iv == SemaphoreKt.CANCELLED ? z : tryResumeAcquire((CancellableContinuation) value$iv);
        }
