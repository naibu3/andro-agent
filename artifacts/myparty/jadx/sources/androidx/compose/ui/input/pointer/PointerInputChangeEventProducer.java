...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo4947screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m4879getIdJ3iCeTQ());
            if (pointerInputData == null) {
                down = false;
                uptime = pointerInputEventData.getUptime();
                jMo4947screenToLocalMKHz9U = pointerInputEventData.m4881getPositionF1C5BW0();
            } else {
                uptime = pointerInputData.getUptime();
                down = pointerInputData.getDown();
                jMo4947screenToLocalMKHz9U = positionCalculator.mo4947screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            longSparseArray.put(pointerInputEventData.m4879getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m4879getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m4881getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo4947screenToLocalMKHz9U, down, false, pointerInputEventData.m4884getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m4883getScrollDeltaF1C5BW0(), pointerInputEventData.m4880getOriginalEventPositionF1C5BW0(), null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m4879getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m4882getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m4884getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m4879getIdJ3iCeTQ());
            }
        }
