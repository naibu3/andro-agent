...
public final class RecordingInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5600getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5599getMaximpl(textFieldValue.getSelection());
