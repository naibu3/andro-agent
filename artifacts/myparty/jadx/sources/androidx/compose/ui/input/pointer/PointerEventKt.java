...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        return !Offset.m3413equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m3432getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        return !Offset.m3413equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m3432getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        return (z || !pointerInputChange.isConsumed()) ? Offset.m3420minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition()) : Offset.INSTANCE.m3432getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        if (Offset.m3413equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m3432getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m4808isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        ...
        return fM3416getXimpl < 0.0f || fM3416getXimpl > ((float) IntSize.m6287getWidthimpl(j)) || fM3417getYimpl < 0.0f || fM3417getYimpl > ((float) IntSize.m6286getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m4809isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        if (!PointerType.m4936equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m4943getTouchT8wyACA())) {
            return m4808isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long position = pointerInputChange.getPosition();
        float fM3416getXimpl = Offset.m3416getXimpl(position);
        float fM3417getYimpl = Offset.m3417getYimpl(position);
        return fM3416getXimpl < (-Size.m3485getWidthimpl(j2)) || fM3416getXimpl > ((float) IntSize.m6287getWidthimpl(j)) + Size.m3485getWidthimpl(j2) || fM3417getYimpl < (-Size.m3482getHeightimpl(j2)) || fM3417getYimpl > ((float) IntSize.m6286getHeightimpl(j)) + Size.m3482getHeightimpl(j2);
    }
}
