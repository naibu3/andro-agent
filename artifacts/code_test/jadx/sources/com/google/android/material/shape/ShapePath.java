    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                ...
                double d2 = -retractLength;
                double retractLength2 = arcRadius;
                Double.isNaN(retractLength2);
                matrix.preTranslate((float) (d2 - retractLength2), (-2.0f) * arcRadius);
                double d3 = arcRadius;
                Double.isNaN(d3);
                shadowRenderer.drawInnerCornerShadow(canvas, this.renderMatrix, rect, (int) arcRadius, 450.0f, sweepAngle, new float[]{(float) (d3 + retractLength), arcRadius * 2.0f});
