...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3746getAutoNrFUSI();
    ...
    public void mo5344setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3742equalsimpl0(i, CompositingStrategy.INSTANCE.m3748getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3742equalsimpl0(i, CompositingStrategy.INSTANCE.m3747getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3742equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3748getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m3628clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
