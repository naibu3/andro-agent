...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM7162clone = m7162clone();
        excluderM7162clone.version = d;
        return excluderM7162clone;
    }

    public Excluder withModifiers(int... iArr) {
        Excluder excluderM7162clone = m7162clone();
        excluderM7162clone.modifiers = 0;
        for (int i : iArr) {
            excluderM7162clone.modifiers = i | excluderM7162clone.modifiers;
        }
        return excluderM7162clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM7162clone = m7162clone();
        excluderM7162clone.serializeInnerClasses = false;
        return excluderM7162clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM7162clone = m7162clone();
        excluderM7162clone.requireExpose = true;
        return excluderM7162clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM7162clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM7162clone.deserializationStrategies = arrayList2;
