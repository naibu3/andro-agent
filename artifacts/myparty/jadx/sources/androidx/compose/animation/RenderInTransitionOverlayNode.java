...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long jMo5002localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5002localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m3432getZeroF1C5BW0());
                float fM3416getXimpl = Offset.m3416getXimpl(jMo5002localPositionOfR5De75A);
                float fM3417getYimpl = Offset.m3417getYimpl(jMo5002localPositionOfR5De75A);
                ...
                if (pathInvoke != null) {
                    ...
                    try {
                        drawContext.getTransform().mo4136clipPathmtrdDE(pathInvoke, iM3646getIntersectrtfAjoo);
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4211recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
