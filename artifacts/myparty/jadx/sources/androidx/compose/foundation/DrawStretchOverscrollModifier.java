...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float f;
        float f2;
        this.overscrollEffect.m559updateSizeuvyYCjk$foundation_release(contentDrawScope.mo4213getSizeNHjbRc());
        if (Size.m3487isEmptyimpl(contentDrawScope.mo4213getSizeNHjbRc())) {
            contentDrawScope.drawContent();
            return;
        }
        this.overscrollEffect.getRedrawSignal$foundation_release().getValue();
        float f3 = contentDrawScope.mo712toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Offset.m3417getYimpl(this.overscrollEffect.m558displacementF1C5BW0$foundation_release()));
            }
        } else {
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Offset.m3416getXimpl(this.overscrollEffect.m558displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Offset.m3417getYimpl(this.overscrollEffect.m558displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Offset.m3416getXimpl(this.overscrollEffect.m558displacementF1C5BW0$foundation_release()));
            }
            zDrawLeftStretch = z;
        }
        if (zDrawLeftStretch) {
        ...
        long j = contentDrawScope.mo4213getSizeNHjbRc();
        ...
        long jMo4134getSizeNHjbRc = contentDrawScope2.getDrawContext().mo4134getSizeNHjbRc();
