...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m5861resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m5860resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m5860resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale platformLocale;
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6021getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6022getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6023getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6024getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6020getContents_7Xco()) ? true : TextDirection.m6016equalsimpl0(i, TextDirection.INSTANCE.m6025getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m5454boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m5457equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m5463getNone_3YsG6Y()));
    }
}
