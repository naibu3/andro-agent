...
public final class ContextMenuGestures_androidKt {
    ...
    static final class C03101 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ ContextMenuState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03101(ContextMenuState contextMenuState, Continuation<? super C03101> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03101 c03101 = new C03101(this.$state, continuation);
            c03101.L$0 = obj;
            return c03101;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03101) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                if (ContextMenuGestures_androidKt.onRightClickDown(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuGestures_androidKt.contextMenuGestures.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m683invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m683invokek4lQ0M(long j) {
    ...
    public static final Modifier contextMenuGestures(Modifier modifier, ContextMenuState contextMenuState) {
        return SuspendingPointerInputFilterKt.pointerInput(modifier, ContextMenuKey.INSTANCE, new C03101(contextMenuState, null));
    }
    ...
    static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            this.$onDown.invoke(Offset.m3405boximpl(pointerInputChange2.getPosition()));
            this.L$0 = null;
            this.label = 2;
    ...
    */
    public static final java.lang.Object awaitFirstRightClickDown(androidx.compose.ui.input.pointer.AwaitPointerEventScope r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r9) {
        ...
        L45:
            ...
            boolean r2 = androidx.compose.ui.input.pointer.PointerEvent_androidKt.m4839isSecondaryPressedaHzCxE(r2)
            if (r2 == 0) goto L39
