...
@DebugMetadata(c = "com.stripe.android.financialconnections.FinancialConnectionsSheetViewModel$onBrowserActivityResult$1", f = "FinancialConnectionsSheetViewModel.kt", i = {0}, l = {628}, m = "invokeSuspend", n = {"$this$withLock_u24default$iv"}, s = {"L$0"})
/* loaded from: classes5.dex */
final class FinancialConnectionsSheetViewModel$onBrowserActivityResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    FinancialConnectionsSheetViewModel$onBrowserActivityResult$1(FinancialConnectionsSheetViewModel financialConnectionsSheetViewModel, Continuation<? super FinancialConnectionsSheetViewModel$onBrowserActivityResult$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FinancialConnectionsSheetViewModel$onBrowserActivityResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            ...
            if (value.getActivityRecreated()) {
                ...
                if (i2 == 1) {
                    ...
                    financialConnectionsSheetViewModel.setState(new Function1() { // from class: com.stripe.android.financialconnections.FinancialConnectionsSheetViewModel$onBrowserActivityResult$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj2) {
                            return FinancialConnectionsSheetViewModel$onBrowserActivityResult$1.invokeSuspend$lambda$1$lambda$0((FinancialConnectionsSheetState) obj2);
                        }
                    });
                } else if (i2 != 3) {
