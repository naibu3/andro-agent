...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6115boximpl(Dp.m6117constructorimpl(0)), null, 2, null);
    ...
    private final Function1<TextFieldValue, Unit> onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
        ...
        public final void invoke2(TextFieldValue textFieldValue) {
            ...
            this.this$0.m1360setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5607getZerod9O1mEE());
            this.this$0.m1357setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m5607getZerod9O1mEE());
    ...
    private final Function1<ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1362invokeKlQnJC8(imeAction.getValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-KlQnJC8, reason: not valid java name */
        public final void m1362invokeKlQnJC8(int i) {
            this.this$0.keyboardActionRunner.m1338runActionKlQnJC8(i);
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m3693getUnspecified0d7_KjU();

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5590boximpl(TextRange.INSTANCE.m5607getZerod9O1mEE()), null, 2, null);

    /* renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m5590boximpl(TextRange.INSTANCE.m5607getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1354getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m6131unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1358setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m6115boximpl(f));
    }
    ...
    public final void m1359setSelectionBackgroundColor8_81llA(long j) {
        this.selectionBackgroundColor = j;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getSelectionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1356getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1360setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m5590boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1353getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1357setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m5590boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m5596getCollapsedimpl(m1356getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m5596getCollapsedimpl(m1353getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1361updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM1396updateTextDelegaterm0N8CA$default = TextDelegateKt.m1396updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != textDelegateM1396updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM1396updateTextDelegaterm0N8CA$default;
    }
}
