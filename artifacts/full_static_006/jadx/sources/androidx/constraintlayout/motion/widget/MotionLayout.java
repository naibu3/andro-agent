    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (constraintAnchor != null) {
                strConcat = RequestConfiguration.MAX_AD_CONTENT_RATING_T.concat(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "B");
            } else {
                strConcat = "__";
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = Constants.USER_ID_SEPARATOR;
                StringBuilder sbAppend = new StringBuilder().append(((constraintAnchor != null ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : Constants.USER_ID_SEPARATOR) + (constraintWidget.mBottom.mTarget != null ? "B" : Constants.USER_ID_SEPARATOR)) + (constraintWidget.mLeft.mTarget != null ? "L" : Constants.USER_ID_SEPARATOR));
                if (constraintWidget.mRight.mTarget != null) {
                    str3 = "R";
                }
                String string = sbAppend.append(str3).toString();
