...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo5904getColor0d7_KjU() {
            return Color.INSTANCE.m3693getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m6027from8_81llA(long color) {
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m6027from8_81llA(TextDrawStyleKt.m6026modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
