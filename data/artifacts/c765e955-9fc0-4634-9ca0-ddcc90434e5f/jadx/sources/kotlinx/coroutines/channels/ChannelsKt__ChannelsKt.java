...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m130constructorimpl(ResultKt.createFailure(th));
                        return ChannelResult.m1640boximpl(!Result.m137isSuccessimpl(r) ? ChannelResult.INSTANCE.m1655successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1653closedJP2dKIU(Result.m133exceptionOrNullimpl(r)));
                    }
                    if (sendChannel.send(e, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r = Result.m130constructorimpl(Unit.INSTANCE);
                    return ChannelResult.m1640boximpl(!Result.m137isSuccessimpl(r) ? ChannelResult.INSTANCE.m1655successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1653closedJP2dKIU(Result.m133exceptionOrNullimpl(r)));
                case 1:
                    try {
                        ResultKt.throwOnFailure($result);
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1635trySendJP2dKIU(e);
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1650isSuccessimpl(sendChannel.mo1635trySendJP2dKIU(e))) {
