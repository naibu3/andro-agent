...
public interface ReceiveChannel<E> {
    ...
    Object mo1736receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1737tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1737tryReceivePtdJZtk = receiveChannel.mo1737tryReceivePtdJZtk();
            if (ChannelResult.m1752isSuccessimpl(objMo1737tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1748getOrThrowimpl(objMo1737tryReceivePtdJZtk);
            }
            Throwable thM1746exceptionOrNullimpl = ChannelResult.m1746exceptionOrNullimpl(objMo1737tryReceivePtdJZtk);
            if (thM1746exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1746exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1736receiveCatchingJP2dKIU = receiveChannel.mo1736receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1747getOrNullimpl(objMo1736receiveCatchingJP2dKIU);
        }
