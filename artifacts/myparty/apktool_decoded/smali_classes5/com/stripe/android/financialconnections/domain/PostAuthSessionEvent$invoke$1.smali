...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v3, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->$events:Ljava/util/List;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;-><init>(Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent;Ljava/lang/String;Ljava/util/List;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast p1, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;

    sget-object p2, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 25
    iget v1, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->label:I
    ...
    iget-object p1, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->L$0:Ljava/lang/Object;
    ...
    iget-object v6, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->$sessionId:Ljava/lang/String;

    iget-object v7, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->$events:Ljava/util/List;
    ...
    .line 27
    iput v2, p0, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->label:I
    :try_end_1
    ...
    :try_start_2
    invoke-interface/range {v3 .. v8}, Lcom/stripe/android/financialconnections/repository/FinancialConnectionsManifestRepository;->postAuthorizationSessionEvent(Ljava/lang/String;Ljava/util/Date;Ljava/lang/String;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 33
    :goto_3
    iget-object v0, v8, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent$invoke$1;->this$0:Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent;
    ...
    .line 34
    invoke-static {v0}, Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent;->access$getLogger$p(Lcom/stripe/android/financialconnections/domain/PostAuthSessionEvent;)Lcom/stripe/android/core/Logger;

    move-result-object v0

    const-string v1, "error posting auth session event"
