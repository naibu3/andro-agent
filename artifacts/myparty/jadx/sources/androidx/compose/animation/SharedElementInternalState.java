...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM3405boximpl = currentBounds != null ? Offset.m3405boximpl(currentBounds.m3451getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM3405boximpl);
            long packedValue = offsetM3405boximpl.getPackedValue();
            float fM3416getXimpl = Offset.m3416getXimpl(packedValue);
            float fM3417getYimpl = Offset.m3417getYimpl(packedValue);
            ...
            if (path != null) {
                ...
                try {
                    ...
                    drawScope.getDrawContext().getTransform().translate(fM3416getXimpl, fM3417getYimpl);
                    try {
    ...
    public final long m446getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m6299toSizeozmzZPI(layoutCoordinatesInvoke.mo5001getSizeYbymL2g());
    }
    ...
    public final long m445calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke == null) {
            throw new IllegalArgumentException("Error: lookahead coordinates is null.".toString());
        }
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5002localPositionOfR5De75A(layoutCoordinatesInvoke, Offset.INSTANCE.m3432getZeroF1C5BW0());
    }
