...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m5864getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m4215getDefaultBlendMode0nO6VwU();
    ...
    public final void m5870setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3416getXimpl(this.shadow.getOffset()), Offset.m3417getYimpl(this.shadow.getOffset()), ColorKt.m3711toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5871setColor8_81llA(long color) {
        if (color != 16) {
            setColor(ColorKt.m3711toArgb8_81llA(color));
            clearShader();
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m5865setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m5869setBrush12SF9DM(brush, j, f);
    }
    ...
    */
    public final void m5869setBrush12SF9DM(final Brush brush, final long size, float alpha) {
        if (brush == null) {
            clearShader();
            return;
        }
        if (brush instanceof SolidColor) {
            m5871setColor8_81llA(TextDrawStyleKt.m6026modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            return;
        }
        if (brush instanceof ShaderBrush) {
            if (Intrinsics.areEqual(this.brush, brush)) {
                Size size2 = this.brushSize;
                if (!(size2 == null ? false : Size.m3481equalsimpl0(size2.getPackedValue(), size))) {
                }
            } else if (size != InlineClassHelperKt.UnspecifiedPackedFloats) {
                this.brush = brush;
                this.brushSize = Size.m3473boximpl(size);
                this.shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.AndroidTextPaint$setBrush$1
                    ...
                    public final Shader invoke() {
                        return ((ShaderBrush) brush).mo3626createShaderuvyYCjk(size);
                    }
                });
            }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            getComposePaint().mo3540setStylek9PVt8s(PaintingStyle.INSTANCE.m3925getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            getComposePaint().setStrokeWidth(stroke.getWidth());
            getComposePaint().setStrokeMiterLimit(stroke.getMiter());
            getComposePaint().mo3539setStrokeJoinWw9F2mQ(stroke.getJoin());
            getComposePaint().mo3538setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m5868setBlendModes9anfk8(int i) {
        if (BlendMode.m3568equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo3535setBlendModes9anfk8(i);
