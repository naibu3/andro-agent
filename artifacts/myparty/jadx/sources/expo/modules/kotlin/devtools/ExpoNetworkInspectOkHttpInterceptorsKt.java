...
public final class ExpoNetworkInspectOkHttpInterceptorsKt {
    ...
    public static final boolean shouldParseBody(Response response) {
        Intrinsics.checkNotNullParameter(response, "response");
        List listListOf = CollectionsKt.listOf((Object[]) new String[]{"text/event-stream", "text/x-component", "audio", AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_VIDEO});
        ...
        String strHeader = response.request().header(NetworkConstantsKt.HEADER_ACCEPT);
