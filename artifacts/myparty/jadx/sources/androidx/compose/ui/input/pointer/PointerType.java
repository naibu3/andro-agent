...
public final class PointerType {
    ...
    private static final int Unknown = m4934constructorimpl(0);
    private static final int Touch = m4934constructorimpl(1);
    private static final int Mouse = m4934constructorimpl(2);
    private static final int Stylus = m4934constructorimpl(3);
    private static final int Eraser = m4934constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m4933boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4934constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4935equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4936equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4937hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4935equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4937hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4938toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4938toStringimpl(int i) {
        if (i == 1) {
            return "Touch";
        }
        if (i == 2) {
