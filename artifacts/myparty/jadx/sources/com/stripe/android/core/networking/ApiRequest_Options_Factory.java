...
public final class ApiRequest_Options_Factory implements Factory<ApiRequest.Options> {
    ...
    public static ApiRequest_Options_Factory create(javax.inject.Provider<Function0<String>> provider, javax.inject.Provider<Function0<String>> provider2) {
        return new ApiRequest_Options_Factory(Providers.asDaggerProvider(provider), Providers.asDaggerProvider(provider2));
    }
