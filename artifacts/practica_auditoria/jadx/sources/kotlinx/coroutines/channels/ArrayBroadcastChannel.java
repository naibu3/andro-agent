...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00cc, code lost:
        ...
        r24.buffer[(int) (r10 % r24.capacity)] = r23.getElement();
        setSize(r22 + 1);
        setTail(r10 + 1);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x00fb, code lost:
        ...
        r0 = th;
     */
    /* JADX WARN: Removed duplicated region for block: B:12:0x0030 A[Catch: all -> 0x002b, TRY_ENTER, TRY_LEAVE, TryCatch #4 {all -> 0x002b, blocks: (B:5:0x0013, B:12:0x0030, B:17:0x0045, B:22:0x005d), top: B:79:0x0013 }] */
    /* JADX WARN: Removed duplicated region for block: B:22:0x005d A[Catch: all -> 0x002b, TRY_ENTER, TRY_LEAVE, TryCatch #4 {all -> 0x002b, blocks: (B:5:0x0013, B:12:0x0030, B:17:0x0045, B:22:0x005d), top: B:79:0x0013 }] */
                                ...
                                if (wasFull) {
                                    while (true) {
                                        ...
                                        try {
                                            ...
                                            Object token = sendTakeFirstSendOrPeekClosed.tryResumeSend(null);
                                            if (token != null) {
                                                break;
                                            }
                                            size = size2;
                                            send3 = sendTakeFirstSendOrPeekClosed;
                                        } catch (Throwable th) {
                                            th = th;
                                        }
                                    }
