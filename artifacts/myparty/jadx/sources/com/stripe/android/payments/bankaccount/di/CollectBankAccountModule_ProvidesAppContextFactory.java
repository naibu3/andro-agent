...
public final class CollectBankAccountModule_ProvidesAppContextFactory implements Factory<Context> {
    ...
    public static CollectBankAccountModule_ProvidesAppContextFactory create(javax.inject.Provider<Application> provider) {
        return new CollectBankAccountModule_ProvidesAppContextFactory(Providers.asDaggerProvider(provider));
    }
