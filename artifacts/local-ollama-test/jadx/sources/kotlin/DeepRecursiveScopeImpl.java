    ...
    public final R runCallLoop() throws Throwable {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m132equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m130constructorimpl(objInvoke));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        continuation.resumeWith(Result.m130constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
