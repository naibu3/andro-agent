...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m3888constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public void mo5223childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5145hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }

        @Override // androidx.compose.ui.node.NodeCoordinator.HitTestSource
        /* renamed from: entityType-OLwlOKw, reason: not valid java name */
        public int mo5224entityTypeOLwlOKw() {
            return NodeKind.m5228constructorimpl(16);
        }
        ...
        public boolean interceptOutOfBoundsChildEvents(Modifier.Node node) {
            int iM5228constructorimpl = NodeKind.m5228constructorimpl(16);
            ...
            while (node != 0) {
                ...
                } else if ((node.getKindSet() & iM5228constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                    Modifier.Node delegate = node.getDelegate();
                    int i = 0;
                    node = node;
                    while (delegate != null) {
                        if ((delegate.getKindSet() & iM5228constructorimpl) != 0) {
                            i++;
                            if (i == 1) {
                                node = delegate;
                            } else {
    ...
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public int mo5224entityTypeOLwlOKw() {
            return NodeKind.m5228constructorimpl(8);
        }
    };
    private Density layerDensity = getLayoutNode().getDensity();
    private LayoutDirection layerLayoutDirection = getLayoutNode().getLayoutDirection();
    private float lastLayerAlpha = 0.8f;
    private long position = IntOffset.INSTANCE.m6255getZeronOccac();
    ...
    public interface HitTestSource {
        /* renamed from: childHitTest-YqVAtuI */
        void mo5223childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* renamed from: entityType-OLwlOKw */
        int mo5224entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m5221visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        boolean zM5237getIncludeSelfInTraversalH91voCI = NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM5237getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return;
        }
        for (Modifier.Node nodeHeadNode = headNode(zM5237getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & type) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean m5200hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m5113has64DMado(nodeHeadNode, type);
    }

    /* renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m5214headH91voCI(int type) {
        boolean zM5237getIncludeSelfInTraversalH91voCI = NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM5237getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return null;
    ...
    public final long mo5001getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        ...
        if (graphicsLayer != null) {
            mo5054placeAtf8xVGno(getPosition(), this.zIndex, graphicsLayer);
        } else {
            mo4994placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
        }
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (ownedLayer != null) {
            ownedLayer.mo5279resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else if (getLayoutNode().isPlaced() && (nodeCoordinator = this.wrappedBy) != null) {
            nodeCoordinator.invalidateLayer();
        }
        m5055setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        if (this.layerBlock != null) {
            updateLayerParameters(false);
        }
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(4);
        boolean zM5237getIncludeSelfInTraversalH91voCI = NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(iM5228constructorimpl);
        Modifier.Node tail = getTail();
        if (zM5237getIncludeSelfInTraversalH91voCI || (tail = tail.getParent()) != null) {
            for (Modifier.Node nodeHeadNode = headNode(zM5237getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM5228constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
                if ((nodeHeadNode.getKindSet() & iM5228constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        ...
                        } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release = delegatingNodePop.getDelegate();
                            int i = 0;
                            delegatingNodePop = delegatingNodePop;
                            while (delegate$ui_release != null) {
                                if ((delegate$ui_release.getKindSet() & iM5228constructorimpl) != 0) {
                                    i++;
                                    if (i == 1) {
    ...
    protected void m5219setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        if (!getLayoutNode().getNodes().m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(64))) {
            return null;
        }
        getTail();
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        for (Modifier.Node tail = getLayoutNode().getNodes().getTail(); tail != null; tail = tail.getParent()) {
            if ((NodeKind.m5228constructorimpl(64) & tail.getKindSet()) != 0) {
                int iM5228constructorimpl = NodeKind.m5228constructorimpl(64);
                MutableVector mutableVector = null;
    ...
    public final long m5212getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m5217performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        m5056setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    public void mo4994placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m5204placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, layerBlock, null);
            return;
        }
        m5204placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo5054placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m5204placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, null, layer);
            return;
        }
        m5204placeSelfMLgxB_4(position, zIndex, null, layer);
    }

    /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    private final void m5204placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer explicitLayer) {
        if (explicitLayer != null) {
            ...
            if (this.layer == null) {
                ...
                ownedLayerCreateLayer.mo5279resizeozmzZPI(getMeasuredSize());
                ownedLayerCreateLayer.mo5278movegyyYBs(position);
        ...
        if (!IntOffset.m6244equalsimpl0(getPosition(), position)) {
            m5219setPositiongyyYBs(position);
            getLayoutNode().getLayoutDelegate().getMeasurePassDelegate().notifyChildrenUsingCoordinatesWhilePlacing();
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5278movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m5218placeSelfApparentToRealOffsetMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        m5204placeSelfMLgxB_4(IntOffset.m6249plusqkQi6aY(position, getApparentToRealOffset()), zIndex, layerBlock, layer);
    }
    ...
    public final void draw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        float fM6245getXimpl = IntOffset.m6245getXimpl(getPosition());
        float fM6246getYimpl = IntOffset.m6246getYimpl(getPosition());
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            ...
            ownedLayerCreateLayer$default.mo5279resizeozmzZPI(getMeasuredSize());
            ownedLayerCreateLayer$default.mo5278movegyyYBs(getPosition());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (ownedLayer != null) {
            ...
            if (function1 != null) {
                ...
                reusableGraphicsLayerScope.m3969setSizeuvyYCjk(IntSizeKt.m6299toSizeozmzZPI(mo5001getSizeYbymL2g()));
    ...
    public final long m5213getMinimumTouchTargetSizeNHjbRc() {
        return this.layerDensity.mo713toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo5149getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m5215hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Modifier.Node nodeM5214headH91voCI = m5214headH91voCI(hitTestSource.mo5224entityTypeOLwlOKw());
        if (!m5222withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float fM5210distanceInMinimumTouchTargettz77jQw = m5210distanceInMinimumTouchTargettz77jQw(pointerPosition, m5213getMinimumTouchTargetSizeNHjbRc());
                if (Float.isInfinite(fM5210distanceInMinimumTouchTargettz77jQw) || Float.isNaN(fM5210distanceInMinimumTouchTargettz77jQw) || !hitTestResult.isHitInMinimumTouchTargetBetter(fM5210distanceInMinimumTouchTargettz77jQw, false)) {
                    return;
                }
                m5202hitNearJHbHoSQ(nodeM5214headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, fM5210distanceInMinimumTouchTargettz77jQw);
                return;
            }
            return;
        }
        if (nodeM5214headH91voCI == null) {
            mo5137hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m5216isPointerInBoundsk4lQ0M(pointerPosition)) {
            m5201hit1hIXUjU(nodeM5214headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float fM5210distanceInMinimumTouchTargettz77jQw2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m5210distanceInMinimumTouchTargettz77jQw(pointerPosition, m5213getMinimumTouchTargetSizeNHjbRc());
        if (!Float.isInfinite(fM5210distanceInMinimumTouchTargettz77jQw2) && !Float.isNaN(fM5210distanceInMinimumTouchTargettz77jQw2) && hitTestResult.isHitInMinimumTouchTargetBetter(fM5210distanceInMinimumTouchTargettz77jQw2, isInLayer)) {
            m5202hitNearJHbHoSQ(nodeM5214headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, fM5210distanceInMinimumTouchTargettz77jQw2);
        } else {
            m5205speculativeHitJHbHoSQ(nodeM5214headH91voCI, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, fM5210distanceInMinimumTouchTargettz77jQw2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m5201hit1hIXUjU(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2) {
        if (node == null) {
            mo5137hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
        } else {
            hitTestResult.hit(node, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5201hit1hIXUjU(NodeCoordinatorKt.m5226nextUntilhw7D004(node, hitTestSource.mo5224entityTypeOLwlOKw(), NodeKind.m5228constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2);
                }
            });
        }
    }
    ...
    public final void m5202hitNearJHbHoSQ(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2, final float f) {
        if (node == null) {
            mo5137hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
        } else {
            hitTestResult.hitInMinimumTouchTarget(node, f, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5202hitNearJHbHoSQ(NodeCoordinatorKt.m5226nextUntilhw7D004(node, hitTestSource.mo5224entityTypeOLwlOKw(), NodeKind.m5228constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
                }
            });
        }
    }
    ...
    public final void m5205speculativeHitJHbHoSQ(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final boolean z, final boolean z2, final float f) {
        if (node == null) {
            mo5137hitTestChildYqVAtuI(hitTestSource, j, hitTestResult, z, z2);
        } else if (!hitTestSource.interceptOutOfBoundsChildEvents(node)) {
            m5205speculativeHitJHbHoSQ(NodeCoordinatorKt.m5226nextUntilhw7D004(node, hitTestSource.mo5224entityTypeOLwlOKw(), NodeKind.m5228constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
        } else {
            hitTestResult.speculativeHit(node, f, z2, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5205speculativeHitJHbHoSQ(NodeCoordinatorKt.m5226nextUntilhw7D004(node, hitTestSource.mo5224entityTypeOLwlOKw(), NodeKind.m5228constructorimpl(2)), hitTestSource, j, hitTestResult, z, z2, f);
                }
            });
        }
    }
    ...
    public void mo5137hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        NodeCoordinator nodeCoordinator = this.wrapped;
        if (nodeCoordinator != null) {
            nodeCoordinator.m5215hitTestYqVAtuI(hitTestSource, m5199fromParentPosition8S9VItk$default(nodeCoordinator, pointerPosition, false, 2, null), hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long jM5209calculateMinimumTouchTargetPaddingE7KxVPU = m5209calculateMinimumTouchTargetPaddingE7KxVPU(m5213getMinimumTouchTargetSizeNHjbRc());
        rectCache.setLeft(-Size.m3485getWidthimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU));
        rectCache.setTop(-Size.m3482getHeightimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU));
        rectCache.setRight(getMeasuredWidth() + Size.m3485getWidthimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU));
        rectCache.setBottom(getMeasuredHeight() + Size.m3482getHeightimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU));
    ...
    public long mo5007screenToLocalMKHz9U(long relativeToScreen) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return mo5002localPositionOfR5De75A(LayoutCoordinatesKt.findRootCoordinates(this), LayoutNodeKt.requireOwner(getLayoutNode()).mo4947screenToLocalMKHz9U(relativeToScreen));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo5005localToScreenMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo4946localToScreenMKHz9U(mo5004localToRootMKHz9U(relativeToLocal));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo5010windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        LayoutCoordinates layoutCoordinatesFindRootCoordinates = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo5002localPositionOfR5De75A(layoutCoordinatesFindRootCoordinates, Offset.m3420minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo5281calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(layoutCoordinatesFindRootCoordinates)));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo5006localToWindowMKHz9U(long relativeToLocal) {
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo5282calculatePositionInWindowMKHz9U(mo5004localToRootMKHz9U(relativeToLocal));
    }
    ...
    public long mo5002localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        return mo5003localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, true);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localPositionOf-S_NoaFU */
    public long mo5003localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ((LookaheadLayoutCoordinates) sourceCoordinates).getCoordinator().onCoordinatesUsed$ui_release();
            return Offset.m3425unaryMinusF1C5BW0(sourceCoordinates.mo5003localPositionOfS_NoaFU(this, Offset.m3425unaryMinusF1C5BW0(relativeToSource), includeMotionFrameOfReference));
        }
        ...
        while (coordinator != nodeCoordinatorFindCommonAncestor$ui_release) {
            relativeToSource = coordinator.m5220toParentPosition8S9VItk(relativeToSource, includeMotionFrameOfReference);
            coordinator = coordinator.wrappedBy;
            Intrinsics.checkNotNull(coordinator);
        }
        return m5198ancestorToLocalS_NoaFU(nodeCoordinatorFindCommonAncestor$ui_release, relativeToSource, includeMotionFrameOfReference);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformFrom-EL8BTi8 */
    public void mo5008transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        NodeCoordinator coordinator = toCoordinator(sourceCoordinates);
        coordinator.onCoordinatesUsed$ui_release();
        NodeCoordinator nodeCoordinatorFindCommonAncestor$ui_release = findCommonAncestor$ui_release(coordinator);
        Matrix.m3897resetimpl(matrix);
        coordinator.m5208transformToAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui_release, matrix);
        m5207transformFromAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui_release, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformToScreen-58bKbWc */
    public void mo5009transformToScreen58bKbWc(float[] matrix) {
        Owner ownerRequireOwner = LayoutNodeKt.requireOwner(getLayoutNode());
        m5208transformToAncestorEL8BTi8(toCoordinator(LayoutCoordinatesKt.findRootCoordinates(this)), matrix);
        ownerRequireOwner.mo4945localToScreen58bKbWc(matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m5208transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator nodeCoordinator = this;
        while (!Intrinsics.areEqual(nodeCoordinator, ancestor)) {
            OwnedLayer ownedLayer = nodeCoordinator.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5280transform58bKbWc(matrix);
            }
            if (!IntOffset.m6244equalsimpl0(nodeCoordinator.getPosition(), IntOffset.INSTANCE.m6255getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m3897resetimpl(fArr);
                Matrix.m3908translateimpl$default(fArr, IntOffset.m6245getXimpl(r1), IntOffset.m6246getYimpl(r1), 0.0f, 4, null);
                Matrix.m3905timesAssign58bKbWc(matrix, fArr);
            }
            nodeCoordinator = nodeCoordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
        }
    ...
    private final void m5207transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (Intrinsics.areEqual(ancestor, this)) {
            return;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        Intrinsics.checkNotNull(nodeCoordinator);
        nodeCoordinator.m5207transformFromAncestorEL8BTi8(ancestor, matrix);
        if (!IntOffset.m6244equalsimpl0(getPosition(), IntOffset.INSTANCE.m6255getZeronOccac())) {
            float[] fArr = tmpMatrix;
            Matrix.m3897resetimpl(fArr);
            Matrix.m3908translateimpl$default(fArr, -IntOffset.m6245getXimpl(getPosition()), -IntOffset.m6246getYimpl(getPosition()), 0.0f, 4, null);
            Matrix.m3905timesAssign58bKbWc(matrix, fArr);
        }
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            ownedLayer.mo5275inverseTransform58bKbWc(matrix);
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        rectCache.setRight(IntSize.m6287getWidthimpl(sourceCoordinates.mo5001getSizeYbymL2g()));
        rectCache.setBottom(IntSize.m6286getHeightimpl(sourceCoordinates.mo5001getSizeYbymL2g()));
    ...
    private final long m5198ancestorToLocalS_NoaFU(NodeCoordinator ancestor, long offset, boolean includeMotionFrameOfReference) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        if (nodeCoordinator == null || Intrinsics.areEqual(ancestor, nodeCoordinator)) {
            return m5211fromParentPosition8S9VItk(offset, includeMotionFrameOfReference);
        }
        return m5211fromParentPosition8S9VItk(nodeCoordinator.m5198ancestorToLocalS_NoaFU(ancestor, offset, includeMotionFrameOfReference), includeMotionFrameOfReference);
    }
    ...
    public long mo5004localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        onCoordinatesUsed$ui_release();
        long jM5206toParentPosition8S9VItk$default = relativeToLocal;
        for (NodeCoordinator nodeCoordinator = this; nodeCoordinator != null; nodeCoordinator = nodeCoordinator.wrappedBy) {
            jM5206toParentPosition8S9VItk$default = m5206toParentPosition8S9VItk$default(nodeCoordinator, jM5206toParentPosition8S9VItk$default, false, 2, null);
        }
        return jM5206toParentPosition8S9VItk$default;
    }
    ...
    public static /* synthetic */ long m5206toParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5220toParentPosition8S9VItk(j, z);
    }

    /* renamed from: toParentPosition-8S9VItk, reason: not valid java name */
    public long m5220toParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            position = ownedLayer.mo5277mapOffset8S9VItk(position, false);
        }
        return (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) ? IntOffsetKt.m6259plusNvtHpc(position, getPosition()) : position;
    }

    /* renamed from: fromParentPosition-8S9VItk$default, reason: not valid java name */
    public static /* synthetic */ long m5199fromParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5211fromParentPosition8S9VItk(j, z);
    }

    /* renamed from: fromParentPosition-8S9VItk, reason: not valid java name */
    public long m5211fromParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        if (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) {
            position = IntOffsetKt.m6257minusNvtHpc(position, getPosition());
        }
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer != null ? ownedLayer.mo5277mapOffset8S9VItk(position, true) : position;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        canvas.drawRect(new Rect(0.5f, 0.5f, IntSize.m6287getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m6286getHeightimpl(getMeasuredSize()) - 0.5f), paint);
    }
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (ownedLayer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long jM5213getMinimumTouchTargetSizeNHjbRc = m5213getMinimumTouchTargetSizeNHjbRc();
                    float fM3485getWidthimpl = Size.m3485getWidthimpl(jM5213getMinimumTouchTargetSizeNHjbRc) / 2.0f;
                    float fM3482getHeightimpl = Size.m3482getHeightimpl(jM5213getMinimumTouchTargetSizeNHjbRc) / 2.0f;
                    bounds.intersect(-fM3485getWidthimpl, -fM3482getHeightimpl, IntSize.m6287getWidthimpl(mo5001getSizeYbymL2g()) + fM3485getWidthimpl, IntSize.m6286getHeightimpl(mo5001getSizeYbymL2g()) + fM3482getHeightimpl);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m6287getWidthimpl(mo5001getSizeYbymL2g()), IntSize.m6286getHeightimpl(mo5001getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        float fM6245getXimpl = IntOffset.m6245getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + fM6245getXimpl);
        bounds.setRight(bounds.getRight() + fM6245getXimpl);
        float fM6246getYimpl = IntOffset.m6246getYimpl(getPosition());
        bounds.setTop(bounds.getTop() + fM6246getYimpl);
        bounds.setBottom(bounds.getBottom() + fM6246getYimpl);
    }
    ...
    protected final boolean m5222withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m3433isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer == null || !this.isClipping || ownedLayer.mo5276isInLayerk4lQ0M(pointerPosition);
    }

    /* renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m5216isPointerInBoundsk4lQ0M(long pointerPosition) {
        float fM3416getXimpl = Offset.m3416getXimpl(pointerPosition);
        float fM3417getYimpl = Offset.m3417getYimpl(pointerPosition);
        return fM3416getXimpl >= 0.0f && fM3417getYimpl >= 0.0f && fM3416getXimpl < ((float) getMeasuredWidth()) && fM3417getYimpl < ((float) getMeasuredHeight());
    }
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (layoutNode == layoutNode2) {
            ...
            int iM5228constructorimpl = NodeKind.m5228constructorimpl(2);
            if (!tail2.getNode().getIsAttached()) {
                InlineClassHelperKt.throwIllegalStateException("visitLocalAncestors called on an unattached node");
            }
            for (Modifier.Node parent = tail2.getNode().getParent(); parent != null; parent = parent.getParent()) {
                if ((parent.getKindSet() & iM5228constructorimpl) != 0 && parent == tail) {
                    return other;
                }
            }
            return this;
    ...
    private final long m5203offsetFromEdgeMKHz9U(long pointerPosition) {
        float fM3416getXimpl = Offset.m3416getXimpl(pointerPosition);
        float fMax = Math.max(0.0f, fM3416getXimpl < 0.0f ? -fM3416getXimpl : fM3416getXimpl - getMeasuredWidth());
        float fM3417getYimpl = Offset.m3417getYimpl(pointerPosition);
        return OffsetKt.Offset(fMax, Math.max(0.0f, fM3417getYimpl < 0.0f ? -fM3417getYimpl : fM3417getYimpl - getMeasuredHeight()));
    }

    /* renamed from: calculateMinimumTouchTargetPadding-E7KxVPU, reason: not valid java name */
    protected final long m5209calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        return SizeKt.Size(Math.max(0.0f, (Size.m3485getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth()) / 2.0f), Math.max(0.0f, (Size.m3482getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight()) / 2.0f));
    }

    /* renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m5210distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m3485getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m3482getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long jM5209calculateMinimumTouchTargetPaddingE7KxVPU = m5209calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float fM3485getWidthimpl = Size.m3485getWidthimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU);
        float fM3482getHeightimpl = Size.m3482getHeightimpl(jM5209calculateMinimumTouchTargetPaddingE7KxVPU);
        long jM5203offsetFromEdgeMKHz9U = m5203offsetFromEdgeMKHz9U(pointerPosition);
        if ((fM3485getWidthimpl > 0.0f || fM3482getHeightimpl > 0.0f) && Offset.m3416getXimpl(jM5203offsetFromEdgeMKHz9U) <= fM3485getWidthimpl && Offset.m3417getYimpl(jM5203offsetFromEdgeMKHz9U) <= fM3482getHeightimpl) {
            return Offset.m3415getDistanceSquaredimpl(jM5203offsetFromEdgeMKHz9U);
        }
        return Float.POSITIVE_INFINITY;
    }
    ...
    public final void onMeasured() {
        ...
        if (m5200hasNodeH91voCI(NodeKind.m5228constructorimpl(128))) {
            Snapshot.Companion companion = Snapshot.INSTANCE;
            Snapshot currentThreadSnapshot = companion.getCurrentThreadSnapshot();
            Function1<Object, Unit> readObserver = currentThreadSnapshot != null ? currentThreadSnapshot.getReadObserver() : null;
            Snapshot snapshotMakeCurrentNonObservable = companion.makeCurrentNonObservable(currentThreadSnapshot);
            try {
                int iM5228constructorimpl = NodeKind.m5228constructorimpl(128);
                boolean zM5237getIncludeSelfInTraversalH91voCI = NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(iM5228constructorimpl);
                if (!zM5237getIncludeSelfInTraversalH91voCI) {
                    ...
                    if ((nodeHeadNode.getKindSet() & iM5228constructorimpl) != 0) {
                        ...
                        while (delegatingNodePop != 0) {
                            if (delegatingNodePop instanceof LayoutAwareModifierNode) {
                                ((LayoutAwareModifierNode) delegatingNodePop).mo702onRemeasuredozmzZPI(getMeasuredSize());
                            } else if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                                Modifier.Node delegate$ui_release = delegatingNodePop.getDelegate();
                                int i = 0;
                                delegatingNodePop = delegatingNodePop;
    ...
    public final void drawContainedDrawModifiers(Canvas canvas, GraphicsLayer graphicsLayer) {
        Modifier.Node nodeM5214headH91voCI = m5214headH91voCI(NodeKind.m5228constructorimpl(4));
        if (nodeM5214headH91voCI == null) {
            performDraw(canvas, graphicsLayer);
        } else {
            getLayoutNode().getMDrawScope$ui_release().m5155draweZhPAX0$ui_release(canvas, IntSizeKt.m6299toSizeozmzZPI(mo5001getSizeYbymL2g()), this, nodeM5214headH91voCI, graphicsLayer);
        }
    }
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m5237getIncludeSelfInTraversalH91voCI(NodeKind.m5228constructorimpl(16)));
        if (nodeHeadNode != null && nodeHeadNode.getIsAttached()) {
            ...
            if ((node2.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & iM5228constructorimpl) != 0) {
