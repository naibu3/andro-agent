...
public final class zzsh extends zzea {
    ...
    private final void zzt(boolean z) {
        ...
        zzeq.zzg(length % this.zze == 0, "bytesConsumed is not aligned to frame size: %s" + length);
        zzeq.zzf(i2 >= i);
        this.zzl -= length;
    ...
    private final void zzu(int i, int i2) {
        ...
        byte[] bArr3 = this.zzm;
        zzeq.zze(i % this.zze == 0, "byteOutput size is not aligned to frame size " + i);
        if (i2 != 3) {
    ...
    protected final zzdx zzi(zzdx zzdxVar) throws zzdy {
        if (zzdxVar.zzd != 2) {
