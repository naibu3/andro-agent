...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point pCenter) throws NotFoundException {
        ...
        while (true) {
            ...
            Point pouta = getFirstDifferent(pina, color, i, -1);
            Point poutb = getFirstDifferent(pinb, color, i, i);
            Point poutc = getFirstDifferent(pinc, color, -1, i);
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            resultPointArr[0] = pinax;
            resultPointArr[c] = pinbx;
            resultPointArr[2] = pincx;
            resultPointArr[3] = pindx;
            return expandSquare(resultPointArr, (this.nbCenterLayers * 2) - 3, this.nbCenterLayers * 2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
