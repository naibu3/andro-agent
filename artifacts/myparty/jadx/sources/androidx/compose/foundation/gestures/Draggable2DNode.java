...
public final class Draggable2DNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        drag2DScope.mo742dragByk4lQ0M(draggable2DNode.m781reverseIfNeededMKHz9U(dragDelta.getDelta()));
                    }
                };
                this.label = 1;
    ...
    public void mo729onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStart.invoke(Offset.m3405boximpl(startedPosition));
    ...
    public void mo730onDragStoppedTH1AsA0(long velocity) {
        this.onDragStop.invoke(Velocity.m6345boximpl(velocity));
    ...
    public final long m780reverseIfNeededAH228Gc(long j) {
        return Velocity.m6360timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m781reverseIfNeededMKHz9U(long j) {
        return Offset.m3423timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
