...
public final class ExtensionsManager {
    ...
    static ListenableFuture<ExtensionsManager> getInstanceAsync(Context context, final CameraProvider cameraProvider, final ClientVersion clientVersion) {
    ...
    static /* synthetic */ Object lambda$getInstanceAsync$0(ClientVersion clientVersion, final Context context, final CameraProvider cameraProvider, final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            ...
            try {
                ...
                if (extensionsAvailability == ExtensionsAvailability.LIBRARY_AVAILABLE) {
                    ...
                    sDeinitializeFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.extensions.ExtensionsManager$$ExternalSyntheticLambda0
                        @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return this.f$0.m249lambda$shutdown$1$androidxcameraextensionsExtensionsManager(completer);
                        }
                    });
                } else {
    ...
    /* synthetic */ Object m249lambda$shutdown$1$androidxcameraextensionsExtensionsManager(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
