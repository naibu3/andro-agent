    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (((Boolean) obj).booleanValue()) {
                Object next = it.next();
                Object objM10659getOrNullimpl = ChannelResult.m10659getOrNullimpl(this.$channel.mo10647tryReceivePtdJZtk());
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(objM10659getOrNullimpl == null ? next : objM10659getOrNullimpl, this.$animatable, this.$animSpec$delegate, this.$listener$delegate, null), 3, null);
                this.L$0 = coroutineScope;
                this.L$1 = it;
                this.label = 1;
                obj = it.hasNext(this);
