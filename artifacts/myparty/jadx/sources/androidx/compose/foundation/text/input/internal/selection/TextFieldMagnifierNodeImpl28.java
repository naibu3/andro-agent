...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6279boximpl(IntSize.INSTANCE.m6292getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3405boximpl(m1590invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1590invoketuRUvjQ(Density density) {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1591invokeEaSLcWc(dpSize.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1591invokeEaSLcWc(long j) {
            ...
            textFieldMagnifierNodeImpl28.m1589setMagnifierSizeozmzZPI(IntSizeKt.IntSize(density.mo706roundToPx0680j_4(DpSize.m6215getWidthD9Ej5fM(j)), density.mo706roundToPx0680j_4(DpSize.m6213getHeightD9Ej5fM(j))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.visible = z;
        this.animatable = new Animatable<>(Offset.m3405boximpl(TextFieldMagnifierKt.m1585calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1588getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3405boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m1588getMagnifierSizeYbymL2g() {
    ...
    public final void m1589setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m6279boximpl(j));
    }
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3405boximpl(m1592invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1592invokeF1C5BW0() {
                        ...
                        return TextFieldMagnifierKt.m1585calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m1588getMagnifierSizeYbymL2g());
                    }
                });
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                        return m1593emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                    }

                    /* renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m1593emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3435isSpecifiedk4lQ0M(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) && OffsetKt.m3435isSpecifiedk4lQ0M(j) && Offset.m3417getYimpl(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) != Offset.m3417getYimpl(j)) {
                        ...
                        Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m3405boximpl(j), continuation);
                    ...
                    static final class C00591 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (Animatable.animateTo$default(this.this$0.animatable, Offset.m3405boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
