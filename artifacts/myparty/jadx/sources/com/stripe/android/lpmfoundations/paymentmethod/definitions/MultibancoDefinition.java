...
public final class MultibancoDefinition implements PaymentMethodDefinition {
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.UnsupportedForSetup, AddPaymentMethodRequirement.MerchantSupportsDelayedPaymentMethods});
    }

    @Override // com.stripe.android.lpmfoundations.paymentmethod.PaymentMethodDefinition
    public UiDefinitionFactory uiDefinitionFactory() {
        return MultibancoUiDefinitionFactory.INSTANCE;
    }
}
