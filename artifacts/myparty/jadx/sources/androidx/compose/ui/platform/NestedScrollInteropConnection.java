...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo1096onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5379getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5381toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3416getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3417getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m5381toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m5380toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo822onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5379getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5381toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3416getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3417getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3416getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3417getYimpl(available)), null, NestedScrollInteropConnectionKt.m5381toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m5380toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m3432getZeroF1C5BW0();
    }
    ...
    public Object mo1095onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6354getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6355getYimpl(j)))) {
    ...
    public Object mo821onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6354getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6355getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m6365getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
