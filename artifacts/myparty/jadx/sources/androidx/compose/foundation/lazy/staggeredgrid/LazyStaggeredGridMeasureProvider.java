...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1228createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1234childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6082fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m6081fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1235getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM1234childConstraintsJhjzzOo = m1234childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo1228createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo1191measure0kLqBqw(index, jM1234childConstraintsJhjzzOo), jM1234childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo1134getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1228createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo1191measure0kLqBqw(index, constraints), constraints);
    }
