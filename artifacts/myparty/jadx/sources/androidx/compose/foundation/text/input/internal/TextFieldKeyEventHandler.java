...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1474onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5596getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1335cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1473onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange textRangeM5590boximpl;
        Integer numM1334consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m4715equalsimpl0(KeyEvent_androidKt.m4723getTypeZmokQxo(event), KeyEventType.INSTANCE.m4719getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1418isTypedEventZmokQxo(event) && (numM1334consumeZmokQxo = this.deadKeyCombiner.m1334consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM1334consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1545isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand keyCommandMo1336mapZmokQxo = this.keyMapping.mo1336mapZmokQxo(event);
        if (keyCommandMo1336mapZmokQxo != null && (!keyCommandMo1336mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1545isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1336mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (numValueOf.intValue() == -1) {
                            numValueOf = null;
                        }
                        textRangeM5590boximpl = numValueOf != null ? TextRange.m5590boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m5597getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (textRangeM5590boximpl != null) {
                            TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5590boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                        TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 21:
                    if (TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        textRangeM5590boximpl = numValueOf2 != null ? TextRange.m5590boximpl(TextRangeKt.TextRange(TextRange.m5602getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                        if (textRangeM5590boximpl != null) {
                            TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM5590boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5597getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5602getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5597getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m5596getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1566replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5602getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
            ...
            if (!TextRange.m5595equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1573selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1573selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
    ...
    private final float getVisibleTextLayoutHeight(TextLayoutState textLayoutState) {
        ...
        if (rectLocalBoundingBoxOf$default != null) {
            return Size.m3482getHeightimpl(rectLocalBoundingBoxOf$default.m3449getSizeNHjbRc());
        }
        return Float.NaN;
    }
}
