...
public final class InstantDebitsDefinition implements PaymentMethodDefinition {
    public static final int $stable = 0;
    private static final boolean supportedAsSavedPaymentMethod = false;
    public static final InstantDebitsDefinition INSTANCE = new InstantDebitsDefinition();
    ...
    private InstantDebitsDefinition() {
    }
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.FinancialConnectionsSdk, AddPaymentMethodRequirement.InstantDebits});
    }

    @Override // com.stripe.android.lpmfoundations.paymentmethod.PaymentMethodDefinition
    public UiDefinitionFactory uiDefinitionFactory() {
        return InstantDebitsUiDefinitionFactory.INSTANCE;
    }
}
