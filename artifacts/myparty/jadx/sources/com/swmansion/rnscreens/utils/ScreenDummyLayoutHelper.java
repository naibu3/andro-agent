...
public final class ScreenDummyLayoutHelper implements LifecycleEventListener {
    ...
    private final float computeDummyLayout(int fontSize, boolean isTitleEmpty) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(width, BasicMeasure.EXACTLY);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(height, BasicMeasure.EXACTLY);
