...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m5984getProportionalPIaL0Z0(), Trim.INSTANCE.m5995getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m5978equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m5989equalsimpl0(this.trim, lineHeightStyle.trim);
    }

    public int hashCode() {
        return (Alignment.m5979hashCodeimpl(this.alignment) * 31) + Trim.m5990hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m5980toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m5993toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m5987constructorimpl(1);
        private static final int LastLineBottom = m5987constructorimpl(16);
        private static final int Both = m5987constructorimpl(17);
        private static final int None = m5987constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m5986boximpl(int i) {
            return new Trim(i);
        }
        ...
        public static final boolean m5991isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5992isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
        ...
        public static String m5993toStringimpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m5996getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m5997getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m5995getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m5998getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m5976constructorimpl(0.0f);
        private static final float Center = m5976constructorimpl(0.5f);
        private static final float Proportional = m5976constructorimpl(-1.0f);
        private static final float Bottom = m5976constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m5975boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5977equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5978equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5979hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m5977equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m5979hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m5976constructorimpl(float f) {
        ...
        public String toString() {
            return m5980toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5980toStringimpl(float f) {
        ...
        public static final class Companion {
            ...
            public final float m5985getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m5983getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m5984getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m5982getBottomPIaL0Z0() {
