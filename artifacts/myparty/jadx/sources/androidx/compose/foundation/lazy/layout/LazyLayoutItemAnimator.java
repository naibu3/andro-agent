...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
            ...
            if (getHasAnimations(t)) {
                ...
                if (itemInfo == null) {
                    ...
                    if (t.getIndex() == index || index == -1) {
                        long jMo1132getOffsetBjo55l4 = t.mo1132getOffsetBjo55l4(0);
                        initializeAnimation(t, t.getIsVertical() ? IntOffset.m6246getYimpl(jMo1132getOffsetBjo55l4) : IntOffset.m6245getXimpl(jMo1132getOffsetBjo55l4), itemInfo2);
                        if (z2) {
                    ...
                    if (z) {
                        ...
                        while (i19 < length2) {
                            ...
                            if (lazyLayoutItemAnimation2 != null) {
                                i9 = i18;
                                i10 = length2;
                                if (!IntOffset.m6244equalsimpl0(lazyLayoutItemAnimation2.getRawOffset(), LazyLayoutItemAnimation.INSTANCE.m1184getNotInitializednOccac())) {
                                    lazyLayoutItemAnimation2.m1183setRawOffsetgyyYBs(IntOffset.m6249plusqkQi6aY(lazyLayoutItemAnimation2.getRawOffset(), jIntOffset));
                                }
                            } else {
                                i9 = i18;
                                i10 = length2;
                    ...
                    while (i28 < i27) {
                        if ((j2 & 255) < 128) {
                            ...
                            if (index2 == -1) {
                                ...
                                LazyLayoutMeasuredItem lazyLayoutMeasuredItemMo1134getAndMeasurehBUhpc = itemProvider.mo1134getAndMeasurehBUhpc(index2, itemInfo4.getLane(), itemInfo4.getSpan(), constraints.getValue());
                                lazyLayoutMeasuredItemMo1134getAndMeasurehBUhpc.setNonScrollableItem(true);
                                ...
                                itemInfo4.updateAnimation(lazyLayoutMeasuredItemMo1134getAndMeasurehBUhpc, coroutineScope, graphicsContext, layoutMinOffset, layoutMaxOffset, itemInfo4.getCrossAxisOffset());
                                if (index2 < this.firstVisibleIndex) {
                                    this.movingAwayToStartBound.add(lazyLayoutMeasuredItemMo1134getAndMeasurehBUhpc);
                                } else {
                                    this.movingAwayToEndBound.add(lazyLayoutMeasuredItemMo1134getAndMeasurehBUhpc);
                                }
                            }
                        } else {
                            i4 = i28;
    ...
    */
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        long jM6241copyiSbpLlY$default;
        int i = 0;
        long jMo1132getOffsetBjo55l4 = item.mo1132getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            jM6241copyiSbpLlY$default = IntOffset.m6241copyiSbpLlY$default(jMo1132getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            jM6241copyiSbpLlY$default = IntOffset.m6241copyiSbpLlY$default(jMo1132getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                lazyLayoutItemAnimation.m1183setRawOffsetgyyYBs(IntOffset.m6249plusqkQi6aY(jM6241copyiSbpLlY$default, IntOffset.m6248minusqkQi6aY(item.mo1132getOffsetBjo55l4(i2), jMo1132getOffsetBjo55l4)));
            }
            i++;
            i2 = i3;
        }
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                long jMo1132getOffsetBjo55l4 = item.mo1132getOffsetBjo55l4(i2);
                long rawOffset = lazyLayoutItemAnimation.getRawOffset();
                if (!IntOffset.m6244equalsimpl0(rawOffset, LazyLayoutItemAnimation.INSTANCE.m1184getNotInitializednOccac()) && !IntOffset.m6244equalsimpl0(rawOffset, jMo1132getOffsetBjo55l4)) {
                    lazyLayoutItemAnimation.m1176animatePlacementDeltaar5cAso(IntOffset.m6248minusqkQi6aY(jMo1132getOffsetBjo55l4, rawOffset), isMovingAway);
                }
                lazyLayoutItemAnimation.m1183setRawOffsetgyyYBs(jMo1132getOffsetBjo55l4);
            }
            i++;
            i2 = i3;
        }
    ...
    public final long m1185getMinSizeToFitDisappearingItemsYbymL2g() {
        long jM6292getZeroYbymL2g = IntSize.INSTANCE.m6292getZeroYbymL2g();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layer != null) {
                jM6292getZeroYbymL2g = IntSizeKt.IntSize(Math.max(IntSize.m6287getWidthimpl(jM6292getZeroYbymL2g), IntOffset.m6245getXimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m6287getWidthimpl(layer.getSize())), Math.max(IntSize.m6286getHeightimpl(jM6292getZeroYbymL2g), IntOffset.m6246getYimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m6286getHeightimpl(layer.getSize())));
            }
        }
        return jM6292getZeroYbymL2g;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem lazyLayoutMeasuredItem) {
        long jMo1132getOffsetBjo55l4 = lazyLayoutMeasuredItem.mo1132getOffsetBjo55l4(0);
        return lazyLayoutMeasuredItem.getIsVertical() ? IntOffset.m6246getYimpl(jMo1132getOffsetBjo55l4) : IntOffset.m6245getXimpl(jMo1132getOffsetBjo55l4);
    }
    ...
    private final class ItemInfo {
        ...
        public final void m1187setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m6058boximpl(positionedItem.getConstraints());
    ...
    private static final /* data */ class DisplayingDisappearingItemsNode extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                GraphicsLayer layer = lazyLayoutItemAnimation.getLayer();
                if (layer != null) {
                    float fM6245getXimpl = IntOffset.m6245getXimpl(lazyLayoutItemAnimation.getFinalOffset());
                    ContentDrawScope contentDrawScope2 = contentDrawScope;
                    float fM6245getXimpl2 = fM6245getXimpl - IntOffset.m6245getXimpl(layer.getTopLeft());
                    float fM6246getYimpl = IntOffset.m6246getYimpl(lazyLayoutItemAnimation.getFinalOffset()) - IntOffset.m6246getYimpl(layer.getTopLeft());
                    contentDrawScope2.getDrawContext().getTransform().translate(fM6245getXimpl2, fM6246getYimpl);
                    try {
