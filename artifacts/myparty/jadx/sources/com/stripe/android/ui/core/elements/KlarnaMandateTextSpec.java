...
public final /* data */ class KlarnaMandateTextSpec extends FormItemSpec {
    ...
    public static /* synthetic */ KlarnaMandateTextSpec copy$default(KlarnaMandateTextSpec klarnaMandateTextSpec, IdentifierSpec identifierSpec, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public final KlarnaMandateTextSpec copy(IdentifierSpec apiPath, int stringResId) {
        Intrinsics.checkNotNullParameter(apiPath, "apiPath");
        return new KlarnaMandateTextSpec(apiPath, stringResId);
    }
    ...
    /* compiled from: KlarnaMandateTextSpec.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/stripe/android/ui/core/elements/KlarnaMandateTextSpec$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/stripe/android/ui/core/elements/KlarnaMandateTextSpec;", "payments-ui-core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public /* synthetic */ KlarnaMandateTextSpec(int i, IdentifierSpec identifierSpec, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        this.apiPath = (i & 1) == 0 ? IdentifierSpec.INSTANCE.Generic("klarna_mandate") : identifierSpec;
        if ((i & 2) == 0) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$payments_ui_core_release(KlarnaMandateTextSpec self, CompositeEncoder output, SerialDescriptor serialDesc) {
        if (output.shouldEncodeElementDefault(serialDesc, 0) || !Intrinsics.areEqual(self.getApiPath(), IdentifierSpec.INSTANCE.Generic("klarna_mandate"))) {
            output.encodeSerializableElement(serialDesc, 0, IdentifierSpec$$serializer.INSTANCE, self.getApiPath());
        }
        if (!output.shouldEncodeElementDefault(serialDesc, 1) && self.stringResId == R.string.stripe_klarna_mandate) {
            return;
        }
    ...
    public /* synthetic */ KlarnaMandateTextSpec(IdentifierSpec identifierSpec, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? IdentifierSpec.INSTANCE.Generic("klarna_mandate") : identifierSpec, (i2 & 2) != 0 ? R.string.stripe_klarna_mandate : i);
    }
    ...
    public KlarnaMandateTextSpec(IdentifierSpec apiPath, int i) {
        super(null);
        Intrinsics.checkNotNullParameter(apiPath, "apiPath");
