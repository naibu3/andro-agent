...
public final class LazyGridMeasureKt {
    ...
    public static final LazyGridMeasureResult m1161measureLazyGridOZKpZRA(int i, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function1<? super Integer, ? extends List<Pair<Integer, Constraints>>> function1, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i13 <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, iM6072getMinWidthimpl, iM6071getMinHeightimpl, new ArrayList(), lazyGridMeasuredItemProvider.getKeyIndexMap(), lazyGridMeasuredItemProvider, z, false, i8, false, 0, 0, coroutineScope, graphicsContext);
            ...
            return new LazyGridMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(iM6072getMinWidthimpl), Integer.valueOf(iM6071getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
        ...
        while (i27 < size) {
            ...
            if (iIntValue < 0 || iIntValue >= index) {
                ...
                LazyGridMeasuredItem lazyGridMeasuredItemMo1134getAndMeasurehBUhpc = lazyGridMeasuredItemProvider.mo1134getAndMeasurehBUhpc(iIntValue, 0, iSpanOf, lazyGridMeasuredLineProvider.m1165childConstraintsJhjzzOo$foundation_release(0, iSpanOf));
                ArrayList arrayList = listEmptyList == null ? new ArrayList() : listEmptyList;
                arrayList.add(lazyGridMeasuredItemMo1134getAndMeasurehBUhpc);
        ...
        while (i29 < size2) {
            ...
            if (index2 + 1 <= iIntValue2 && iIntValue2 < i13) {
                ...
                LazyGridMeasuredItem lazyGridMeasuredItemMo1134getAndMeasurehBUhpc2 = lazyGridMeasuredItemProvider.mo1134getAndMeasurehBUhpc(iIntValue2, 0, iSpanOf2, lazyGridMeasuredLineProvider.m1165childConstraintsJhjzzOo$foundation_release(0, iSpanOf2));
                if (arrayListEmptyList == null) {
                    arrayListEmptyList = new ArrayList();
                }
                List list5 = arrayListEmptyList;
                list5.add(lazyGridMeasuredItemMo1134getAndMeasurehBUhpc2);
        ...
        if (z) {
            iM6087constrainWidthK40F9xA = Constraints.m6070getMaxWidthimpl(j);
        } else {
            iM6087constrainWidthK40F9xA = ConstraintsKt.m6087constrainWidthK40F9xA(j, mainAxisSizeWithSpacings3);
        }
        int i33 = iM6087constrainWidthK40F9xA;
        if (z) {
            iM6069getMaxHeightimpl = ConstraintsKt.m6086constrainHeightK40F9xA(j, mainAxisSizeWithSpacings3);
        } else {
            iM6069getMaxHeightimpl = Constraints.m6069getMaxHeightimpl(j);
        }
        int iM6086constrainHeightK40F9xA = iM6069getMaxHeightimpl;
        int i34 = mainAxisSizeWithSpacings3;
        int i35 = index;
        int i36 = index2;
        List list6 = arrayListEmptyList;
        final List<LazyGridMeasuredItem> listCalculateItemsOffsets = calculateItemsOffsets(arrayDeque, list4, list6, i33, iM6086constrainHeightK40F9xA, i34, i2, i26, z, vertical, horizontal, z2, density);
        lazyLayoutItemAnimator.onMeasured((int) f2, i33, iM6086constrainHeightK40F9xA, listCalculateItemsOffsets, lazyGridMeasuredItemProvider.getKeyIndexMap(), lazyGridMeasuredItemProvider, z, false, i8, false, i32, i34, coroutineScope, graphicsContext);
        ...
        if (IntSize.m6285equalsimpl0(jM1185getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
            iM6087constrainWidthK40F9xA2 = i33;
        } else {
            int i37 = z ? iM6086constrainHeightK40F9xA : i33;
            iM6087constrainWidthK40F9xA2 = ConstraintsKt.m6087constrainWidthK40F9xA(j, Math.max(i33, IntSize.m6287getWidthimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
            iM6086constrainHeightK40F9xA = ConstraintsKt.m6086constrainHeightK40F9xA(j, Math.max(iM6086constrainHeightK40F9xA, IntSize.m6286getHeightimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
            int i38 = z ? iM6086constrainHeightK40F9xA : iM6087constrainWidthK40F9xA2;
            if (i38 != i37) {
        ...
        MeasureResult measureResultInvoke = function3.invoke(Integer.valueOf(iM6087constrainWidthK40F9xA2), Integer.valueOf(iM6086constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$6
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, Function1<? super Integer, Boolean> function1) {
        ...
        while (i < size) {
            ...
            if (function1.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                ...
                LazyGridMeasuredItem lazyGridMeasuredItemMo1134getAndMeasurehBUhpc = lazyGridMeasuredItemProvider2.mo1134getAndMeasurehBUhpc(iIntValue, 0, iSpanOf, lazyGridMeasuredLineProvider.m1165childConstraintsJhjzzOo$foundation_release(0, iSpanOf));
                if (arrayList == null) {
