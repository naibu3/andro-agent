        ...
        while (dataRegionRow < numDataRegionsRow) {
            ...
            while (dataRegionColumn < numDataRegionsColumn) {
                ...
                while (i < dataRegionSizeRows) {
                    ...
                    while (readColumnOffset < dataRegionSizeColumns) {
                        int j = readColumnOffset;
                        int symbolSizeColumns2 = symbolSizeColumns;
                        if (bitMatrix.get(((dataRegionSizeColumns + 2) * dataRegionColumn) + 1 + j, readRowOffset)) {
                            int readColumnOffset2 = dataRegionColumnOffset + j;
                            bitMatrixWithoutAlignment.set(readColumnOffset2, writeRowOffset);
                        }
                        readColumnOffset = j + 1;
