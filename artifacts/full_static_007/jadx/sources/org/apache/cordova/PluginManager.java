...
public class PluginManager {
    ...
    public void exec(String str, String str2, String str3, String str4) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
    ...
    public CordovaPlugin getPlugin(String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
    ...
    */
    private CordovaPlugin instantiatePlugin(String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        Class<?> cls;
        if (str != null) {
            try {
