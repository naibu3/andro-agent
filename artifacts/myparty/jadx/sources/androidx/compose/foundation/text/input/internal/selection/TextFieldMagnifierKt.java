...
public final class TextFieldMagnifierKt {
    ...
    public static final long m1585calculateSelectionMagnifierCenterAndroidhUlJWOE(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, long j) {
        int iM5602getStartimpl;
        long jM1609getHandleDragPositionF1C5BW0 = textFieldSelectionState.m1609getHandleDragPositionF1C5BW0();
        if (OffsetKt.m3437isUnspecifiedk4lQ0M(jM1609getHandleDragPositionF1C5BW0) || transformedTextFieldState.getVisualText().length() == 0) {
        ...
        if (i == 1 || i == 2) {
            iM5602getStartimpl = TextRange.m5602getStartimpl(selection);
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM5602getStartimpl = TextRange.m5597getEndimpl(selection);
        }
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        }
        float fM3416getXimpl = Offset.m3416getXimpl(jM1609getHandleDragPositionF1C5BW0);
        int lineForOffset = layoutResult.getLineForOffset(iM5602getStartimpl);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                jOffset = TextLayoutStateKt.m1560coerceIn3MmeM6k(jOffset, SelectionManagerKt.visibleBounds(textLayoutNodeCoordinates));
            }
        }
        return TextLayoutStateKt.m1562fromTextLayoutToCoreUv8p0NA(textLayoutState, jOffset);
    }
}
