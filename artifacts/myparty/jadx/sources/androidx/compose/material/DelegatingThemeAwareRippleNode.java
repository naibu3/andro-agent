...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public final void attachNewRipple() {
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m2106createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, new ColorProducer() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            @Override // androidx.compose.ui.graphics.ColorProducer
            /* renamed from: invoke-0d7_KjU, reason: not valid java name */
            public final long mo1876invoke0d7_KjU() {
                long jMo1876invoke0d7_KjU = this.this$0.color.mo1876invoke0d7_KjU();
                if (jMo1876invoke0d7_KjU != 16) {
                    return jMo1876invoke0d7_KjU;
                }
                ...
                return RippleDefaults.INSTANCE.m1980rippleColor5vOe2sY(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m3667unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight());
            }
            ...
            public final RippleAlpha invoke() {
                ...
                RippleConfiguration rippleConfiguration = (RippleConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, RippleKt.getLocalRippleConfiguration());
                return (rippleConfiguration == null || (rippleAlpha = rippleConfiguration.getRippleAlpha()) == null) ? RippleDefaults.INSTANCE.m1979rippleAlphaDxMtmZc(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m3667unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight()) : rippleAlpha;
            }
        }));
    }
