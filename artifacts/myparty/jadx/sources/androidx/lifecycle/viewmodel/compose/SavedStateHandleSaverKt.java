...
public final class SavedStateHandleSaverKt {
    ...
    public static /* synthetic */ Object saveable$default(SavedStateHandle savedStateHandle, String str, Saver saver, Function0 function0, int i, Object obj) {
        ...
        return m6446saveable(savedStateHandle, str, saver, function0);
    }

    /* renamed from: saveable, reason: collision with other method in class */
    public static final <T> T m6446saveable(SavedStateHandle savedStateHandle, String key, final Saver<T, ? extends Object> saver, Function0<? extends T> init) {
        final T tInvoke;
        Object obj;
    ...
    public static final <T> MutableState<T> saveable(SavedStateHandle savedStateHandle, String key, Saver<T, ? extends Object> stateSaver, Function0<? extends MutableState<T>> init) {
        ...
        Intrinsics.checkNotNullParameter(init, "init");
        return (MutableState) m6446saveable(savedStateHandle, key, mutableStateSaver(stateSaver), (Function0) init);
    }
    ...
    public static final ReadOnlyProperty saveable$lambda$3(SavedStateHandle this_saveable, Saver saver, Function0 init, Object obj, KProperty property) {
        ...
        final Object objM6446saveable = m6446saveable(this_saveable, (obj != null ? Reflection.getOrCreateKotlinClass(obj.getClass()).getQualifiedName() + FilenameUtils.EXTENSION_SEPARATOR : "") + property.getName(), (Saver<Object, ? extends Object>) saver, (Function0<? extends Object>) init);
        return new ReadOnlyProperty() { // from class: androidx.lifecycle.viewmodel.compose.SavedStateHandleSaverKt$$ExternalSyntheticLambda3
            ...
            public final Object getValue(Object obj2, KProperty kProperty) {
                return SavedStateHandleSaverKt.saveable$lambda$3$lambda$2(objM6446saveable, obj2, kProperty);
            }
        };
    }
    ...
    public static final ReadWriteProperty saveable$lambda$4(SavedStateHandle this_saveable, Saver stateSaver, Function0 init, Object obj, KProperty property) {
        ...
        Intrinsics.checkNotNullParameter(init, "$init");
        Intrinsics.checkNotNullParameter(property, "property");
        final MutableState mutableStateSaveable = saveable(this_saveable, (obj != null ? Reflection.getOrCreateKotlinClass(obj.getClass()).getQualifiedName() + FilenameUtils.EXTENSION_SEPARATOR : "") + property.getName(), stateSaver, init);
