...
public /* synthetic */ class DropdownItemSpec$$serializer implements GeneratedSerializer<DropdownItemSpec> {
    ...
    public final DropdownItemSpec deserialize(Decoder decoder) {
        String str;
        ...
        return new DropdownItemSpec(i, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(Encoder encoder, DropdownItemSpec value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DropdownItemSpec.write$Self$payments_ui_core_release(value, compositeEncoderBeginStructure, serialDescriptor);
