...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m5369setBackground8_81llA(m5339decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m5370setBaselineShift_isdbwI(BaselineShift.m5890boximpl(m5337decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m5375setLetterSpacingR2X_6o(m5342decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m5374setFontSynthesistDdu0R4(FontSynthesis.m5720boximpl(m5341decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m5373setFontStylemLjRB2g(FontStyle.m5709boximpl(m5340decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m5372setFontSizeR2X_6o(m5342decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m5371setColor8_81llA(m5339decodeColor0d7_KjU());
            }
        }
    ...
    public final long m5339decodeColor0d7_KjU() {
        return Color.m3653constructorimpl(m5338decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m5342decodeTextUnitXSAIIZE() {
        long jM6344getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM6344getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6343getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM6344getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6342getEmUIouoOA();
        } else {
            jM6344getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m6344getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6338equalsimpl0(jM6344getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m6344getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m6321getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m6322TextUnitanM5pPY(decodeFloat(), jM6344getUnspecifiedUIouoOA);
    }
    ...
    public final int m5340decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m5719getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m5718getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m5719getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5341decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m5730getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m5729getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m5731getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m5732getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m5730getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m5337decodeBaselineShifty9eOQZs() {
        return BaselineShift.m5891constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5339decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m5338decodeULongsVKNKU() {
        return ULong.m9296constructorimpl(this.parcel.readLong());
    }
