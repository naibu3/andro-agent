...
public final class IntRectKt {
    ...
    public static final IntRect m6277IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m6245getXimpl(j), IntOffset.m6246getYimpl(j), IntOffset.m6245getXimpl(j) + IntSize.m6287getWidthimpl(j2), IntOffset.m6246getYimpl(j) + IntSize.m6286getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m6276IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m6245getXimpl(j), IntOffset.m6246getYimpl(j), IntOffset.m6245getXimpl(j2), IntOffset.m6246getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m6278IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m6245getXimpl(j) - i, IntOffset.m6246getYimpl(j) - i, IntOffset.m6245getXimpl(j) + i, IntOffset.m6246getYimpl(j) + i);
    }
