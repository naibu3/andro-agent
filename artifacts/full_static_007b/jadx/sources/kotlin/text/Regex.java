        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    matcher = Regex.this.nativePattern.matcher(c00641.$input);
                    if (c00641.$limit == 1 || !matcher.find()) {
                        c00641.label = 1;
                        return $this$sequence2.yield(c00641.$input.toString(), c00641) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    ...
                    c00641.L$1 = matcher;
                    c00641.I$0 = splitCount;
                    c00641.label = 2;
                    if ($this$sequence.yield(c00641.$input.subSequence(nextStart, matcher.start()).toString(), c00641) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00641.$limit - 1 || !matcher.find()) {
                        CharSequence charSequence = c00641.$input;
                        c00641.L$0 = null;
                        c00641.L$1 = null;
                        c00641.label = 3;
                        return $this$sequence.yield(charSequence.subSequence(nextStart, charSequence.length()).toString(), c00641) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    c00641.L$0 = $this$sequence;
                    c00641.L$1 = matcher;
                    c00641.I$0 = splitCount;
                    ...
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00641.$limit - 1) {
                    }
                    CharSequence charSequence2 = c00641.$input;
                    c00641.L$0 = null;
                    c00641.L$1 = null;
                    c00641.label = 3;
                    if ($this$sequence.yield(charSequence2.subSequence(nextStart, charSequence2.length()).toString(), c00641) == coroutine_suspended) {
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                case 2:
                    c00641 = this;
                    splitCount = c00641.I$0;
                    matcher = (Matcher) c00641.L$1;
                    ...
                    CharSequence charSequence22 = c00641.$input;
                    c00641.L$0 = null;
                    c00641.L$1 = null;
                    c00641.label = 3;
                    if ($this$sequence.yield(charSequence22.subSequence(nextStart, charSequence22.length()).toString(), c00641) == coroutine_suspended) {
                    }
                    break;
                case 3:
                    ResultKt.throwOnFailure($result);
