                        ...
                        if (i11 != 0) {
                            ...
                            if (i13 == 0) {
                                ...
                                if (i15 == 0) {
                                    ...
                                    i21 = i4 & 4096;
                                    if (i21 == 0) {
                                        i22 = i26 | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT;
                                    } else if ((i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 0) {
                                        i22 = i26 | (composerStartRestartGroup.changed(c) ? 256 : 128);
                                    } else {
                                        i22 = i26;
                                    }
                                    if ((i5 & 306783379) == 306783378 || (i22 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
                                        ...
                                        int iM1470getRevealLastTypedvTwcZD0 = i20 == 0 ? TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0() : i;
                                        ...
                                        if (zChangedInstance) {
                                            ...
                                            final boolean zM1465equalsimpl0 = TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0());
                                            Boolean boolValueOf = Boolean.valueOf(zM1465equalsimpl0);
                                            ComposerKt.sourceInformationMarkerStart(composer4, 121001808, "CC(remember):BasicSecureTextField.kt#9igjgp");
                                            zChanged = composer4.changed(zM1465equalsimpl0) | composer4.changedInstance(secureTextFieldController);
                                            ...
                                            if (zChanged) {
                                                ...
                                                z4 = (i23 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32;
                                                objRememberedValue2 = composer4.rememberedValue();
                                                if (!z4 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                                                    if (!TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0())) {
                                                        codepointTransformation = secureTextFieldController.getCodepointTransformation();
                                                    } else {
                                                        codepointTransformation = TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1469getHiddenvTwcZD0()) ? new CodepointTransformation() { // from class: androidx.compose.foundation.text.BasicSecureTextFieldKt$$ExternalSyntheticLambda0
                                                ...
                                                i24 = iM1470getRevealLastTypedvTwcZD0;
                                                composer3 = composer4;
                                                z5 = z3;
                                            ...
                                            basicSecureTextFieldKt$BasicSecureTextField$2$1RememberedValue = new BasicSecureTextFieldKt$BasicSecureTextField$2$1(zM1465equalsimpl0, secureTextFieldController, null);
                                            composer4.updateRememberedValue(basicSecureTextFieldKt$BasicSecureTextField$2$1RememberedValue);
                                            ComposerKt.sourceInformationMarkerEnd(composer4);
                                            EffectsKt.LaunchedEffect(boolValueOf, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) basicSecureTextFieldKt$BasicSecureTextField$2$1RememberedValue, composer4, 0);
                                            ComposerKt.sourceInformationMarkerStart(composer4, 121007343, "CC(remember):BasicSecureTextField.kt#9igjgp");
                                            if ((i23 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32) {
                                            }
                                            objRememberedValue2 = composer4.rememberedValue();
                                            if (!z4) {
                                                if (!TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0())) {
                                        ...
                                        ComposerKt.sourceInformationMarkerEnd(composer4);
                                        EffectsKt.LaunchedEffect(secureTextFieldController, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) basicSecureTextFieldKt$BasicSecureTextField$1$1RememberedValue, composer4, 0);
                                        final boolean zM1465equalsimpl02 = TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0());
                                        Boolean boolValueOf2 = Boolean.valueOf(zM1465equalsimpl02);
                                        ComposerKt.sourceInformationMarkerStart(composer4, 121001808, "CC(remember):BasicSecureTextField.kt#9igjgp");
                                        zChanged = composer4.changed(zM1465equalsimpl02) | composer4.changedInstance(secureTextFieldController);
                                        ...
                                        basicSecureTextFieldKt$BasicSecureTextField$2$1RememberedValue2 = new BasicSecureTextFieldKt$BasicSecureTextField$2$1(zM1465equalsimpl02, secureTextFieldController, null);
                                    ...
                                    if (scopeUpdateScopeEndRestartGroup == null) {
                                        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.BasicSecureTextFieldKt$BasicSecureTextField$4
                                            ...
                                            public final void invoke(Composer composer5, int i27) {
                                                BasicSecureTextFieldKt.m1308BasicSecureTextFieldJb9bMDk(textFieldState, modifier3, z5, inputTransformation3, textStyle3, keyboardOptions3, keyboardActionHandler3, function22, mutableInteractionSource2, brush2, textFieldDecorator2, i24, c3, composer5, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3), i4);
                                            }
                                        });
                                        return;
                                    }
                                ...
                                if ((i5 & 306783379) == 306783378) {
                                    ...
                                    final boolean zM1465equalsimpl022 = TextObfuscationMode.m1465equalsimpl0(iM1470getRevealLastTypedvTwcZD0, TextObfuscationMode.INSTANCE.m1470getRevealLastTypedvTwcZD0());
                                    Boolean boolValueOf22 = Boolean.valueOf(zM1465equalsimpl022);
                                    ComposerKt.sourceInformationMarkerStart(composer42, 121001808, "CC(remember):BasicSecureTextField.kt#9igjgp");
                                    zChanged = composer42.changed(zM1465equalsimpl022) | composer42.changedInstance(secureTextFieldController2);
                                    ...
                                    basicSecureTextFieldKt$BasicSecureTextField$2$1RememberedValue22 = new BasicSecureTextFieldKt$BasicSecureTextField$2$1(zM1465equalsimpl022, secureTextFieldController2, null);
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier modifierOnPreviewKeyEvent = KeyInputModifierKt.onPreviewKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.text.BasicSecureTextFieldKt.DisableCutCopy.1.1
                            ...
                            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                                return m1309invokeZmokQxo(keyEvent.m4711unboximpl());
                            }

                            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
                            public final Boolean m1309invokeZmokQxo(android.view.KeyEvent keyEvent) {
                                KeyCommand keyCommandMo1336mapZmokQxo = KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo1336mapZmokQxo(keyEvent);
                                return Boolean.valueOf(keyCommandMo1336mapZmokQxo == KeyCommand.COPY || keyCommandMo1336mapZmokQxo == KeyCommand.CUT);
                            }
                        });
