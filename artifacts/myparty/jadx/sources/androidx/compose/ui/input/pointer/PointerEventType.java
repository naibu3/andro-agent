...
public final class PointerEventType {
    ...
    private static final int Unknown = m4811constructorimpl(0);
    private static final int Press = m4811constructorimpl(1);
    private static final int Release = m4811constructorimpl(2);
    private static final int Move = m4811constructorimpl(3);
    private static final int Enter = m4811constructorimpl(4);
    private static final int Exit = m4811constructorimpl(5);
    private static final int Scroll = m4811constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerEventType m4810boximpl(int i) {
        return new PointerEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4811constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4823getUnknown7fucELk() {
            return PointerEventType.Unknown;
        }

        /* renamed from: getPress-7fucELk, reason: not valid java name */
        public final int m4820getPress7fucELk() {
            return PointerEventType.Press;
        }

        /* renamed from: getRelease-7fucELk, reason: not valid java name */
        public final int m4821getRelease7fucELk() {
            return PointerEventType.Release;
        }

        /* renamed from: getMove-7fucELk, reason: not valid java name */
        public final int m4819getMove7fucELk() {
            return PointerEventType.Move;
        }

        /* renamed from: getEnter-7fucELk, reason: not valid java name */
        public final int m4817getEnter7fucELk() {
            return PointerEventType.Enter;
        }

        /* renamed from: getExit-7fucELk, reason: not valid java name */
        public final int m4818getExit7fucELk() {
            return PointerEventType.Exit;
        }

        /* renamed from: getScroll-7fucELk, reason: not valid java name */
        public final int m4822getScroll7fucELk() {
    ...
    public static String m4815toStringimpl(int i) {
        return m4813equalsimpl0(i, Press) ? "Press" : m4813equalsimpl0(i, Release) ? "Release" : m4813equalsimpl0(i, Move) ? "Move" : m4813equalsimpl0(i, Enter) ? ReactEditTextInputConnectionWrapper.ENTER_KEY_VALUE : m4813equalsimpl0(i, Exit) ? "Exit" : m4813equalsimpl0(i, Scroll) ? "Scroll" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
