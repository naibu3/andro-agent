...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM6310getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m6307equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m6307equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m6328isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m6328isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM6309getTypeUIouoOA = TextUnit.m6309getTypeUIouoOA(textIndent.getFirstLine());
            float fM6310getValueimpl2 = 0.0f;
            if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6343getSpUIouoOA())) {
                fM6310getValueimpl = density.mo711toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM6310getValueimpl = TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6342getEmUIouoOA()) ? TextUnit.m6310getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM6309getTypeUIouoOA2 = TextUnit.m6309getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA2, TextUnitType.INSTANCE.m6343getSpUIouoOA())) {
                fM6310getValueimpl2 = density.mo711toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA2, TextUnitType.INSTANCE.m6342getEmUIouoOA())) {
                fM6310getValueimpl2 = TextUnit.m6310getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM6310getValueimpl), (int) Math.ceil(fM6310getValueimpl2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m5883setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM5878resolveLineHeightInPxo2QH7mI = m5878resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5878resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM5878resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m5991isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5992isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m5884setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM5878resolveLineHeightInPxo2QH7mI = m5878resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5878resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM5878resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m5878resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM6310getValueimpl;
        long jM6309getTypeUIouoOA = TextUnit.m6309getTypeUIouoOA(j);
        if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6343getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo711toPxR2X_6o(j);
            }
            fM6310getValueimpl = TextUnit.m6310getValueimpl(j) / TextUnit.m6310getValueimpl(density.mo715toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6342getEmUIouoOA())) {
                return Float.NaN;
            }
            fM6310getValueimpl = TextUnit.m6310getValueimpl(j);
        }
        return fM6310getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM5877createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM5877createLetterSpacingSpaneAf_CNQ = m5877createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM5877createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m5880setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m5881setColorRPmYEkk(spannable, item.m5552getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m5882setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m5879setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m5877createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM6309getTypeUIouoOA = TextUnit.m6309getTypeUIouoOA(j);
        if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6343getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo711toPxR2X_6o(j));
        }
        if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6342getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6310getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m6338equalsimpl0(TextUnit.m6309getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6343getSpUIouoOA()) || TextUnitType.m6338equalsimpl0(TextUnit.m6309getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6342getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m3711toArgb8_81llA(shadow.getColor()), Offset.m3416getXimpl(shadow.getOffset()), Offset.m3417getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m5879setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m3711toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m5882setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM6309getTypeUIouoOA = TextUnit.m6309getTypeUIouoOA(j);
        if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6343getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo711toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m6338equalsimpl0(jM6309getTypeUIouoOA, TextUnitType.INSTANCE.m6342getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m6310getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m5881setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m3711toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m5880setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m5896unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m5881setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m5635getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m5634getFontStyle4Lr2A7w(), textStyle.m5635getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM5709boximpl, FontSynthesis.m5720boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5729getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
}
