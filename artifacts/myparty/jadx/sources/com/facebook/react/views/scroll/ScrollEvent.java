...
public final class ScrollEvent extends Event<ScrollEvent> {
    ...
    protected WritableMap getEventMap() {
        ...
        readableMapBuilder.put("top", AudioStats.AUDIO_AMPLITUDE_NONE);
        readableMapBuilder.put("bottom", AudioStats.AUDIO_AMPLITUDE_NONE);
        readableMapBuilder.put("left", AudioStats.AUDIO_AMPLITUDE_NONE);
        readableMapBuilder.put("right", AudioStats.AUDIO_AMPLITUDE_NONE);
        ...
        readableMapBuilder2.put(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, PixelUtil.toDIPFromPixel(this.scrollY));
        ...
        readableMapBuilder5.put(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, PixelUtil.toDIPFromPixel(this.yVelocity));
