...
public final class DragGestureDetectorCopyKt {
    ...
    */
    public static final Object m1878awaitHorizontalPointerSlopOrCancellationgDDlDlE(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        ...
        if (i4 == 0) {
            ...
            if (m1880isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
                return null;
            }
            float fM1881pointerSlopE8SPZFQ = m1881pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
            ...
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.F$1 = fM3416getXimpl;
        ...
        if (i4 != 1) {
            ...
            if (objAwaitPointerEvent$default != coroutine_suspended) {
                ...
                if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
                    ...
                    fM3416getXimpl = (Offset.m3416getXimpl(pointerInputChange.getPosition()) - Offset.m3416getXimpl(pointerInputChange.getPreviousPosition())) + f3;
                    if (Math.abs(fM3416getXimpl) < f2) {
                        ...
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.F$1 = fM3416getXimpl;
                        ...
                        function22.invoke(pointerInputChange, Boxing.boxFloat(fM3416getXimpl - (Math.signum(fM3416getXimpl) * f2)));
                        if (pointerInputChange.isConsumed()) {
    ...
    private static final Object m1879awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        float f2;
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float fFloatValue = f + (function1.invoke(Offset.m3405boximpl(pointerInputChange3.getPosition())).floatValue() - function1.invoke(Offset.m3405boximpl(pointerInputChange3.getPreviousPosition())).floatValue());
                if (Math.abs(fFloatValue) < fM1881pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(fFloatValue - (Math.signum(fFloatValue) * fM1881pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {
    ...
    private static final boolean m1880isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        PointerInputChange pointerInputChange;
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        boolean z = false;
    ...
    public static final float m1881pointerSlopE8SPZFQ(ViewConfiguration viewConfiguration, int i) {
