...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3405boximpl(Offset.INSTANCE.m3432getZeroF1C5BW0()), null, 2, null);
            ...
            this.placementScopeInvalidator = ObservableScopeInvalidator.m1197constructorimpl$default(null, 1, null);
            this.measurementScopeInvalidator = ObservableScopeInvalidator.m1197constructorimpl$default(null, 1, null);
    ...
    public final long m1268getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m1270setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m3405boximpl(j));
    }
    ...
    public final float performScroll(float delta) {
        ...
        if (value.tryToApplyScrollWithoutRemeasure(-i)) {
            ...
            ObservableScopeInvalidator.m1201invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        return Math.min(this.density.mo712toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m1269setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m1266getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final void snapToItem$foundation_release(int page, float offsetFraction, boolean forceRemeasure) {
        ...
        ObservableScopeInvalidator.m1201invalidateScopeimpl(this.measurementScopeInvalidator);
    }

    /* renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation_release, reason: not valid java name */
    public final MutableState<Unit> m1265getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    static final class C04051 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C04051(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C04051(null), 3, null);
        }
    ...
    */
    public final Object animateScrollToPage(int i, float f, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        ...
        if (i2 == 0) {
            ...
            anonymousClass12.L$1 = animationSpec;
        ...
        animationSpec = (AnimationSpec) anonymousClass12.L$1;
        pagerState = (PagerState) anonymousClass12.L$0;
        ResultKt.throwOnFailure(obj);
    ...
    */
    static /* synthetic */ Object scroll$suspendImpl(PagerState pagerState, MutatePriority mutatePriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C04061) {
            ...
            if ((c04061.label & Integer.MIN_VALUE) != 0) {
                ...
                c04061 = pagerState.new C04061(continuation);
            }
        }
        Object obj = c04061.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c04061.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c04061.L$0 = pagerState;
            c04061.L$1 = mutatePriority;
            c04061.L$2 = function2;
            c04061.label = 1;
            if (pagerState.awaitScrollDependencies(c04061) != coroutine_suspended) {
            }
            return coroutine_suspended;
        }
        if (i != 1) {
            ...
            pagerState = (PagerState) c04061.L$0;
            ResultKt.throwOnFailure(obj);
            pagerState.setProgrammaticScrollTargetPage(-1);
            return Unit.INSTANCE;
        }
        function2 = (Function2) c04061.L$2;
        mutatePriority = (MutatePriority) c04061.L$1;
        pagerState = (PagerState) c04061.L$0;
        ResultKt.throwOnFailure(obj);
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
            if (Math.signum(scrollDelta) == Math.signum(-Offset.m3417getYimpl(m1268getUpDownDifferenceF1C5BW0$foundation_release()))) {
                return true;
            }
        } else if (Math.signum(scrollDelta) == Math.signum(-Offset.m3416getXimpl(m1268getUpDownDifferenceF1C5BW0$foundation_release()))) {
            return true;
        }
    ...
    private final boolean isNotGestureAction() {
        return ((int) Offset.m3416getXimpl(m1268getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3417getYimpl(m1268getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
    ...
    private final void notifyPrefetch(float delta, PagerLayoutInfo info) {
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (index != this.indexToPrefetch) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m1192schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
            if (z) {
