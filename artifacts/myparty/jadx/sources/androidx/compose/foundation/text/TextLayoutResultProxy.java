...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1429getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1430getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1430getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m1428coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m5574getOffsetForPositionk4lQ0M(m1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m3417getYimpl(m1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1428coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m1431isPositionOnTextk4lQ0M(long offset) {
        long jM1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1428coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m3417getYimpl(jM1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release));
        return Offset.m3416getXimpl(jM1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m3416getXimpl(jM1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        return layoutCoordinates3 == null ? offset : layoutCoordinates2.mo5002localPositionOfR5De75A(layoutCoordinates3, offset);
    }

    /* renamed from: translateInnerToDecorationCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1433translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 == null) {
            return offset;
        ...
        LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
        return layoutCoordinates3 == null ? offset : layoutCoordinates3.mo5002localPositionOfR5De75A(layoutCoordinates2, offset);
    }
    ...
    */
    private final long m1428coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        ...
        return TextLayoutResultProxyKt.m1435coerceIn3MmeM6k(j, zero);
    }
}
