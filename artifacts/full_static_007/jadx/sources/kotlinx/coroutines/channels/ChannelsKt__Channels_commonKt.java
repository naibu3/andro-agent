...
final /* synthetic */ class ChannelsKt__Channels_commonKt {
    ...
    static final class C02821<E> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
    ...
    public static final <E> Object toList(ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c02821.L$0 = list;
                c02821.L$1 = list2;
                c02821.L$2 = receiveChannel2;
                c02821.L$3 = it;
                c02821.label = 1;
                objHasNext = it.hasNext(c02821);
                if (objHasNext != coroutine_suspended) {
                }
            } catch (Throwable th2) {
                receiveChannel2 = receiveChannel;
            ...
            it = (ChannelIterator) c02821.L$3;
            ReceiveChannel<? extends E> receiveChannel3 = (ReceiveChannel) c02821.L$2;
            List list3 = (List) c02821.L$1;
            list = (List) c02821.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                List list4 = list3;
                if (!((Boolean) obj).booleanValue()) {
