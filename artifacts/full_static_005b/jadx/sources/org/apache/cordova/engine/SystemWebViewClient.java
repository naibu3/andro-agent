...
public class SystemWebViewClient extends WebViewClient {
    ...
    public SystemWebViewClient(final SystemWebViewEngine systemWebViewEngine) {
        ...
        httpAllowed.addPathHandler("/", new WebViewAssetLoader.PathHandler() { // from class: org.apache.cordova.engine.SystemWebViewClient$$ExternalSyntheticLambda0
            ...
            public final WebResourceResponse handle(String str) {
                return this.f$0.m1858lambda$new$0$orgapachecordovaengineSystemWebViewClient(systemWebViewEngine, str);
            }
        });
    ...
    /* synthetic */ WebResourceResponse m1858lambda$new$0$orgapachecordovaengineSystemWebViewClient(SystemWebViewEngine systemWebViewEngine, String str) throws IOException {
    ...
    public void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        try {
            if ((this.parentEngine.f14cordova.getActivity().getPackageManager().getApplicationInfo(this.parentEngine.f14cordova.getActivity().getPackageName(), 128).flags & 2) != 0) {
    ...
    @Override // android.webkit.WebViewClient
    public WebResourceResponse shouldInterceptRequest(WebView webView, String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        try {
