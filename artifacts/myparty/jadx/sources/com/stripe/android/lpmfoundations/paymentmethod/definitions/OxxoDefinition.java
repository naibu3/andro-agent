...
public final class OxxoDefinition implements PaymentMethodDefinition {
    ...
    public static final OxxoDefinition INSTANCE = new OxxoDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Oxxo;
