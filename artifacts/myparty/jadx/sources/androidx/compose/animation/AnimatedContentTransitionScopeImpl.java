...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6279boximpl(IntSize.INSTANCE.m6292getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo380slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m399isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6287getWidthimpl(this.m398getCurrentSizeYbymL2g()) - IntOffset.m6245getXimpl(this.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m398getCurrentSizeYbymL2g()))));
            }
        }) : m400isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6245getXimpl(this.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m398getCurrentSizeYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m394getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6286getHeightimpl(this.m398getCurrentSizeYbymL2g()) - IntOffset.m6246getYimpl(this.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m398getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m389getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6246getYimpl(this.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m398getCurrentSizeYbymL2g()))) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m399isLeftgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m391getLeftDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m393getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m390getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl;
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m400isRightgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m392getRightDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m393getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m390getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m397calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3262alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo381slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m399isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6245getXimpl(this.this$0.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g()))) - i));
            }
        }) : m400isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6245getXimpl(this.this$0.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6287getWidthimpl(packedValue)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m394getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6246getYimpl(this.this$0.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m385equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m389getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6246getYimpl(this.this$0.m397calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6286getHeightimpl(packedValue)));
            }
    ...
    public final long m401getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m402setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m6279boximpl(j));
    }
    ...
    public final long m398getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m401getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo403measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo462createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long packedValue2 = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue3 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo462createAnimationSpecTemP2vQ = value.mo462createAnimationSpecTemP2vQ(packedValue2, packedValue3)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo462createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6279boximpl(m404invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m404invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6292getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight());
            } else {
                packedValue = stateAnimate.getValue().getPackedValue();
            }
            int iM6287getWidthimpl = IntSize.m6287getWidthimpl(packedValue);
            int iM6286getHeightimpl = IntSize.m6286getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.layout$default(measureScope, iM6287getWidthimpl, iM6286getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m5057place70tqf50$default(placementScope, placeableMo4993measureBRTryo0, animatedContentTransitionScopeImpl3.getContentAlignment().mo3262alignKFBX0sM(IntSizeKt.IntSize(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
