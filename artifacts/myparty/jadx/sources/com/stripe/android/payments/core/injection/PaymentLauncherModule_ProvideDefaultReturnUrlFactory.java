...
public final class PaymentLauncherModule_ProvideDefaultReturnUrlFactory implements Factory<DefaultReturnUrl> {
    ...
    public static PaymentLauncherModule_ProvideDefaultReturnUrlFactory create(PaymentLauncherModule paymentLauncherModule, javax.inject.Provider<Context> provider) {
        return new PaymentLauncherModule_ProvideDefaultReturnUrlFactory(paymentLauncherModule, Providers.asDaggerProvider(provider));
    }
