    ...
    public static final boolean requestFocus(FocusRequesterModifierNode focusRequesterModifierNode) {
        ...
        while (node != null) {
            if (node instanceof FocusTargetNode) {
                ...
                return focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() ? FocusTransactionsKt.requestFocus(focusTargetNode) : TwoDimensionalFocusSearchKt.m3377findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m3335getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
            ...
            if ((node.getKindSet() & iM5228constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                int i = 0;
                    ...
                    if ((nodePop.getKindSet() & iM5228constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                return focusTargetNode2.fetchFocusProperties$ui_release().getCanFocus() ? FocusTransactionsKt.requestFocus(focusTargetNode2) : TwoDimensionalFocusSearchKt.m3377findChildCorrespondingToFocusEnterOMvw8(focusTargetNode2, FocusDirection.INSTANCE.m3335getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                                    @Override // kotlin.jvm.functions.Function1
                            ...
                            if ((nodePop.getKindSet() & iM5228constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                ...
                                for (Modifier.Node delegate2 = ((DelegatingNode) nodePop).getDelegate(); delegate2 != null; delegate2 = delegate2.getChild()) {
                                    if ((delegate2.getKindSet() & iM5228constructorimpl) != 0) {
                                        i2++;
                                        if (i2 == 1) {
                                            nodePop = delegate2;
                                        } else {
