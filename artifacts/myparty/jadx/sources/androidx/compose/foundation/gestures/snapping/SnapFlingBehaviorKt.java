...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m6117constructorimpl(400);
    ...
    */
    public static final Object animateWithTarget(final ScrollScope scrollScope, float f, final float f2, AnimationState<Float, AnimationVector1D> animationState, AnimationSpec<Float> animationSpec, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        Ref.FloatRef floatRef;
        float f4;
        if (continuation instanceof C03521) {
            c03521 = (C03521) continuation;
            if ((c03521.label & Integer.MIN_VALUE) != 0) {
                c03521.label -= Integer.MIN_VALUE;
            } else {
                c03521 = new C03521(continuation);
            }
        }
        C03521 c035212 = c03521;
        Object obj = c035212.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c035212.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c035212.L$0 = animationState;
            c035212.L$1 = floatRef2;
            f3 = f;
            c035212.F$0 = f3;
            c035212.F$1 = fFloatValue;
            c035212.label = 1;
            if (SuspendAnimationKt.animateTo(animationState, fBoxFloat, animationSpec, z, function12, c035212) == coroutine_suspended) {
                return coroutine_suspended;
            }
            ...
            f4 = c035212.F$1;
            float f5 = c035212.F$0;
            floatRef = (Ref.FloatRef) c035212.L$1;
            AnimationState<Float, AnimationVector1D> animationState3 = (AnimationState) c035212.L$0;
            ResultKt.throwOnFailure(obj);
            f3 = f5;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final float m866calculateFinalOffsetFhqu1e0(int i, float f, float f2) {
        if (FinalSnappingItem.m859equalsimpl0(i, FinalSnappingItem.INSTANCE.m863getClosestItembbeMdSM())) {
            if (Math.abs(f2) <= Math.abs(f)) {
                f = f2;
            }
        } else if (!FinalSnappingItem.m859equalsimpl0(i, FinalSnappingItem.INSTANCE.m864getNextItembbeMdSM())) {
            if (!FinalSnappingItem.m859equalsimpl0(i, FinalSnappingItem.INSTANCE.m865getPreviousItembbeMdSM())) {
                f = 0.0f;
            }
        }
