        ...
        if (value instanceof ReadableMap) {
            if (colorPropConverter.supportWideGamut()) {
                ...
                if (readableMap.hasKey("space")) {
                    ...
                    return Color.valueOf(Color.pack((float) readableMap.getDouble(JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR), (float) readableMap.getDouble("g"), (float) readableMap.getDouble("b"), (float) readableMap.getDouble("a"), colorSpace));
                }
            }
