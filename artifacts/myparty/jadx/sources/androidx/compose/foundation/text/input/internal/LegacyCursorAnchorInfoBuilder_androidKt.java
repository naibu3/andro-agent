...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM5600getMinimpl = TextRange.m5600getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM5600getMinimpl, TextRange.m5599getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM5600getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM5599getMaximpl = composition2 != null ? TextRange.m5599getMaximpl(composition2.getPackedValue()) : -1;
            if (iM5600getMinimpl2 >= 0 && iM5600getMinimpl2 < iM5599getMaximpl) {
                builder.setComposingText(iM5600getMinimpl2, textFieldValue.getText().subSequence(iM5600getMinimpl2, iM5599getMaximpl));
                addCharacterBounds(builder, iM5600getMinimpl2, iM5599getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float fCoerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, IntSize.m6287getWidthimpl(textLayoutResult.getSize()));
    ...
    */
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m5467fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(iOriginalToTransformed, iOriginalToTransformed2), fArr, 0);
