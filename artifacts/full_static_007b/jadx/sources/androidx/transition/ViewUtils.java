...
class ViewUtils {
    ...
    static void setTransitionVisibility(View view, int visibility) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    static void setLeftTopRightBottom(View v, int left, int top, int right, int bottom) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
