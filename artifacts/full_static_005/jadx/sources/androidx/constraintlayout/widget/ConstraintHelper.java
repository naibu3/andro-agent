...
public abstract class ConstraintHelper extends View {
    ...
    public void updatePreLayout(ConstraintLayout container) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        ...
        for (int i = 0; i < this.mCount; i++) {
            int id2 = this.mIds[i];
            View view = container.getViewById(id2);
            if (view == null && (foundId = findId(container, (candidate = this.mMap.get(Integer.valueOf(id2))))) != 0) {
                this.mIds[i] = foundId;
        ...
        if (child != null) {
            ...
            if (constraint.layout.mReferenceIds != null) {
                for (int i = 0; i < constraint.layout.mReferenceIds.length; i++) {
                    ...
                    ConstraintWidget widget = mapIdToWidget.get(id2);
                    if (widget != null) {
                        child.add(widget);
                    }
                }
