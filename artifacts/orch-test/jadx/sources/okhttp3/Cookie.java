...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public final Cookie parse$okhttp(long currentTimeMillis, HttpUrl url, String setCookie) {
            ...
            int cookiePairEnd2 = Util.delimiterOffset$default(setCookie2, ';', 0, 0, 6, (Object) null);
            int pairEqualsSign = Util.delimiterOffset$default(setCookie2, '=', 0, cookiePairEnd2, 2, (Object) null);
            if (pairEqualsSign == cookiePairEnd2) {
                return null;
            }
            ...
            if (!(cookieName.length() == 0) && Util.indexOfControlOrNonAscii(cookieName) == -1) {
                String cookieValue = Util.trimSubstring(setCookie2, pairEqualsSign + 1, cookiePairEnd2);
                ...
                for (int limit2 = setCookie2.length(); pos2 < limit2; limit2 = limit) {
                    ...
                    if (StringsKt.equals(attributeName, "expires", true)) {
                        try {
                            ...
                            limit = limit2;
                            cookiePairEnd = cookiePairEnd2;
                            try {
                                long expiresAt2 = companion.parseExpires(attributeValue, 0, length);
                ...
                return new Cookie(cookieName, cookieValue, expiresAt, domain2, path2, secureOnly, httpOnly, persistent, hostOnly, null);
            }
            return null;
        }
