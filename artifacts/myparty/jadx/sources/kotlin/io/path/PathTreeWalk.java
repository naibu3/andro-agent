...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    static final class C12391 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C12391 c12391 = PathTreeWalk.this.new C12391(continuation);
            c12391.L$0 = obj;
            return c12391;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C12391) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    private final Iterator<Path> dfsIterator() {
        return SequencesKt.iterator(new C12391(null));
    }
