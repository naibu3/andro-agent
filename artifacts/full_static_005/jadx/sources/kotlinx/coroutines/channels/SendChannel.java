...
public interface SendChannel<E> {
    ...
    Object mo1589trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1589trySendJP2dKIU(e);
            if (ChannelResult.m1604isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1598exceptionOrNullimpl = ChannelResult.m1598exceptionOrNullimpl(result);
