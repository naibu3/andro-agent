...
public final class VINParsedResult extends ParsedResult {
    ...
    public String getDisplayResult() {
        ...
        sb.append(this.worldManufacturerID).append(CardNumberConfig.SEPARATOR);
        sb.append(this.vehicleDescriptorSection).append(CardNumberConfig.SEPARATOR);
        sb.append(this.vehicleIdentifierSection).append('\n');
        String str = this.countryCode;
        if (str != null) {
            sb.append(str).append(CardNumberConfig.SEPARATOR);
        }
        sb.append(this.modelYear).append(CardNumberConfig.SEPARATOR);
        sb.append(this.plantCode).append(CardNumberConfig.SEPARATOR);
