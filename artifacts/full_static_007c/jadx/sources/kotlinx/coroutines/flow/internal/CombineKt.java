        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    holder = resultChannel.mo1633receiveCatchingJP2dKIU(anonymousClass2);
                    if (holder == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    latestValues2 = latestValues;
                    element = (IndexedValue) ChannelResult.m1645getOrNullimpl(holder);
                    if (element != null) {
                        return Unit.INSTANCE;
                    }
                    do {
                        ...
                        if (lastReceivedEpoch[index] != remainingAbsentValues) {
                            ...
                            element = (IndexedValue) ChannelResult.m1645getOrNullimpl(resultChannel.mo1634tryReceivePtdJZtk());
                        }
                ...
                case 3:
                    ...
                    resultChannel = (Channel) anonymousClass2.L$1;
                    Object[] latestValues5 = (Object[]) anonymousClass2.L$0;
                    ResultKt.throwOnFailure($result);
