...
public final class LinkCardBrandDefinition implements PaymentMethodDefinition {
    ...
    private LinkCardBrandDefinition() {
    }
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.FinancialConnectionsSdk, AddPaymentMethodRequirement.LinkCardBrand});
    }

    @Override // com.stripe.android.lpmfoundations.paymentmethod.PaymentMethodDefinition
    public UiDefinitionFactory uiDefinitionFactory() {
        return LinkCardBrandDefinitionFactory.INSTANCE;
    }
}
