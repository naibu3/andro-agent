...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3405boximpl(Offset.INSTANCE.m3432getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3405boximpl(Offset.INSTANCE.m3432getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1715invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1715invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long jMo5001getSizeYbymL2g = layoutCoordinates.mo5001getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m6287getWidthimpl(jMo5001getSizeYbymL2g), IntSize.m6286getHeightimpl(jMo5001getSizeYbymL2g));
                if (!SelectionManagerKt.m1720containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1560coerceIn3MmeM6k(j, rect);
                }
                long jM1699convertToContainerCoordinatesR5De75A = SelectionManager.this.m1699convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m3435isSpecifiedk4lQ0M(jM1699convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1706startSelection9KIMszo(jM1699convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1716invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1716invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1699convertToContainerCoordinatesR5De75A = SelectionManager.this.m1699convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1699convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1699convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1714updateSelectionqNKwrvQ$foundation_release(Offset.m3405boximpl(jM1699convertToContainerCoordinatesR5De75A), jM1699convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1701setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if (selection != null && (start = selection.getStart()) != null && j == start.getSelectableId()) {
                    SelectionManager.this.m1705setStartHandlePosition_kEHs6E(null);
                }
                ...
                if (selection2 != null && (end = selection2.getEnd()) != null && j == end.getSelectableId()) {
                    SelectionManager.this.m1704setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().contains(j)) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1717invokeZmokQxo(keyEvent.m4711unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1717invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1722isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM3405boximpl = layoutCoordinates != null ? Offset.m3405boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM3405boximpl)) {
            return;
        }
        this.previousPosition = offsetM3405boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1702setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m3405boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1709getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1703setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m3405boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1710getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1705setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1712getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1704setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1711getEndHandlePosition_m7T9E() {
    ...
    public final void m1701setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1708getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || (layoutCoordinates2 == null && layoutCoordinates3 == null)) {
            m1705setStartHandlePosition_kEHs6E(null);
            m1704setEndHandlePosition_kEHs6E(null);
            return;
        }
        Rect rectVisibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        if (layoutCoordinates2 != null) {
            long jMo1668getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1668getHandlePositiondBAh8RU(selection, true);
            if (OffsetKt.m3437isUnspecifiedk4lQ0M(jMo1668getHandlePositiondBAh8RU)) {
                offsetM3405boximpl = null;
            } else {
                offsetM3405boximpl = Offset.m3405boximpl(layoutCoordinates.mo5002localPositionOfR5De75A(layoutCoordinates2, jMo1668getHandlePositiondBAh8RU));
                long packedValue = offsetM3405boximpl.getPackedValue();
                if (getDraggingHandle() != Handle.SelectionStart && !SelectionManagerKt.m1720containsInclusiveUv8p0NA(rectVisibleBounds, packedValue)) {
                }
            }
        }
        m1705setStartHandlePosition_kEHs6E(offsetM3405boximpl);
        if (layoutCoordinates3 != null) {
            long jMo1668getHandlePositiondBAh8RU2 = anchorSelectable$foundation_release2.mo1668getHandlePositiondBAh8RU(selection, false);
            if (!OffsetKt.m3437isUnspecifiedk4lQ0M(jMo1668getHandlePositiondBAh8RU2)) {
                Offset offsetM3405boximpl2 = Offset.m3405boximpl(layoutCoordinates.mo5002localPositionOfR5De75A(layoutCoordinates3, jMo1668getHandlePositiondBAh8RU2));
                long packedValue2 = offsetM3405boximpl2.getPackedValue();
                if (getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m1720containsInclusiveUv8p0NA(rectVisibleBounds, packedValue2)) {
                    offset = offsetM3405boximpl2;
                }
            }
        }
        m1704setEndHandlePosition_kEHs6E(offset);
    }
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.showMenu$default(textToolbar, contentRect, isNonEmptySelection$foundation_release() ? new C04611(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C04622(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C04611 extends FunctionReferenceImpl implements Function0<Unit> {
        C04611(Object obj) {
    ...
    /* synthetic */ class C04622 extends FunctionReferenceImpl implements Function0<Unit> {
        C04622(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rectM3453translatek4lQ0M = rectIntersect.m3453translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(rectM3453translatek4lQ0M, 0.0f, 0.0f, 0.0f, rectM3453translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1397onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1712getStartHandlePosition_m7T9E = isStartHandle ? this.m1712getStartHandlePosition_m7T9E() : this.m1711getEndHandlePosition_m7T9E();
                if (offsetM1712getStartHandlePosition_m7T9E != null) {
                    offsetM1712getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long jMo1668getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1668getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m3437isUnspecifiedk4lQ0M(jMo1668getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1683getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1683getAdjustedCoordinatesk4lQ0M(jMo1668getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1701setCurrentDragPosition_kEHs6E(Offset.m3405boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo5002localPositionOfR5De75A(layoutCoordinates, jM1683getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1399onStartk4lQ0M(long startPoint) {
                ...
                long jMo1668getHandlePositiondBAh8RU = selectable2.mo1668getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3437isUnspecifiedk4lQ0M(jMo1668getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1683getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1683getAdjustedCoordinatesk4lQ0M(jMo1668getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1702setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo5002localPositionOfR5De75A(layoutCoordinates, jM1683getAdjustedCoordinatesk4lQ0M));
                this.m1703setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3432getZeroF1C5BW0());
            }
            ...
            public void mo1398onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1703setDragTotalDistancek4lQ0M(Offset.m3421plusMKHz9U(selectionManager.m1710getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM3421plusMKHz9U = Offset.m3421plusMKHz9U(this.m1709getDragBeginPositionF1C5BW0$foundation_release(), this.m1710getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1714updateSelectionqNKwrvQ$foundation_release(Offset.m3405boximpl(jM3421plusMKHz9U), this.m1709getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1702setDragBeginPositionk4lQ0M(jM3421plusMKHz9U);
                    this.m1703setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3432getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1701setCurrentDragPosition_kEHs6E(null);
            }
    ...
    static final class C04582 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04582(Function1<? super Offset, Unit> function1, Continuation<? super C04582> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04582 c04582 = new C04582(this.$onTap, continuation);
            c04582.L$0 = obj;
            return c04582;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m3405boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C04582(function1, null), continuation);
    ...
    static final class C04601 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04601(Function0<Unit> function0, Continuation<? super C04601> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04601 c04601 = SelectionManager.this.new C04601(this.$block, continuation);
            c04601.L$0 = obj;
            return c04601;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C04601) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public final void m1718invokek4lQ0M(long j) {
                        function0.invoke();
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C04601(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1699convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo5002localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1706startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1713updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3431getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1714updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1713updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1713updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1701setCurrentDragPosition_kEHs6E(Offset.m3405boximpl(position));
        SelectionLayout selectionLayoutM1700getSelectionLayoutWko1d7g = m1700getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1700getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1700getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1700getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1700getSelectionLayoutWko1d7g;
        return true;
    }

    /* renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1700getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
    ...
    public final void m1707contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m5596getCollapsedimpl(selection.m1674toTextRanged9O1mEE()) : true) {
            m1706startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
