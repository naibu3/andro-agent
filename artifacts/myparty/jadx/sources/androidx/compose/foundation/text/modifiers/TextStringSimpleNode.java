...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6055getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m1662updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1655updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1655updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult textLayoutResultSlowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m5622mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo1876invoke0d7_KjU() : Color.INSTANCE.m3693getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM1653layoutWithConstraintsK40F9xA = layoutCache.m1653layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM1653layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(Constraints.INSTANCE.m6079fitPrioritizingWidthZbe2FdA(IntSize.m6287getWidthimpl(layoutSize), IntSize.m6287getWidthimpl(layoutSize), IntSize.m6286getHeightimpl(layoutSize), IntSize.m6286getHeightimpl(layoutSize)));
        int iM6287getWidthimpl = IntSize.m6287getWidthimpl(layoutSize);
        int iM6286getHeightimpl = IntSize.m6286getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6287getWidthimpl, iM6286getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            if (didOverflow) {
                float fM6287getWidthimpl = IntSize.m6287getWidthimpl(layoutCache.getLayoutSize());
                float fM6286getHeightimpl = IntSize.m6286getHeightimpl(layoutCache.getLayoutSize());
                canvas.save();
                Canvas.m3629clipRectN_I0leg$default(canvas, 0.0f, 0.0f, fM6287getWidthimpl, fM6286getHeightimpl, 0, 16, null);
            }
            try {
                ...
                if (brush != null) {
                    Paragraph.m5477painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ...
                    Paragraph.m5475paintLG529CI$default(paragraph, canvas, jMo1876invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
            } finally {
                if (didOverflow) {
                    canvas.restore();
