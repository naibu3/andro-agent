...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m857constructorimpl(0);
    private static final int NextItem = m857constructorimpl(1);
    private static final int PreviousItem = m857constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m856boximpl(int i) {
    ...
    public static boolean m858equalsimpl(int i, Object obj) {
        return (obj instanceof FinalSnappingItem) && i == ((FinalSnappingItem) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m859equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m860hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m858equalsimpl(this.value, obj);
    }
