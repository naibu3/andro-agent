    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo1494getDeclarationDescriptor();
                classDescriptor = classifierDescriptorMo1494getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1494getDeclarationDescriptor : null;
