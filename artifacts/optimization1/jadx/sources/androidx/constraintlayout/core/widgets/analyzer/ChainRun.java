...
public class ChainRun extends WidgetRun {
    ...
    */
    public void update(Dependency dependency) {
        ...
        if (size3 > distance) {
            position4 = isInRtl3 ? position4 + ((int) (((size3 - distance) / 2.0f) + 0.5f)) : position4 - ((int) (((size3 - distance) / 2.0f) + 0.5f));
        }
        if (numMatchConstraints2 > 0) {
            int matchConstraintsDimension = (int) (((distance - size3) / numMatchConstraints2) + 0.5f);
            int appliedLimits = 0;
            int i6 = 0;
            while (i6 < count) {
                ...
                if (run2.widget.getVisibility() == 8) {
                    ...
                    if (weights2 > 0.0f) {
                        dimension2 = (int) ((((distance - size3) * run2.widget.mWeight[chainRun.orientation]) / weights2) + 0.5f);
                    }
                    ...
                    if (chainRun.orientation == 0) {
                        ...
                        int i7 = size3;
                        size2 = run2.widget.mMatchConstraintMinWidth;
                        max = max2;
                        size = i7;
                    } else {
                        int max3 = run2.widget.mMatchConstraintMaxHeight;
                        int i8 = size3;
                        size2 = run2.widget.mMatchConstraintMinHeight;
                        max = max3;
                        size = i8;
                    }
                    numMatchConstraints = numMatchConstraints2;
                    int numMatchConstraints3 = run2.matchConstraintsType;
                    weights = weights2;
                    if (numMatchConstraints3 == 1) {
            ...
            isInRtl = isInRtl3;
            int size4 = size3;
            int numMatchConstraints4 = numMatchConstraints2;
            f = 0.5f;
            if (appliedLimits <= 0) {
                size3 = size4;
                numMatchConstraints2 = numMatchConstraints4;
            } else {
                numMatchConstraints2 = numMatchConstraints4 - appliedLimits;
                int size5 = 0;
                for (int i9 = 0; i9 < count; i9++) {
                    WidgetRun run3 = chainRun.widgets.get(i9);
