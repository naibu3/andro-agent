...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m10654boximpl(Result.m9125isSuccessimpl(objM9118constructorimpl) ? ChannelResult.INSTANCE.m10669successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m10667closedJP2dKIU(Result.m9121exceptionOrNullimpl(objM9118constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo10639trySendJP2dKIU = sendChannel.mo10639trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m10664isSuccessimpl(sendChannel.mo10639trySendJP2dKIU(obj))) {
            return;
        }
