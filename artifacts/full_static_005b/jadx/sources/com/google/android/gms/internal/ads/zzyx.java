...
final class zzyx {
    ...
    public final boolean zzd(zzk zzkVar, zzan zzanVar) throws IllegalArgumentException {
        int iZzh = zzgd.zzh(("audio/eac3-joc".equals(zzanVar.zzn) && zzanVar.zzA == 16) ? 12 : zzanVar.zzA);
        if (iZzh == 0) {
            return false;
        }
