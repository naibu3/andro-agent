    ...
    private String sideToString(int side) {
        switch (side) {
            ...
            case 5:
                return "baseline";
            case 6:
                return Generated.Actions.START;
            case 7:
                return "end";
            default:
    ...
    */
    ...
    static String getDebugName(int v) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(Constants.USER_ID_SEPARATOR) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", Generated.Actions.START, "end"}, -1);
