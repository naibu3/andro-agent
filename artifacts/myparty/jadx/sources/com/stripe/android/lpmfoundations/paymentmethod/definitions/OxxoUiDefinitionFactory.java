...
final class OxxoUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod(OxxoDefinition.INSTANCE.getType().code, (String) null, R.string.stripe_paymentsheet_payment_method_oxxo, R.drawable.stripe_ic_paymentsheet_pm_oxxo, (Integer) null, false, (String) null, (String) null, (ResolvableString) null, (Integer) null, 770, (DefaultConstructorMarker) null);
    }
}
