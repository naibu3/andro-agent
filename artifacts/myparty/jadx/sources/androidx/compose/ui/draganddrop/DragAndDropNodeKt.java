...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m3290containsUv8p0NA(DragAndDropModifierNode dragAndDropModifierNode, long j) {
        ...
        long jMo5001getSizeYbymL2g = coordinates.mo5001getSizeYbymL2g();
        int iM6287getWidthimpl = IntSize.m6287getWidthimpl(jMo5001getSizeYbymL2g);
        int iM6286getHeightimpl = IntSize.m6286getHeightimpl(jMo5001getSizeYbymL2g);
        long jPositionInRoot = LayoutCoordinatesKt.positionInRoot(coordinates);
        float fM3416getXimpl = Offset.m3416getXimpl(jPositionInRoot);
        float fM3417getYimpl = Offset.m3417getYimpl(jPositionInRoot);
        float f = iM6287getWidthimpl + fM3416getXimpl;
        float f2 = iM6286getHeightimpl + fM3417getYimpl;
        float fM3416getXimpl2 = Offset.m3416getXimpl(j);
        if (fM3416getXimpl <= fM3416getXimpl2 && fM3416getXimpl2 <= f) {
            float fM3417getYimpl2 = Offset.m3417getYimpl(j);
            if (fM3417getYimpl <= fM3417getYimpl2 && fM3417getYimpl2 <= f2) {
                return true;
            }
        }
        return false;
