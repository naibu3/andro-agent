...
public final class Motion {
    ...
    public static boolean m501equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m507unboximpl();
    }
    ...
    public static final long m499copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m500copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m503getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m504getVelocityimpl(j);
        }
        return m499copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl, reason: not valid java name */
    public static final float m503getValueimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m504getVelocityimpl(long j) {
