...
public enum zzhbe {
    ...
    static {
        zzhbe[] zzhbeVarArrValues = values();
        zzZ = new zzhbe[zzhbeVarArrValues.length];
        for (zzhbe zzhbeVar : zzhbeVarArrValues) {
            zzZ[zzhbeVar.zzac] = zzhbeVar;
        }
    }

    zzhbe(int i, int i2, zzhcf zzhcfVar) {
        this.zzac = i;
        this.zzab = zzhcfVar;
        int i3 = i2 - 1;
        if (i3 == 1 || i3 == 3) {
