...
public /* synthetic */ class DataAccessNoticeBody$$serializer implements GeneratedSerializer<DataAccessNoticeBody> {
    ...
    public final KSerializer<?>[] childSerializers() {
        return new KSerializer[]{DataAccessNoticeBody.$childSerializers[0]};
    }
    ...
    public final DataAccessNoticeBody deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = DataAccessNoticeBody.$childSerializers;
        int i = 1;
        ...
        return new DataAccessNoticeBody(i, list, null);
    }
    ...
    public final void serialize(Encoder encoder, DataAccessNoticeBody value) {
        ...
        compositeEncoderBeginStructure.encodeSerializableElement(serialDescriptor, 0, DataAccessNoticeBody.$childSerializers[0], value.bullets);
