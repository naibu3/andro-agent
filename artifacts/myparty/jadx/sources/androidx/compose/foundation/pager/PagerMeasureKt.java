...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m1262measurePagerbmk8ZPk(final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, final PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), i8, i5, i4, orientation, -i3, i2 + i4, false, i9, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m6072getMinWidthimpl(j)), Integer.valueOf(Constraints.m6071getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$4
        ...
        final long jConstraints$default = ConstraintsKt.Constraints$default(0, orientation2 == Orientation.Vertical ? Constraints.m6070getMaxWidthimpl(j) : i8, 0, orientation2 != Orientation.Vertical ? Constraints.m6069getMaxHeightimpl(j) : i8, 5, null);
        int i21 = i6;
        int i22 = i7;
        while (i21 > 0 && i22 > 0) {
            i21--;
        ...
        while (i26 < 0 && i21 > 0) {
            int i27 = i21 - 1;
            MeasuredPage measuredPageM1261getAndMeasureSGf7dI0 = m1261getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i27, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation2, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            arrayDeque.add(0, measuredPageM1261getAndMeasureSGf7dI0);
            iMax2 = Math.max(iMax2, measuredPageM1261getAndMeasureSGf7dI0.getCrossAxisSize());
            i26 += iCoerceAtLeast;
            i25 = i25;
            i21 = i27;
        ...
        while (i36 < i && (i33 < iCoerceAtLeast2 || i33 <= 0 || arrayDeque.isEmpty())) {
            ...
            int i39 = i36;
            MeasuredPage measuredPageM1261getAndMeasureSGf7dI02 = m1261getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i39, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            int i40 = i37;
            int i41 = i - 1;
            i33 += i39 == i41 ? i8 : iCoerceAtLeast;
            if (i33 > i28 || i39 == i41) {
                iMax3 = Math.max(iMax3, measuredPageM1261getAndMeasureSGf7dI02.getCrossAxisSize());
                arrayDeque.add(measuredPageM1261getAndMeasureSGf7dI02);
                i20 = i32;
                i37 = i40;
            } else {
                i20 = i39 + 1;
        ...
        if (i33 < i2) {
            ...
            while (i11 < i3 && i12 > 0) {
                int i44 = i12 - 1;
                MeasuredPage measuredPageM1261getAndMeasureSGf7dI03 = m1261getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i44, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                arrayDeque.add(0, measuredPageM1261getAndMeasureSGf7dI03);
                iMax = Math.max(iMax, measuredPageM1261getAndMeasureSGf7dI03.getCrossAxisSize());
                i11 += iCoerceAtLeast;
                i36 = i36;
                i12 = i44;
            }
        ...
        List<MeasuredPage> listCreatePagesBeforeList = createPagesBeforeList(i12, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i49) {
                ...
                return PagerMeasureKt.m1261getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i49, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        ...
        List<MeasuredPage> listCreatePagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque.last()).getIndex(), i, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            ...
            public final MeasuredPage invoke(int i50) {
                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                return PagerMeasureKt.m1261getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i50, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        ...
        int iM6087constrainWidthK40F9xA = ConstraintsKt.m6087constrainWidthK40F9xA(j, orientation == Orientation.Vertical ? iMax4 : i33);
        if (orientation == Orientation.Vertical) {
            iMax4 = i33;
        }
        int iM6086constrainHeightK40F9xA = ConstraintsKt.m6086constrainHeightK40F9xA(j, iMax4);
        int i51 = i10;
        int i52 = i33;
        final List<MeasuredPage> listCalculatePagesOffsets = calculatePagesOffsets(lazyLayoutMeasureScope, arrayDeque, list2, listCreatePagesAfterList, iM6087constrainWidthK40F9xA, iM6086constrainHeightK40F9xA, i52, i2, i13, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (z4) {
        ...
        MeasuredPage measuredPageCalculateNewCurrentPage = calculateNewCurrentPage(orientation == Orientation.Vertical ? iM6086constrainHeightK40F9xA : iM6087constrainWidthK40F9xA, arrayList, i3, i4, iCoerceAtLeast, snapPosition, i);
        ...
        return new PagerMeasureResult(list5, i8, i5, i4, orientation, i24, i31, z, i9, measuredPage, measuredPageCalculateNewCurrentPage, i18 == 0 ? 0.0f : RangesKt.coerceIn((snapPosition2.position(i15, i17, i16, i19, index, i14) - (measuredPageCalculateNewCurrentPage != null ? measuredPageCalculateNewCurrentPage.getOffset() : 0)) / i18, -0.5f, 0.5f), i48, i51 < i14 || i52 > i15, snapPosition, function3.invoke(Integer.valueOf(iM6087constrainWidthK40F9xA), Integer.valueOf(iM6086constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$14
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasuredPage m1261getAndMeasureSGf7dI0(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return new MeasuredPage(i, i2, lazyLayoutMeasureScope.mo1191measure0kLqBqw(i, j), j2, pagerLazyLayoutItemProvider.getKey(i), orientation, horizontal, vertical, layoutDirection, z, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM903spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m903spacedBy0680j_4(lazyLayoutMeasureScope.mo709toDpu2uoSUM(i6));
            if (orientation == Orientation.Vertical) {
                horizontalOrVerticalM903spacedBy0680j_4.arrange(density, i10, iArr, iArr2);
            } else {
                horizontalOrVerticalM903spacedBy0680j_4.arrange(density, i10, iArr, LayoutDirection.Ltr, iArr2);
            }
