...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult textLayoutResult) {
        ...
        if (this._previousTextLayoutResult != textLayoutResult) {
            if (!textLayoutResult.getDidOverflowHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                int iCoerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition(IntSize.m6286getHeightimpl(textLayoutResult.getSize())), textLayoutResult.getLineCount() - 1);
                while (iCoerceAtMost >= 0 && textLayoutResult.getLineTop(iCoerceAtMost) >= IntSize.m6286getHeightimpl(textLayoutResult.getSize())) {
                    iCoerceAtMost--;
                }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long jM3420minusMKHz9U;
        LayoutCoordinates layoutCoordinates = getLayoutCoordinates();
        if (layoutCoordinates == null || (textLayoutResultInvoke = this.layoutResultCallback.invoke()) == null) {
            return;
        }
        long jMo5002localPositionOfR5De75A = builder.getContainerCoordinates().mo5002localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3432getZeroF1C5BW0());
        long jM3420minusMKHz9U2 = Offset.m3420minusMKHz9U(builder.getCurrentPosition(), jMo5002localPositionOfR5De75A);
        if (OffsetKt.m3437isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition())) {
            jM3420minusMKHz9U = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        } else {
            jM3420minusMKHz9U = Offset.m3420minusMKHz9U(builder.getPreviousHandlePosition(), jMo5002localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m1670appendSelectableInfoParwq6A(builder, textLayoutResultInvoke, jM3420minusMKHz9U2, jM3420minusMKHz9U, getSelectableId());
    }
    ...
    public long mo1668getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResultInvoke;
    ...
    public long mo1669getRangeOfLineContainingjx7JFs(int offset) {
        TextLayoutResult textLayoutResultInvoke = this.layoutResultCallback.invoke();
        if (textLayoutResultInvoke == null) {
