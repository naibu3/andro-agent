...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM214constructorimpl = Result.m214constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m220isFailureimpl(objM214constructorimpl)) {
                objM214constructorimpl = null;
            }
            return (E) objM214constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM214constructorimpl = Result.m214constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m220isFailureimpl(objM214constructorimpl) ? null : objM214constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM214constructorimpl = Result.m214constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m220isFailureimpl(objM214constructorimpl)) {
            objM214constructorimpl = numValueOf;
        }
        return ((Number) objM214constructorimpl).intValue();
    }
