...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m3247boximpl(int i) {
    ...
    public static boolean m3250equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m3256unboximpl();
    }
    ...
    public static final boolean m3253isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m3250equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m3252hashCodeimpl(this.mask);
    }

    public String toString() {
        return m3254toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m3249constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m3248constructorimpl(i);
    }
    ...
    public static final int m3255withReadIn3QSx2Dw(int i, int i2) {
        return m3248constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m3257getComposition6f8NoZ8() {
            return ReaderKind.m3248constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m3259getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m3248constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m3258getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m3248constructorimpl(4);
        }
    }
}
