    ...
    */
    public static final LazyListMeasureResult m1127measureLazyListx0Ok8Vo(int i, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, List<Integer> list, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyListMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list2, boolean z3, final boolean z4, LazyListLayoutInfo lazyListLayoutInfo, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, iM6072getMinWidthimpl, iM6071getMinHeightimpl, new ArrayList(), lazyListMeasuredItemProvider.getKeyIndexMap(), lazyListMeasuredItemProvider, z, z4, 1, z3, 0, 0, coroutineScope, graphicsContext);
            if (!z4) {
                long jM1185getMinSizeToFitDisappearingItemsYbymL2g = lazyLayoutItemAnimator.m1185getMinSizeToFitDisappearingItemsYbymL2g();
                if (!IntSize.m6285equalsimpl0(jM1185getMinSizeToFitDisappearingItemsYbymL2g, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
                    iM6072getMinWidthimpl = ConstraintsKt.m6087constrainWidthK40F9xA(j, IntSize.m6287getWidthimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g));
                    iM6071getMinHeightimpl = ConstraintsKt.m6086constrainHeightK40F9xA(j, IntSize.m6286getHeightimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g));
                }
            }
            return new LazyListMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(iM6072getMinWidthimpl), Integer.valueOf(iM6071getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$3
        ...
        while (mainAxisSizeWithSpacings < 0 && i22 > 0) {
            int i27 = i22 - 1;
            int i28 = i26;
            LazyListMeasuredItem lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default = LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i27, 0L, 2, null);
            arrayDeque.add(0, lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default);
            iMax = Math.max(iMax, lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default.getCrossAxisSize());
            mainAxisSizeWithSpacings = lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default.getMainAxisSizeWithSpacings() + mainAxisSizeWithSpacings;
            i22 = i27;
            i26 = i28;
            i25 = i25;
            i24 = i24;
        ...
        while (i42 < i && (i40 < iCoerceAtLeast || i40 <= 0 || arrayDeque.isEmpty())) {
            ...
            int i48 = i39;
            LazyListMeasuredItem lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default2 = LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i42, 0L, 2, null);
            int i49 = i42;
            int mainAxisSizeWithSpacings4 = lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default2.getMainAxisSizeWithSpacings() + i44;
            if (mainAxisSizeWithSpacings4 <= i32 && i49 != i - 1) {
                i20 = i49 + 1;
                mainAxisSizeWithSpacings3 = i47 - lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default2.getMainAxisSizeWithSpacings();
                z6 = true;
            } else {
                int iMax2 = Math.max(i48, lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default2.getCrossAxisSize());
                arrayDeque.add(lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default2);
        ...
        if (i54 < i2) {
            ...
            while (mainAxisSizeWithSpacings5 < i21 && i14 > 0) {
                ...
                LazyListMeasuredItem lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default3 = LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i14, 0L, 2, null);
                arrayDeque.add(0, lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default3);
                iMax3 = Math.max(iMax3, lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default3.getCrossAxisSize());
                mainAxisSizeWithSpacings5 = i57 + lazyListMeasuredItemM1133getAndMeasure0kLqBqw$default3.getMainAxisSizeWithSpacings();
                i53 = i53;
                i21 = i3;
            }
            i12 = i53;
        ...
        int iM6087constrainWidthK40F9xA = ConstraintsKt.m6087constrainWidthK40F9xA(j, z ? iMax5 : i16);
        if (z) {
            iMax5 = i16;
        }
        int iM6086constrainHeightK40F9xA = ConstraintsKt.m6086constrainHeightK40F9xA(j, iMax5);
        float f6 = f2;
        final ArrayList arrayListCalculateItemsOffsets = calculateItemsOffsets(arrayDeque2, listCreateItemsBeforeList, listCreateItemsAfterList, iM6087constrainWidthK40F9xA, iM6086constrainHeightK40F9xA, i16, i2, i59, z, vertical, horizontal, z2, density);
        LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem2;
        lazyLayoutItemAnimator.onMeasured((int) f6, iM6087constrainWidthK40F9xA, iM6086constrainHeightK40F9xA, arrayListCalculateItemsOffsets, lazyListMeasuredItemProvider.getKeyIndexMap(), lazyListMeasuredItemProvider, z, z4, 1, z3, i18, i16, coroutineScope, graphicsContext);
        int iM6087constrainWidthK40F9xA2 = iM6087constrainWidthK40F9xA;
        int i63 = i16;
        if (!z4) {
            long jM1185getMinSizeToFitDisappearingItemsYbymL2g2 = lazyLayoutItemAnimator.m1185getMinSizeToFitDisappearingItemsYbymL2g();
            if (IntSize.m6285equalsimpl0(jM1185getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
                i19 = iM6086constrainHeightK40F9xA;
            } else {
                int i64 = z ? iM6086constrainHeightK40F9xA : iM6087constrainWidthK40F9xA2;
                iM6087constrainWidthK40F9xA2 = ConstraintsKt.m6087constrainWidthK40F9xA(j, Math.max(iM6087constrainWidthK40F9xA2, IntSize.m6287getWidthimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
                int iM6086constrainHeightK40F9xA2 = ConstraintsKt.m6086constrainHeightK40F9xA(j, Math.max(iM6086constrainHeightK40F9xA, IntSize.m6286getHeightimpl(jM1185getMinSizeToFitDisappearingItemsYbymL2g2)));
                int i65 = z ? iM6086constrainHeightK40F9xA2 : iM6087constrainWidthK40F9xA2;
                if (i65 != i64) {
                ...
                i19 = iM6086constrainHeightK40F9xA2;
            }
        }
        int i67 = iM6087constrainWidthK40F9xA2;
        ...
        MeasureResult measureResultInvoke = function3.invoke(Integer.valueOf(i67), Integer.valueOf(i19), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$8
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                ObservableScopeInvalidator.m1194attachToScopeimpl(mutableState);
            }
        });
        if (!z7) {
    ...
    private static final List<LazyListMeasuredItem> createItemsAfterList(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, int i2, List<Integer> list2, float f, boolean z, LazyListLayoutInfo lazyListLayoutInfo) {
        ...
        if (index2 <= iMin2) {
            ...
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i4, 0L, 2, null));
                if (i4 == iMin2) {
                    break;
                }
                i4++;
            ...
            if (lazyListItemInfo != null && (index = lazyListItemInfo.getIndex()) <= (iMin = Math.min(lazyListItemInfo2.getIndex(), i3))) {
                ...
                while (true) {
                    ...
                    if (lazyListMeasuredItem4 == null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, i5, 0L, 2, null));
                    }
                    if (i5 == iMin) {
                        break;
                    }
            ...
            if (viewportEndOffset > 0.0f) {
                ...
                while (index3 < i && i7 < viewportEndOffset) {
                    ...
                    if (lazyListMeasuredItem != null) {
                        ...
                        arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, index3, 0L, 2, null));
                        index3++;
        ...
        for (int i10 = 0; i10 < size5; i10++) {
            ...
            if (iIntValue > iMin2) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider, iIntValue, 0L, 2, null));
            }
        }
    ...
    private static final List<LazyListMeasuredItem> createItemsBeforeList(int i, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i2, List<Integer> list) {
        ...
        if (iMax <= i3) {
            ...
            while (true) {
                ...
                lazyListMeasuredItemProvider2 = lazyListMeasuredItemProvider;
                arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider2, i4, 0L, 2, null));
                if (i4 == iMax) {
                    break;
                }
                i4--;
        ...
        if (size >= 0) {
            while (true) {
                ...
                if (iIntValue < iMax) {
                    ...
                    arrayList.add(LazyListMeasuredItemProvider.m1133getAndMeasure0kLqBqw$default(lazyListMeasuredItemProvider2, iIntValue, 0L, 2, null));
                }
                if (i5 < 0) {
                    break;
                }
