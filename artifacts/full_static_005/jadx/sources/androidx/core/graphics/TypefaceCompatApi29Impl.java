...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int id2, String path, int style) throws IOException {
        try {
            Font font = new Font.Builder(resources, id2).build();
