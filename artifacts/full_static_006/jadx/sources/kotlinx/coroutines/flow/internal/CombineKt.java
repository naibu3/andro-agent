        ...
        */
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                this.I$1 = b2;
                this.label = 1;
                holder = channel.mo1736receiveCatchingJP2dKIU(this);
                ...
                bArr = bArr2;
                channel = channel2;
                indexedValue = (IndexedValue) ChannelResult.m1747getOrNullimpl(holder);
                ...
                if (indexedValue == null) {
                    do {
                        ...
                        bArr[index] = b2;
                        indexedValue = (IndexedValue) ChannelResult.m1747getOrNullimpl(channel.mo1737tryReceivePtdJZtk());
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                try {
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        if (this.$flows[this.$i].collect(new C00721(this.$resultChannel, this.$i), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
            ...
            static final class C00721<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;
