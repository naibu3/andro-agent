...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public void update(TriStateToggleableNode node) {
        node.m1285updateQzZPfjk(this.state, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((iHashCode3 + (role != null ? Role.m5409hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
