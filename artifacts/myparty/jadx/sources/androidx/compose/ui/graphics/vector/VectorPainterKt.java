...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m4376rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long jM3693getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m3693getUnspecified0d7_KjU() : j;
        int iM3597getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m3597getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM4377rememberVectorPaintervIP8VLU = m4377rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM3693getUnspecified0d7_KjU, iM3597getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return vectorPainterM4377rememberVectorPaintervIP8VLU;
    }
    ...
    */
    public static final VectorPainter m4377rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        Object obj;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long jM4374obtainSizePxVpY3zN4 = m4374obtainSizePxVpY3zN4((Density) objConsume, f, f2);
        final long jM4375obtainViewportSizePq9zytI = m4375obtainViewportSizePq9zytI(jM4374obtainSizePxVpY3zN4, f5, f6);
        ComposerKt.sourceInformationMarkerStart(composer, -1837515400, "CC(remember):VectorPainter.kt#9igjgp");
        boolean z3 = z2;
        String str3 = str2;
        boolean z4 = ((((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072 && composer.changed(jM3693getUnspecified0d7_KjU)) || (i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 131072) | ((((3670016 & i2) ^ 1572864) > 1048576 && composer.changed(iM3597getSrcIn0nO6VwU)) || (i2 & 1572864) == 1048576);
        Object objRememberedValue = composer.rememberedValue();
        if (z4 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = m4373createColorFilterxETnrds(jM3693getUnspecified0d7_KjU, iM3597getSrcIn0nO6VwU);
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new VectorPainter(null, 1, false ? 1 : 0);
            composer.updateRememberedValue(objRememberedValue2);
        }
        VectorPainter vectorPainter = (VectorPainter) objRememberedValue2;
        ComposerKt.sourceInformationMarkerEnd(composer);
        m4371configureVectorPainterT4PVSW8(vectorPainter, jM4374obtainSizePxVpY3zN4, jM4375obtainViewportSizePq9zytI, str3, colorFilter, z3);
        ...
        boolean z5 = ((((i2 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(f5)) || (i2 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | ((((i2 & 7168) ^ 3072) > 2048 && composer.changed(f6)) || (i2 & 3072) == 2048) | ((((234881024 & i2) ^ 100663296) > 67108864 && composer.changed(function4)) || (i2 & 100663296) == 67108864);
            ...
            if (objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                ...
                composition2.setContent(ComposableLambdaKt.composableLambdaInstance(-824421385, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt$rememberVectorPainter$2$1$1
                    ...
                    public final void invoke(Composer composer2, int i4) {
                        ...
                        function4.invoke(Float.valueOf(Size.m3485getWidthimpl(jM4375obtainViewportSizePq9zytI)), Float.valueOf(Size.m3482getHeightimpl(jM4375obtainViewportSizePq9zytI)), composer2, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
    ...
    private static final long m4374obtainSizePxVpY3zN4(Density density, float f, float f2) {
        return SizeKt.Size(density.mo712toPx0680j_4(f), density.mo712toPx0680j_4(f2));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m4375obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
            f = Size.m3485getWidthimpl(j);
        }
        if (Float.isNaN(f2)) {
            f2 = Size.m3482getHeightimpl(j);
        }
        return SizeKt.Size(f, f2);
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m4373createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m3701tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m4372configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            str = RootGroupName;
        }
        return m4371configureVectorPainterT4PVSW8(vectorPainter, j, j2, str, colorFilter, (i & 16) != 0 ? false : z);
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m4371configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m4369setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m4370setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long jM4374obtainSizePxVpY3zN4 = m4374obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m4371configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), jM4374obtainSizePxVpY3zN4, m4375obtainViewportSizePq9zytI(jM4374obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m4373createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m4355setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m4356setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m4357setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
