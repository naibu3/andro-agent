...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public boolean mo3349requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
    ...
    public boolean mo3350takeFocusaToIllA(final int focusDirection, Rect previouslyFocusedRect) {
        Boolean boolMo3348focusSearchULY8qGw = mo3348focusSearchULY8qGw(focusDirection, previouslyFocusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$takeFocus$1
            ...
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                Boolean boolM3367requestFocusMxy_nc0 = FocusTransactionsKt.m3367requestFocusMxy_nc0(focusTargetNode, focusDirection);
    ...
    public void clearFocus(boolean force) {
        mo3345clearFocusI7lrPNg(force, true, true, FocusDirection.INSTANCE.m3336getExitdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: clearFocus-I7lrPNg */
    public boolean mo3345clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection) {
        boolean zClearFocus;
        FocusTransactionManager focusTransactionManager = getFocusTransactionManager();
        ...
        try {
            ...
            if (!force) {
                int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m3363performCustomClearFocusMxy_nc0(this.rootFocusNode, focusDirection).ordinal()];
    ...
    public boolean mo3343moveFocus3ESFkO8(final int focusDirection) {
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = false;
        Boolean boolMo3348focusSearchULY8qGw = mo3348focusSearchULY8qGw(focusDirection, this.onFocusRectInterop.invoke(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$focusSearchSuccess$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                objectRef.element = FocusTransactionsKt.m3367requestFocusMxy_nc0(focusTargetNode, focusDirection);
                Boolean bool = objectRef.element;
                return Boolean.valueOf(bool != null ? bool.booleanValue() : false);
            }
        });
        if (boolMo3348focusSearchULY8qGw == null || objectRef.element == 0) {
            return false;
        }
        if (Intrinsics.areEqual((Object) boolMo3348focusSearchULY8qGw, (Object) true) && Intrinsics.areEqual((Object) objectRef.element, (Object) true)) {
            return true;
        }
        if (FocusOwnerImplKt.m3354is1dFocusSearch3ESFkO8(focusDirection)) {
            return mo3345clearFocusI7lrPNg(false, true, false, focusDirection) && mo3350takeFocusaToIllA(focusDirection, null);
        }
        return this.onMoveFocusInterop.invoke(FocusDirection.m3325boximpl(focusDirection)).booleanValue();
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: focusSearch-ULY8qGw */
    public Boolean mo3348focusSearchULY8qGw(int focusDirection, Rect focusedRect, final Function1<? super FocusTargetNode, Boolean> onFound) {
        final FocusTargetNode focusTargetNodeFindActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (focusTargetNodeFindActiveFocusNode != null) {
            FocusRequester focusRequesterM3368customFocusSearchOMvw8 = FocusTraversalKt.m3368customFocusSearchOMvw8(focusTargetNodeFindActiveFocusNode, focusDirection, this.onLayoutDirection.invoke());
            if (Intrinsics.areEqual(focusRequesterM3368customFocusSearchOMvw8, FocusRequester.INSTANCE.getCancel())) {
                return null;
            }
            if (!Intrinsics.areEqual(focusRequesterM3368customFocusSearchOMvw8, FocusRequester.INSTANCE.getDefault())) {
                return Boolean.valueOf(focusRequesterM3368customFocusSearchOMvw8.findFocusTargetNode$ui_release(onFound));
            }
        } else {
            focusTargetNodeFindActiveFocusNode = null;
        }
        return FocusTraversalKt.m3369focusSearch0X8WOeE(this.rootFocusNode, focusDirection, this.onLayoutDirection.invoke(), focusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$focusSearch$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
    ...
    */
    public boolean mo3347dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem) {
        ...
        if (!m3353validateKeyEventZmokQxo(keyEvent)) {
            return false;
        }
        ...
        if (focusTargetNodeFindActiveFocusNode == null || (node = lastLocalKeyInputNode(focusTargetNodeFindActiveFocusNode)) == null) {
            if (focusTargetNodeFindActiveFocusNode != null) {
                ...
                int iM5228constructorimpl = NodeKind.m5228constructorimpl(8192);
                ...
                loop10: while (true) {
                    ...
                    if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                        while (node2 != null) {
                            if ((node2.getKindSet() & iM5228constructorimpl) != 0) {
                                ...
                                while (delegatingNodePop2 != 0) {
                                    ...
                                    if ((delegatingNodePop2.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop2 instanceof DelegatingNode)) {
                ...
                if (keyInputModifierNode != null) {
                    ...
                    int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(8192);
                    ...
                    loop14: while (true) {
                        ...
                        if ((layoutNodeRequireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl2) != 0) {
                            while (parent != null) {
                                if ((parent.getKindSet() & iM5228constructorimpl2) != 0) {
                                    ...
                                    while (delegatingNodePop != 0) {
                                        ...
                                        if ((delegatingNodePop.getKindSet() & iM5228constructorimpl2) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
                                            Modifier.Node delegate2 = delegatingNodePop.getDelegate();
                                            int i2 = 0;
                                            delegatingNodePop = delegatingNodePop;
                                            while (delegate2 != null) {
                                                if ((delegate2.getKindSet() & iM5228constructorimpl2) != 0) {
                                                    i2++;
                                                    if (i2 == 1) {
        ...
        if (node != null) {
            ...
            int iM5228constructorimpl3 = NodeKind.m5228constructorimpl(8192);
            ...
            while (layoutNodeRequireLayoutNode3 != null) {
                if ((layoutNodeRequireLayoutNode3.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl3) != 0) {
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & iM5228constructorimpl3) != 0) {
                            ...
                            while (nodePop != null) {
                                ...
                                } else if ((nodePop.getKindSet() & iM5228constructorimpl3) != 0 && (nodePop instanceof DelegatingNode)) {
                                    int i3 = 0;
                                    for (Modifier.Node delegate3 = ((DelegatingNode) nodePop).getDelegate(); delegate3 != null; delegate3 = delegate3.getChild()) {
                                        if ((delegate3.getKindSet() & iM5228constructorimpl3) != 0) {
                                            i3++;
                                            if (i3 == 1) {
                                                nodePop = delegate3;
                                            } else {
            ...
            if (arrayList != null) {
                ...
                if (size >= 0) {
                    while (true) {
                        int i4 = size - 1;
                        if (((KeyInputModifierNode) arrayList.get(size)).mo549onPreKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                        if (i4 < 0) {
                            break;
            ...
            while (node4 != 0) {
                if (node4 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node4).mo549onPreKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node4.getKindSet() & iM5228constructorimpl3) != 0 && (node4 instanceof DelegatingNode)) {
                    Modifier.Node delegate4 = node4.getDelegate();
                    int i5 = 0;
                    node4 = node4;
                    while (delegate4 != null) {
                        if ((delegate4.getKindSet() & iM5228constructorimpl3) != 0) {
                            i5++;
                            if (i5 == 1) {
                                node4 = delegate4;
                            } else {
            ...
            while (node5 != 0) {
                if (node5 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node5).mo547onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node5.getKindSet() & iM5228constructorimpl3) != 0 && (node5 instanceof DelegatingNode)) {
                    Modifier.Node delegate5 = node5.getDelegate();
                    int i6 = 0;
                    node5 = node5;
                    while (delegate5 != null) {
                        if ((delegate5.getKindSet() & iM5228constructorimpl3) != 0) {
                            i6++;
                            if (i6 == 1) {
                                node5 = delegate5;
                            } else {
            ...
            if (arrayList != null) {
                ...
                for (int i7 = 0; i7 < size2; i7++) {
                    if (((KeyInputModifierNode) arrayList.get(i7)).mo547onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                }
    ...
    public boolean mo3346dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (focusTargetNodeFindActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = focusTargetNodeFindActiveFocusNode;
            int iM5228constructorimpl = NodeKind.m5228constructorimpl(131072);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            ...
            loop0: while (true) {
                ...
                if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                    while (node != null) {
                        if ((node.getKindSet() & iM5228constructorimpl) != 0) {
                            MutableVector mutableVector = null;
                            ...
                            while (delegatingNodePop != 0) {
                                ...
                                if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0 && (delegatingNodePop instanceof DelegatingNode)) {
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(131072);
                        ...
                        if ((parent.getKindSet() & iM5228constructorimpl2) != 0) {
                            ...
                            while (nodePop != null) {
                                if (nodePop instanceof SoftKeyboardInterceptionModifierNode) {
                                    ...
                                    arrayList.add(nodePop);
                                } else if ((nodePop.getKindSet() & iM5228constructorimpl2) != 0 && (nodePop instanceof DelegatingNode)) {
                                    int i2 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i3 = size - 1;
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(size)).mo4410onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i3 < 0) {
                        break;
            ...
            while (node2 != 0) {
                if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node2).mo4410onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node2.getKindSet() & iM5228constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                    Modifier.Node delegate3 = node2.getDelegate();
                    int i4 = 0;
                    node2 = node2;
                    while (delegate3 != null) {
                        if ((delegate3.getKindSet() & iM5228constructorimpl2) != 0) {
                            i4++;
                            if (i4 == 1) {
                                node2 = delegate3;
                            } else {
            ...
            while (node3 != 0) {
                if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node3).mo4409onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & iM5228constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                    Modifier.Node delegate4 = node3.getDelegate();
                    int i5 = 0;
                    node3 = node3;
                    while (delegate4 != null) {
                        if ((delegate4.getKindSet() & iM5228constructorimpl2) != 0) {
                            i5++;
                            if (i5 == 1) {
                                node3 = delegate4;
                            } else {
            ...
            if (arrayList != null) {
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i6)).mo4409onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (focusTargetNodeFindActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = focusTargetNodeFindActiveFocusNode;
            int iM5228constructorimpl = NodeKind.m5228constructorimpl(16384);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node node = focusTargetNode.getNode();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(16384);
    ...
    private final boolean m3353validateKeyEventZmokQxo(KeyEvent keyEvent) {
        long jM4722getKeyZmokQxo = KeyEvent_androidKt.m4722getKeyZmokQxo(keyEvent);
        int iM4723getTypeZmokQxo = KeyEvent_androidKt.m4723getTypeZmokQxo(keyEvent);
        if (KeyEventType.m4715equalsimpl0(iM4723getTypeZmokQxo, KeyEventType.INSTANCE.m4719getKeyDownCS__XNY())) {
            MutableLongSet mutableLongSet = this.keysCurrentlyDown;
            if (mutableLongSet == null) {
                mutableLongSet = new MutableLongSet(3);
                this.keysCurrentlyDown = mutableLongSet;
            }
            mutableLongSet.plusAssign(jM4722getKeyZmokQxo);
        } else if (KeyEventType.m4715equalsimpl0(iM4723getTypeZmokQxo, KeyEventType.INSTANCE.m4720getKeyUpCS__XNY())) {
            MutableLongSet mutableLongSet2 = this.keysCurrentlyDown;
            if (mutableLongSet2 == null || !mutableLongSet2.contains(jM4722getKeyZmokQxo)) {
                return false;
            }
            MutableLongSet mutableLongSet3 = this.keysCurrentlyDown;
            if (mutableLongSet3 != null) {
                mutableLongSet3.remove(jM4722getKeyZmokQxo);
            }
        }
        return true;
    }
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m3352traverseAncestorsIncludingSelfQFhIj7k(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function0<Unit> function0, Function1<? super T, Unit> function12) {
        int i2;
        int size;
        NodeChain nodes;
    ...
    private final /* synthetic */ <T> T m3351nearestAncestorIncludingSelf64DMado(DelegatableNode delegatableNode, int i) {
        NodeChain nodes;
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(1024) | NodeKind.m5228constructorimpl(8192);
        if (!delegatableNode.getNode().getIsAttached()) {
            InlineClassHelperKt.throwIllegalStateException("visitLocalDescendants called on an unattached node");
        }
        Modifier.Node node = delegatableNode.getNode();
        Modifier.Node node2 = null;
        if ((node.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
            for (Modifier.Node child = node.getChild(); child != null; child = child.getChild()) {
                if ((child.getKindSet() & iM5228constructorimpl) != 0) {
                    if ((NodeKind.m5228constructorimpl(1024) & child.getKindSet()) != 0) {
                        return node2;
                    }
                    node2 = child;
                }
