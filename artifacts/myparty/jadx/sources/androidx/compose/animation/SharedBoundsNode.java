...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final long jSize = SizeKt.Size(placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measureScope, placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    ...
                    long j2 = jSize;
                    long jMo5002localPositionOfR5De75A = sharedBoundsNode.getRootLookaheadCoords().mo5002localPositionOfR5De75A(coordinates, Offset.INSTANCE.m3432getZeroF1C5BW0());
                    if (sharedBoundsNode.getSharedElement().getCurrentBounds() == null) {
                        sharedBoundsNode.getSharedElement().setCurrentBounds(RectKt.m3456Recttz77jQw(jMo5002localPositionOfR5De75A, j2));
                    }
                    offsetM3405boximpl = Offset.m3405boximpl(jMo5002localPositionOfR5De75A);
                } else {
                ...
                if (offsetM3405boximpl != null) {
                    SharedBoundsNode sharedBoundsNode2 = this;
                    sharedBoundsNode2.getSharedElement().m444onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), jSize, offsetM3405boximpl.getPackedValue());
                }
            }
        }, 4, null);
    }
    ...
    private final MeasureResult place(MeasureScope measureScope, final Placeable placeable) {
        long jMo447calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo447calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5001getSizeYbymL2g(), IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default(measureScope, IntSize.m6287getWidthimpl(jMo447calculateSizeJyjRU_E), IntSize.m6286getHeightimpl(jMo447calculateSizeJyjRU_E), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.place.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (SharedBoundsNode.this.getSharedElement().getFoundMatch()) {
                    ...
                    Offset offsetM3405boximpl = coordinates2 != null ? Offset.m3405boximpl(SharedBoundsNode.this.getRootCoords().mo5002localPositionOfR5De75A(coordinates2, Offset.INSTANCE.m3432getZeroF1C5BW0())) : null;
                    if (value != null) {
                        if (SharedBoundsNode.this.getBoundsAnimation().getTarget()) {
                            SharedBoundsNode.this.getSharedElement().setCurrentBounds(value);
                        }
                        jM3451getTopLeftF1C5BW0 = value.m3451getTopLeftF1C5BW0();
                    } else {
                        ...
                        jM3451getTopLeftF1C5BW0 = currentBounds2.m3451getTopLeftF1C5BW0();
                    }
                    long jM3420minusMKHz9U = offsetM3405boximpl != null ? Offset.m3420minusMKHz9U(jM3451getTopLeftF1C5BW0, offsetM3405boximpl.getPackedValue()) : Offset.INSTANCE.m3432getZeroF1C5BW0();
                    Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Offset.m3416getXimpl(jM3420minusMKHz9U)), Math.round(Offset.m3417getYimpl(jM3420minusMKHz9U)), 0.0f, 4, null);
                    return;
                }
    ...
    public boolean mo443isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return getSharedElement().getFoundMatch() && this.state.getSharedElement().getScope().isTransitionActive();
    }

    @Override // androidx.compose.ui.layout.ApproachLayoutModifierNode
    /* renamed from: approachMeasure-3p2s80s, reason: not valid java name */
    public MeasureResult mo442approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long jM6295roundToIntSizeuvyYCjk = IntSizeKt.m6295roundToIntSizeuvyYCjk(value.m3449getSizeNHjbRc());
                int iM6287getWidthimpl = IntSize.m6287getWidthimpl(jM6295roundToIntSizeuvyYCjk);
                int iM6286getHeightimpl = IntSize.m6286getHeightimpl(jM6295roundToIntSizeuvyYCjk);
                if (iM6287getWidthimpl == Integer.MAX_VALUE || iM6286getHeightimpl == Integer.MAX_VALUE) {
                ...
                j = Constraints.INSTANCE.m6080fixedJhjzzOo(RangesKt.coerceAtLeast(iM6287getWidthimpl, 0), RangesKt.coerceAtLeast(iM6286getHeightimpl, 0));
            }
        }
        return place(approachMeasureScope, measurable.mo4993measureBRTryo0(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        getSharedElement().setCurrentBounds(RectKt.m3456Recttz77jQw(getRootCoords().mo5002localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3432getZeroF1C5BW0()), SizeKt.Size(IntSize.m6287getWidthimpl(layoutCoordinates.mo5001getSizeYbymL2g()), IntSize.m6286getHeightimpl(layoutCoordinates.mo5001getSizeYbymL2g()))));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4211recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.draw.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
