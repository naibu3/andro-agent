...
public final class ShapeTokens {
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m1303RoundedCornerShape0680j_4(Dp.m6117constructorimpl(f));
        ...
        CornerExtraLargeTop = RoundedCornerShapeKt.m1304RoundedCornerShapea9UjIt4(fM6117constructorimpl, fM6117constructorimpl2, Dp.m6117constructorimpl(f2), Dp.m6117constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m1303RoundedCornerShape0680j_4(Dp.m6117constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m1304RoundedCornerShapea9UjIt4(Dp.m6117constructorimpl(f3), Dp.m6117constructorimpl(f3), Dp.m6117constructorimpl(f2), Dp.m6117constructorimpl(f2));
        CornerFull = RoundedCornerShapeKt.getCircleShape();
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m1303RoundedCornerShape0680j_4(Dp.m6117constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m1304RoundedCornerShapea9UjIt4(Dp.m6117constructorimpl(f2), Dp.m6117constructorimpl(f4), Dp.m6117constructorimpl(f4), Dp.m6117constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m1304RoundedCornerShapea9UjIt4(Dp.m6117constructorimpl(f4), Dp.m6117constructorimpl(f4), Dp.m6117constructorimpl(f2), Dp.m6117constructorimpl(f2));
        CornerMedium = RoundedCornerShapeKt.m1303RoundedCornerShape0680j_4(Dp.m6117constructorimpl((float) 12.0d));
        CornerNone = RectangleShapeKt.getRectangleShape();
        CornerSmall = RoundedCornerShapeKt.m1303RoundedCornerShape0680j_4(Dp.m6117constructorimpl((float) 8.0d));
    }
}
