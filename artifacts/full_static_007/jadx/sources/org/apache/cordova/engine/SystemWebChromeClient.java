...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    @Override // android.webkit.WebChromeClient
    public void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        ...
        if (fileChooserParams.isCaptureEnabled()) {
            ...
            if (context.getPackageManager().hasSystemFeature("android.hardware.camera.any") && intent.resolveActivity(context.getPackageManager()) != null) {
                ...
                try {
                    ...
                    intent = null;
                    intentCreateChooser = Intent.createChooser(intentCreateIntent, null);
                    if (intent != null) {
                    }
                    LOG.i(LOG_TAG, "Starting intent for file chooser");
                    this.parentEngine.f14cordova.startActivityForResult(new CordovaPlugin() { // from class: org.apache.cordova.engine.SystemWebChromeClient.4
                        ...
                        */
                        public void onActivityResult(int i, int i2, Intent intent2) {
                            ...
                            if (i2 == -1) {
                                ...
                                } else if (uriCreateUriForFile != null) {
                                    LOG.v(SystemWebChromeClient.LOG_TAG, "Adding camera capture: " + uriCreateUriForFile);
                                    arrayList.add(uriCreateUriForFile);
