...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m4064equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4071getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m4064equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m4071getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m4081computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m4082computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        private final float[] m4082computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m4087equalsimpl0(intent, RenderIntent.INSTANCE.m4091getAbsoluteuksYyKA())) {
        ...
        public long mo4079transformToColorl2rxGTc$ui_graphics_release(long color) {
            float fM3663getRedimpl = Color.m3663getRedimpl(color);
            float fM3662getGreenimpl = Color.m3662getGreenimpl(color);
            float fM3660getBlueimpl = Color.m3660getBlueimpl(color);
            float fM3659getAlphaimpl = Color.m3659getAlphaimpl(color);
            float fInvoke = (float) this.mSource.getEotfFunc().invoke(fM3663getRedimpl);
            float fInvoke2 = (float) this.mSource.getEotfFunc().invoke(fM3662getGreenimpl);
            float fInvoke3 = (float) this.mSource.getEotfFunc().invoke(fM3660getBlueimpl);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc().invoke((fArr[0] * fInvoke) + (fArr[3] * fInvoke2) + (fArr[6] * fInvoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[1] * fInvoke) + (fArr[4] * fInvoke2) + (fArr[7] * fInvoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[2] * fInvoke) + (fArr[5] * fInvoke2) + (fArr[8] * fInvoke3)), fM3659getAlphaimpl, this.mDestination);
        }
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m4081computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m4087equalsimpl0(intent, RenderIntent.INSTANCE.m4091getAbsoluteuksYyKA())) {
                return null;
            }
            boolean zM4064equalsimpl0 = ColorModel.m4064equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4071getRgbxdoWZVw());
            boolean zM4064equalsimpl02 = ColorModel.m4064equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4071getRgbxdoWZVw());
            if (zM4064equalsimpl0 && zM4064equalsimpl02) {
                return null;
            }
            if (!zM4064equalsimpl0 && !zM4064equalsimpl02) {
                return null;
            }
            if (!zM4064equalsimpl0) {
                source = destination;
            }
            Intrinsics.checkNotNull(source, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = zM4064equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM4064equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int iM4093getRelativeuksYyKA = RenderIntent.INSTANCE.m4093getRelativeuksYyKA();
            return new Connector(source, iM4093getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    return v;
                }
                ...
                {
                    super(source, source, iM4093getRelativeuksYyKA, null);
                }
            };
        }
    }
    ...
    public long mo4079transformToColorl2rxGTc$ui_graphics_release(long color) {
        ...
        float fM3660getBlueimpl = Color.m3660getBlueimpl(color);
        float fM3659getAlphaimpl = Color.m3659getAlphaimpl(color);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(fM3663getRedimpl, fM3662getGreenimpl, fM3660getBlueimpl);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(fM3663getRedimpl, fM3662getGreenimpl, fM3660getBlueimpl);
        float[] fArr = this.transform;
        if (fArr != null) {
        ...
        return this.transformDestination.mo4074xyzaToColorJlNiLsg$ui_graphics_release(f, fIntBitsToFloat2, z$ui_graphics_release, fM3659getAlphaimpl, this.destination);
    }
}
