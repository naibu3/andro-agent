...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType(it.next(), attributes$default).getConstructor().mo10409getDeclarationDescriptor();
    ...
    final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo10409getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo10409getDeclarationDescriptor = mo10409getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo10409getDeclarationDescriptor, arrayList5);
            }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo10404findAnnotation = annotations.mo10404findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (annotationDescriptorMo10404findAnnotation == null) {
                return null;
            }
            Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo10404findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo10409getDeclarationDescriptor() {
