...
final class AmazonPayUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) AmazonPayDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_amazon_pay, R.drawable.stripe_ic_paymentsheet_pm_amazon_pay, (Integer) null, false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        if (AmazonPayDefinition.INSTANCE.requiresMandate(metadata)) {
            listEmptyList = CollectionsKt.listOf(new MandateTextSpec((IdentifierSpec) null, R.string.stripe_amazon_pay_mandate, 1, (DefaultConstructorMarker) null));
        } else {
