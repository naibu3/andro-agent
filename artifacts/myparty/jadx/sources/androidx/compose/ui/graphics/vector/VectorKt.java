...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4010getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4021getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3597getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3692getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m3940getNonZeroRgk1Os();
    ...
    public static final boolean m4365rgbEqualOWjLjI(long j, long j2) {
        return Color.m3663getRedimpl(j) == Color.m3663getRedimpl(j2) && Color.m3662getGreenimpl(j) == Color.m3662getGreenimpl(j2) && Color.m3660getBlueimpl(j) == Color.m3660getBlueimpl(j2);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m3568equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3597getSrcIn0nO6VwU()) || BlendMode.m3568equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3599getSrcOver0nO6VwU());
    }
}
