...
public final class zzcyq implements zzhkp {
    ...
    public final zzcyp zzb() {
        ...
        VersionInfoParcel versionInfoParcelZza = ((zzcjv) this.zzb).zza();
        ApplicationInfo applicationInfoZzb = ((zzdzq) this.zzc).zzb();
        String strZzb = ((zzdzv) this.zzd).zzb();
        zzbeg zzbegVar = zzbep.zza;
        return new zzcyp(zzfltVar, versionInfoParcelZza, applicationInfoZzb, strZzb, com.google.android.gms.ads.internal.client.zzba.zza().zza(), (PackageInfo) this.zzf.zzb(), zzhko.zza(zzhla.zza(this.zzg)), ((zzcjh) this.zzh).zzb(), (String) this.zzi.zzb(), ((zzeya) this.zzj).zzb(), ((zzczc) this.zzk).zza(), (zzdeu) this.zzl.zzb());
    }
}
