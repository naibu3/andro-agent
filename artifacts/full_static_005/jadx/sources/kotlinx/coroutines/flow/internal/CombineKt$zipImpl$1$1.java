            ...
            static final class C00081 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    C00081 c00081;
                    Object objMo1587receiveCatchingJP2dKIU;
                    Object obj2;
                    C00081 c000812;
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c00081 = this;
                            c00081.label = 1;
                            objMo1587receiveCatchingJP2dKIU = c00081.$second.mo1587receiveCatchingJP2dKIU(c00081);
                            if (objMo1587receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            FlowCollector flowCollector2 = c00081.$this_unsafeFlow;
                            if (!(objMo1587receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                                Throwable thM1598exceptionOrNullimpl = ChannelResult.m1598exceptionOrNullimpl(objMo1587receiveCatchingJP2dKIU);
                                if (thM1598exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector2);
                                }
                                throw thM1598exceptionOrNullimpl;
                            }
                            Function3<T1, T2, Continuation<? super R>, Object> function3 = c00081.$transform;
                            T1 t1 = c00081.$value;
                            if (objMo1587receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1587receiveCatchingJP2dKIU = null;
                            }
                            c00081.L$0 = flowCollector2;
                            c00081.label = 2;
                            Object objInvoke = function3.invoke(t1, objMo1587receiveCatchingJP2dKIU, c00081);
                            ...
                            c000812.L$0 = null;
                            c000812.label = 3;
                            return flowCollector.emit(obj, c000812) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            c00081 = this;
                            ResultKt.throwOnFailure(obj);
                            objMo1587receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                            FlowCollector flowCollector22 = c00081.$this_unsafeFlow;
                            if (!(objMo1587receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                            }
                            break;
                        case 2:
                            ...
                            c000812.L$0 = null;
                            c000812.label = 3;
                            if (flowCollector.emit(obj, c000812) != coroutine_suspended) {
                            }
                            break;
                        case 3:
                            ResultKt.throwOnFailure(obj);
