        ...
        public void run() {
            ...
            if (RecyclerView.this.mLayout != null) {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    boolean doneScrolling = scroller.isFinished() || ((scrollerFinishedX || unconsumedX4 != 0) && (scrollerFinishedY || unconsumedY4 != 0));
                    ...
                    if (!smoothScrollerPending && doneScrolling) {
                        if (RecyclerView.this.getOverScrollMode() != 2) {
                            ...
                            int velX = unconsumedX4 < 0 ? -vel : unconsumedX4 > 0 ? vel : 0;
                            int velY = unconsumedY4 < 0 ? -vel : unconsumedY4 > 0 ? vel : 0;
