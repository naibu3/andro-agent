...
public final class zzdkq implements zzdmb {
    ...
    private final boolean zzH(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) throws JSONException {
        try {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zziE)).booleanValue()) {
                this.zzd.zzl("/clickRecorded", new zzdkn(this, zzdkmVar));
            } else {
                this.zzd.zzl("/logScionEvent", new zzdkl(this, objArr == true ? 1 : 0));
            }
            this.zzd.zzl("/nativeImpression", new zzdkp(this, objArr2 == true ? 1 : 0));
    ...
    public final boolean zzC(Bundle bundle) {
        if (zzF("impression_reporting")) {
            return zzH(null, null, null, null, ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzlv)).booleanValue() ? zzD(null) : null, com.google.android.gms.ads.internal.client.zzay.zzb().zzk(bundle, null), false);
        }
    ...
    public final void zzk(View view, View view2, Map map, Map map2, boolean z, ImageView.ScaleType scaleType) throws JSONException {
        ...
        zzn(true == ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzdE)).booleanValue() ? view2 : view, jSONObjectZzg, jSONObjectZzd, jSONObjectZzf, jSONObjectZze, strZzE, com.google.android.gms.ads.internal.util.zzbz.zzc(strZzE, context, this.zzz, this.zzy), null, z, false);
    }
    ...
    protected final void zzn(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) throws JSONException {
        ...
        try {
            ...
            jSONObject8.put("custom_mute_requested", zzbhkVar != null && zzbhkVar.zzg);
