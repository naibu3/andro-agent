...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double d3 = J0 + n;
        Double.isNaN(d3);
        double solarTransitJ2000 = d3 + arcLongitude + (Math.sin(meanAnomaly) * 0.0053d) + (Math.sin(2.0d * solarLng) * (-0.0069d));
        ...
        double solarTransitJ20002 = hourAngle;
        Double.isNaN(solarTransitJ20002);
        this.sunset = Math.round((solarTransitJ2000 + solarTransitJ20002) * 8.64E7d) + UTC_2000;
        double d4 = hourAngle;
        Double.isNaN(d4);
