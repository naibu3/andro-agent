            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    ...
                    if (layoutParams.width == -2) {
                        ...
                        iMakeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i8, BasicMeasure.EXACTLY);
                    } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i4 = i9;
                                    int iMakeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY);
                                    if (measuredWidth2 != i11) {
                                        childAt2.measure(iMakeMeasureSpec5, iMakeMeasureSpec);
                                    }
                                } else {
                                    i4 = i9;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i7)) / f)), BasicMeasure.EXACTLY), iMakeMeasureSpec);
                                }
                            }
