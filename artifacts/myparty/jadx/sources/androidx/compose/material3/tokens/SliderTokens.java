...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2724getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2725getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2724getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m6117constructorimpl((float) 28.0d);
    ...
    private static final float StateLayerSize = Dp.m6117constructorimpl((float) 40.0d);
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2724getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m6117constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m6117constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m6117constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m6117constructorimpl(f2);
        HandleWidth = Dp.m6117constructorimpl(f2);
        InactiveTrackHeight = Dp.m6117constructorimpl(f);
    }
    ...
    public final float m3007getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3008getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m3009getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m3010getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3011getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3012getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3013getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3014getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m3016getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m3018getTrackElevationD9Ej5fM() {
    ...
    public final float m3015getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m3017getTickMarksContainerSizeD9Ej5fM() {
