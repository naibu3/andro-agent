...
public final class FlowLiveDataConversions {
    ...
    static final class C06541<T> extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
        ...
        C06541(Flow<? extends T> flow, Continuation<? super C06541> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06541 c06541 = new C06541(this.$this_asLiveData, continuation);
            c06541.L$0 = obj;
            return c06541;
        }
        ...
        public final Object invoke(LiveDataScope<T> liveDataScope, Continuation<? super Unit> continuation) {
            return ((C06541) create(liveDataScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> LiveData<T> asLiveData(Flow<? extends T> flow, CoroutineContext context, long j) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        LoaderManagerImpl.LoaderInfo loaderInfo = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j, new C06541(flow, null));
            ...
            if (r1 == 0) {
                ...
                Observer observer3 = new Observer() { // from class: androidx.lifecycle.FlowLiveDataConversions$asFlow$1$$ExternalSyntheticLambda0
                    ...
                    public final void onChanged(Object obj2) {
                        producerScope.mo10639trySendJP2dKIU(obj2);
                    }
                };
                this.L$0 = observer3;
                this.label = 1;
                Object objWithContext = BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C01271(this.$this_asFlow, observer3, null), this);
                observer = observer3;
