...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public void mo729onDragStartedk4lQ0M(long startedPosition) {
    }
    ...
    public void mo730onDragStoppedTH1AsA0(long velocity) {
    ...
    public boolean mo547onKeyEventZmokQxo(KeyEvent event) {
        ...
        if ((!Key.m4414equalsimpl0(KeyEvent_androidKt.m4722getKeyZmokQxo(event), Key.INSTANCE.m4602getPageDownEK5gGoQ()) && !Key.m4414equalsimpl0(KeyEvent_androidKt.m4722getKeyZmokQxo(event), Key.INSTANCE.m4603getPageUpEK5gGoQ())) || !KeyEventType.m4715equalsimpl0(KeyEvent_androidKt.m4723getTypeZmokQxo(event), KeyEventType.INSTANCE.m4719getKeyDownCS__XNY()) || KeyEvent_androidKt.m4726isCtrlPressedZmokQxo(event)) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM6286getHeightimpl = IntSize.m6286getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m4414equalsimpl0(KeyEvent_androidKt.m4722getKeyZmokQxo(event), Key.INSTANCE.m4603getPageUpEK5gGoQ()) ? iM6286getHeightimpl : -iM6286getHeightimpl);
        } else {
            int iM6287getWidthimpl = IntSize.m6287getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m4414equalsimpl0(KeyEvent_androidKt.m4722getKeyZmokQxo(event), Key.INSTANCE.m4603getPageUpEK5gGoQ()) ? iM6287getWidthimpl : -iM6287getWidthimpl, 0.0f);
        }
    ...
    public void mo548onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            ...
            if (getCanDrag().invoke(changes.get(i)).booleanValue()) {
                super.mo548onPointerEventH0pRuoY(pointerEvent, pass, bounds);
                break;
            }
            i++;
        }
        if (pass == PointerEventPass.Main && PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4822getScroll7fucELk())) {
            m823processMouseWheelEventO0kMr_c(pointerEvent, bounds);
        }
    }
            ...
            static final class C00261 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableKt.m820semanticsScrollByd4ec7I(this.this$0.scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this) == coroutine_suspended) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m824invoke3MmeM6k(offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m824invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m3405boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            long j = this.J$0;
            this.label = 1;
            Object objM820semanticsScrollByd4ec7I = ScrollableKt.m820semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, j, this);
            return objM820semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM820semanticsScrollByd4ec7I;
        }
    }
    ...
    private final void m823processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$processMouseWheelEvent$2$1(this, scrollConfig.mo733calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size), null), 3, null);
