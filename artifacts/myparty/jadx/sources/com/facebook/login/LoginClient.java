...
public class LoginClient implements Parcelable {
    ...
    /* compiled from: LoginClient.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, d2 = {"Lcom/facebook/login/LoginClient$OnCompletedListener;", "", "onCompleted", "", FinancialConnectionsSheetNativeActivity.EXTRA_RESULT, "Lcom/facebook/login/LoginClient$Result;", "facebook-common_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    private final void addLoggingExtra(String key, String value, boolean accumulate) {
        ...
        if (map.containsKey(key) && accumulate) {
            value = map.get(key) + AbstractJsonLexerKt.COMMA + value;
        }
        map.put(key, value);
    }
    ...
    */
    ...
    public static final class Request implements Parcelable {
        ...
        private Request(Parcel parcel) {
            ...
            this.applicationId = Validate.notNullOrEmpty(parcel.readString(), NamedConstantsKt.APPLICATION_ID);
