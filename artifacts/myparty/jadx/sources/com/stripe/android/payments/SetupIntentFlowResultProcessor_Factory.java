...
public final class SetupIntentFlowResultProcessor_Factory implements Factory<SetupIntentFlowResultProcessor> {
    ...
    public static SetupIntentFlowResultProcessor_Factory create(javax.inject.Provider<Context> provider, javax.inject.Provider<Function0<String>> provider2, javax.inject.Provider<StripeRepository> provider3, javax.inject.Provider<Logger> provider4, javax.inject.Provider<CoroutineContext> provider5) {
        return new SetupIntentFlowResultProcessor_Factory(Providers.asDaggerProvider(provider), Providers.asDaggerProvider(provider2), Providers.asDaggerProvider(provider3), Providers.asDaggerProvider(provider4), Providers.asDaggerProvider(provider5));
    }
