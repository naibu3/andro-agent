...
final class ComposableSingletons$SignUpScreenKt$lambda2$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-780417639, i, -1, "com.stripe.android.link.ui.signup.ComposableSingletons$SignUpScreenKt.lambda-2.<anonymous> (SignUpScreen.kt:303)");
            }
            SimpleTextFieldController simpleTextFieldControllerCreateController$default = EmailConfig.Companion.createController$default(EmailConfig.INSTANCE, "email", false, 2, null);
            ...
            SignUpScreenState signUpScreenState = new SignUpScreenState("Example, Inc.", false, true, true, SignUpState.InputtingRemainingFields, false, null, 96, null);
            composer.startReplaceGroup(-1431391364);
            Object objRememberedValue = composer.rememberedValue();
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.stripe.android.link.ui.signup.ComposableSingletons$SignUpScreenKt$lambda-2$1$$ExternalSyntheticLambda0
