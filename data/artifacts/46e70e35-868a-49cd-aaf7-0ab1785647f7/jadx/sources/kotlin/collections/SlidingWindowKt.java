        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    int gap3 = anonymousClass1.$step - anonymousClass1.$size;
                    if (gap3 >= 0) {
                        buffer2 = new ArrayList(bufferInitialCapacity);
                    ...
                    RingBuffer buffer5 = new RingBuffer(bufferInitialCapacity);
                    ...
                    if (buffer4.size() <= anonymousClass13.$step) {
                        List arrayList2 = anonymousClass13.$reuseBuffer ? buffer4 : new ArrayList(buffer4);
                        anonymousClass13.L$0 = sequenceScope2;
                        anonymousClass13.L$1 = buffer4;
                        anonymousClass13.L$2 = null;
                        anonymousClass13.label = 4;
                        if (sequenceScope2.yield(arrayList2, anonymousClass13) == obj2) {
                            return obj2;
                        }
                        buffer4.removeFirst(anonymousClass13.$step);
                        if (buffer4.size() <= anonymousClass13.$step) {
                            if (!buffer4.isEmpty()) {
                                ...
                                if (sequenceScope2.yield(buffer4, anonymousClass13) == obj2) {
                                    return obj2;
                                }
                            }
                            return Unit.INSTANCE;
