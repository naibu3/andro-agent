...
public final class NestedScrollNode extends Modifier.Node implements TraversableNode, NestedScrollConnection {
    ...
    public long mo1096onPreScrollOzD1aCk(long available, int source) {
        ...
        long jMo1096onPreScrollOzD1aCk = parentConnection != null ? parentConnection.mo1096onPreScrollOzD1aCk(available, source) : Offset.INSTANCE.m3432getZeroF1C5BW0();
        return Offset.m3421plusMKHz9U(jMo1096onPreScrollOzD1aCk, this.connection.mo1096onPreScrollOzD1aCk(Offset.m3420minusMKHz9U(available, jMo1096onPreScrollOzD1aCk), source));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo822onPostScrollDzOQY0M(long consumed, long available, int source) {
        long jM3432getZeroF1C5BW0;
        long jMo822onPostScrollDzOQY0M = this.connection.mo822onPostScrollDzOQY0M(consumed, available, source);
        NestedScrollConnection parentConnection = getParentConnection();
        if (parentConnection != null) {
            jM3432getZeroF1C5BW0 = parentConnection.mo822onPostScrollDzOQY0M(Offset.m3421plusMKHz9U(consumed, jMo822onPostScrollDzOQY0M), Offset.m3420minusMKHz9U(available, jMo822onPostScrollDzOQY0M), source);
        } else {
            jM3432getZeroF1C5BW0 = Offset.INSTANCE.m3432getZeroF1C5BW0();
        }
        return Offset.m3421plusMKHz9U(jMo822onPostScrollDzOQY0M, jM3432getZeroF1C5BW0);
    }
    ...
    */
    public Object mo1095onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        Object objMo1095onPreFlingQWom1Mo = nestedScrollNode$onPreFling$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = nestedScrollNode$onPreFling$1.label;
        if (i == 0) {
            ResultKt.throwOnFailure(objMo1095onPreFlingQWom1Mo);
            NestedScrollConnection parentConnection = getParentConnection();
            if (parentConnection != null) {
                nestedScrollNode$onPreFling$1.L$0 = this;
                nestedScrollNode$onPreFling$1.J$0 = j;
                nestedScrollNode$onPreFling$1.label = 1;
                objMo1095onPreFlingQWom1Mo = parentConnection.mo1095onPreFlingQWom1Mo(j, nestedScrollNode$onPreFling$1);
                if (objMo1095onPreFlingQWom1Mo != coroutine_suspended) {
            ...
            nestedScrollNode = this;
            long j3 = jM6365getZero9UxMQ8M;
            long j4 = j;
            j2 = j3;
            NestedScrollConnection nestedScrollConnection = nestedScrollNode.connection;
            long jM6357minusAH228Gc = Velocity.m6357minusAH228Gc(j4, j2);
            nestedScrollNode$onPreFling$1.L$0 = null;
            nestedScrollNode$onPreFling$1.J$0 = j2;
            nestedScrollNode$onPreFling$1.label = 2;
            objMo1095onPreFlingQWom1Mo = nestedScrollConnection.mo1095onPreFlingQWom1Mo(jM6357minusAH228Gc, nestedScrollNode$onPreFling$1);
        } else {
            if (i != 1) {
                if (i != 2) {
                ...
                ResultKt.throwOnFailure(objMo1095onPreFlingQWom1Mo);
                return Velocity.m6345boximpl(Velocity.m6358plusAH228Gc(j2, ((Velocity) objMo1095onPreFlingQWom1Mo).getPackedValue()));
            }
            j = nestedScrollNode$onPreFling$1.J$0;
            nestedScrollNode = (NestedScrollNode) nestedScrollNode$onPreFling$1.L$0;
            ResultKt.throwOnFailure(objMo1095onPreFlingQWom1Mo);
        }
        jM6365getZero9UxMQ8M = ((Velocity) objMo1095onPreFlingQWom1Mo).getPackedValue();
        long j32 = jM6365getZero9UxMQ8M;
        long j42 = j;
        j2 = j32;
        NestedScrollConnection nestedScrollConnection2 = nestedScrollNode.connection;
        long jM6357minusAH228Gc2 = Velocity.m6357minusAH228Gc(j42, j2);
        nestedScrollNode$onPreFling$1.L$0 = null;
        nestedScrollNode$onPreFling$1.J$0 = j2;
        nestedScrollNode$onPreFling$1.label = 2;
        objMo1095onPreFlingQWom1Mo = nestedScrollConnection2.mo1095onPreFlingQWom1Mo(jM6357minusAH228Gc2, nestedScrollNode$onPreFling$1);
    }
    ...
    */
    public Object mo821onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        Object objMo821onPostFlingRZ2iAVY = nestedScrollNode$onPostFling$12.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ...
        if (i == 0) {
            ...
            objMo821onPostFlingRZ2iAVY = nestedScrollConnection.mo821onPostFlingRZ2iAVY(j, j2, nestedScrollNode$onPostFling$12);
        ...
        if (i != 1) {
            ...
            ResultKt.throwOnFailure(objMo821onPostFlingRZ2iAVY);
            jM6365getZero9UxMQ8M = ((Velocity) objMo821onPostFlingRZ2iAVY).getPackedValue();
            packedValue = j5;
            return Velocity.m6345boximpl(Velocity.m6358plusAH228Gc(packedValue, jM6365getZero9UxMQ8M));
        }
        ...
        ResultKt.throwOnFailure(objMo821onPostFlingRZ2iAVY);
        packedValue = ((Velocity) objMo821onPostFlingRZ2iAVY).getPackedValue();
        NestedScrollConnection parentConnection = nestedScrollNode.getParentConnection();
        if (parentConnection != null) {
            long jM6358plusAH228Gc = Velocity.m6358plusAH228Gc(j3, packedValue);
            long jM6357minusAH228Gc = Velocity.m6357minusAH228Gc(j4, packedValue);
            ...
            objMo821onPostFlingRZ2iAVY = parentConnection.mo821onPostFlingRZ2iAVY(jM6358plusAH228Gc, jM6357minusAH228Gc, nestedScrollNode$onPostFling$12);
            if (objMo821onPostFlingRZ2iAVY != coroutine_suspended) {
                j5 = packedValue;
                jM6365getZero9UxMQ8M = ((Velocity) objMo821onPostFlingRZ2iAVY).getPackedValue();
                packedValue = j5;
