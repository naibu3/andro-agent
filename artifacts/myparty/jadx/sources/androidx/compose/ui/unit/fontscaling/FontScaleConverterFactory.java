...
public final class FontScaleConverterFactory {
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM373clone = sLookupTables.m373clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM373clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM373clone;
            Unit unit = Unit.INSTANCE;
        }
    }
