...
public class NativeToJsMessageQueue {
    ...
    public static class LoadUrlBridgeMode extends BridgeMode {
        ...
        private final CordovaInterface f12cordova;
        ...
        public void onNativeToJsMessageAvailable(final NativeToJsMessageQueue nativeToJsMessageQueue) {
            this.f12cordova.getActivity().runOnUiThread(new Runnable() { // from class: org.apache.cordova.NativeToJsMessageQueue.LoadUrlBridgeMode.1
    ...
    public static class EvalBridgeMode extends BridgeMode {
        ...
        /* renamed from: cordova, reason: collision with root package name */
        private final CordovaInterface f11cordova;
        private final CordovaWebViewEngine engine;
        ...
        @Override // org.apache.cordova.NativeToJsMessageQueue.BridgeMode
        public void onNativeToJsMessageAvailable(final NativeToJsMessageQueue nativeToJsMessageQueue) {
            this.f11cordova.getActivity().runOnUiThread(new Runnable() { // from class: org.apache.cordova.NativeToJsMessageQueue.EvalBridgeMode.1
                @Override // java.lang.Runnable
                public void run() {
                    String strPopAndEncodeAsJs = nativeToJsMessageQueue.popAndEncodeAsJs();
                    if (strPopAndEncodeAsJs != null) {
