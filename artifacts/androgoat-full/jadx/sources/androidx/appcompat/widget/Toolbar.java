    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            if (isRtl2) {
                ...
                left3 = layoutChildLeft(this.mNavButtonView, left3, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mCollapseButtonView)) {
            if (isRtl2) {
                ...
                left3 = layoutChildLeft(this.mCollapseButtonView, left3, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mMenuView)) {
            if (isRtl2) {
                left3 = layoutChildLeft(this.mMenuView, left3, collapsingMargins, alignmentHeight);
            } else {
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            if (isRtl2) {
                ...
                left4 = layoutChildLeft(this.mExpandedActionView, left4, collapsingMargins, alignmentHeight);
            }
        }
        if (shouldLayout(this.mLogoView)) {
            if (isRtl2) {
                ...
                left4 = layoutChildLeft(this.mLogoView, left4, collapsingMargins, alignmentHeight);
            }
        }
        ...
        for (int centerViewsCount = this.mTempViews.size(); rightViewsCount2 < centerViewsCount; centerViewsCount = centerViewsCount) {
            centerLeft = layoutChildLeft(this.mTempViews.get(rightViewsCount2), centerLeft, collapsingMargins, alignmentHeight);
            rightViewsCount2++;
        }
