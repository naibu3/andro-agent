        ...
        private final void recordRead(Object value, int currentToken, Object currentScope, MutableObjectIntMap<Object> recordedValues) {
                            ...
                            while (i7 < i6) {
                                if ((j & 255) < 128) {
                                    ...
                                    if (stateObject instanceof StateObjectImpl) {
                                        ...
                                        ((StateObjectImpl) stateObject).m3261recordReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(i3));
                                    }
            ...
            if (iPut == i2) {
                if (value instanceof StateObjectImpl) {
                    ...
                    ((StateObjectImpl) value).m3261recordReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(i));
                }
            ...
            if (changes instanceof ScatterSetWrapper) {
                            ...
                            while (i14 < i13) {
                                if ((j4 & 255) < 128) {
                                    ...
                                    if (obj4 instanceof StateObjectImpl) {
                                        ReaderKind.Companion companion = ReaderKind.INSTANCE;
                                        scopeMap4 = scopeMap6;
                                        if (!((StateObjectImpl) obj4).m3260isReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(2))) {
                                            objArr2 = objArr4;
                                            str2 = str4;
                                            i3 = length;
                                            i4 = i12;
                ...
                while (it3.hasNext()) {
                    ...
                    if (next instanceof StateObjectImpl) {
                        ReaderKind.Companion companion2 = ReaderKind.INSTANCE;
                        if (!((StateObjectImpl) next).m3260isReadInh_f27i8$runtime_release(ReaderKind.m3248constructorimpl(2))) {
                            it = it3;
                            scopeMap = scopeMap5;
