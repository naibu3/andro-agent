...
public final class LocusIdCompat {
    ...
    public LocusIdCompat(String id2) {
        this.mId = (String) Preconditions.checkStringNotEmpty(id2, "id cannot be empty");
        if (Build.VERSION.SDK_INT >= 29) {
            this.mWrapped = Api29Impl.create(id2);
        } else {
            this.mWrapped = null;
        }
    }
    ...
    private static class Api29Impl {
        ...
        static LocusId create(String id2) {
