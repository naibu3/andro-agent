...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo10409getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = mo10409getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo10409getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo10409getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = mo10409getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor2 = typeConstructor.mo10409getDeclarationDescriptor();
        if (classifierDescriptorMo10409getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo10409getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo10409getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo10409getDeclarationDescriptor2);
        }
        return false;
    }
