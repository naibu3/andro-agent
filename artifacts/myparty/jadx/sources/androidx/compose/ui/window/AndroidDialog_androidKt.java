    ...
    public static final void Dialog(final Function0<Unit> function0, DialogProperties dialogProperties, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if (i7 == 0) {
            ...
            if ((i3 & 147) == 146 || !composerStartRestartGroup.getSkipping()) {
                ...
                uuid = (UUID) RememberSaveableKt.m3243rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialogId$1
                ...
                zChangedInstance2 = composerStartRestartGroup.changedInstance(dialogWrapper) | ((i4 & 14) != i5) | ((i4 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) != i6) | composerStartRestartGroup.changed(layoutDirection);
            ...
            AnonymousClass1 anonymousClass1 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1
                ...
                public final MeasureResult mo377measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                    ...
                    for (int i5 = 0; i5 < size; i5++) {
                        arrayList.add(list.get(i5).mo4993measureBRTryo0(j));
                    }
                    ...
                    int width3 = placeable2 != null ? placeable2.getWidth() : Constraints.m6072getMinWidthimpl(j);
                    if (!arrayList2.isEmpty()) {
                    ...
                    return MeasureScope.layout$default(measureScope, width3, placeable3 != null ? placeable3.getHeight() : Constraints.m6071getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(1);
