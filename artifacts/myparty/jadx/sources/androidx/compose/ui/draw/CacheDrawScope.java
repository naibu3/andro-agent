...
public final class CacheDrawScope implements Density {
    ...
    public final long m3306getSizeNHjbRc() {
        return this.cacheParams.mo3304getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m3305recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m6298toIntSizeuvyYCjk(cacheDrawScope.m3306getSizeNHjbRc());
        }
        cacheDrawScope.m3307recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* renamed from: record-TdoYBX4, reason: not valid java name */
    public final void m3307recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, final long j, final Function1<? super ContentDrawScope, Unit> function1) {
        graphicsLayer.m4307recordmLhObY(density, layoutDirection, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long jSize = SizeKt.Size(IntSize.m6287getWidthimpl(j2), IntSize.m6286getHeightimpl(j2));
                ...
                drawContext.mo4135setSizeuvyYCjk(jSize);
