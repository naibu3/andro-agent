...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m98constructorimpl(ResultKt.createFailure(th));
                        return ChannelResult.m1594boximpl(!Result.m105isSuccessimpl(r) ? ChannelResult.INSTANCE.m1609successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1607closedJP2dKIU(Result.m101exceptionOrNullimpl(r)));
                    }
                    if (sendChannel.send(e, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r = Result.m98constructorimpl(Unit.INSTANCE);
                    return ChannelResult.m1594boximpl(!Result.m105isSuccessimpl(r) ? ChannelResult.INSTANCE.m1609successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1607closedJP2dKIU(Result.m101exceptionOrNullimpl(r)));
                case 1:
                    try {
                        ResultKt.throwOnFailure($result);
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess$iv = sendChannel.mo1589trySendJP2dKIU(e);
        ...
        return ChannelResult.INSTANCE.m1609successJP2dKIU(Unit.INSTANCE);
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1604isSuccessimpl(sendChannel.mo1589trySendJP2dKIU(e))) {
