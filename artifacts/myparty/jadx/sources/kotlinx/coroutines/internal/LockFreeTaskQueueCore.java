    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i3 & i2)) {
                getRedactedPhoneNumber getredactedphonenumber = (Object) getArray().get(this.mask & i);
                if (getredactedphonenumber != null && !(getredactedphonenumber instanceof Placeholder)) {
                    arrayList.add(transform.invoke(getredactedphonenumber));
                }
                i++;
            } else {
                return arrayList;
