...
final class GroupKind {
    ...
    private static final int Group = m3119constructorimpl(0);
    private static final int Node = m3119constructorimpl(1);
    private static final int ReusableNode = m3119constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m3118boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3119constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3120equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m3126unboximpl();
    }
    ...
    public static String m3125toStringimpl(int i) {
    ...
    public static final boolean m3123isNodeimpl(int i) {
        return i != INSTANCE.m3127getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m3124isReusableimpl(int i) {
        return i != INSTANCE.m3128getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m3127getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m3128getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m3129getReusableNodeULZAiWs() {
