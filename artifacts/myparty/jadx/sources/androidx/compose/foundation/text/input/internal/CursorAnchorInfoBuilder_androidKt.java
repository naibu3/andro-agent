...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static /* synthetic */ CursorAnchorInfo m1480buildvxqZcH0$default(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4, int i, Object obj) {
        ...
        return m1479buildvxqZcH0(builder, charSequence, j, textRange, textLayoutResult, matrix, rect, rect2, z, z2, z3, z4);
    }

    /* renamed from: build-vxqZcH0, reason: not valid java name */
    public static final CursorAnchorInfo m1479buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int iM5600getMinimpl = TextRange.m5600getMinimpl(j);
        builder.setSelectionRange(iM5600getMinimpl, TextRange.m5599getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, iM5600getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int iM5600getMinimpl2 = textRange != null ? TextRange.m5600getMinimpl(textRange.getPackedValue()) : -1;
            int iM5599getMaximpl = textRange != null ? TextRange.m5599getMaximpl(textRange.getPackedValue()) : -1;
            if (iM5600getMinimpl2 >= 0 && iM5600getMinimpl2 < iM5599getMaximpl) {
                builder.setComposingText(iM5600getMinimpl2, charSequence.subSequence(iM5600getMinimpl2, iM5599getMaximpl));
                addCharacterBounds(builder, iM5600getMinimpl2, iM5599getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m5467fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(i, i2), fArr, 0);
