...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo1147invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m6058boximpl(constraints));
