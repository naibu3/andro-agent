...
.method public createFormHeaderInformation(ZLcom/stripe/android/paymentsheet/model/PaymentMethodIncentive;)Lcom/stripe/android/lpmfoundations/FormHeaderInformation;
    ...
    .line 49
    invoke-virtual {p0}, Lcom/stripe/android/lpmfoundations/paymentmethod/definitions/UsBankAccountUiDefinitionFactory;->createSupportedPaymentMethod()Lcom/stripe/android/lpmfoundations/luxe/SupportedPaymentMethod;

    move-result-object p1

    invoke-virtual {p1, p2}, Lcom/stripe/android/lpmfoundations/luxe/SupportedPaymentMethod;->asFormHeaderInformation(Lcom/stripe/android/paymentsheet/model/PaymentMethodIncentive;)Lcom/stripe/android/lpmfoundations/FormHeaderInformation;

    move-result-object v0

    .line 50
    sget p1, Lcom/stripe/android/ui/core/R$string;->stripe_paymentsheet_add_us_bank_account:I
...
.method public createSupportedPaymentMethod()Lcom/stripe/android/lpmfoundations/luxe/SupportedPaymentMethod;
    ...
    .line 35
    sget-object v0, Lcom/stripe/android/lpmfoundations/paymentmethod/definitions/UsBankAccountDefinition;->INSTANCE:Lcom/stripe/android/lpmfoundations/paymentmethod/definitions/UsBankAccountDefinition;

    invoke-virtual {v0}, Lcom/stripe/android/lpmfoundations/paymentmethod/definitions/UsBankAccountDefinition;->getType()Lcom/stripe/android/model/PaymentMethod$Type;
    ...
    .line 36
    sget v4, Lcom/stripe/android/ui/core/R$string;->stripe_paymentsheet_payment_method_us_bank_account:I
