    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                NativeStorage.AnonymousClass15 anonymousClass15 = (Object) this.array.get(i3 & i);
                if (anonymousClass15 != null && !(anonymousClass15 instanceof Placeholder)) {
                    arrayList.add(transform.invoke(anonymousClass15));
                }
                i++;
            } else {
                return arrayList;
