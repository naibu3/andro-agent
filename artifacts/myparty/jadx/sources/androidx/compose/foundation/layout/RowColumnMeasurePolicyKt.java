    ...
    public static final MeasureResult measure(RowColumnMeasurePolicy rowColumnMeasurePolicy, int i, int i2, int i3, int i4, int i5, MeasureScope measureScope, List<? extends Measurable> list, Placeable[] placeableArr, int i6, int i7, int[] iArr, int i8) {
        ...
        while (true) {
            ...
            if (weight > 0.0f) {
                ...
                int i40 = i3 - i9;
                Placeable placeableMo4993measureBRTryo0 = placeableArr[i33];
                if (placeableMo4993measureBRTryo0 == null) {
                    ...
                    i28 = i34;
                    placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(RowColumnMeasurePolicy.m1045createConstraintsxF2OJ5Q$default(rowColumnMeasurePolicy2, 0, numValueOf != null ? numValueOf.intValue() : i32, i3 != Integer.MAX_VALUE ? RangesKt.coerceAtLeast(i40, i32) : Integer.MAX_VALUE, numValueOf != null ? numValueOf.intValue() : i29, false, 16, null));
                } else {
                    i24 = i31;
                    i25 = i33;
                    i26 = i40;
                ...
                int iMainAxisSize = rowColumnMeasurePolicy2.mainAxisSize(placeableMo4993measureBRTryo0);
                int iCrossAxisSize = rowColumnMeasurePolicy2.crossAxisSize(placeableMo4993measureBRTryo0);
                ...
                placeableArr[i25] = placeableMo4993measureBRTryo0;
                i38 = iMax;
                i37 = iMin;
                i34 = i28;
                f4 = f5;
                    ...
                    try {
                        try {
                            if (RowColumnImplKt.getFill(rowColumnParentData2)) {
                                ...
                                str10 = str19;
                                str11 = str20;
                                Placeable placeableMo4993measureBRTryo02 = measurable2.mo4993measureBRTryo0(rowColumnMeasurePolicy.mo935createConstraintsxF2OJ5Q(i52, iIntValue, i20, i53, true));
                                int iMainAxisSize2 = rowColumnMeasurePolicy.mainAxisSize(placeableMo4993measureBRTryo02);
                                int iCrossAxisSize2 = rowColumnMeasurePolicy.crossAxisSize(placeableMo4993measureBRTryo02);
                                iArr2[i16 - i6] = iMainAxisSize2;
                                iMax2 = Math.max(iMax2, iCrossAxisSize2);
                                placeableArr[i16] = placeableMo4993measureBRTryo02;
                            ...
                            Placeable placeableMo4993measureBRTryo022 = measurable2.mo4993measureBRTryo0(rowColumnMeasurePolicy.mo935createConstraintsxF2OJ5Q(i52, iIntValue, i20, i53, true));
                            int iMainAxisSize22 = rowColumnMeasurePolicy.mainAxisSize(placeableMo4993measureBRTryo022);
                            int iCrossAxisSize22 = rowColumnMeasurePolicy.crossAxisSize(placeableMo4993measureBRTryo022);
                            iArr2[i16 - i6] = iMainAxisSize22;
                            iMax2 = Math.max(iMax2, iCrossAxisSize22);
                            placeableArr[i16] = placeableMo4993measureBRTryo022;
