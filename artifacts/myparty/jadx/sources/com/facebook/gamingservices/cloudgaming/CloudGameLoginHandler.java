...
public class CloudGameLoginHandler {
    ...
    private static AccessToken setCurrentAccessToken(JSONObject jSONObject) throws JSONException {
        ...
        if (strOptString6.isEmpty()) {
            ...
            str = null;
            j = 1000;
            date = new Date(Integer.parseInt(strOptString6) * 1000);
        }
        Object date3 = !strOptString9.isEmpty() ? new Date(Integer.parseInt(strOptString9) * j) : str;
        Object date4 = !strOptString7.isEmpty() ? new Date(Integer.parseInt(strOptString7) * j) : str;
