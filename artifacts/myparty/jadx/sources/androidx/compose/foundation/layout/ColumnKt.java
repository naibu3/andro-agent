...
public final class ColumnKt {
    ...
    public static final long createColumnConstraints(boolean z, int i, int i2, int i3, int i4) {
        ...
        return Constraints.INSTANCE.m6078fitPrioritizingHeightZbe2FdA(i2, i4, i, i3);
    }
}
