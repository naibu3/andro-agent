...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a2, final CallableDescriptor b, final boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil overridingUtilCreate = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality(z, a2, b) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$2
            ...
            if (overridingUtilCreate.isOverridableBy(a2, b, null, !z3).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE && overridingUtilCreate.isOverridableBy(b, a2, null, !z3).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE) {
                return true;
            }
        }
        return false;
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = c1.mo10409getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor2 = c2.mo10409getDeclarationDescriptor();
        if ((classifierDescriptorMo10409getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo10409getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo10409getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo10409getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3
