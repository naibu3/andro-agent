...
public abstract class CallerImpl<M extends Member> implements Caller<M> {
    ...
    */
    ...
    public final M mo1486getMember() {
        return this.member;
    }
    ...
    public static final class Constructor extends CallerImpl<java.lang.reflect.Constructor<?>> {
        ...
        public Object call(Object[] args) {
            ...
            checkArguments(args);
            return mo1486getMember().newInstance(Arrays.copyOf(args, args.length));
        }
    }
    ...
    public static final class BoundConstructor extends CallerImpl<java.lang.reflect.Constructor<?>> implements BoundCaller {
        ...
        public Object call(Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            java.lang.reflect.Constructor<?> member = mo1486getMember();
            SpreadBuilder spreadBuilder = new SpreadBuilder(2);
    ...
    public static abstract class Method extends CallerImpl<java.lang.reflect.Method> {
        ...
        protected final Object callMethod(Object instance, Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            return this.isVoidMethod ? Unit.INSTANCE : mo1486getMember().invoke(instance, Arrays.copyOf(args, args.length));
        }
    ...
    public static abstract class FieldGetter extends CallerImpl<Field> {
        ...
        public Object call(Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            return mo1486getMember().get(getInstanceClass() != null ? ArraysKt.first(args) : null);
        }
        ...
        public static final class BoundInstance extends FieldGetter implements BoundCaller {
            ...
            public Object call(Object[] args) {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                return mo1486getMember().get(this.boundReceiver);
            }
        }
    ...
    public static abstract class FieldSetter extends CallerImpl<Field> {
        ...
        public Object call(Object[] args) throws IllegalAccessException, IllegalArgumentException {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            mo1486getMember().set(getInstanceClass() != null ? ArraysKt.first(args) : null, ArraysKt.last(args));
        ...
        public static final class BoundInstance extends FieldSetter implements BoundCaller {
            ...
            public Object call(Object[] args) throws IllegalAccessException, IllegalArgumentException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo1486getMember().set(this.boundReceiver, ArraysKt.first(args));
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class BoundJvmStaticInObject extends FieldSetter implements BoundCaller {
            ...
            public Object call(Object[] args) throws IllegalAccessException, IllegalArgumentException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo1486getMember().set(null, ArraysKt.last(args));
                return Unit.INSTANCE;
            }
        }
    }
    ...
    /* compiled from: CallerImpl.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006J(\u0010\u0007\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006J(\u0010\b\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006¨\u0006\t"}, d2 = {"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Companion;", "", "()V", "dropFirst", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "([Ljava/lang/Object;)[Ljava/lang/Object;", "dropFirstAndLast", "dropLast", "kotlin-reflection"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
