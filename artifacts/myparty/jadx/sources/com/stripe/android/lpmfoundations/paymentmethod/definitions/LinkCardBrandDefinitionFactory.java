...
final class LinkCardBrandDefinitionFactory implements UiDefinitionFactory.Simple {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod() {
        return new SupportedPaymentMethod(InstantDebitsDefinition.INSTANCE.getType().code, "link_card_brand", R.string.stripe_paymentsheet_payment_method_instant_debits, R.drawable.stripe_ic_paymentsheet_pm_bank, (Integer) null, true, (String) null, (String) null, (ResolvableString) null, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_bank_outlined), 256, (DefaultConstructorMarker) null);
    }
