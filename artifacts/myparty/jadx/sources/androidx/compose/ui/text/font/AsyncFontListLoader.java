    ...
    */
    public final Object load(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i3 == 0) {
            ...
            List<Font> list3 = (List) anonymousClass1.L$1;
            asyncFontListLoader3 = (AsyncFontListLoader) anonymousClass1.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                font = font2;
                list2 = list3;
            ...
            try {
                ...
                if (i < size) {
                    try {
                        ...
                        if (FontLoadingStrategy.m5699equalsimpl0(font3.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m5703getAsyncPKNRLFQ())) {
                            ...
                            anonymousClass12.L$0 = asyncFontListLoader2;
                            anonymousClass12.L$1 = list;
                            anonymousClass12.L$2 = font3;
                            anonymousClass12.I$0 = i;
                            anonymousClass12.I$1 = size;
                            anonymousClass12.label = 1;
                            Object objRunCached = asyncTypefaceCache.runCached(font3, platformFontLoader, false, asyncFontListLoader$load$2$typeface$1, anonymousClass12);
                            if (objRunCached != coroutine_suspended) {
                                ...
                                i2 = i;
                                if (obj == null) {
                                    asyncFontListLoader3.setValue(FontSynthesis_androidKt.m5733synthesizeTypefaceFxwP2eA(asyncFontListLoader3.typefaceRequest.m5758getFontSynthesisGVVA2EU(), obj, font, asyncFontListLoader3.typefaceRequest.getFontWeight(), asyncFontListLoader3.typefaceRequest.m5757getFontStyle_LCdwA()));
                                    Unit unit = Unit.INSTANCE;
                                    boolean zIsActive = JobKt.isActive(anonymousClass1.get$context());
                                ...
                                anonymousClass1.L$0 = asyncFontListLoader3;
        ...
        boolean zIsActive3 = JobKt.isActive(anonymousClass1.get$context());
