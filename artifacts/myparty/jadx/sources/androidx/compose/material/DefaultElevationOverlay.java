...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1875apply7g2Lkgo(long j, float f, Composer composer, int i) {
        ...
        if (Dp.m6116compareTo0680j_4(f, Dp.m6117constructorimpl(0)) > 0 && !colors.isLight()) {
            composer.startReplaceGroup(1169013963);
            ComposerKt.sourceInformation(composer, "71@2841L42");
            j = ColorKt.m3702compositeOverOWjLjI(ElevationOverlayKt.m1901calculateForegroundColorCLU3JFs(j, f, composer, i & WebSocketProtocol.PAYLOAD_SHORT), j);
