...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m3494getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m4329applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m4293getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo4322setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m3508toAndroidBlendModes9anfk8(i));
    ...
    public void mo4321setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m3711toArgb8_81llA(j));
    }
    ...
    public void mo4327setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m3711toArgb8_81llA(j));
    }
    ...
    private final void m4329applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m4289equalsimpl0(i, CompositingStrategy.INSTANCE.m4295getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4289equalsimpl0(i, CompositingStrategy.INSTANCE.m4294getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4329applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m4295getOffscreenke2Ky5w());
        } else {
            m4329applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo4326setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m6287getWidthimpl(size) + x, IntSize.m6286getHeightimpl(size) + y);
        this.size = IntSizeKt.m6299toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo4135setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4289equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4295getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
