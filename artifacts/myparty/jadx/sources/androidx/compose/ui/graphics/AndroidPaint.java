...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3599getSrcOver0nO6VwU();
    }
    ...
    public long mo3530getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3536setColor8_81llA(long j) {
        AndroidPaint_androidKt.m3542setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo3535setBlendModes9anfk8(int i) {
        if (BlendMode.m3568equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m3541setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3534getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo3540setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m3546setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo3532getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo3538setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m3544setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3533getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3539setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m3545setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo3531getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo3537setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m3543setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
