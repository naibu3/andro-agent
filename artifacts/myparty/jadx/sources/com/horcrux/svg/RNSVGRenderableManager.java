...
class RNSVGRenderableManager extends NativeSvgRenderableModuleSpec {
    ...
    public boolean isPointInFill(Double d, ReadableMap readableMap) {
        ...
        return renderableViewByTag.hitTest(new float[]{((float) readableMap.getDouble("x")) * f, ((float) readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE)) * f}) != -1;
    }
    ...
    public boolean isPointInStroke(Double d, ReadableMap readableMap) {
        ...
        try {
            ...
            int i2 = (int) (readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE) * d2);
    ...
    public WritableMap getPointAtLength(Double d, ReadableMap readableMap) {
        ...
        try {
            ...
            writableMapCreateMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, fArr[1] / r8);
    ...
    public WritableMap getBBox(Double d, ReadableMap readableMap) {
        ...
        try {
            ...
            writableMapCreateMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, rectF.top / f);
