...
public final class FileSystem {
    ...
    @DebugMetadata(c = "okio.internal.-FileSystem$commonListRecursively$1", f = "FileSystem.kt", i = {0, 0}, l = {AESGCM.IV_BIT_LENGTH}, m = "invokeSuspend", n = {"$this$sequence", StackTraceHelper.STACK_KEY}, s = {"L$0", "L$1"})
    /* renamed from: okio.internal.-FileSystem$commonListRecursively$1, reason: invalid class name and case insensitive filesystem */
    static final class C13211 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C13211(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C13211> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C13211 c13211 = new C13211(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c13211.L$0 = obj;
            return c13211;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C13211) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C13211(dir, fileSystem, z, null));
    }
    ...
    */
    public static final Object collectRecursively(SequenceScope<? super Path> sequenceScope, okio.FileSystem fileSystem, ArrayDeque<Path> arrayDeque, Path path, boolean z, boolean z2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            SequenceScope<? super Path> sequenceScope4 = (SequenceScope) anonymousClass1.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                boolean z12 = z10;
                z4 = z11;
                ...
                if (!it.hasNext()) {
                    try {
                        ...
                        Object objCollectRecursively = collectRecursively(sequenceScope3, fileSystem4, arrayDeque3, next, z5, z6, anonymousClass12);
    ...
    public static final void commonCopy(okio.FileSystem fileSystem, Path source, Path target) throws IOException {
        ...
        try {
            ...
            if (bufferedSinkBuffer != null) {
                ...
                if (th != null) {
                    ?? ValueOf = Long.valueOf(lValueOf.longValue());
                    if (source2 != null) {
                        try {
                            source2.close();
                        } catch (Throwable th6) {
