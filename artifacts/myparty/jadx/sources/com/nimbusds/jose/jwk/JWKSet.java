...
public class JWKSet implements Serializable {
    ...
    public JWKSet(JWK jwk) {
        this((List<JWK>) Collections.singletonList(Objects.requireNonNull(jwk, "The JWK must not be null")));
    }
    ...
    public JWKSet(List<JWK> list, Map<String, Object> map) {
        this.keys = Collections.unmodifiableList((List) Objects.requireNonNull(list, "The JWK list must not be null"));
