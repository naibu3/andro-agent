...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public void onDetach() {
        ...
        if (i == 1 || i == 2) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo3345clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m3336getExitdhqQ8s());
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(2048);
        int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = iM5228constructorimpl | iM5228constructorimpl2;
            ...
            if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & iM5228constructorimpl2) != 0) {
                            break loop0;
                        }
    ...
    public final void m3361fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomEnter) {
            return;
        }
        this.isProcessingCustomEnter = true;
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3325boximpl(focusDirection));
    ...
    public final void m3362fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (this.isProcessingCustomExit) {
            return;
        }
        this.isProcessingCustomExit = true;
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3325boximpl(focusDirection));
            if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(focusRequesterInvoke);
            }
        } finally {
        ...
        while (mutableVector.isNotEmpty()) {
            ...
            if ((node.getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                for (Modifier.Node child2 = node; child2 != null; child2 = child2.getChild()) {
                    if ((child2.getKindSet() & iM5228constructorimpl) != 0) {
