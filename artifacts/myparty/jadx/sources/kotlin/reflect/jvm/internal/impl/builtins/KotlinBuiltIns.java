...
public abstract class KotlinBuiltIns {
    ...
    */
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo10411getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = kotlinType.getConstructor().mo10409getDeclarationDescriptor();
        return (classifierDescriptorMo10409getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo10409getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo10409getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = kotlinType.getConstructor().mo10409getDeclarationDescriptor();
        return (classifierDescriptorMo10409getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo10409getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo10409getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo10409getDeclarationDescriptor, fqNameUnsafe);
    }
