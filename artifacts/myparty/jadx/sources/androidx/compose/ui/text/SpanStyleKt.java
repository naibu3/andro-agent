...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m3692getTransparent0d7_KjU();
    ...
    static {
        long jM3683getBlack0d7_KjU = Color.INSTANCE.m3683getBlack0d7_KjU();
        DefaultColor = jM3683getBlack0d7_KjU;
        DefaultColorForegroundStyle = TextForegroundStyle.INSTANCE.m6027from8_81llA(jM3683getBlack0d7_KjU);
    }

    /* renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m5558lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m6328isUnspecifiedR2X_6o(j) || TextUnitKt.m6328isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m6300boximpl(j), TextUnit.m6300boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m6330lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle spanStyle, SpanStyle spanStyle2, float f) {
        ...
        long jM5558lerpTextUnitInheritableC3pnCVY = m5558lerpTextUnitInheritableC3pnCVY(spanStyle.getFontSize(), spanStyle2.getFontSize(), f);
        ...
        long jM5558lerpTextUnitInheritableC3pnCVY2 = m5558lerpTextUnitInheritableC3pnCVY(spanStyle.getLetterSpacing(), spanStyle2.getLetterSpacing(), f);
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        float fM5896unboximpl = baselineShift != null ? baselineShift.m5896unboximpl() : BaselineShift.m5891constructorimpl(0.0f);
        BaselineShift baselineShift2 = spanStyle2.getBaselineShift();
        float fM5903lerpjWV1Mfo = BaselineShiftKt.m5903lerpjWV1Mfo(fM5896unboximpl, baselineShift2 != null ? baselineShift2.m5896unboximpl() : BaselineShift.m5891constructorimpl(0.0f), f);
        ...
        long jM3708lerpjxsXWHM = ColorKt.m3708lerpjxsXWHM(spanStyle.getBackground(), spanStyle2.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM5558lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM5558lerpTextUnitInheritableC3pnCVY2, BaselineShift.m5890boximpl(fM5903lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM3708lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle spanStyle) {
        ...
        long fontSize = TextUnitKt.m6328isUnspecifiedR2X_6o(spanStyle.getFontSize()) ? DefaultFontSize : spanStyle.getFontSize();
        FontWeight fontWeight = spanStyle.getFontWeight();
        if (fontWeight == null) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        ...
        FontSynthesis fontSynthesisM5720boximpl = FontSynthesis.m5720boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5729getAllGVVA2EU());
        ...
        if (TextUnitKt.m6328isUnspecifiedR2X_6o(spanStyle.getLetterSpacing())) {
        ...
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        BaselineShift baselineShiftM5890boximpl = BaselineShift.m5890boximpl(baselineShift != null ? baselineShift.m5896unboximpl() : BaselineShift.INSTANCE.m5900getNoney9eOQZs());
        TextGeometricTransform textGeometricTransform = spanStyle.getTextGeometricTransform();
        if (textGeometricTransform == null) {
            textGeometricTransform = TextGeometricTransform.INSTANCE.getNone$ui_text_release();
        }
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM5709boximpl, fontSynthesisM5720boximpl, fontFamily2, str, j, baselineShiftM5890boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    */
    public static final SpanStyle m5557fastMergedSHsh3o(SpanStyle spanStyle, long j, Brush brush, float f, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle) {
        long fontSize;
        ...
        TextDecoration textDecoration2 = textDecoration;
        Shadow shadow2 = shadow;
        if (!TextUnitKt.m6328isUnspecifiedR2X_6o(j2)) {
            fontSize = j2;
            if (!TextUnit.m6307equalsimpl0(fontSize, spanStyle.getFontSize())) {
                textGeometricTransform2 = textGeometricTransform;
                background = j4;
                drawStyle2 = drawStyle;
            }
            if (brush == null) {
                textForegroundStyleM6027from8_81llA = TextForegroundStyle.INSTANCE.from(brush, f);
            } else {
                textForegroundStyleM6027from8_81llA = TextForegroundStyle.INSTANCE.m6027from8_81llA(j);
            }
            TextForegroundStyle textForegroundStyleMerge = spanStyle.getTextForegroundStyle().merge(textForegroundStyleM6027from8_81llA);
            FontFamily fontFamily2 = fontFamily != null ? spanStyle.getFontFamily() : fontFamily;
            if (TextUnitKt.m6328isUnspecifiedR2X_6o(fontSize)) {
            ...
            long letterSpacing = TextUnitKt.m6328isUnspecifiedR2X_6o(j3) ? j3 : spanStyle.getLetterSpacing();
        ...
        fontSize = j2;
        if ((brush != null || j == 16 || Color.m3658equalsimpl0(j, spanStyle.getTextForegroundStyle().mo5904getColor0d7_KjU())) && ((fontStyle == null || Intrinsics.areEqual(fontStyle, spanStyle.getFontStyle())) && ((fontWeight == null || Intrinsics.areEqual(fontWeight, spanStyle.getFontWeight())) && ((fontFamily == null || fontFamily == spanStyle.getFontFamily()) && (TextUnitKt.m6328isUnspecifiedR2X_6o(j3) || TextUnit.m6307equalsimpl0(j3, spanStyle.getLetterSpacing())))))) {
            if ((textDecoration2 == null || Intrinsics.areEqual(textDecoration2, spanStyle.getTextDecoration())) && Intrinsics.areEqual(brush, spanStyle.getTextForegroundStyle().getBrush()) && ((brush == null || f == spanStyle.getTextForegroundStyle().getAlpha()) && ((fontSynthesis == null || Intrinsics.areEqual(fontSynthesis, spanStyle.getFontSynthesis())) && ((fontFeatureSettings == null || Intrinsics.areEqual(fontFeatureSettings, spanStyle.getFontFeatureSettings())) && (baselineShift2 == null || Intrinsics.areEqual(baselineShift2, spanStyle.getBaselineShift())))))) {
                ...
                if (localeList == null || Intrinsics.areEqual(localeList, spanStyle.getLocaleList())) {
                    if (j4 != 16) {
                        background = j4;
                        if (Color.m3658equalsimpl0(background, spanStyle.getBackground())) {
                        }
                    } else {
                        background = j4;
                    }
        ...
        TextForegroundStyle textForegroundStyleMerge2 = spanStyle.getTextForegroundStyle().merge(textForegroundStyleM6027from8_81llA);
        if (fontFamily != null) {
        }
        if (TextUnitKt.m6328isUnspecifiedR2X_6o(fontSize)) {
        }
        ...
        if (TextUnitKt.m6328isUnspecifiedR2X_6o(j3)) {
        }
        if (baselineShift2 == null) {
        }
        if (textGeometricTransform2 == null) {
