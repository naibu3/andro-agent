    ...
    void applyToInternal(ConstraintLayout constraintLayout, boolean applyPostLayout) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id2))) {
                ...
                if (id2 != -1) {
                    if (this.mConstraints.containsKey(Integer.valueOf(id2))) {
                        used.remove(Integer.valueOf(id2));
                        Constraint constraint = this.mConstraints.get(Integer.valueOf(id2));
                        if (constraint != null) {
                            if (view instanceof Barrier) {
        ...
        while (it.hasNext()) {
            Integer id3 = it.next();
            Constraint constraint2 = this.mConstraints.get(id3);
            if (constraint2 != null) {
                if (constraint2.layout.mHelperType == 1) {
                    Barrier barrier2 = new Barrier(constraintLayout.getContext());
                    barrier2.setId(id3.intValue());
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer id2 : ConstraintSet.this.mConstraints.keySet()) {
                ...
                String idName = getName(id2.intValue());
        ...
        String getName(int id2) {
            ...
            String name = lookup(id2);
            this.idMap.put(Integer.valueOf(id2), name);
            return "@+id/" + name + "";
        }
