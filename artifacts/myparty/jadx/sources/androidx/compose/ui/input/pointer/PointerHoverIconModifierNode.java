...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo548onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4817getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m4813equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4818getExit7fucELk())) {
                onExit();
            }
        }
    }
