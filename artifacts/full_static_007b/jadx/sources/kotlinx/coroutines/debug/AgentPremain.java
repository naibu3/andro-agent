...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM98constructorimpl = Result.m98constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM98constructorimpl = Result.m98constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m104isFailureimpl(objM98constructorimpl) ? null : objM98constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1611installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1611installSignalHandler$lambda1(Signal it) {
