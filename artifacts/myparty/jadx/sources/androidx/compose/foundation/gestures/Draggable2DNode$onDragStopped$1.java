...
final class Draggable2DNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Velocity velocityM6345boximpl = Velocity.m6345boximpl(this.this$0.m780reverseIfNeededAH228Gc(this.$velocity));
            this.label = 1;
            if (function3.invoke(coroutineScope, velocityM6345boximpl, this) == coroutine_suspended) {
