...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo5854getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5666getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m5712equalsimpl0(fontStyle, FontStyle.INSTANCE.m5718getItalic_LCdwA()));
    }
}
