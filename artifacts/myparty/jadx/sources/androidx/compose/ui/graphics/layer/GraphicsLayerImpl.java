...
public interface GraphicsLayerImpl {
    ...
    void mo4321setAmbientShadowColor8_81llA(long j);

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    void mo4322setBlendModes9anfk8(int i);
    ...
    void mo4323setCompositingStrategyWpw9cng(int i);

    void setInvalidated(boolean z);

    /* renamed from: setOutline-O0kMr_c, reason: not valid java name */
    void mo4324setOutlineO0kMr_c(Outline outline, long outlineSize);

    /* renamed from: setPivotOffset-k-4lQ0M, reason: not valid java name */
    void mo4325setPivotOffsetk4lQ0M(long j);

    /* renamed from: setPosition-H0pRuoY, reason: not valid java name */
    void mo4326setPositionH0pRuoY(int x, int y, long size);
    ...
    void mo4327setSpotShadowColor8_81llA(long j);
    ...
    public static final class Companion {
        ...
        private static final Function1<DrawScope, Unit> DefaultDrawBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.layer.GraphicsLayerImpl$Companion$DefaultDrawBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                DrawScope.m4207drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m3692getTransparent0d7_KjU(), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
            }
        };
