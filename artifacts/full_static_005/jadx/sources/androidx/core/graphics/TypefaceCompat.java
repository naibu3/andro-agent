...
public class TypefaceCompat {
    ...
    public static Typeface findFromCache(Resources resources, int id2, String path, int cookie, int style) {
        return sTypefaceCache.get(createResourceUid(resources, id2, path, cookie, style));
    }

    @Deprecated
    public static Typeface findFromCache(Resources resources, int id2, int style) {
        return findFromCache(resources, id2, null, 0, style);
    }

    private static String createResourceUid(Resources resources, int id2, String path, int cookie, int style) {
        return resources.getResourcePackageName(id2) + '-' + path + '-' + cookie + '-' + id2 + '-' + style;
    }
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry entry, Resources resources, int id2, String path, int cookie, int style, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean isRequestFromLayoutInflator) {
        Typeface typeface;
        boolean isBlocking;
        ...
        if (typeface != null) {
            sTypefaceCache.put(createResourceUid(resources, id2, path, cookie, style), typeface);
        }
        return typeface;
    }

    @Deprecated
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry entry, Resources resources, int id2, int style, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean isRequestFromLayoutInflator) {
        return createFromResourcesFamilyXml(context, entry, resources, id2, null, 0, style, fontCallback, handler, isRequestFromLayoutInflator);
    }

    public static Typeface createFromResourcesFontFile(Context context, Resources resources, int id2, String path, int cookie, int style) {
        Typeface typeface = sTypefaceCompatImpl.createFromResourcesFontFile(context, resources, id2, path, style);
        if (typeface != null) {
            String resourceUid = createResourceUid(resources, id2, path, cookie, style);
    ...
    @Deprecated
    public static Typeface createFromResourcesFontFile(Context context, Resources resources, int id2, String path, int style) {
        return createFromResourcesFontFile(context, resources, id2, path, 0, style);
    }
