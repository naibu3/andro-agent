...
final class StaticLayoutBuilderCompat {
    ...
    public StaticLayout build() throws StaticLayoutBuilderCompatException {
        ...
        CharSequence textToDraw2 = this.source;
        if (this.maxLines == 1) {
            CharSequence textToDraw3 = TextUtils.ellipsize(this.source, this.paint, availableWidth, this.ellipsize);
            textToDraw = textToDraw3;
        } else {
            textToDraw = textToDraw2;
        }
