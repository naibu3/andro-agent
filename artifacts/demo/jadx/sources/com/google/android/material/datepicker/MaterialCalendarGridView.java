            ...
            if (range.first == null) {
                ...
                if (!skipMonth(firstOfMonth, lastOfMonth, Long.valueOf(startItem), Long.valueOf(endItem))) {
                    ...
                    while (row <= lastRow) {
                        ...
                        int firstPositionInRow = row * materialCalendarGridView.getNumColumns();
                        int row2 = row;
                        int row3 = (firstPositionInRow + materialCalendarGridView.getNumColumns()) - 1;
                        ...
                        if (!isRtl) {
                            ...
                            width = rangeHighlightStart3 > row3 ? getWidth() : rangeHighlightEnd;
                        } else {
                            left = rangeHighlightStart3 > row3 ? 0 : rangeHighlightEnd;
