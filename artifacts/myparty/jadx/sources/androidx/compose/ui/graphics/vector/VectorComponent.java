...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3473boximpl(Size.INSTANCE.m3494getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m3493getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    drawContext.getTransform().mo4141scale0AR0LA0(f, f2, jM3432getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m4358getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo3524getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m3878getArgb8888_sVssgQ();
    }
    ...
    public final long m4359getViewportSizeNHjbRc$ui_release() {
        return ((Size) this.viewportSize.getValue()).getPackedValue();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4360setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m3473boximpl(j));
    }
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m3481equalsimpl0(this.previousDrawSize, drawScope.mo4213getSizeNHjbRc()) || !ImageBitmapConfig.m3873equalsimpl0(i, m4358getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m3873equalsimpl0(i, ImageBitmapConfig.INSTANCE.m3877getAlpha8_sVssgQ()) ? ColorFilter.Companion.m3698tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Size.m3485getWidthimpl(drawScope.mo4213getSizeNHjbRc()) / Size.m3485getWidthimpl(m4359getViewportSizeNHjbRc$ui_release());
            this.rootScaleY = Size.m3482getHeightimpl(drawScope.mo4213getSizeNHjbRc()) / Size.m3482getHeightimpl(m4359getViewportSizeNHjbRc$ui_release());
            this.cacheDrawScope.m4341drawCachedImageFqjB98A(i, IntSizeKt.IntSize((int) Math.ceil(Size.m3485getWidthimpl(drawScope.mo4213getSizeNHjbRc())), (int) Math.ceil(Size.m3482getHeightimpl(drawScope.mo4213getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo4213getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        ...
        sb.append(Size.m3485getWidthimpl(m4359getViewportSizeNHjbRc$ui_release())).append("\n\tviewportHeight: ");
        sb.append(Size.m3482getHeightimpl(m4359getViewportSizeNHjbRc$ui_release())).append("\n");
