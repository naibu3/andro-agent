...
public class MobileAds {
    ...
    public static CustomTabsSession registerCustomTabsSession(Context context, CustomTabsClient customTabsClient, String str, CustomTabsCallback customTabsCallback) {
        ...
        zzcbg zzcbgVarZza = zzbvx.zza(context);
        if (zzcbgVarZza == null) {
            zzm.zzg("Internal error, query info generator is null.");
            return null;
        }
        try {
            return (CustomTabsSession) ObjectWrapper.unwrap(zzcbgVarZza.zze(ObjectWrapper.wrap(context), ObjectWrapper.wrap(customTabsClient), str, ObjectWrapper.wrap(customTabsCallback)));
    ...
    public static void registerWebView(WebView webView) {
        ...
        zzcbg zzcbgVarZza = zzbvx.zza(webView.getContext());
        if (zzcbgVarZza == null) {
            zzm.zzg("Internal error, query info generator is null.");
            return;
        }
        try {
            zzcbgVarZza.zzj(ObjectWrapper.wrap(webView));
