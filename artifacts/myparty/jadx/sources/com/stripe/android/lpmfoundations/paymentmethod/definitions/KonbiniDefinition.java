...
public final class KonbiniDefinition implements PaymentMethodDefinition {
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.MerchantSupportsDelayedPaymentMethods, AddPaymentMethodRequirement.UnsupportedForSetup});
    }

    @Override // com.stripe.android.lpmfoundations.paymentmethod.PaymentMethodDefinition
    public UiDefinitionFactory uiDefinitionFactory() {
        return KonbiniUiDefinitionFactory.INSTANCE;
    }
}
