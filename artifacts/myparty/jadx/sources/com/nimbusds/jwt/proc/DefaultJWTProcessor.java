...
public class DefaultJWTProcessor<C extends SecurityContext> implements ConfigurableJWTProcessor<C> {
    ...
    protected JWTClaimsSet verifyJWTClaimsSet(JWTClaimsSet jWTClaimsSet, C c) throws BadJWTException {
    ...
    protected List<? extends Key> selectKeys(JWSHeader jWSHeader, JWTClaimsSet jWTClaimsSet, C c) throws KeySourceException, BadJOSEException {
