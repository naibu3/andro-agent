...
public final class ClickableTextKt {
    ...
    */
    public static final void m1321ClickableText4YKlhWE(final AnnotatedString annotatedString, Modifier modifier, TextStyle textStyle, boolean z, int i, int i2, Function1<? super TextLayoutResult, Unit> function1, final Function1<? super Integer, Unit> function12, Composer composer, final int i3, final int i4) {
        ...
        if (i12 != 0) {
            ...
            if (i6 == 0) {
                ...
                if (i7 != 0) {
                    ...
                    if (i8 != 0) {
                        ...
                        if ((i5 & 4793491) != 4793490 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            BasicTextKt.m1314BasicTextRWo7tUw(annotatedString2, modifierThen, textStyle4, (Function1) objRememberedValue2, iM6055getClipgIe3tQ8, z6, i15, 0, null, null, composer2, (i14 & 58254) | ((i14 << 6) & 458752) | (3670016 & (i14 << 3)), 896);
                            if (ComposerKt.isTraceInProgress()) {
                        ...
                        final int i16 = iM6055getClipgIe3tQ8;
                        ...
                        if (scopeUpdateScopeEndRestartGroup != null) {
                            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$3
                                ...
                                public final void invoke(Composer composer3, int i17) {
                                    ClickableTextKt.m1321ClickableText4YKlhWE(annotatedString, modifier3, textStyle3, z5, i16, i11, function13, function12, composer3, RecomposeScopeImplKt.updateChangedFlags(i3 | 1), i4);
                                }
                            });
                            return;
                        }
                    ...
                    if ((i5 & 4793491) != 4793490) {
                        ...
                        if (!z3) {
                            ...
                            if (!z4) {
                                ...
                                BasicTextKt.m1314BasicTextRWo7tUw(annotatedString2, modifierThen2, textStyle42, (Function1) objRememberedValue2, iM6055getClipgIe3tQ8, z62, i152, 0, null, null, composer2, (i142 & 58254) | ((i142 << 6) & 458752) | (3670016 & (i142 << 3)), 896);
                                if (ComposerKt.isTraceInProgress()) {
                                }
                                function13 = clickableTextKt$ClickableText$1;
                    ...
                    final int i162 = iM6055getClipgIe3tQ8;
                    scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                    if (scopeUpdateScopeEndRestartGroup != null) {
                    }
                }
                ...
                final int i1622 = iM6055getClipgIe3tQ8;
                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                if (scopeUpdateScopeEndRestartGroup != null) {
                }
            }
            ...
            final int i16222 = iM6055getClipgIe3tQ8;
            scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
            if (scopeUpdateScopeEndRestartGroup != null) {
            }
        }
        ...
        final int i162222 = iM6055getClipgIe3tQ8;
        scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup != null) {
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1320ClickableText03UYbkw(final AnnotatedString annotatedString, final Function1<? super Integer, Unit> function1, Modifier modifier, TextStyle textStyle, boolean z, int i, int i2, Function1<? super TextLayoutResult, Unit> function12, final Function1<? super Integer, Unit> function13, Composer composer, final int i3, final int i4) {
        AnnotatedString annotatedString2;
        int i5;
        Modifier modifier2;
        int i6;
            ...
            if (i6 == 0) {
                ...
                if (i7 == 0) {
                    ...
                    if ((i5 & 38347923) == 38347922 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        int iM6055getClipgIe3tQ8 = i8 == 0 ? TextOverflow.INSTANCE.m6055getClipgIe3tQ8() : i9;
                        if (i10 != 0) {
                        ...
                        int i15 = i5;
                        zChangedInstance = composerStartRestartGroup.changedInstance(coroutineScope) | ((i5 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) != 32) | ((i15 & 234881024) != 67108864);
                        ...
                        TextStyle textStyle4 = textStyle2;
                        boolean z5 = z2;
                        BasicTextKt.m1314BasicTextRWo7tUw(annotatedString2, modifierThen, textStyle4, (Function1) objRememberedValue3, iM6055getClipgIe3tQ8, z5, i17, 0, null, null, composer2, (i15 & 14) | (i16 & 896) | (i16 & 57344) | ((i15 << 3) & 458752) | (i15 & 3670016), 896);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    ...
                    if (scopeUpdateScopeEndRestartGroup == null) {
                        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$6
                            ...
                            public final void invoke(Composer composer3, int i18) {
                                ClickableTextKt.m1320ClickableText03UYbkw(annotatedString, function1, modifier3, textStyle3, z4, i9, i13, function15, function13, composer3, RecomposeScopeImplKt.updateChangedFlags(i3 | 1), i4);
                            }
                        });
                        return;
                    }
                ...
                if ((i5 & 38347923) == 38347922) {
                    ...
                    ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1498201253, "CC(remember):ClickableText.kt#9igjgp");
                    int i152 = i5;
                    zChangedInstance = composerStartRestartGroup.changedInstance(coroutineScope) | ((i5 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) != 32) | ((i152 & 234881024) != 67108864);
                    clickableTextKt$ClickableText$pointerInputModifier$1$1RememberedValue = composerStartRestartGroup.rememberedValue();
                    if (zChangedInstance) {
                        function14 = function1;
                        clickableTextKt$ClickableText$pointerInputModifier$1$1RememberedValue = new ClickableTextKt$ClickableText$pointerInputModifier$1$1(coroutineScope, function1, mutableState, function13, null);
                        ...
                        if (!z3) {
                            ...
                            TextStyle textStyle42 = textStyle2;
                            boolean z52 = z2;
                            BasicTextKt.m1314BasicTextRWo7tUw(annotatedString2, modifierThen2, textStyle42, (Function1) objRememberedValue3, iM6055getClipgIe3tQ8, z52, i172, 0, null, null, composer2, (i152 & 14) | (i162 & 896) | (i162 & 57344) | ((i152 << 3) & 458752) | (i152 & 3670016), 896);
                            if (ComposerKt.isTraceInProgress()) {
                            }
                            function15 = clickableTextKt$ClickableText$4;
                            modifier3 = modifier2;
    ...
    public static final Integer ClickableText_03UYbkw$getOffset(MutableState<TextLayoutResult> mutableState, long j) {
        ...
        if (value != null && (multiParagraph = value.getMultiParagraph()) != null) {
            if (!m1322containsWithinBoundsUv8p0NA(multiParagraph, j)) {
                multiParagraph = null;
            }
            if (multiParagraph != null) {
                return Integer.valueOf(multiParagraph.m5468getOffsetForPositionk4lQ0M(j));
            }
        }
        return null;
    }
    ...
    private static final boolean m1322containsWithinBoundsUv8p0NA(MultiParagraph multiParagraph, long j) {
        float fM3416getXimpl = Offset.m3416getXimpl(j);
        float fM3417getYimpl = Offset.m3417getYimpl(j);
        return fM3416getXimpl > 0.0f && fM3417getYimpl >= 0.0f && fM3416getXimpl <= multiParagraph.getWidth() && fM3417getYimpl <= multiParagraph.getHeight();
    }
}
