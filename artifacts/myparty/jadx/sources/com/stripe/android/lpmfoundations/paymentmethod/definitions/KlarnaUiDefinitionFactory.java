...
final class KlarnaUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) KlarnaDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_klarna, R.drawable.stripe_ic_paymentsheet_pm_klarna, (Integer) null, false, ResolvableStringUtilsKt.getResolvableString(R.string.stripe_klarna_pay_later), (Integer) null, 160, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        if (KlarnaDefinition.INSTANCE.requiresMandate(metadata)) {
            listEmptyList = CollectionsKt.listOf(new KlarnaMandateTextSpec((IdentifierSpec) null, 0, 3, (DefaultConstructorMarker) null));
        } else {
