...
final class CryptoUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) CryptoDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_crypto, R.drawable.stripe_ic_paymentsheet_pm_crypto_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_crypto_night), true, (ResolvableString) null, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_crypto_outlined), 64, (DefaultConstructorMarker) null);
    }
}
