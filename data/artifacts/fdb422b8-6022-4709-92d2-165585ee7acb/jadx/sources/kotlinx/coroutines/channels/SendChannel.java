...
public interface SendChannel<E> {
    ...
    Object mo1635trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1635trySendJP2dKIU(e);
            if (ChannelResult.m1650isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1644exceptionOrNullimpl = ChannelResult.m1644exceptionOrNullimpl(result);
