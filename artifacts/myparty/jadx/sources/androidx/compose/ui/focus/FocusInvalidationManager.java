                        ...
                        if ((j7 & j) < 128) {
                            ...
                            if (focusEventModifierNode.getNode().getIsAttached()) {
                                ...
                                while (mutableVector7.isNotEmpty()) {
                                    ...
                                    if ((nodePop2.getAggregateChildKindSet() & iM5228constructorimpl2) == 0) {
                                        DelegatableNodeKt.addLayoutNodeChildren(mutableVector7, nodePop2);
                                    } else {
                                        while (nodePop2 != null) {
                                            if ((nodePop2.getKindSet() & iM5228constructorimpl2) != 0) {
                                                ...
                                                while (nodePop2 != null) {
                                                    ...
                                                    } else if ((nodePop2.getKindSet() & iM5228constructorimpl2) != 0 && (nodePop2 instanceof DelegatingNode)) {
                                                        int i19 = 0;
