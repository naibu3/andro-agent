...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m4791addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m4792addHitPathQJqDSyo(j, list, z);
    }
    ...
    */
    public final void m4792addHitPathQJqDSyo(long pointerId, List<? extends Modifier.Node> pointerInputNodes, boolean prunePointerIdsAndChangesNotInNodesList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (size2 <= 0) {
                    ...
                    if (node2 == null) {
                        node2.markIsIn();
                        node2.getPointerIds().m4957add0FcD4WY(pointerId);
                        ...
                        node4.getPointerIds().m4957add0FcD4WY(pointerId);
                ...
                node42.getPointerIds().m4957add0FcD4WY(pointerId);
