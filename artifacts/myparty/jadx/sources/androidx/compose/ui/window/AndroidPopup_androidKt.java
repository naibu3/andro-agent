...
public final class AndroidPopup_androidKt {
    ...
    */
    public static final void m6372PopupK5zGePQ(Alignment alignment, long j, Function0<Unit> function0, PopupProperties popupProperties, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
                ...
                if (i5 != 0) {
                    ...
                    if ((i2 & 16) != 0) {
                        ...
                        if ((i3 & 9363) != 9362 || !composerStartRestartGroup.getSkipping()) {
                            ...
                            z = ((i3 & 14) != 4) | ((i3 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32);
                        ...
                        if (scopeUpdateScopeEndRestartGroup != null) {
                            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt.Popup.1
                                ...
                                public final void invoke(Composer composer2, int i8) {
                                    AndroidPopup_androidKt.m6372PopupK5zGePQ(topStart, j3, function03, popupProperties3, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                }
                            });
                            return;
                        }
    ...
    */
        ...
        if (i8 != 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i5 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    UUID uuid = (UUID) RememberSaveableKt.m3243rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupId$1
                        @Override // kotlin.jvm.functions.Function0
                        ...
                        popupLayout2.setContent(compositionContextRememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(1302892335, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1
                            ...
                            public final void invoke(Composer composer3, int i9) {
                                ...
                                if ((i9 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (zChangedInstance5 || objRememberedValue6 == Composer.INSTANCE.getEmpty()) {
                                        objRememberedValue6 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1$2$1
                                            ...
                                            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                                m6373invokeozmzZPI(intSize.getPackedValue());
                                                return Unit.INSTANCE;
                                            }

                                            /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                                            public final void m6373invokeozmzZPI(long j) {
                                                popupLayout3.m6377setPopupContentSizefhxjrPA(IntSize.m6279boximpl(j));
                                    ...
                                    AndroidPopup_androidKt.C06331 c06331 = AndroidPopup_androidKt.C06331.INSTANCE;
                                    ...
                                    Updater.m3157setimpl(composerM3150constructorimpl2, c06331, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                    ...
                    int i9 = i6 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                    int i10 = i6;
                    int i11 = i10 & 896;
            ...
            if ((i5 & 1171) != 1170) {
                ...
                UUID uuid2 = (UUID) RememberSaveableKt.m3243rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupId$1
                    @Override // kotlin.jvm.functions.Function0
                    public final UUID invoke() {
                        return UUID.randomUUID();
                    }
                ...
                int i92 = i6 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                int i102 = i6;
                int i112 = i102 & 896;
                layoutDirection2 = layoutDirection;
                            ...
                            if (!zChangedInstance2) {
                                ...
                                if (!zChangedInstance3) {
                                    ...
                                    if (!zChangedInstance4) {
                                        ...
                                        composerM3150constructorimpl = Updater.m3150constructorimpl(composer2);
                                        Updater.m3157setimpl(composerM3150constructorimpl, measurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m3157setimpl(composerM3150constructorimpl, c06331, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m3157setimpl(composerM3150constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
    ...
    public static final class C06331 implements MeasurePolicy {
        ...
        public final MeasureResult mo377measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(measureScope, placeableMo4993measureBRTryo0.getWidth(), placeableMo4993measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt.SimpleStack.1.2
                    {
                        super(1);
                    }
