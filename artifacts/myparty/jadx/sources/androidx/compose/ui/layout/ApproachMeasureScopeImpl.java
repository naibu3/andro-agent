...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int mo705roundToPxR2X_6o(long j) {
        return this.coordinator.mo705roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo706roundToPx0680j_4(float f) {
        return this.coordinator.mo706roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo707toDpGaN1DYA(long j) {
        return this.coordinator.mo707toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo708toDpu2uoSUM(float f) {
        return this.coordinator.mo708toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo709toDpu2uoSUM(int i) {
        return this.coordinator.mo709toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo710toDpSizekrfVVM(long j) {
        return this.coordinator.mo710toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo711toPxR2X_6o(long j) {
        return this.coordinator.mo711toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo712toPx0680j_4(float f) {
        return this.coordinator.mo712toPx0680j_4(f);
    }
    ...
    public long mo713toSizeXkaWNTQ(long j) {
        return this.coordinator.mo713toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo714toSp0xMU5do(float f) {
        return this.coordinator.mo714toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo715toSpkPz2Gy4(float f) {
        return this.coordinator.mo715toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo716toSpkPz2Gy4(int i) {
        return this.coordinator.mo716toSpkPz2Gy4(i);
    }
    ...
    public long mo4967getLookaheadConstraintsmsEJaDk() {
    ...
    public long mo4968getLookaheadSizeYbymL2g() {
