...
public class ConstraintLayout extends ViewGroup {
    ...
    public void setDesignInformation(int type, Object value1, Object value2) {
        if (type == 0 && (value1 instanceof String) && (value2 instanceof Integer)) {
            ...
            int id2 = ((Integer) value2).intValue();
            this.mDesignIds.put(name, Integer.valueOf(id2));
        }
    }
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    ...
                    if (id2 != 0) {
                        try {
                            parseLayoutDescription(id2);
                        } catch (Resources.NotFoundException e) {
                            this.mConstraintLayoutSpec = null;
                        }
                    }
                } else if (attr == R.styleable.ConstraintLayout_Layout_constraintSet) {
                    int id3 = a.getResourceId(attr, 0);
                    try {
                        ConstraintSet constraintSet = new ConstraintSet();
                        this.mConstraintSet = constraintSet;
                        constraintSet.load(getContext(), id3);
                    } catch (Resources.NotFoundException e2) {
                        this.mConstraintSet = null;
                    }
                    this.mConstraintSetId = id3;
                }
            }
            a.recycle();
        }
    ...
    public String getSceneString() throws Resources.NotFoundException {
        ...
        if (this.mLayoutWidget.stringId == null) {
            int id3 = getId();
            if (id3 != -1) {
                String str = getContext().getResources().getResourceEntryName(id3);
        ...
        while (it.hasNext()) {
            ...
            if (v != null) {
                if (child.stringId == null && (id2 = v.getId()) != -1) {
                    String str2 = getContext().getResources().getResourceEntryName(id2);
                    child.stringId = str2;
                }
