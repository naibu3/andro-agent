...
public final class TimeoutKt {
    ...
    public static final <T> Object m1729withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1721toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m1730withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1721toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM1722timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM1722timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m1722timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM1722timeoutMessageLRDsOJo == null) {
                strM1722timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        }
        return new TimeoutCancellationException(strM1722timeoutMessageLRDsOJo, job);
    }
}
