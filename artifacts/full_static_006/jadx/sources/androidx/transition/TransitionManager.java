...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo92clone = transition.mo92clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo92clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo92clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo92clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo92clone = transition.mo92clone();
        sceneChangeSetup(viewGroup, transitionMo92clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo92clone);
    }
