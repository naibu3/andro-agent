...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m6027from8_81llA(ColorKt.m3708lerpjxsXWHM(textForegroundStyle.mo5904getColor0d7_KjU(), textForegroundStyle2.mo5904getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m6026modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m3656copywmQWz5c$default(j, Color.m3659getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
