...
public final class ContentUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) throws FileNotFoundException {
        ...
        if (isContactPhotoUri$coil_core_release(this.data)) {
            assetFileDescriptorOpenAssetFileDescriptor = contentResolver.openAssetFileDescriptor(androidUri, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
    ...
    private final Bundle newMusicThumbnailSizeOptions() {
        ...
        int iM6511unboximpl = pixels.m6511unboximpl();
        ...
        int iM6511unboximpl2 = pixels2.m6511unboximpl();
        Bundle bundle = new Bundle(1);
        bundle.putParcelable("android.content.extra.SIZE", new Point(iM6511unboximpl, iM6511unboximpl2));
        return bundle;
    }
