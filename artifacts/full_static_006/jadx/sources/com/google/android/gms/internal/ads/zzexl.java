...
public final class zzexl implements zzexw {
    ...
    zzexl(zzgge zzggeVar, Context context, VersionInfoParcel versionInfoParcel, String str) {
        this.zza = zzggeVar;
        this.zzb = context;
    ...
    final /* synthetic */ zzexm zzc() throws Exception {
        ...
        return new zzexm(zIsCallerInstantApp, zZzE, str, zZzF, i, DynamiteModule.getRemoteVersion(context, ModuleDescriptor.MODULE_ID), DynamiteModule.getLocalVersion(context, ModuleDescriptor.MODULE_ID), this.zzd);
    }
}
