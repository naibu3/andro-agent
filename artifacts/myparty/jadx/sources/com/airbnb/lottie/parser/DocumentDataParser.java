...
public class DocumentDataParser implements ValueParser<DocumentData> {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of(JWKParameterNames.RSA_OTHER_PRIMES__FACTOR_CRT_COEFFICIENT, "f", "s", "j", "tr", "lh", "ls", "fc", "sc", "sw", "of", "ps", "sz");
