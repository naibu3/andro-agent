...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver resolver, URLSpanCache uRLSpanCache) {
        ...
        if (spanStylesOrNull$ui_text_release != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                setSpanStyle(spannableString, SpanStyle.m5543copyGSF8kmg$default(range.component1(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null), range.getStart(), range.getEnd(), density, resolver);
            }
        }
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m5881setColorRPmYEkk(spannableString2, spanStyle.m5552getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m5882setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m5666getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m5715unboximpl() : FontStyle.INSTANCE.m5719getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m5686resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5729getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m5879setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
