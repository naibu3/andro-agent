    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo10410getSupertypes = capturedTypeConstructorImpl.mo10410getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo10410getSupertypes, 10));
                Iterator<T> it = collectionMo10410getSupertypes.iterator();
                while (it.hasNext()) {
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo10410getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo10410getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo10410getSupertypes2, 10));
            Iterator<T> it2 = collectionMo10410getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo10410getSupertypes3 = intersectionTypeConstructor.mo10410getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo10410getSupertypes3, 10));
        Iterator<T> it3 = collectionMo10410getSupertypes3.iterator();
        while (it3.hasNext()) {
