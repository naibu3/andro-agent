...
public final class AuthenticationTokenHeader implements Parcelable {
    ...
    public AuthenticationTokenHeader(String encodedHeaderString) throws JSONException {
        ...
        this.alg = string;
        String string2 = jSONObject.getString(HeaderParameterNames.TYPE);
    ...
    public AuthenticationTokenHeader(Parcel parcel) {
        ...
        this.typ = Validate.notNullOrEmpty(parcel.readString(), HeaderParameterNames.TYPE);
    ...
    private final boolean isValidHeader(String headerString) {
        ...
        try {
            ...
            strOptString = jSONObject.optString(HeaderParameterNames.TYPE);
    ...
    public final JSONObject toJSONObject$facebook_core_release() throws JSONException {
        ...
        jSONObject.put(HeaderParameterNames.TYPE, this.typ);
