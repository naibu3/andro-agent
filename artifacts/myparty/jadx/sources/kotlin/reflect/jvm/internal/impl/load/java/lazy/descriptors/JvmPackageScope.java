...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo10411getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo10411getContributedClassifier = this.javaScope.mo10411getContributedClassifier(name, location);
        if (classDescriptorMo10411getContributedClassifier != null) {
            return classDescriptorMo10411getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo10411getContributedClassifier(name, location);
