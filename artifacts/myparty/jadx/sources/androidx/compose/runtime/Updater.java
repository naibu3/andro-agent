...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3149boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3150constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3151equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3152equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3153hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3158toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3151equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3153hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3158toStringimpl(this.composer);
    }
    ...
    public static final void m3156setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3157setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m3159updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3160updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m3154initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3155reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
