...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str, boolean z2, String str2) {
        ...
        sb2.append(str4);
        e.g(sb2, "DefaultSSLContextImpl", str3, this, "SSLContext.Default");
        if (z2) {
        ...
        StringBuilder sbE = e.e(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", "AES", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", "AES");
        sbE.append(str4);
        sbE.append("IvParameters$ChaCha20");
        put("AlgorithmParameters.ChaCha20", sbE.toString());
        ...
        StringBuilder sbE2 = e.e(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", "GCM", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", "GCM");
        sbE2.append(str4);
        sbE2.append("OAEPParameters");
        put("AlgorithmParameters.OAEP", sbE2.toString());
        ...
        StringBuilder sbE3 = e.e(this, "Alg.Alias.KeyGenerator.RC4", "ARC4", "Alg.Alias.KeyGenerator.1.2.840.113549.3.4", "ARC4");
        sbE3.append(str4);
        sbE3.append("KeyGeneratorImpl$AES");
        put("KeyGenerator.AES", sbE3.toString());
