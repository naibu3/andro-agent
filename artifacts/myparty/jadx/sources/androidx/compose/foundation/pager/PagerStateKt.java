...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m6117constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m3243rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM6287getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m6287getWidthimpl(pagerLayoutInfo.mo1259getViewportSizeYbymL2g()) : IntSize.m6286getHeightimpl(pagerLayoutInfo.mo1259getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (iM6287getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM6287getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM6287getWidthimpl)), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM6287getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m6287getWidthimpl(pagerMeasureResult.mo1259getViewportSizeYbymL2g()) : IntSize.m6286getHeightimpl(pagerMeasureResult.mo1259getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM6287getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM6287getWidthimpl);
    }
