...
public final class zzbfm {
            ...
            if (listQueryIntentActivities != null && resolveInfoResolveActivity != null) {
                for (int i = 0; i < listQueryIntentActivities.size(); i++) {
                    if (resolveInfoResolveActivity.activityInfo.name.equals(listQueryIntentActivities.get(i).activityInfo.name)) {
                        return resolveInfoResolveActivity.activityInfo.packageName.equals(zzhlh.zza(context));
                    }
                }
            }
        }
    ...
    public final void zzb(Activity activity) {
        String strZza;
        if (this.zzb == null && (strZza = zzhlh.zza(activity)) != null) {
            zzhli zzhliVar = new zzhli(this);
            this.zzc = zzhliVar;
            CustomTabsClient.bindCustomTabsService(activity, strZza, zzhliVar);
        }
    }
