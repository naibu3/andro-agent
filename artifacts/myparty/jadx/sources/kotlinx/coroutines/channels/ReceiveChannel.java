...
public interface ReceiveChannel<E> {
    ...
    Object mo10646receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo10647tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo10647tryReceivePtdJZtk = receiveChannel.mo10647tryReceivePtdJZtk();
            if (ChannelResult.m10664isSuccessimpl(objMo10647tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10660getOrThrowimpl(objMo10647tryReceivePtdJZtk);
            }
            Throwable thM10658exceptionOrNullimpl = ChannelResult.m10658exceptionOrNullimpl(objMo10647tryReceivePtdJZtk);
            if (thM10658exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM10658exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object objMo10646receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo10646receiveCatchingJP2dKIU = receiveChannel.mo10646receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo10646receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo10646receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m10659getOrNullimpl(objMo10646receiveCatchingJP2dKIU);
        }
