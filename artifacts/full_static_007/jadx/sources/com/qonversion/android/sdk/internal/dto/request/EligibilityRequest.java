...
public final /* data */ class EligibilityRequest extends RequestData {
    ...
    public final EligibilityRequest copy(@Json(name = "install_date") long installDate, @Json(name = "device") Environment device, @Json(name = "version") String version, @Json(name = "access_token") String accessToken, @Json(name = "q_uid") String clientUid, @Json(name = "receipt") String receipt, @Json(name = "debug_mode") String debugMode, @Json(name = "products_local_data") List<StoreProductInfo> productInfos) {
        ...
        return new EligibilityRequest(installDate, device, version, accessToken, clientUid, receipt, debugMode, productInfos);
    }
    ...
    public boolean equals(Object other) {
        ...
        EligibilityRequest eligibilityRequest = (EligibilityRequest) other;
    ...
    public int hashCode() {
        ...
        return ((((((iHashCode + (str == null ? 0 : str.hashCode())) * 31) + this.receipt.hashCode()) * 31) + this.debugMode.hashCode()) * 31) + this.productInfos.hashCode();
    }
    ...
    public EligibilityRequest(@Json(name = "install_date") long j, @Json(name = "device") Environment device, @Json(name = "version") String version, @Json(name = "access_token") String accessToken, @Json(name = "q_uid") String str, @Json(name = "receipt") String receipt, @Json(name = "debug_mode") String debugMode, @Json(name = "products_local_data") List<StoreProductInfo> productInfos) {
        Intrinsics.checkNotNullParameter(device, "device");
        Intrinsics.checkNotNullParameter(version, "version");
        Intrinsics.checkNotNullParameter(accessToken, "accessToken");
        Intrinsics.checkNotNullParameter(receipt, "receipt");
