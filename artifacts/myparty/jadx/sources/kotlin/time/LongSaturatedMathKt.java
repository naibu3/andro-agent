...
public final class LongSaturatedMathKt {
    ...
    public static final long m10587saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM10521toLongimpl = Duration.m10521toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m10586checkInfiniteSumDefinedPjuGub4(j, j2, jM10521toLongimpl);
        }
        if (((jM10521toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m10588saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM10521toLongimpl;
        return ((j ^ j3) & (jM10521toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m10586checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m10507isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m10588saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM10485divUwyO8pc = Duration.m10485divUwyO8pc(j2, 2);
        long jM10521toLongimpl = Duration.m10521toLongimpl(jM10485divUwyO8pc, durationUnit);
        return (1 | (jM10521toLongimpl - 1)) == Long.MAX_VALUE ? jM10521toLongimpl : m10587saturatingAddNuflL3o(m10587saturatingAddNuflL3o(j, durationUnit, jM10485divUwyO8pc), durationUnit, Duration.m10510minusLRDsOJo(j2, jM10485divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m10572getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m10571getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m10526unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m10511plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m10526unaryMinusUwyO8pc(infinityOfSign(j3));
        }
