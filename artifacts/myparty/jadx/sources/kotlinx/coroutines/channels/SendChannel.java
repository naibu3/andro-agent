...
public interface SendChannel<E> {
    ...
    Object mo10639trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m10664isSuccessimpl(objMo10639trySendJP2dKIU)) {
                return true;
            }
            Throwable thM10658exceptionOrNullimpl = ChannelResult.m10658exceptionOrNullimpl(objMo10639trySendJP2dKIU);
