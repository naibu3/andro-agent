...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m6292getZeroYbymL2g();
    ...
    public final void m561setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m6285equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
            width = IntSize.m6287getWidthimpl(this.surfaceSize);
            height = IntSize.m6286getHeightimpl(this.surfaceSize);
