...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM98constructorimpl = Result.m98constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM98constructorimpl = Result.m98constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m104isFailureimpl(objM98constructorimpl) ? null : objM98constructorimpl);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1585postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1585postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
