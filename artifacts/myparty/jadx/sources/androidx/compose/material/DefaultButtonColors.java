...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m3658equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m3658equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m3658equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m3664hashCodeimpl(this.backgroundColor) * 31) + Color.m3664hashCodeimpl(this.contentColor)) * 31) + Color.m3664hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m3664hashCodeimpl(this.disabledContentColor);
    }
}
