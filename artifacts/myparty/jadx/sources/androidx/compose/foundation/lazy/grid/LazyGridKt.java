...
public final class LazyGridKt {
                    ...
                    if ((i3 & 256) == 0) {
                        ...
                        if ((i3 & 512) == 0) {
                            ...
                            if ((i4 & 306783379) == 306783378 || (i6 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
                                ...
                                if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                    ...
                                    PaddingValues paddingValuesM1013PaddingValues0680j_4 = i9 == 0 ? PaddingKt.m1013PaddingValues0680j_4(Dp.m6117constructorimpl(0)) : paddingValues2;
                                    if (i5 != 0) {
                                        z4 = false;
                                    }
                                    if ((i3 & 64) == 0) {
                                        paddingValues3 = paddingValuesM1013PaddingValues0680j_4;
                                        modifier3 = companion;
                                        i7 = i4 & (-3670017);
                                ...
                                int i10 = i7 >> 3;
                                int i11 = i10 & 14;
                                Function0<LazyGridItemProvider> function0RememberLazyGridItemProviderLambda = LazyGridItemProviderKt.rememberLazyGridItemProviderLambda(lazyGridState, function1, composerStartRestartGroup, ((i6 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i11);
                                int i12 = i7 >> 9;
                                LazyLayoutSemanticState lazyLayoutSemanticStateRememberLazyGridSemanticState = LazySemanticsKt.rememberLazyGridSemanticState(lazyGridState, z4, composerStartRestartGroup, (i12 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i11);
                                ...
                                ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                                int i13 = i7 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                                int i14 = i7 & 57344;
                                int i15 = i7;
                        ...
                        if ((i4 & 306783379) == 306783378) {
                            ...
                            if ((i & 1) != 0) {
                                ...
                                int i102 = i7 >> 3;
                                int i112 = i102 & 14;
                                Function0<LazyGridItemProvider> function0RememberLazyGridItemProviderLambda2 = LazyGridItemProviderKt.rememberLazyGridItemProviderLambda(lazyGridState, function1, composerStartRestartGroup, ((i6 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i112);
                                int i122 = i7 >> 9;
                                LazyLayoutSemanticState lazyLayoutSemanticStateRememberLazyGridSemanticState2 = LazySemanticsKt.rememberLazyGridSemanticState(lazyGridState, z4, composerStartRestartGroup, (i122 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | i112);
                                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 773894976, "CC(rememberCoroutineScope)482@20332L144:Effects.kt#9igjgp");
                                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -954367824, "CC(remember):Effects.kt#9igjgp");
                                objRememberedValue = composerStartRestartGroup.rememberedValue();
                                if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                ...
                                ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                                int i132 = i7 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
                                int i142 = i7 & 57344;
                                int i152 = i7;
    ...
    */
    private static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> rememberLazyGridMeasurePolicy(final Function0<? extends LazyGridItemProvider> function0, final LazyGridState lazyGridState, final LazyGridSlotsProvider lazyGridSlotsProvider, final PaddingValues paddingValues, final boolean z, boolean z2, final Arrangement.Horizontal horizontal, final Arrangement.Vertical vertical, final CoroutineScope coroutineScope, final GraphicsContext graphicsContext, Composer composer, int i) {
        ...
        boolean z5 = ((((i & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) ^ 48) > 32 && composer.changed(lazyGridState)) || (i & 48) == 32) | ((((i & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(lazyGridSlotsProvider)) || (i & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | ((((i & 7168) ^ 3072) > 2048 && composer.changed(paddingValues)) || (i & 3072) == 2048) | ((((57344 & i) ^ 24576) > 16384 && composer.changed(z)) || (i & 24576) == 16384);
            ...
            if (!zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                    ...
                    public /* bridge */ /* synthetic */ LazyGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                        return m1158invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                    }
                    ...
                    public final LazyGridMeasureResult m1158invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                        int i2;
                        int i3;
                        int i4;
                        float spacing;
                        ...
                        ObservableScopeInvalidator.m1194attachToScopeimpl(lazyGridState.m1166getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                        CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, z6 ? Orientation.Vertical : Orientation.Horizontal);
                        if (z6) {
                            i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo971calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                        } else {
                            i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                        }
                        if (z6) {
                            i3 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo972calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                        } else {
                            i3 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                        }
                        int i5 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getTop());
                        int i6 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.getBottom());
                        final int i7 = i5 + i6;
                        final int i8 = i2 + i3;
                        boolean z7 = z6;
                        int i9 = z7 ? i7 : i8;
                        ...
                        final int i10 = i9 - i4;
                        long jM6089offsetNN6EwU = ConstraintsKt.m6089offsetNN6EwU(j, -i8, -i7);
                        ...
                        final LazyGridSlots lazyGridSlotsMo1147invoke0kLqBqw = lazyGridSlotsProvider.mo1147invoke0kLqBqw(lazyLayoutMeasureScope2, j);
                        int length = lazyGridSlotsMo1147invoke0kLqBqw.getSizes().length;
                        ...
                        final int i11 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(spacing);
                        final int itemCount = lazyGridItemProviderInvoke.getItemCount();
                        if (z6) {
                            iM6070getMaxWidthimpl = Constraints.m6069getMaxHeightimpl(j) - i7;
                        } else {
                            iM6070getMaxWidthimpl = Constraints.m6070getMaxWidthimpl(j) - i8;
                        }
                        int i12 = iM6070getMaxWidthimpl;
                        if (!z || i12 > 0) {
                        ...
                        final ?? r33 = new LazyGridMeasuredItemProvider(lazyGridItemProviderInvoke, lazyLayoutMeasureScope, i11, lazyGridState2, z9, z10, i13, i10, j2) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1
                            ...
                            public LazyGridMeasuredItem mo1159createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span) {
                        ...
                        final ?? r28 = new LazyGridMeasuredLineProvider(z11, lazyGridSlotsMo1147invoke0kLqBqw, itemCount, i11, r33, spanLayoutProvider) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
                            final /* synthetic */ boolean $isVertical;
                            final /* synthetic */ LazyGridSlots $resolvedSlots;

                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(z11, lazyGridSlotsMo1147invoke0kLqBqw, itemCount, i11, r33, spanLayoutProvider);
                                this.$isVertical = z11;
                                this.$resolvedSlots = lazyGridSlotsMo1147invoke0kLqBqw;
                            }
                        ...
                        Function1<Integer, ArrayList<Pair<? extends Integer, ? extends Constraints>>> function1 = new Function1<Integer, ArrayList<Pair<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$prefetchInfoRetriever$1
                            ...
                            public final ArrayList<Pair<Integer, Constraints>> invoke(int i14) {
                                ...
                                for (int i16 = 0; i16 < size; i16++) {
                                    int iM1143getCurrentLineSpanimpl = GridItemSpan.m1143getCurrentLineSpanimpl(spans.get(i16).getPackedValue());
                                    arrayList.add(TuplesKt.to(Integer.valueOf(firstItemIndex), Constraints.m6058boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m1165childConstraintsJhjzzOo$foundation_release(i15, iM1143getCurrentLineSpanimpl))));
                                    firstItemIndex++;
                                    i15 += iM1143getCurrentLineSpanimpl;
                                }
                                return arrayList;
                            }
                        };
                        ...
                        try {
                            ...
                            LazyGridMeasureResult lazyGridMeasureResultM1161measureLazyGridOZKpZRA = LazyGridMeasureKt.m1161measureLazyGridOZKpZRA(itemCount, (LazyGridMeasuredLineProvider) r28, (LazyGridMeasuredItemProvider) r33, i12, i4, i10, i11, i14, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), jM6089offsetNN6EwU, z6, vertical, horizontal, z, lazyLayoutMeasureScope2, lazyGridState.getItemAnimator$foundation_release(), length, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyGridItemProviderInvoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), coroutineScope, lazyGridState.m1167getPlacementScopeInvalidatorzYiylxw$foundation_release(), graphicsContext, function1, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measureResult$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                                ...
                                public final MeasureResult invoke(int i15, int i16, Function1<? super Placeable.PlacementScope, Unit> function12) {
                                    return lazyLayoutMeasureScope.layout(ConstraintsKt.m6087constrainWidthK40F9xA(j, i15 + i8), ConstraintsKt.m6086constrainHeightK40F9xA(j, i16 + i7), MapsKt.emptyMap(), function12);
                                }
                            });
                            LazyGridState.applyMeasureResult$foundation_release$default(lazyGridState, lazyGridMeasureResultM1161measureLazyGridOZKpZRA, false, 2, null);
                            return lazyGridMeasureResultM1161measureLazyGridOZKpZRA;
                        } catch (Throwable th) {
                            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                            throw th;
                        }
        ...
        if (!zChanged) {
            ...
            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                ...
                public final LazyGridMeasureResult m1158invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    ...
                    int firstVisibleItemScrollOffset;
                    ObservableScopeInvalidator.m1194attachToScopeimpl(lazyGridState.m1166getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                    CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, z62 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z62) {
                        i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(paddingValues.mo971calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    ...
                    final boolean z10 = z;
                    final int i13 = i4;
                    final LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1 r33 = new LazyGridMeasuredItemProvider(lazyGridItemProviderInvoke, lazyLayoutMeasureScope, i11, lazyGridState2, z9, z10, i13, i10, j2) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1
                        final /* synthetic */ int $afterContentPadding;
                        final /* synthetic */ int $beforeContentPadding;
                        final /* synthetic */ boolean $isVertical;
                        final /* synthetic */ boolean $reverseLayout;
                    ...
                    final LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1 r28 = new LazyGridMeasuredLineProvider(z11, lazyGridSlotsMo1147invoke0kLqBqw, itemCount, i11, r33, spanLayoutProvider) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
                        final /* synthetic */ boolean $isVertical;
                        final /* synthetic */ LazyGridSlots $resolvedSlots;
                    ...
                    try {
                        ...
                        Unit unit = Unit.INSTANCE;
                        companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
                        LazyGridMeasureResult lazyGridMeasureResultM1161measureLazyGridOZKpZRA = LazyGridMeasureKt.m1161measureLazyGridOZKpZRA(itemCount, (LazyGridMeasuredLineProvider) r28, (LazyGridMeasuredItemProvider) r33, i12, i4, i10, i11, i14, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), jM6089offsetNN6EwU, z62, vertical, horizontal, z, lazyLayoutMeasureScope2, lazyGridState.getItemAnimator$foundation_release(), length, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyGridItemProviderInvoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), coroutineScope, lazyGridState.m1167getPlacementScopeInvalidatorzYiylxw$foundation_release(), graphicsContext, function1, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measureResult$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
