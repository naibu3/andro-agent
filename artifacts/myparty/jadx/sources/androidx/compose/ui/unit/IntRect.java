...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6263getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6271getSizeYbymL2g() {
    ...
    public final IntRect m6275translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6245getXimpl(offset), this.top + IntOffset.m6246getYimpl(offset), this.right + IntOffset.m6245getXimpl(offset), this.bottom + IntOffset.m6246getYimpl(offset));
    }
