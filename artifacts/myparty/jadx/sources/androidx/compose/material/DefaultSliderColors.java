...
final class DefaultSliderColors implements SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m3658equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m3658equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m3658equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m3658equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m3658equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m3658equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m3658equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m3658equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m3658equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3664hashCodeimpl(this.thumbColor) * 31) + Color.m3664hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3664hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3664hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3664hashCodeimpl(this.activeTickColor)) * 31) + Color.m3664hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3664hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3664hashCodeimpl(this.disabledInactiveTickColor);
    }
}
