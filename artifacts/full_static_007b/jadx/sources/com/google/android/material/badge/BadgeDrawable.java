...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    public static BadgeDrawable createFromResource(Context context, int id2) {
    ...
    public void setTextAppearance(int id2) {
    ...
    public void setBadgeWithoutTextShapeAppearance(int id2) {
        this.state.setBadgeShapeAppearanceResId(id2);
        onBadgeShapeAppearanceUpdated();
    }

    public void setBadgeWithoutTextShapeAppearanceOverlay(int id2) {
        this.state.setBadgeShapeAppearanceOverlayResId(id2);
        onBadgeShapeAppearanceUpdated();
    }

    public void setBadgeWithTextShapeAppearance(int id2) {
        this.state.setBadgeWithTextShapeAppearanceResId(id2);
        onBadgeShapeAppearanceUpdated();
    }

    public void setBadgeWithTextShapeAppearanceOverlay(int id2) {
