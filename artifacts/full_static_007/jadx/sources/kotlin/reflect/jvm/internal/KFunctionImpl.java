            ...
            public final Caller<? extends Executable> invoke() throws NoSuchMethodException, SecurityException {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method.getModifiers())) {
                        ...
                        methodCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo1489findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    }
            ...
            */
            public final Caller<? extends Executable> invoke() {
                ...
                if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(this.this$0.getCaller().mo1486getMember());
                ...
                if (constructorFindDefaultConstructor instanceof Constructor) {
                    KFunctionImpl kFunctionImpl = this.this$0;
                    methodCreateConstructorCaller = kFunctionImpl.createConstructorCaller((Constructor) constructorFindDefaultConstructor, kFunctionImpl.getDescriptor(), true);
                } else if (!(constructorFindDefaultConstructor instanceof Method)) {
                    methodCreateConstructorCaller = null;
                } else if (this.this$0.getDescriptor().getAnnotations().mo1489findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                    ...
                    CallerImpl.Method methodCreateJvmStaticInObjectCaller = !((ClassDescriptor) containingDeclaration2).isCompanionObject() ? this.this$0.createJvmStaticInObjectCaller((Method) constructorFindDefaultConstructor) : this.this$0.createStaticMethodCaller((Method) constructorFindDefaultConstructor);
                    methodCreateConstructorCaller = methodCreateJvmStaticInObjectCaller;
                }
                if (methodCreateConstructorCaller != null) {
                    return ValueClassAwareCallerKt.createValueClassAwareCallerIfNeeded(methodCreateConstructorCaller, this.this$0.getDescriptor(), true);
                }
                return null;
            }
        });
