...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public final void m2105drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float fM2100getRippleEndRadiuscSwnlzA;
        StateLayer stateLayer = this.stateLayer;
        if (Float.isNaN(f)) {
            fM2100getRippleEndRadiuscSwnlzA = RippleAnimationKt.m2100getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.mo4213getSizeNHjbRc());
        } else {
            fM2100getRippleEndRadiuscSwnlzA = drawScope.mo712toPx0680j_4(f);
        }
        stateLayer.m2113drawStateLayermxwnekA(drawScope, fM2100getRippleEndRadiuscSwnlzA, j);
    }
}
