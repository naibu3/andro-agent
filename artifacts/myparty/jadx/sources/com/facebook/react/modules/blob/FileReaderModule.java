...
public final class FileReaderModule extends NativeFileReaderModuleSpec {
    ...
    public void readAsText(ReadableMap blob, String encoding, Promise promise) {
        ...
        byte[] bArrResolve = blobModule.resolve(string, blob.getInt(TypedValues.CycleType.S_WAVE_OFFSET), blob.getInt("size"));
        if (bArrResolve == null) {
    ...
    public void readAsDataURL(ReadableMap blob, Promise promise) {
        ...
        byte[] bArrResolve = blobModule.resolve(string2, blob.getInt(TypedValues.CycleType.S_WAVE_OFFSET), blob.getInt("size"));
        if (bArrResolve == null) {
            promise.reject(ERROR_INVALID_BLOB, "The specified blob is invalid");
            return;
        }
