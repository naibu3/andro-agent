...
public final class IdealDefinition implements PaymentMethodDefinition {
    ...
    public static final IdealDefinition INSTANCE = new IdealDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Ideal;
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        ...
        return SetsKt.setOfNotNull(addPaymentMethodRequirement);
    }
    ...
    public UiDefinitionFactory uiDefinitionFactory() {
        return IdealUiDefinitionFactory.INSTANCE;
    }
}
