...
public final class SessionMutex<T> {
    ...
    public static final /* synthetic */ SessionMutex m3264boximpl(AtomicReference atomicReference) {
        return new SessionMutex(atomicReference);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static <T> AtomicReference<Session<T>> m3266constructorimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3267equalsimpl(AtomicReference<Session<T>> atomicReference, Object obj) {
    ...
    public static final boolean m3268equalsimpl0(AtomicReference<Session<T>> atomicReference, AtomicReference<Session<T>> atomicReference2) {
        return Intrinsics.areEqual(atomicReference, atomicReference2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3270hashCodeimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3271toStringimpl(AtomicReference<Session<T>> atomicReference) {
        return "SessionMutex(currentSessionHolder=" + atomicReference + ')';
    }

    public boolean equals(Object obj) {
        return m3267equalsimpl(this.currentSessionHolder, obj);
    }

    public int hashCode() {
        return m3270hashCodeimpl(this.currentSessionHolder);
    }

    public String toString() {
        return m3271toStringimpl(this.currentSessionHolder);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> AtomicReference<Session<T>> m3265constructorimpl() {
        return m3266constructorimpl(new AtomicReference(null));
    }

    /* renamed from: getCurrentSession-impl, reason: not valid java name */
    public static final T m3269getCurrentSessionimpl(AtomicReference<Session<T>> atomicReference) {
    ...
    public static final <R> Object m3272withSessionCancellingPreviousimpl(AtomicReference<Session<T>> atomicReference, Function1<? super CoroutineScope, ? extends T> function1, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
