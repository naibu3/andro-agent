...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1445getOriginalRangejx7JFs = changeList.mo1445getOriginalRangejx7JFs(0);
            long jMo1446getRangejx7JFs = changeList.mo1446getRangejx7JFs(0);
            if (TextRange.m5596getCollapsedimpl(jMo1445getOriginalRangejx7JFs) && TextRange.m5596getCollapsedimpl(jMo1446getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m5600getMinimpl(jMo1445getOriginalRangejx7JFs), TextRangeKt.m5609substringFDrldGo(textFieldCharSequence, jMo1445getOriginalRangejx7JFs), TextRangeKt.m5609substringFDrldGo(textFieldCharSequence2, jMo1446getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
