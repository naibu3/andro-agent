...
public final class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    */
        ...
        if (resizeMethod != null) {
            switch (resizeMethod.hashCode()) {
                ...
                case 3387192:
                    ...
                    break;
                case 109250890:
                    if (resizeMethod.equals(PaymentSheetAppearanceKeys.SCALE)) {
    ...
    @Override // com.facebook.react.uimanager.BaseViewManager, com.facebook.react.uimanager.ViewManager
    public void onAfterUpdateTransaction(ReactImageView view) throws NumberFormatException {
        Intrinsics.checkNotNullParameter(view, "view");
