...
public final class DefaultStripe3ds2ChallengeResultProcessor_Factory implements Factory<DefaultStripe3ds2ChallengeResultProcessor> {
    ...
    public static DefaultStripe3ds2ChallengeResultProcessor_Factory create(javax.inject.Provider<StripeRepository> provider, javax.inject.Provider<AnalyticsRequestExecutor> provider2, javax.inject.Provider<PaymentAnalyticsRequestFactory> provider3, javax.inject.Provider<RetryDelaySupplier> provider4, javax.inject.Provider<Logger> provider5, javax.inject.Provider<CoroutineContext> provider6) {
        return new DefaultStripe3ds2ChallengeResultProcessor_Factory(Providers.asDaggerProvider(provider), Providers.asDaggerProvider(provider2), Providers.asDaggerProvider(provider3), Providers.asDaggerProvider(provider4), Providers.asDaggerProvider(provider5), Providers.asDaggerProvider(provider6));
    }
