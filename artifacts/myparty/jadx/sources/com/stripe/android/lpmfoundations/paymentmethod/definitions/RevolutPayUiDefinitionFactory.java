...
final class RevolutPayUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) RevolutPayDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_revolut_pay, R.drawable.stripe_ic_paymentsheet_pm_revolut_pay_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_revolut_pay_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        if (RevolutPayDefinition.INSTANCE.requiresMandate(metadata)) {
            listEmptyList = CollectionsKt.listOf(new MandateTextSpec((IdentifierSpec) null, R.string.stripe_revolut_mandate, 1, (DefaultConstructorMarker) null));
        } else {
