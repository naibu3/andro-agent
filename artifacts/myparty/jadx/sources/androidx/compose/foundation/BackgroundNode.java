...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode {
    ...
    public final void m577setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m3493getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3658equalsimpl0(this.color, Color.INSTANCE.m3693getUnspecified0d7_KjU())) {
            DrawScope.m4207drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m4206drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m3658equalsimpl0(this.color, Color.INSTANCE.m3693getUnspecified0d7_KjU())) {
            OutlineKt.m3916drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m3914drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }
    ...
    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        ...
        if (Size.m3481equalsimpl0(contentDrawScope.mo4213getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ?? r1 = this.lastOutline;
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.foundation.BackgroundNode.getOutline.1
                ...
                public final void invoke2() {
                    objectRef.element = this.getShape().mo623createOutlinePq9zytI(contentDrawScope.mo4213getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
                }
            });
        }
        this.lastOutline = (Outline) objectRef.element;
        this.lastSize = contentDrawScope.mo4213getSizeNHjbRc();
