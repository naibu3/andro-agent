...
public final /* data */ class IbanSpec extends FormItemSpec {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof IbanSpec) && Intrinsics.areEqual(this.apiPath, ((IbanSpec) other).apiPath);
    }
    ...
    /* compiled from: IbanSpec.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/stripe/android/ui/core/elements/IbanSpec$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/stripe/android/ui/core/elements/IbanSpec;", "payments-ui-core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public /* synthetic */ IbanSpec(int i, IdentifierSpec identifierSpec, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if ((i & 1) == 0) {
            this.apiPath = IdentifierSpec.INSTANCE.Generic("sepa_debit[iban]");
        } else {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$payments_ui_core_release(IbanSpec self, CompositeEncoder output, SerialDescriptor serialDesc) {
        if (!output.shouldEncodeElementDefault(serialDesc, 0) && Intrinsics.areEqual(self.getApiPath(), IdentifierSpec.INSTANCE.Generic("sepa_debit[iban]"))) {
            return;
        }
    ...
    public /* synthetic */ IbanSpec(IdentifierSpec identifierSpec, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? IdentifierSpec.INSTANCE.Generic("sepa_debit[iban]") : identifierSpec);
    }
    ...
    public final SectionElement transform(Map<IdentifierSpec, String> initialValues) {
        ...
        return FormItemSpec.createSectionElement$payments_ui_core_release$default(this, new IbanElement(getApiPath(), new SimpleTextFieldController(new IbanConfig(), false, initialValues.get(getApiPath()), null, 10, null)), (ResolvableString) null, 2, (Object) null);
    }
}
