...
public class SwipeableState<T> {
    ...
    static final class C05052 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05052(float f, SwipeableState<T> swipeableState, Continuation<? super C05052> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05052 c05052 = new C05052(this.$target, this.this$0, continuation);
            c05052.L$0 = obj;
            return c05052;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C05052) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapInternalToOffset(float f, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.drag$default(this.draggableState, null, new C05052(f, this, null), continuation, 1, null);
    ...
    static final class C05062<T> implements FlowCollector {
        final /* synthetic */ T $targetValue;
        final /* synthetic */ SwipeableState<T> this$0;

        C05062(T t, SwipeableState<T> swipeableState) {
            this.$targetValue = t;
            this.this$0 = swipeableState;
        }
        ...
        */
        public final Object emit(Map<Float, ? extends T> map, Continuation<? super Unit> continuation) {
            ...
            if (i == 0) {
                ...
                c05062 = (C05062) swipeableState$snapTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
            c05062.this$0.setCurrentValue(c05062.$targetValue);
            return Unit.INSTANCE;
        }
    }

    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objCollect = this.latestNonEmptyAnchorsFlow.collect(new C05062(t, this), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }
    ...
    static final class C05032<T> implements FlowCollector {
        final /* synthetic */ AnimationSpec<Float> $anim;
        final /* synthetic */ T $targetValue;
        final /* synthetic */ SwipeableState<T> this$0;

        C05032(T t, SwipeableState<T> swipeableState, AnimationSpec<Float> animationSpec) {
            this.$targetValue = t;
            this.this$0 = swipeableState;
        ...
        */
        public final Object emit(Map<Float, ? extends T> map, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i != 0) {
                ...
                c05032 = (C05032) swipeableState$animateTo$2$emit$1.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                    float floatValue = ((SwipeableState) c05032.this$0).absoluteOffset.getFloatValue();
                    ...
                    if (objFirstOrNull2 == null) {
                        objFirstOrNull2 = c05032.this$0.getCurrentValue();
                    }
                    c05032.this$0.setCurrentValue(objFirstOrNull2);
                    return Unit.INSTANCE;
                } catch (Throwable th) {
                    th = th;
                    float floatValue2 = ((SwipeableState) c05032.this$0).absoluteOffset.getFloatValue();
                    ...
                    if (objFirstOrNull == null) {
                        objFirstOrNull = c05032.this$0.getCurrentValue();
                    }
                    c05032.this$0.setCurrentValue(objFirstOrNull);
                    throw th;
                }
            }
            ResultKt.throwOnFailure(obj);
            try {
                ...
                c05032 = this;
                float floatValue3 = ((SwipeableState) c05032.this$0).absoluteOffset.getFloatValue();
                ...
                th = th2;
                c05032 = this;
                float floatValue22 = ((SwipeableState) c05032.this$0).absoluteOffset.getFloatValue();
    ...
    public final Object animateTo(T t, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Object objCollect = this.latestNonEmptyAnchorsFlow.collect(new C05032(t, this, animationSpec), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }
