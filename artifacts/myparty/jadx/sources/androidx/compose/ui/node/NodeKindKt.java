...
public final class NodeKindKt {
    ...
    public static final boolean m5236contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m5238or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(131072);
        }
        if (node instanceof TraversableNode) {
            iM5228constructorimpl |= NodeKind.m5228constructorimpl(262144);
        }
        mutableObjectIntMap.set(objClassKeyForObject, iM5228constructorimpl);
        return iM5228constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m5228constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m5115requireCoordinator64DMado(node, NodeKind.m5228constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m5228constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m5228constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m5228constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m5228constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m5228constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m5228constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode) && i2 != 2) {
                FocusTargetNodeKt.invalidateFocusTarget((FocusTargetNode) node);
            }
            if ((NodeKind.m5228constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m5228constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m5237getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m5228constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? NodeKind.m5228constructorimpl(128) | iM5228constructorimpl : iM5228constructorimpl;
    }
}
