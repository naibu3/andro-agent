...
final class SatispayUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) SatispayDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_satispay, R.drawable.stripe_ic_paymentsheet_pm_satispay_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_satispay_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        if (SatispayDefinition.INSTANCE.requiresMandate(metadata)) {
            listEmptyList = CollectionsKt.listOf(new MandateTextSpec((IdentifierSpec) null, R.string.stripe_satispay_mandate, 1, (DefaultConstructorMarker) null));
        } else {
