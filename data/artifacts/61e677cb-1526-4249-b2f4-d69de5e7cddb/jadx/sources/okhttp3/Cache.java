...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1705deprecated_directory() {
        return this.cache.getDirectory();
    }
        ...
        public Entry(Source rawSource) throws IOException {
            ...
            try {
                ...
                if (isHttps()) {
                    ...
                    TlsVersion tlsVersion = !source.exhausted() ? TlsVersion.INSTANCE.forJavaName(source.readUtf8LineStrict()) : TlsVersion.SSL_3_0;
