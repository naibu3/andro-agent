    ...
    */
    ...
    static class ElevationSet extends ViewTimeCycle {
        ...
        public boolean setProperty(View view, float t, long time, KeyCache cache) {
            ...
            if (Build.VERSION.SDK_INT < 21) {
                ...
                elevationSet = this;
                view.setElevation(elevationSet.get(t, time, view, cache));
            }
            return elevationSet.mContinue;
        }
    }
    ...
    static class TranslationZset extends ViewTimeCycle {
        ...
        public boolean setProperty(View view, float t, long time, KeyCache cache) {
            ...
            if (Build.VERSION.SDK_INT < 21) {
                translationZset = this;
            } else {
                translationZset = this;
                view.setTranslationZ(translationZset.get(t, time, view, cache));
            }
            return translationZset.mContinue;
        }
    }
