...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m6117constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m6117constructorimpl(f);
        ListItemTrailingIconSize = Dp.m6117constructorimpl(f);
    }
    ...
    public final float m2867getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2868getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2869getListItemTrailingIconSizeD9Ej5fM() {
