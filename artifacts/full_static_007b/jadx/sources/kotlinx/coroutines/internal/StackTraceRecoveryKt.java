...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM98constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM98constructorimpl = Result.m98constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m101exceptionOrNullimpl(objM98constructorimpl) == null) {
            obj2 = objM98constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM98constructorimpl2 = Result.m98constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM98constructorimpl2 = Result.m98constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m101exceptionOrNullimpl(objM98constructorimpl2) == null) {
            obj = objM98constructorimpl2;
        }
