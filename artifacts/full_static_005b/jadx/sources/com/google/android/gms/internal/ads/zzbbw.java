...
public final class zzbbw {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) throws UnsupportedEncodingException {
        ...
        while (true) {
            ...
            long jZza = zzbbs.zza(strArr[i3 - 1]);
            long jZza2 = zzbbs.zza(strArr[i3 + 5]);
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long jZza = (zzbbs.zza(strArr[0]) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            jZza = (((jZza * 16785407) % 1073807359) + ((zzbbs.zza(strArr[i3]) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZza;
    }
}
