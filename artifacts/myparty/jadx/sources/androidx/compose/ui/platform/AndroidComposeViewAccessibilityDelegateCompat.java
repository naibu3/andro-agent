...
public final class AndroidComposeViewAccessibilityDelegateCompat extends AccessibilityDelegateCompat {
    ...
    public final boolean m5326canScroll0AR0LA0$ui_release(boolean vertical, int direction, long position) {
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            return m5325canScrollmoWRBKg(getCurrentSemanticsNodes(), vertical, direction, position);
        }
        return false;
    }
    ...
    */
    private final boolean m5325canScrollmoWRBKg(IntObjectMap<SemanticsNodeWithAdjustedBounds> currentSemanticsNodes, boolean vertical, int direction, long position) {
        SemanticsPropertyKey<ScrollAxisRange> horizontalScrollAxisRange;
        ScrollAxisRange scrollAxisRange;
        if (Offset.m3413equalsimpl0(position, Offset.INSTANCE.m3431getUnspecifiedF1C5BW0()) || !Offset.m3419isValidimpl(position)) {
            return false;
        }
        if (vertical) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((j & 255) < 128) {
                        ...
                        if (RectHelper_androidKt.toComposeRect(semanticsNodeWithAdjustedBounds.getAdjustedBounds()).m3442containsk4lQ0M(position) && (scrollAxisRange = (ScrollAxisRange) SemanticsConfigurationKt.getOrNull(semanticsNodeWithAdjustedBounds.getSemanticsNode().getUnmergedConfig(), horizontalScrollAxisRange)) != null) {
    ...
    public final Rect boundsInScreen(SemanticsNodeWithAdjustedBounds node) {
        ...
        long jMo4946localToScreenMKHz9U = this.view.mo4946localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.left, adjustedBounds.top));
        long jMo4946localToScreenMKHz9U2 = this.view.mo4946localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.right, adjustedBounds.bottom));
        return new Rect((int) Math.floor(Offset.m3416getXimpl(jMo4946localToScreenMKHz9U)), (int) Math.floor(Offset.m3417getYimpl(jMo4946localToScreenMKHz9U)), (int) Math.ceil(Offset.m3416getXimpl(jMo4946localToScreenMKHz9U2)), (int) Math.ceil(Offset.m3417getYimpl(jMo4946localToScreenMKHz9U2)));
    }
    ...
    */
    private final void populateAccessibilityNodeInfoProperties(int virtualViewId, AccessibilityNodeInfoCompat info, SemanticsNode semanticsNode) {
        ...
        if (role != null) {
            ...
            if (semanticsNode.getIsFake() || semanticsNode.getReplacedChildren$ui_release().isEmpty()) {
                if (Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c())) {
                    info.setRoleDescription(this.view.getContext().getResources().getString(R.string.tab));
                } else if (Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5417getSwitcho7Vup1c())) {
                    info.setRoleDescription(this.view.getContext().getResources().getString(R.string.switch_role));
                } else {
                    String strM5385toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m5385toLegacyClassNameV4PA4sw(role.getValue());
                    if (!Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5415getImageo7Vup1c()) || semanticsNode.isUnmergedLeafNode$ui_release() || semanticsNode.getUnmergedConfig().getIsMergingSemanticsOfDescendants()) {
                        info.setClassName(strM5385toLegacyClassNameV4PA4sw);
                    }
                }
            }
        ...
        if (bool != null) {
            ...
            if (role == null ? false : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c())) {
        ...
        if (liveRegionMode != null) {
            ...
            info.setLiveRegion((LiveRegionMode.m5399equalsimpl0(value, LiveRegionMode.INSTANCE.m5404getPolite0phEisY()) || !LiveRegionMode.m5399equalsimpl0(value, LiveRegionMode.INSTANCE.m5403getAssertive0phEisY())) ? 1 : 2);
        ...
        if (accessibilityAction != null) {
            ...
            if (!(role == null ? false : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c()))) {
                boolean z = role == null ? false : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5416getRadioButtono7Vup1c());
    ...
    private final String getInfoStateDescriptionOrNull(SemanticsNode node) throws Resources.NotFoundException {
        ...
        if (toggleableState != null) {
            ...
            if (i == 1) {
                if ((role == null ? false : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5417getSwitcho7Vup1c())) && orNull == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c())) && orNull == null) {
                if (zBooleanValue) {
    ...
    private final boolean getInfoIsCheckable(SemanticsNode node) {
        ...
        if (bool != null) {
            bool.booleanValue();
            if (!(role != null ? Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c()) : false)) {
                return true;
            }
        }
        return z;
    ...
    private final RectF toScreenCoords(SemanticsNode textNode, androidx.compose.ui.geometry.Rect bounds) {
        ...
        androidx.compose.ui.geometry.Rect rectM3453translatek4lQ0M = bounds.m3453translatek4lQ0M(textNode.m5420getPositionInRootF1C5BW0());
        androidx.compose.ui.geometry.Rect boundsInRoot = textNode.getBoundsInRoot();
        androidx.compose.ui.geometry.Rect rectIntersect = rectM3453translatek4lQ0M.overlaps(boundsInRoot) ? rectM3453translatek4lQ0M.intersect(boundsInRoot) : null;
        if (rectIntersect == null) {
            return null;
        }
        long jMo4946localToScreenMKHz9U = this.view.mo4946localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getLeft(), rectIntersect.getTop()));
        long jMo4946localToScreenMKHz9U2 = this.view.mo4946localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getRight(), rectIntersect.getBottom()));
        return new RectF(Offset.m3416getXimpl(jMo4946localToScreenMKHz9U), Offset.m3417getYimpl(jMo4946localToScreenMKHz9U), Offset.m3416getXimpl(jMo4946localToScreenMKHz9U2), Offset.m3417getYimpl(jMo4946localToScreenMKHz9U2));
    }
    ...
    public final int hitTestSemanticsAt$ui_release(float x, float y) {
        ...
        LayoutNode.m5142hitTestSemanticsM_7yMNQ$ui_release$default(this.view.getRoot(), OffsetKt.Offset(x, y), hitTestResult, false, false, 12, null);
        ...
        while (true) {
            ...
            if (layoutNodeRequireLayoutNode.getNodes().m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(8))) {
    ...
    */
    ...
    public final void notifySubtreeAccessibilityStateChangedIfNeeded(LayoutNode layoutNode) {
        if (this.subtreeChangedLayoutNodes.add(layoutNode)) {
            this.boundsUpdateChannel.mo10639trySendJP2dKIU(Unit.INSTANCE);
        }
    }
    ...
    private final void sendSubtreeChangeAccessibilityEvents(LayoutNode layoutNode, MutableIntSet subtreeChangedSemanticsNodesIds) {
        ...
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            if (!layoutNode.getNodes().m5189hasH91voCI$ui_release(NodeKind.m5228constructorimpl(8))) {
                                        ...
                                        if (Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getStateDescription()) ? true : Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getToggleableState())) {
                                            ...
                                            if (Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getProgressBarRangeInfo())) {
                                                ...
                                                if (Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getSelected())) {
                                                    Role role = (Role) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsProperties.INSTANCE.getRole());
                                                    if ((role == null ? i6 : Role.m5408equalsimpl0(role.getValue(), Role.INSTANCE.m5418getTabo7Vup1c())) != 0) {
                                                    ...
                                                    if (Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getEditableText())) {
                                                        if (semanticsNode.getUnmergedConfig().contains(SemanticsActions.INSTANCE.getSetText())) {
                                                            ...
                                                            if (i28 != 0 || i29 != 0) {
                                                                ...
                                                                accessibilityEventCreateTextSelectionChangedEvent.setFromIndex(TextRange.m5602getStartimpl(packedValue));
                                                                accessibilityEventCreateTextSelectionChangedEvent.setToIndex(TextRange.m5597getEndimpl(packedValue));
                                                                androidComposeViewAccessibilityDelegateCompat.sendEvent(accessibilityEventCreateTextSelectionChangedEvent);
                                                                i10 = i21;
                                                            }
                                                        } else {
                                                        ...
                                                        if (Intrinsics.areEqual(key, SemanticsProperties.INSTANCE.getTextSelectionRange())) {
                                                            ...
                                                            androidComposeViewAccessibilityDelegateCompat.sendEvent(androidComposeViewAccessibilityDelegateCompat.createTextSelectionChangedEvent(androidComposeViewAccessibilityDelegateCompat.semanticsNodeIdToAccessibilityVirtualNodeId(i8), Integer.valueOf(TextRange.m5602getStartimpl(packedValue2)), Integer.valueOf(TextRange.m5597getEndimpl(packedValue2)), Integer.valueOf(str2.length()), androidComposeViewAccessibilityDelegateCompat.trimToSize(str2, 100000)));
    ...
    */
    ...
    private final int getAccessibilitySelectionStart(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5602getStartimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
    ...
    private final int getAccessibilitySelectionEnd(SemanticsNode node) {
        if (!node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getContentDescription()) && node.getUnmergedConfig().contains(SemanticsProperties.INSTANCE.getTextSelectionRange())) {
            return TextRange.m5597getEndimpl(((TextRange) node.getUnmergedConfig().get(SemanticsProperties.INSTANCE.getTextSelectionRange())).getPackedValue());
        }
        return this.accessibilityCursorPosition;
    }
