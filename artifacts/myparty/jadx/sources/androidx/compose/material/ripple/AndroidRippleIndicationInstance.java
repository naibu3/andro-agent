...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int iRoundToInt;
        this.rippleSize = contentDrawScope.mo4213getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m2100getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo4213getSizeNHjbRc()));
        } else {
            iRoundToInt = contentDrawScope.mo706roundToPx0680j_4(this.radius);
        }
        ...
        if (rippleHostView != null) {
            rippleHostView.m2104setRippleProperties07v42R4(contentDrawScope.mo4213getSizeNHjbRc(), jM3667unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m2103addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m3667unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
