...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m563constructorimpl(0);
    private static final int MediaOverlay = m563constructorimpl(1);
    private static final int OnTop = m563constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m562boximpl(int i) {
    ...
    public static boolean m564equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m568unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m564equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m566hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m567toStringimpl(this.zOrder);
    }
