...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo4993measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final Constraints m5161getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m5169getLastConstraintsDWUhwKw();
    }
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m6255getZeronOccac();
        ...
        private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m6255getZeronOccac();
            ...
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        placementScope2.m5072placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (function1 == null) {
                        placementScope2.m5063place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        placementScope2.m5071placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                    }
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m5169getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m6058boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo4993measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo4993measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m5170remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5170remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m6063equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long jMo5001getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5001getSizeYbymL2g();
            m5056setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m5160performMeasureBRTryo0(constraints);
            if (IntSize.m6285equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5001getSizeYbymL2g(), jMo5001getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m5055setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo4994placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5168placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public void mo5054placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5168placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m5168placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            if (!IntOffset.m6244equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m6245getXimpl(position), IntOffset.m6246getYimpl(position), 0.0f, 4, null);
            }
            ...
            m5167placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m5167placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m5218placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                try {
                    measurePassDelegate.m5167placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m5144remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate != null) {
                if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                    ...
                    mo4993measureBRTryo0(lookaheadConstraints.getValue());
                    return;
                } else {
                    if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InLayoutBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                        ...
                        mo4993measureBRTryo0(lookaheadConstraints2.getValue());
                        return;
                    }
                    return;
                }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadPassDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate();
            if (lookaheadPassDelegate != null) {
                m5168placeSelfMLgxB_4(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release(), lookaheadPassDelegate.getLastExplicitLayer());
            } else {
                InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("invalid lookaheadDelegate");
                throw new KotlinNothingValueException();
            }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        */
        public Placeable mo4993measureBRTryo0(long constraints) {
            ...
            m5166remeasureBRTryo0(constraints);
            return this;
        }
        ...
        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5166remeasureBRTryo0(long constraints) {
            long jIntSize;
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("measure is called on a deactivated node");
            }
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m6063equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m6058boximpl(constraints);
            m5056setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            m5055setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m6287getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m6286getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo4994placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5163placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5054placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5163placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m5163placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m6244equalsimpl0(position, this.lastPosition)) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m5177placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            } else {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m5057place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate = layoutNode2.getLayoutDelegate().getLookaheadPassDelegate();
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints constraintsM5162getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m5162getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(constraintsM5162getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m5166remeasureBRTryo0(constraintsM5162getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                try {
                    lookaheadPassDelegate.m5163placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
    ...
    public final void m5159performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo4993measureBRTryo0(constraints);
            }
        }, 2, null);
