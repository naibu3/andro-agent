...
final class zzhfb {
    static /* bridge */ /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzhcd {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zzhcd {
        if (b < -62 || zzg(b2)) {
            throw zzhcd.zzd();
        }
    ...
    */
    static /* bridge */ /* synthetic */ void zzb(byte b, byte b2, byte b3, char[] cArr, int i) throws zzhcd {
        if (!zzg(b2)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zzg(b3)) {
