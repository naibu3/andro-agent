...
final class AffirmUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) AffirmDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_affirm, R.drawable.stripe_ic_paymentsheet_pm_affirm, (Integer) null, false, ResolvableStringUtilsKt.getResolvableString(com.stripe.android.R.string.stripe_affirm_buy_now_pay_later_plaintext), (Integer) null, 160, (DefaultConstructorMarker) null);
    }
}
