...
public final class zzgyy implements zzgts {
    ...
    public zzgyy(byte[] bArr) throws GeneralSecurityException {
        ...
        byte[] bArrZza = zzgsz.zza(cipherZzb.doFinal(new byte[16]));
        this.zzb = bArrZza;
        this.zzc = zzgsz.zza(bArrZza);
    }
    ...
    public final byte[] zza(byte[] bArr, int i) throws GeneralSecurityException {
        ...
        int i3 = i2 * 16;
        if (iMax * 16 == length) {
            bArrZzc = zzgyd.zzd(bArr, i3, this.zzb, 0, 16);
        } else {
            ...
            bArrZzc = zzgyd.zzc(bArrCopyOf, this.zzc);
        }
        byte[] bArrDoFinal = new byte[16];
        for (int i4 = 0; i4 < i2; i4++) {
            bArrDoFinal = cipherZzb.doFinal(zzgyd.zzd(bArrDoFinal, 0, bArr, i4 * 16, 16));
        }
        return Arrays.copyOf(cipherZzb.doFinal(zzgyd.zzc(bArrZzc, bArrDoFinal)), i);
    }
}
