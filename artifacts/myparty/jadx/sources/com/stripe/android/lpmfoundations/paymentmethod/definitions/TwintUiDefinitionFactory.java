...
final class TwintUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) TwintDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_twint, R.drawable.stripe_ic_paymentsheet_pm_twint, (Integer) null, false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
