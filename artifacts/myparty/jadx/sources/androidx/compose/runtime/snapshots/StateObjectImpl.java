...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3261recordReadInh_f27i8$runtime_release(int reader) {
        int iM3248constructorimpl;
        do {
            iM3248constructorimpl = ReaderKind.m3248constructorimpl(this.readerKind.get());
            if ((iM3248constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM3248constructorimpl, ReaderKind.m3248constructorimpl(iM3248constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m3260isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m3248constructorimpl(this.readerKind.get())) != 0;
    }
}
