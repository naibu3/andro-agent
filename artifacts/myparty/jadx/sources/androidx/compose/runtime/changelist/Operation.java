...
public abstract class Operation {
    ...
    public String mo3162intParamNamew8GmfQM(int parameter) {
        return "IntParameter(" + parameter + ')';
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo3163objectParamName31yXWZQ(int parameter) {
    ...
    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0087@\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u000b\u0010\fJ\u0010\u0010\r\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\u000e\u0010\u0005J\u0010\u0010\u000f\u001a\u00020\u0010HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u0013"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$IntParameter;", "", TypedValues.CycleType.S_WAVE_OFFSET, "", "constructor-impl", "(I)I", "getOffset", "()I", "equals", "", "other", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", InAppPurchaseConstants.METHOD_TO_STRING, "", "toString-impl", "(I)Ljava/lang/String;", "runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class IntParameter {
        private final int offset;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ IntParameter m3189boximpl(int i) {
        ...
        public static boolean m3191equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m3195unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m3191equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3193hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3194toStringimpl(this.offset);
        }
    ...
    public static final class ObjectParameter<T> {
        ...
        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m3200boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m3201constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3202equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m3206unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m3202equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3204hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3205toStringimpl(this.offset);
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m3225getCountjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? NewHtcHomeBadger.COUNT : super.mo3162intParamNamew8GmfQM(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int iMo3226getIntw8GmfQM = operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0));
            for (int i = 0; i < iMo3226getIntw8GmfQM; i++) {
                applier.up();
            }
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m3177getNodesHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "nodes" : super.mo3163objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public final int m3164getDistancejn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? "distance" : super.mo3162intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m3215getEffectHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "effect" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        public final int m3212getValueHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "value" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m3165getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3166getValueHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "anchor" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "value" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            Object objMo3227getObject31yXWZQ = operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            if (objMo3227getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo3227getObject31yXWZQ).getWrapped());
            }
            slotWriter.appendSlot(anchor, objMo3227getObject31yXWZQ);
        }
    }
    ...
    public static final class TrimParentValues extends Operation {
        ...
        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3216getCountjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            for (int iMax = Math.max(iSlotsStartIndex$runtime_release, iSlotsEndIndex$runtime_release - iMo3226getIntw8GmfQM); iMax < iSlotsEndIndex$runtime_release; iMax++) {
            ...
            slotWriter.trimTailSlots(iMo3226getIntw8GmfQM);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3224getValueHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3223getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? "groupSlotIndex" : super.mo3162intParamNamew8GmfQM(parameter);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objMo3227getObject31yXWZQ = operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            int iMo3226getIntw8GmfQM = operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0));
            if (objMo3227getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo3227getObject31yXWZQ).getWrapped());
            }
            Object obj = slotWriter.set(iMo3226getIntw8GmfQM, objMo3227getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting(((RememberObserverHolder) obj).getWrapped(), slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(slotWriter.getCurrentGroup(), iMo3226getIntw8GmfQM), -1, -1);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
            }
        }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3219getValueHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3217getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3218getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "value" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "anchor" : super.mo3163objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            int slotsSize;
            Object objMo3227getObject31yXWZQ = operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            int iMo3226getIntw8GmfQM = operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0));
            if (objMo3227getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo3227getObject31yXWZQ).getWrapped());
            }
            int iAnchorIndex2 = slotWriter.anchorIndex(anchor);
            Object obj = slotWriter.set(iAnchorIndex2, iMo3226getIntw8GmfQM, objMo3227getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                int slotsSize2 = slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(iAnchorIndex2, iMo3226getIntw8GmfQM);
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m3220getDataHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "data" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3180getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "anchor" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m3196getOffsetjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? TypedValues.CycleType.S_WAVE_OFFSET : super.mo3162intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m3178getActionHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3179getCompositionHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "anchor" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "composition" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0))).invoke((Composition) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3222getValueHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m3221getBlockHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "value" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "block" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)));
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        public final int m3214getRemoveIndexjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3213getCountjn0FJLE() {
            return IntParameter.m3190constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? "removeIndex" : IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(1)) ? NewHtcHomeBadger.COUNT : super.mo3162intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0)), operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(1)));
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        public final int m3198getFromjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m3199getTojn0FJLE() {
            return IntParameter.m3190constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3197getCountjn0FJLE() {
            return IntParameter.m3190constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? "from" : IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(1)) ? "to" : IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(2)) ? NewHtcHomeBadger.COUNT : super.mo3162intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0)), operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(1)), operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3184getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3185getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "anchor" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "from" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3186getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3188getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m3187getFixupsHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "anchor" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "from" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(2)) ? "fixups" : super.mo3163objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m3181getFactoryHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3183getInsertIndexjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3182getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3162intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3192equalsimpl0(parameter, IntParameter.m3190constructorimpl(0)) ? "insertIndex" : super.mo3162intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "factory" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "groupAnchor" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objInvoke = ((Function0) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            int iMo3226getIntw8GmfQM = operationArgContainer.mo3226getIntw8GmfQM(IntParameter.m3190constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode(anchor, objInvoke);
            applier.insertTopDown(iMo3226getIntw8GmfQM, objInvoke);
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3208getInsertIndexjn0FJLE() {
            return IntParameter.m3190constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3207getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "groupAnchor" : super.mo3163objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(iMo3226getIntw8GmfQM, slotWriter.node(anchor));
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m3176getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3175getAnchorHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "anchor" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m3169getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m3170getNodesHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "nodes" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m3173getResolvedStateHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3172getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m3171getFromHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m3174getToHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "resolvedState" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(2)) ? "from" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(3)) ? "to" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            MovableContentState movableContentStateMovableContentStateResolve$runtime_release = (MovableContentState) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3209getCompositionHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3210getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m3211getReferenceHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "composition" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(2)) ? TypedValues.Custom.S_REFERENCE : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0)), (CompositionContext) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1)), (MovableContentStateReference) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(2)), slotWriter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m3167getChangesHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m3168getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3201constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3163objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(0)) ? "changes" : ObjectParameter.m3203equalsimpl0(parameter, ObjectParameter.m3201constructorimpl(1)) ? "effectiveNodeIndex" : super.mo3163objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo3227getObject31yXWZQ(ObjectParameter.m3201constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                arrayList.add(IntParameter.m3189boximpl(IntParameter.m3190constructorimpl(i3)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m3200boximpl(ObjectParameter.m3201constructorimpl(i4)));
            }
