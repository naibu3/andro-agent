...
public final class Utf8 {
    ...
    */
                            ...
                            if (endIndex <= index + 3) {
                                ...
                                if (endIndex > it4) {
                                    ...
                                    if (!(other$iv$iv$iv3 == 128)) {
                                        ...
                                        b1$iv = !(other$iv$iv$iv4 == 128) ? (byte) 2 : (byte) 3;
                                    }
                                }
                            } else {
                                ...
                                if ((b1$iv4 & 192) == 128) {
                                    ...
                                    if ((b2$iv2 & 192) == 128) {
                                        ...
                                        if ((b3$iv & 192) == 128) {
                                            ...
                                            int it5 = codePoint$iv3 > 1114111 ? REPLACEMENT_CODE_POINT : ((55296 <= codePoint$iv3 && 57343 >= codePoint$iv3) || codePoint$iv3 < 65536) ? REPLACEMENT_CODE_POINT : codePoint$iv3;
    ...
    /* JADX WARN: Removed duplicated region for block: B:135:0x02c3 A[PHI: r12
      0x02c3: PHI (r12v15 'codePoint' int) = (r12v12 'codePoint' int), (r12v13 'codePoint' int), (r12v14 'codePoint' int), (r12v16 'codePoint' int) binds: [B:150:0x0300, B:147:0x02fb, B:142:0x02f0, B:134:0x02c1] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if (b0 >= 0) {
                ...
                if (other$iv == -2) {
                    if (endIndex <= index + 1) {
                        ...
                        int b1$iv = processUtf16Chars[index + 1];
                    ...
                    if (other$iv2 == -2) {
                        if (endIndex <= index + 2) {
                            ...
                            int it2 = index + 1;
                            if (endIndex > it2) {
                                int byte$iv$iv = processUtf16Chars[index + 1];
                                int other$iv$iv$iv2 = 192 & byte$iv$iv;
                                i2 = !(other$iv$iv$iv2 == 128) ? 1 : 2;
                            }
                        } else {
                        ...
                        if (other$iv3 == -2) {
                            if (endIndex <= index + 3) {
                                ...
                                Unit unit8 = Unit.INSTANCE;
                                if (endIndex > index + 1) {
                                    int byte$iv$iv2 = processUtf16Chars[index + 1];
                                    int other$iv$iv$iv3 = 192 & byte$iv$iv2;
                                    if (!(other$iv$iv$iv3 == 128)) {
                                        b0$iv = 1;
                                    } else if (endIndex > index + 2) {
                                        int byte$iv$iv3 = processUtf16Chars[index + 2];
                                        int other$iv$iv$iv4 = 192 & byte$iv$iv3;
                                        b0$iv = !(other$iv$iv$iv4 == 128) ? (byte) 2 : (byte) 3;
                                    }
                                }
                            } else {
