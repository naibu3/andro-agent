...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int id2) throws Resources.NotFoundException {
        ...
        a.recycle();
        TypedArray a2 = context.obtainStyledAttributes(id2, R.styleable.MaterialTextAppearance);
