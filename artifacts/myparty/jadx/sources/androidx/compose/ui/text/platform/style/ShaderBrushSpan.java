...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3473boximpl(Size.INSTANCE.m3493getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m5888getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m3487isEmptyimpl(this.this$0.m5888getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo3626createShaderuvyYCjk(this.this$0.m5888getSizeNHjbRc());
        }
    });
    ...
    public final long m5888getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m5889setSizeuvyYCjk(long j) {
