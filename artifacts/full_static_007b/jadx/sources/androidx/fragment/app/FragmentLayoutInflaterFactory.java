...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        int id2 = a.getResourceId(R.styleable.Fragment_android_id, -1);
        ...
        if (containerId != -1 || id2 != -1 || tag != null) {
            Fragment fragment = id2 != -1 ? this.mFragmentManager.findFragmentById(id2) : null;
            ...
            if (fragment == null) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v(TAG, "Fragment " + fragment + " has been inflated via the <fragment> tag: id=0x" + Integer.toHexString(id2));
                }
            } else {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v(TAG, "Retained Fragment " + fragment + " has been re-attached via the <fragment> tag: id=0x" + Integer.toHexString(id2));
                }
            }
