...
public final class RealCall implements Call {
    ...
    */
    ...
    private final Address createAddress(HttpUrl url) {
        ...
        CertificatePinner certificatePinner2 = (CertificatePinner) null;
        if (!url.getIsHttps()) {
            certificatePinner = certificatePinner2;
            sslSocketFactory = sslSocketFactory2;
            hostnameVerifier = hostnameVerifier2;
        } else {
            SSLSocketFactory sslSocketFactory3 = this.client.sslSocketFactory();
            HostnameVerifier hostnameVerifier3 = this.client.hostnameVerifier();
            CertificatePinner certificatePinner3 = this.client.certificatePinner();
            certificatePinner = certificatePinner3;
