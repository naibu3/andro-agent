...
public final class AffirmDefinition implements PaymentMethodDefinition {
    ...
    public static final AffirmDefinition INSTANCE = new AffirmDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Affirm;
    ...
    public Set<AddPaymentMethodRequirement> requirementsToBeUsedAsNewPaymentMethod(boolean hasIntentToSetup) {
        return SetsKt.setOf((Object[]) new AddPaymentMethodRequirement[]{AddPaymentMethodRequirement.ShippingAddress, AddPaymentMethodRequirement.UnsupportedForSetup});
    }
