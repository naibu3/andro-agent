...
public interface TimeMark {
    ...
    TimeMark mo1406minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1407plusLRDsOJo(long j);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1549plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1548minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1407plusLRDsOJo(Duration.m1465unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1446isNegativeimpl($this.mo1405elapsedNowUwyO8pc());
        }
