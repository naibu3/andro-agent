...
final class StateLayer {
    ...
    public final void m2113drawStateLayermxwnekA(DrawScope drawScope, float f, long j) {
        long j2;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue <= 0.0f) {
            return;
        }
        long jM3656copywmQWz5c$default = Color.m3656copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m4194drawCircleVaOC9Bg$default(drawScope, jM3656copywmQWz5c$default, f, 0L, 0.0f, null, null, 0, 124, null);
            return;
        }
