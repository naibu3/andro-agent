...
public final class zzbqz {
    ...
    public zzbqz(JSONObject jSONObject) throws JSONException {
        ...
        this.zzb = zzbra.zza(jSONObjectOptJSONObject, "click_urls");
        com.google.android.gms.ads.internal.zzu.zzg();
        this.zzc = zzbra.zza(jSONObjectOptJSONObject, "imp_urls");
        com.google.android.gms.ads.internal.zzu.zzg();
        this.zzd = zzbra.zza(jSONObjectOptJSONObject, "downloaded_imp_urls");
        com.google.android.gms.ads.internal.zzu.zzg();
        this.zze = zzbra.zza(jSONObjectOptJSONObject, "nofill_urls");
        com.google.android.gms.ads.internal.zzu.zzg();
        this.zzf = zzbra.zza(jSONObjectOptJSONObject, "remote_ping_urls");
        jSONObjectOptJSONObject.optBoolean("render_in_browser", false);
        jSONObjectOptJSONObject.optLong("refresh", -1L);
        zzbyt zzbytVarZza = zzbyt.zza(jSONObjectOptJSONObject.optJSONArray("rewards"));
        if (zzbytVarZza == null) {
            this.zzh = null;
        } else {
            this.zzh = zzbytVarZza.zza;
        }
