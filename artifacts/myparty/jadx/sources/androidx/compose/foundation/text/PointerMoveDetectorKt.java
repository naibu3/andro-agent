            ...
            */
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (!(!PointerEventType.m4813equalsimpl0(type, PointerEventType.INSTANCE.m4819getMove7fucELk()) ? true : PointerEventType.m4813equalsimpl0(type, PointerEventType.INSTANCE.m4817getEnter7fucELk())) ? true : PointerEventType.m4813equalsimpl0(type, PointerEventType.INSTANCE.m4818getExit7fucELk())) {
                        Offset offsetM3405boximpl = Offset.m3405boximpl(((PointerInputChange) CollectionsKt.first((List) pointerEvent.getChanges())).getPosition());
                        if (Offset.m3412equalsimpl(offsetM3405boximpl.getPackedValue(), objectRef.element)) {
                        ...
                        if (offsetM3405boximpl != null) {
                            ...
                            objectRef.element = Offset.m3405boximpl(packedValue);
                            function1.invoke(Offset.m3405boximpl(packedValue));
                        }
                    }
                    if (JobKt.isActive(this.$currentContext)) {
                        ...
                        if (!(!PointerEventType.m4813equalsimpl0(type2, PointerEventType.INSTANCE.m4819getMove7fucELk()) ? true : PointerEventType.m4813equalsimpl0(type2, PointerEventType.INSTANCE.m4817getEnter7fucELk())) ? true : PointerEventType.m4813equalsimpl0(type2, PointerEventType.INSTANCE.m4818getExit7fucELk())) {
                        }
                        if (JobKt.isActive(this.$currentContext)) {
                            return Unit.INSTANCE;
                        }
