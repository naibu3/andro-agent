...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1494getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo1494getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = kotlinType.getConstructor().mo1494getDeclarationDescriptor();
        if (classifierDescriptorMo1494getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo1494getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = kotlinType.getConstructor().mo1494getDeclarationDescriptor();
        return (classifierDescriptorMo1494getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo1494getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
