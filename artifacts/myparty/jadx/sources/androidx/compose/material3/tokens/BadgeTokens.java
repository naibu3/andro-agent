...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m6117constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m6117constructorimpl((float) 6.0d);
    ...
    public final float m2623getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m2624getSizeD9Ej5fM() {
        return Size;
    }
}
