...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo10411getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor classifierDescriptorMo10411getContributedClassifier = memberScope.mo10411getContributedClassifier(name, location);
            if (classifierDescriptorMo10411getContributedClassifier != null) {
                if (!(classifierDescriptorMo10411getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) classifierDescriptorMo10411getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo10411getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = classifierDescriptorMo10411getContributedClassifier;
                }
            }
        }
    ...
    public void mo10415recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo10415recordLookup(name, location);
        }
    }
