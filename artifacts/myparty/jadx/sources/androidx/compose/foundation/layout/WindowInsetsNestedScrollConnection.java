...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo1096onPreScrollOzD1aCk(long available, int source) {
        return m1094scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3416getXimpl(available), Offset.m3417getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo822onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m1094scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3416getXimpl(available), Offset.m3417getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m1094scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo1046consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo1095onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m1093flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m6354getXimpl(j), Velocity.m6355getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo821onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m1093flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m6354getXimpl(j2), Velocity.m6355getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final Object m1093flinghuYlsQE(long j, float f, boolean z, Continuation<? super Velocity> continuation) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                ResultKt.throwOnFailure(obj);
                return Velocity.m6345boximpl(windowInsetsNestedScrollConnection2.sideCalculator.mo1047consumedVelocityQWom1Mo(j3, floatRef.element));
            }
            if (i != 3) {
            ...
            ResultKt.throwOnFailure(obj);
            return Velocity.m6345boximpl(windowInsetsNestedScrollConnection3.sideCalculator.mo1047consumedVelocityQWom1Mo(j4, 0.0f));
        }
