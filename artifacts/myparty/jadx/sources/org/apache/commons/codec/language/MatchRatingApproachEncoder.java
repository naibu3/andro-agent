...
public class MatchRatingApproachEncoder implements StringEncoder {
    private static final String[] DOUBLE_CONSONANT = {"BB", "CC", DefaultAuthenticationRequestParametersFactory.KEY_DEVICE_DATA, "FF", "GG", "HH", "JJ", "KK", "LL", "MM", "NN", "PP", "QQ", "RR", "SS", "TT", "VV", "WW", "XX", "YY", "ZZ"};
    ...
    int leftToRightThenRightToLeftProcessing(String str, String str2) {
        ...
        while (i < charArray.length && i <= length2) {
            ...
            if (strSubstring.equals(strSubstring3)) {
                charArray[i] = CardNumberConfig.SEPARATOR;
                charArray2[i] = CardNumberConfig.SEPARATOR;
            }
            if (strSubstring2.equals(strSubstring4)) {
                charArray[i3] = CardNumberConfig.SEPARATOR;
                charArray2[i4] = CardNumberConfig.SEPARATOR;
            }
            i = i2;
        }
