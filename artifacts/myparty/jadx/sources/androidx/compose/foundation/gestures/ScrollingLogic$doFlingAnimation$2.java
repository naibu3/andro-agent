...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m837toFloatk4lQ0M(nestedScrollScope.mo794scrollByWithOverscrollOzD1aCk(scrollingLogic4.m835reverseIfNeededMKHz9U(scrollingLogic4.m838toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m4758getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m830toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m831updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
