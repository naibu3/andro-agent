...
public final class SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m3658equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m3658equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m3658equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m3658equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m3658equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m3658equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m3658equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m3658equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m3658equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m3658equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m3658equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m3658equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m3664hashCodeimpl(this.containerColor) * 31) + Color.m3664hashCodeimpl(this.labelColor)) * 31) + Color.m3664hashCodeimpl(this.leadingIconColor)) * 31) + Color.m3664hashCodeimpl(this.trailingIconColor)) * 31) + Color.m3664hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3664hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3664hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m3664hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m3664hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m3664hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m3664hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m3664hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m3664hashCodeimpl(this.selectedTrailingIconColor);
    }
}
