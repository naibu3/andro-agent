...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        outShadowSize.set(density.mo706roundToPx0680j_4(density.mo708toDpu2uoSUM(Size.m3485getWidthimpl(this.decorationSize))), density.mo706roundToPx0680j_4(density.mo708toDpu2uoSUM(Size.m3482getHeightimpl(this.decorationSize))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m4133setSizeuvyYCjk(j);
        Canvas.save();
