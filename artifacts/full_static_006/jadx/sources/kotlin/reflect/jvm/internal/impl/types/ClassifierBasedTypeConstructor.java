...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo1494getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = mo1494getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo1494getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo1494getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = mo1494getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor2 = typeConstructor.mo1494getDeclarationDescriptor();
        if (classifierDescriptorMo1494getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo1494getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo1494getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo1494getDeclarationDescriptor2);
        }
        return false;
    }
