...
public final class TransformedTextFieldState {
    ...
    private static final long m1564mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1577mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1565mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1578mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1573selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1573selectCharsIn5zctL8(long transformedRange) {
        m1574selectUntransformedCharsIn5zctL8(m1569mapFromTransformedGEjPoXI(transformedRange));
    }

    /* renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1574selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        textFieldState.getMainBuffer().setSelection(TextRange.m5602getStartimpl(untransformedRange), TextRange.m5597getEndimpl(untransformedRange));
    ...
    public final void m1567highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long jM1569mapFromTransformedGEjPoXI = m1569mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        textFieldState.getMainBuffer().m1483setHighlightK7f2yys(type, TextRange.m5602getStartimpl(jM1569mapFromTransformedGEjPoXI), TextRange.m5597getEndimpl(jM1569mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.delete(TextRange.m5600getMinimpl(mainBuffer.m1482getSelectiond9O1mEE()), TextRange.m5599getMaximpl(mainBuffer.m1482getSelectiond9O1mEE()));
        mainBuffer.setSelection(TextRange.m5600getMinimpl(mainBuffer.m1482getSelectiond9O1mEE()), TextRange.m5600getMinimpl(mainBuffer.m1482getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }

    /* renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1566replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        transformedTextFieldState.m1572replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior2, z);
    }

    /* renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1572replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        long jM1569mapFromTransformedGEjPoXI = m1569mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m5600getMinimpl(jM1569mapFromTransformedGEjPoXI), TextRange.m5599getMaximpl(jM1569mapFromTransformedGEjPoXI), newText);
        int iM5600getMinimpl = TextRange.m5600getMinimpl(jM1569mapFromTransformedGEjPoXI) + newText.length();
        mainBuffer.setSelection(iM5600getMinimpl, iM5600getMinimpl);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long jM1482getSelectiond9O1mEE = mainBuffer.m1482getSelectiond9O1mEE();
        mainBuffer.replace(TextRange.m5600getMinimpl(jM1482getSelectiond9O1mEE), TextRange.m5599getMaximpl(jM1482getSelectiond9O1mEE), newText);
        int iM5600getMinimpl = TextRange.m5600getMinimpl(jM1482getSelectiond9O1mEE) + newText.length();
        mainBuffer.setSelection(iM5600getMinimpl, iM5600getMinimpl);
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5599getMaximpl(mainBuffer.m1482getSelectiond9O1mEE()), TextRange.m5599getMaximpl(mainBuffer.m1482getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m5597getEndimpl(mainBuffer.m1482getSelectiond9O1mEE()), TextRange.m5597getEndimpl(mainBuffer.m1482getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final long m1570mapToTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        ...
        if (offsetMapping2 != null) {
            jTextRange = offsetMapping2.m1520mapFromSourcejx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping != null ? Companion.m1578mapToTransformedXGyztTk(jTextRange, offsetMapping, getSelectionWedgeAffinity()) : jTextRange;
    }

    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1571mapToTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping2 != null) {
            range = Companion.m1579mapToTransformedXGyztTk$default(Companion, range, offsetMapping2, null, 4, null);
        }
        return offsetMapping != null ? Companion.m1578mapToTransformedXGyztTk(range, offsetMapping, getSelectionWedgeAffinity()) : range;
    }

    /* renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1568mapFromTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        ...
        if (offsetMapping != null) {
            jTextRange = offsetMapping.m1519mapFromDestjx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping2 != null ? Companion.m1577mapFromTransformedxdX6G0(jTextRange, offsetMapping2) : jTextRange;
    }

    /* renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1569mapFromTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping != null) {
            range = Companion.m1577mapFromTransformedxdX6G0(range, offsetMapping);
        }
        return offsetMapping2 != null ? Companion.m1577mapFromTransformedxdX6G0(range, offsetMapping2) : range;
    }
    ...
    */
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextRange textRangeM5590boximpl = null;
            if (textFieldBuffer.getChanges().getChangeCount() == 0) {
                return null;
            }
            long jM1578mapToTransformedXGyztTk = m1578mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                textRangeM5590boximpl = TextRange.m5590boximpl(TransformedTextFieldState.Companion.m1578mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(textFieldBuffer.m1444toTextFieldCharSequenceudt6zUU$foundation_release(jM1578mapToTransformedXGyztTk, textRangeM5590boximpl), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            return new TransformedText(new TextFieldCharSequence(visualText, jM1578mapToTransformedXGyztTk, textRangeM5590boximpl, null, 8, null), offsetMappingCalculator);
        }

        /* renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1579mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1578mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long jTextRange;
            long jM1520mapFromSourcejx7JFs = mapping.m1520mapFromSourcejx7JFs(TextRange.m5602getStartimpl(range));
            long jM1520mapFromSourcejx7JFs2 = TextRange.m5596getCollapsedimpl(range) ? jM1520mapFromSourcejx7JFs : mapping.m1520mapFromSourcejx7JFs(TextRange.m5597getEndimpl(range));
            int iMin = Math.min(TextRange.m5600getMinimpl(jM1520mapFromSourcejx7JFs), TextRange.m5600getMinimpl(jM1520mapFromSourcejx7JFs2));
            int iMax = Math.max(TextRange.m5599getMaximpl(jM1520mapFromSourcejx7JFs), TextRange.m5599getMaximpl(jM1520mapFromSourcejx7JFs2));
            if (TextRange.m5601getReversedimpl(range)) {
                jTextRange = TextRangeKt.TextRange(iMax, iMin);
            } else {
                jTextRange = TextRangeKt.TextRange(iMin, iMax);
            }
            if (TextRange.m5596getCollapsedimpl(range) && !TextRange.m5596getCollapsedimpl(jTextRange)) {
                ...
                if (i != -1) {
                    if (i == 1) {
                        return TextRangeKt.TextRange(TextRange.m5602getStartimpl(jTextRange));
                    }
                    if (i == 2) {
                        return TextRangeKt.TextRange(TextRange.m5597getEndimpl(jTextRange));
                    }
        ...
        @JvmStatic
        /* renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1577mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long jM1519mapFromDestjx7JFs = mapping.m1519mapFromDestjx7JFs(TextRange.m5602getStartimpl(range));
            long jM1519mapFromDestjx7JFs2 = TextRange.m5596getCollapsedimpl(range) ? jM1519mapFromDestjx7JFs : mapping.m1519mapFromDestjx7JFs(TextRange.m5597getEndimpl(range));
            int iMin = Math.min(TextRange.m5600getMinimpl(jM1519mapFromDestjx7JFs), TextRange.m5600getMinimpl(jM1519mapFromDestjx7JFs2));
            int iMax = Math.max(TextRange.m5599getMaximpl(jM1519mapFromDestjx7JFs), TextRange.m5599getMaximpl(jM1519mapFromDestjx7JFs2));
            if (TextRange.m5601getReversedimpl(range)) {
