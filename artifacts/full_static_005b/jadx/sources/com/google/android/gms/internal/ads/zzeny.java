...
public final class zzeny {
    ...
    private final synchronized zzgbf zzh(String str) {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(com.google.android.gms.ads.internal.zzu.zzo().zzi().zzh().zzc())) {
            boolean zMatches = Pattern.matches((String) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzde), str);
            boolean zMatches2 = Pattern.matches((String) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzdf), str);
            if (zMatches) {
                map = new HashMap(this.zze);
            } else if (zMatches2) {
                map = new HashMap(this.zzd);
            }
            return zzgbf.zzc(map);
        }
        return zzgbf.zzd();
    }
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (((zzeoa) this.zza.get(str2)) != null) {
                        arrayList.add(new zzeoa(str2, str, bundleZzo));
                    }
                }
            }
        }
    ...
    private final synchronized void zzk() {
        ...
        if (!((Boolean) zzbgq.zzb.zze()).booleanValue()) {
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzbN)).booleanValue() && (jSONObjectZzf = com.google.android.gms.ads.internal.zzu.zzo().zzi().zzh().zzf()) != null) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        if (!TextUtils.isEmpty(strOptString)) {
                            for (int i2 = 0; i2 < jSONArrayOptJSONArray.length(); i2++) {
                                ...
                                zzeoc zzeocVar = new zzeoc(strOptString, zOptBoolean2, zOptBoolean, zOptBoolean3, new Bundle());
                                if (strOptString2.equals("ADMOB")) {
                                    this.zzd.put(strOptString, zzeocVar);
                                } else if (strOptString2.equals("AD_MANAGER")) {
                                    this.zze.put(strOptString, zzeocVar);
                                }
                            }
                        }
                    }
            ...
            try {
                ...
                if (jSONArrayOptJSONArray2 != null) {
                    for (int i = 0; i < jSONArrayOptJSONArray2.length(); i++) {
                        ...
                        String lowerCase = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzkR)).booleanValue() ? jSONObject.optString("ad_unit_id", "").toLowerCase(Locale.ROOT) : jSONObject.optString("ad_unit_id", "");
    ...
    private final synchronized void zzn() {
        ...
        if (!((Boolean) zzbgq.zzg.zze()).booleanValue()) {
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbep.zzbM)).booleanValue() && (jSONObjectZzf = com.google.android.gms.ads.internal.zzu.zzo().zzi().zzh().zzf()) != null) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        if (!TextUtils.isEmpty(strOptString)) {
                            this.zzb.put(strOptString, new zzeoc(strOptString, zOptBoolean2, zOptBoolean, true, bundleZzo));
                        }
                    }
                } catch (JSONException e) {
                    com.google.android.gms.ads.internal.util.zze.zzb("Malformed config loading JSON.", e);
    ...
    public final synchronized Map zza(String str, String str2) {
        ...
        zzgbf zzgbfVarZzh = zzh(str2);
        map = new HashMap();
        for (Map.Entry entry : ((zzgbf) mapZzb).entrySet()) {
            String str3 = (String) entry.getKey();
            if (zzgbfVarZzh.containsKey(str3)) {
                zzeoc zzeocVar = (zzeoc) zzgbfVarZzh.get(str3);
                List list = (List) entry.getValue();
                map.put(str3, new zzeoc(str3, zzeocVar.zzb, zzeocVar.zzc, zzeocVar.zzd, (list == null || list.isEmpty()) ? new Bundle() : (Bundle) list.get(0)));
            }
        }
        zzgdi zzgdiVarZze = zzgbfVarZzh.entrySet().iterator();
        while (zzgdiVarZze.hasNext()) {
            Map.Entry entry2 = (Map.Entry) zzgdiVarZze.next();
            String str4 = (String) entry2.getKey();
            if (!map.containsKey(str4) && ((zzeoc) entry2.getValue()).zzd) {
                map.put(str4, (zzeoc) entry2.getValue());
            }
        }
        return map;
    }
    ...
    public final synchronized Map zzb(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(com.google.android.gms.ads.internal.zzu.zzo().zzi().zzh().zzc()) && (map = (Map) this.zzc.get(str)) != null) {
            ...
            if (list == null) {
                String strZza = zzdta.zza(this.zzg, str2, str);
            ...
            if (list != null) {
                ...
                for (zzeoa zzeoaVar : list) {
                    ...
                    ((List) map2.get(str3)).add(zzeoaVar.zzc);
                }
                return zzgbf.zzc(map2);
            }
        }
        return zzgbf.zzd();
    }
