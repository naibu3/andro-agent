...
public final class AnchoredDraggableState<T> {
    ...
    static final class C04681 extends ContinuationImpl {
        ...
        C04681(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C04681> continuation) {
            super(continuation);
    ...
    */
    public final Object anchoredDrag(MutatePriority mutatePriority, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C04681) {
            ...
            if ((c04681.label & Integer.MIN_VALUE) != 0) {
                ...
                c04681 = new C04681(this, continuation);
            }
        }
        ...
        if (i != 0) {
            ...
            anchoredDraggableState = (AnchoredDraggableState) c04681.L$0;
            try {
        ...
        try {
            ...
            C04692 c04692 = new C04692(this, function3, null);
            c04681.L$0 = this;
            c04681.label = 1;
            if (internalMutatorMutex.mutate(mutatePriority, c04692, c04681) == coroutine_suspended) {
    ...
    static final class C04692 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04692(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C04692> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04692(this.this$0, this.$block, continuation);
        }
