...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM1760trySendImplMj0NB7M = conflatedBufferedChannel.m1760trySendImplMj0NB7M(e, true);
        if (objM1760trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1746exceptionOrNullimpl(objM1760trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM1760trySendImplMj0NB7M = conflatedBufferedChannel.m1760trySendImplMj0NB7M(e, true);
        if (!(objM1760trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1732trySendJP2dKIU(E element) {
        return m1760trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1760trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1758trySendDropLatestMj0NB7M(element, isSendOp) : m1759trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1758trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo1732trySendJP2dKIU = super.mo1732trySendJP2dKIU(element);
        if (ChannelResult.m1752isSuccessimpl(objMo1732trySendJP2dKIU) || ChannelResult.m1750isClosedimpl(objMo1732trySendJP2dKIU)) {
            return objMo1732trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m1757successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m1759trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo1732trySendJP2dKIU = mo1732trySendJP2dKIU(element);
        if (!(objMo1732trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo1732trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1746exceptionOrNullimpl(objMo1732trySendJP2dKIU);
