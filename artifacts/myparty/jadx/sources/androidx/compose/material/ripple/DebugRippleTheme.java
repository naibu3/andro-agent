...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1856defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM2111defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2111defaultRippleColor5vOe2sY(Color.INSTANCE.m3683getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return jM2111defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM2110defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2110defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3683getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleAlphaM2110defaultRippleAlphaDxMtmZc;
    }
}
