...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C02741(input, limit, null));
    }
    ...
    static final class C02741 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02741(CharSequence charSequence, int i, Continuation<? super C02741> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02741 c02741 = Regex.this.new C02741(this.$input, this.$limit, continuation);
            c02741.L$0 = obj;
            return c02741;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C02741) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
