...
class FontRequestWorker {
    ...
    static Typeface requestFontSync(final Context context, final FontRequest request, CallbackWithHandler callback, final int style, int timeoutInMillis) throws Throwable {
        final String id2 = createCacheId(request, style);
        ...
        if (timeoutInMillis == -1) {
            TypefaceResult typefaceResult = getFontSync(id2, context, request, style);
        ...
        Callable<TypefaceResult> fetcher = new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.1
            ...
            public TypefaceResult call() {
                return FontRequestWorker.getFontSync(id2, context, request, style);
            }
        };
        try {
    ...
    static Typeface requestFontAsync(final Context context, final FontRequest request, final int style, Executor executor, final CallbackWithHandler callback) {
        ...
        synchronized (LOCK) {
            ...
            ArrayList<Consumer<TypefaceResult>> pendingReplies = simpleArrayMap.get(id2);
            ...
            simpleArrayMap.put(id2, pendingReplies2);
            ...
            RequestExecutor.execute(finalExecutor, fetcher, new Consumer<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.4
                ...
                public void accept(TypefaceResult typefaceResult) {
                    synchronized (FontRequestWorker.LOCK) {
                        ArrayList<Consumer<TypefaceResult>> replies = FontRequestWorker.PENDING_REPLIES.get(id2);
                        if (replies == null) {
                            return;
                        }
                        FontRequestWorker.PENDING_REPLIES.remove(id2);
