...
public final class LazyGridState implements ScrollableState {
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        arrayList.add(lazyGridState.getPrefetchState().m1192schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                    }
    ...
    public final MutableState<Unit> m1167getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m1166getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    public Object scroll(MutatePriority mutatePriority, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        if (i == 0) {
            ...
            c03911.L$0 = this;
            c03911.L$1 = mutatePriority;
            c03911.L$2 = function2;
            c03911.label = 1;
            if (awaitFirstLayoutModifier.waitForFirstLayout(c03911) != coroutine_suspended) {
                lazyGridState = this;
            }
            return coroutine_suspended;
        }
        ...
        function2 = (Function2) c03911.L$2;
        mutatePriority = (MutatePriority) c03911.L$1;
        lazyGridState = (LazyGridState) c03911.L$0;
        ResultKt.throwOnFailure(obj);
