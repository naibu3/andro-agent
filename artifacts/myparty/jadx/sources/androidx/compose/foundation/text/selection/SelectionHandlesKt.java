...
public final class SelectionHandlesKt {
    ...
    public static final long m1683getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3416getXimpl(j), Offset.m3417getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m6117constructorimpl(f);
        HandleHeight = Dp.m6117constructorimpl(f);
    }
}
