...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m889setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m888setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo430measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m869alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m6328isUnspecifiedR2X_6o(this.before) ? measureScope.mo707toDpGaN1DYA(this.before) : Dp.INSTANCE.m6137getUnspecifiedD9Ej5fM(), !TextUnitKt.m6328isUnspecifiedR2X_6o(this.after) ? measureScope.mo707toDpGaN1DYA(this.after) : Dp.INSTANCE.m6137getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
