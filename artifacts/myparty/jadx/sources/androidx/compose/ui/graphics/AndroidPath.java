...
public final class AndroidPath implements Path {
    ...
    public int mo3548getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m3939getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m3940getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3550setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m3935equalsimpl0(i, PathFillType.INSTANCE.m3939getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m3391getXimpl(roundRect.m3466getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3392getYimpl(roundRect.m3466getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3391getXimpl(roundRect.m3467getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3392getYimpl(roundRect.m3467getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3391getXimpl(roundRect.m3465getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3392getYimpl(roundRect.m3465getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3391getXimpl(roundRect.m3464getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3392getYimpl(roundRect.m3464getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3547addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3416getXimpl(offset), Offset.m3417getYimpl(offset));
            return;
        }
    ...
    public void mo3552translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3416getXimpl(offset), Offset.m3417getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3551transform58bKbWc(float[] matrix) {
    ...
    public boolean mo3549opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m3945equalsimpl0(operation, PathOperation.INSTANCE.m3949getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3945equalsimpl0(operation, PathOperation.INSTANCE.m3950getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3945equalsimpl0(operation, PathOperation.INSTANCE.m3951getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3945equalsimpl0(operation, PathOperation.INSTANCE.m3952getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
