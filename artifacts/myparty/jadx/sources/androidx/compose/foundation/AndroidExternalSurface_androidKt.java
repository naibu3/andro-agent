...
public final class AndroidExternalSurface_androidKt {
    ...
    */
    public static final void m573AndroidExternalSurface58FFMhA(Modifier modifier, boolean z, long j, int i, boolean z2, final Function1<? super AndroidExternalSurfaceScope, Unit> function1, Composer composer, final int i2, final int i3) {
        Modifier modifier2;
        int i4;
        boolean z3;
        long jM6292getZeroYbymL2g;
        int i5;
        int iM569getBehindB_4ceCc;
        int i6;
        boolean z4;
        ...
        if (i10 != 0) {
            ...
            if ((i2 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) != 0) {
                jM6292getZeroYbymL2g = j;
                i4 |= ((i3 & 4) == 0 && composerStartRestartGroup.changed(jM6292getZeroYbymL2g)) ? 256 : 128;
            } else {
                jM6292getZeroYbymL2g = j;
            }
            i5 = i3 & 8;
            if (i5 == 0) {
                ...
                if ((i2 & 3072) == 0) {
                    iM569getBehindB_4ceCc = i;
                    i4 |= composerStartRestartGroup.changed(iM569getBehindB_4ceCc) ? 2048 : 1024;
                }
                i6 = i3 & 16;
                if (i6 == 0) {
                    if ((i2 & 24576) == 0) {
                    ...
                    if ((i4 & 74899) == 74898 || !composerStartRestartGroup.getSkipping()) {
                        ...
                        if ((i2 & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i3 & 4) != 0) {
                                i4 &= -897;
                                jM6292getZeroYbymL2g = IntSize.INSTANCE.m6292getZeroYbymL2g();
                            }
                            if (i5 != 0) {
                                iM569getBehindB_4ceCc = AndroidExternalSurfaceZOrder.INSTANCE.m569getBehindB_4ceCc();
                            }
                            if (i6 != 0) {
                                z4 = false;
                            }
                        ...
                        z5 = ((((i4 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composerStartRestartGroup.changed(jM6292getZeroYbymL2g)) || (i4 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | ((i4 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32) | ((i4 & 7168) == 2048) | ((57344 & i4) == 16384);
                        Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
                        if (z5 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            final boolean z9 = z3;
                            final long j4 = jM6292getZeroYbymL2g;
                            final boolean z10 = z4;
                            final int i11 = iM569getBehindB_4ceCc;
                            j2 = j4;
                            i7 = i11;
                            z6 = z10;
                            obj = (Function1) new Function1<SurfaceView, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidExternalSurface$3$1
                                ...
                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                public final void invoke2(SurfaceView surfaceView) {
                                    if (!IntSize.m6285equalsimpl0(j4, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
                                        surfaceView.getHolder().setFixedSize(IntSize.m6287getWidthimpl(j4), IntSize.m6286getHeightimpl(j4));
                                    } else {
                                        surfaceView.getHolder().setSizeFromLayout();
                                    }
                                    surfaceView.getHolder().setFormat(z9 ? -1 : -3);
                                    int i12 = i11;
                                    if (AndroidExternalSurfaceZOrder.m565equalsimpl0(i12, AndroidExternalSurfaceZOrder.INSTANCE.m569getBehindB_4ceCc())) {
                                        surfaceView.setZOrderOnTop(false);
                                    } else if (AndroidExternalSurfaceZOrder.m565equalsimpl0(i12, AndroidExternalSurfaceZOrder.INSTANCE.m570getMediaOverlayB_4ceCc())) {
                                        surfaceView.setZOrderMediaOverlay(true);
                                    } else if (AndroidExternalSurfaceZOrder.m565equalsimpl0(i12, AndroidExternalSurfaceZOrder.INSTANCE.m571getOnTopB_4ceCc())) {
                            ...
                            j2 = jM6292getZeroYbymL2g;
                            z6 = z4;
                            i7 = iM569getBehindB_4ceCc;
                        }
                        ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                        Modifier modifier4 = companion;
                        AndroidView_androidKt.AndroidView(function12, modifier4, androidExternalSurface_androidKt$AndroidExternalSurface$2, null, (Function1) obj, composerStartRestartGroup, ((i4 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT, 8);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        j3 = j2;
                        ...
                        modifier3 = modifier2;
                        z7 = z3;
                        j3 = jM6292getZeroYbymL2g;
                        z8 = z4;
                        i8 = iM569getBehindB_4ceCc;
                    }
                    ...
                    if (scopeUpdateScopeEndRestartGroup == null) {
                        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidExternalSurface$4
                            ...
                            public final void invoke(Composer composer2, int i12) {
                                AndroidExternalSurface_androidKt.m573AndroidExternalSurface58FFMhA(modifier3, z7, j3, i8, z8, function1, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
                            }
                        });
                        return;
                    }
                        ...
                        if (!zChangedInstance) {
                            ...
                            if (((i4 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256) {
                                ...
                                if (z5) {
                                    ...
                                    final long j42 = jM6292getZeroYbymL2g;
                                    final boolean z102 = z4;
                                    final int i112 = iM569getBehindB_4ceCc;
                                    j2 = j42;
                                    i7 = i112;
                                    z6 = z102;
                                    obj = (Function1) new Function1<SurfaceView, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidExternalSurface$3$1
                                        ...
                                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                        public final void invoke2(SurfaceView surfaceView) {
                                            if (!IntSize.m6285equalsimpl0(j42, IntSize.INSTANCE.m6292getZeroYbymL2g())) {
                                                surfaceView.getHolder().setFixedSize(IntSize.m6287getWidthimpl(j42), IntSize.m6286getHeightimpl(j42));
                                            } else {
                                                surfaceView.getHolder().setSizeFromLayout();
                                            }
                                    ...
                                    AndroidView_androidKt.AndroidView(function122, modifier42, androidExternalSurface_androidKt$AndroidExternalSurface$22, null, (Function1) obj, composerStartRestartGroup, ((i4 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT, 8);
                                    if (ComposerKt.isTraceInProgress()) {
                                    }
                                    j3 = j2;
                                    z7 = z3;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m572AndroidEmbeddedExternalSurfacesv6N_fY(Modifier modifier, boolean z, long j, float[] fArr, final Function1<? super AndroidExternalSurfaceScope, Unit> function1, Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        boolean z2;
        long jM6292getZeroYbymL2g;
        ...
        if (i6 != 0) {
            ...
            if ((i & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) != 0) {
                jM6292getZeroYbymL2g = j;
                i3 |= ((i2 & 4) == 0 && composerStartRestartGroup.changed(jM6292getZeroYbymL2g)) ? 256 : 128;
            } else {
                jM6292getZeroYbymL2g = j;
            }
            i4 = i2 & 8;
            if (i4 == 0) {
                ...
                i3 |= composerStartRestartGroup.changedInstance(fArr != null ? Matrix.m3886boximpl(fArr) : null) ? 2048 : 1024;
            }
            if ((i2 & 16) != 0) {
                if ((i & 24576) == 0) {
                ...
                if ((i3 & 9363) != 9362 || !composerStartRestartGroup.getSkipping()) {
                    ...
                    if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i4 == 0) {
                            ...
                            zChangedInstance = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composerStartRestartGroup.changed(jM6292getZeroYbymL2g)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | composerStartRestartGroup.changedInstance(androidEmbeddedExternalSurfaceStateRememberAndroidEmbeddedExternalSurfaceState) | ((57344 & i3) == 16384) | ((i3 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32) | composerStartRestartGroup.changedInstance(fArr2 != null ? Matrix.m3886boximpl(fArr2) : null);
                            objRememberedValue = composerStartRestartGroup.rememberedValue();
                            if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                j2 = jM6292getZeroYbymL2g;
                                ...
                                objRememberedValue = (Function1) new Function1<TextureView, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$3$1
                                    ...
                                    public final void invoke2(TextureView textureView) {
                                        ...
                                        if (!IntSize.m6285equalsimpl0(j2, IntSize.INSTANCE.m6292getZeroYbymL2g()) && (surfaceTexture = textureView.getSurfaceTexture()) != null) {
                                            surfaceTexture.setDefaultBufferSize(IntSize.m6287getWidthimpl(j2), IntSize.m6286getHeightimpl(j2));
                                        }
                                        androidEmbeddedExternalSurfaceStateRememberAndroidEmbeddedExternalSurfaceState.m561setSurfaceSizeozmzZPI(j2);
                                        ...
                                        if (fArr4 != null) {
                                            ...
                                            AndroidMatrixConversions_androidKt.m3527setFromEL8BTi8(matrix, fArr4);
                                        } else {
                                            matrix = null;
                                        }
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                            Modifier modifier4 = companion;
                            AndroidView_androidKt.AndroidView(androidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$1, modifier4, androidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$2, null, (Function1) objRememberedValue, composerStartRestartGroup, ((i3 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | 390, 8);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier3 = modifier4;
                    ...
                    ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 184054658, "CC(remember):AndroidExternalSurface.android.kt#9igjgp");
                    if (((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256) {
                        zChangedInstance = ((((i3 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) <= 256 && composerStartRestartGroup.changed(jM6292getZeroYbymL2g)) || (i3 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256) | composerStartRestartGroup.changedInstance(androidEmbeddedExternalSurfaceStateRememberAndroidEmbeddedExternalSurfaceState) | ((57344 & i3) == 16384) | ((i3 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) == 32) | composerStartRestartGroup.changedInstance(fArr2 != null ? Matrix.m3886boximpl(fArr2) : null);
                        objRememberedValue = composerStartRestartGroup.rememberedValue();
                        if (zChangedInstance) {
                            j2 = jM6292getZeroYbymL2g;
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                            Modifier modifier42 = companion;
                            AndroidView_androidKt.AndroidView(androidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$12, modifier42, androidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$22, null, (Function1) objRememberedValue, composerStartRestartGroup, ((i3 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | 390, 8);
                            if (ComposerKt.isTraceInProgress()) {
                            }
                            modifier3 = modifier42;
                            j3 = j2;
                ...
                if (scopeUpdateScopeEndRestartGroup != null) {
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$4
                        ...
                        public final void invoke(Composer composer2, int i7) {
                            AndroidExternalSurface_androidKt.m572AndroidEmbeddedExternalSurfacesv6N_fY(modifier3, z4, j3, fArr3, function1, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                    return;
                }
