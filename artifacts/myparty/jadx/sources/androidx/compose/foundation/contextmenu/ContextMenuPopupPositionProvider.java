...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo684calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6245getXimpl(this.localPosition), IntSize.m6287getWidthimpl(popupContentSize), IntSize.m6287getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6246getYimpl(this.localPosition), IntSize.m6286getHeightimpl(popupContentSize), IntSize.m6286getHeightimpl(windowSize), false, 8, null));
    }
}
