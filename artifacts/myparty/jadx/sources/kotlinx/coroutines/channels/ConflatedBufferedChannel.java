...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM10673trySendImplMj0NB7M = conflatedBufferedChannel.m10673trySendImplMj0NB7M(e, true);
        if (objM10673trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m10658exceptionOrNullimpl(objM10673trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM10673trySendImplMj0NB7M = conflatedBufferedChannel.m10673trySendImplMj0NB7M(e, true);
        if (!(objM10673trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo10639trySendJP2dKIU(E element) {
        return m10673trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m10673trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m10672trySendDropLatestMj0NB7M(element, isSendOp) : m10648trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m10672trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo10639trySendJP2dKIU = super.mo10639trySendJP2dKIU(element);
        if (ChannelResult.m10664isSuccessimpl(objMo10639trySendJP2dKIU) || ChannelResult.m10662isClosedimpl(objMo10639trySendJP2dKIU)) {
            return objMo10639trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo10639trySendJP2dKIU = mo10639trySendJP2dKIU(element);
        if (!(objMo10639trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo10639trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m10658exceptionOrNullimpl(objMo10639trySendJP2dKIU);
