...
public final class BancontactDefinition implements PaymentMethodDefinition {
    ...
    public static final BancontactDefinition INSTANCE = new BancontactDefinition();
    private static final PaymentMethod.Type type = PaymentMethod.Type.Bancontact;

    private BancontactDefinition() {
    }
