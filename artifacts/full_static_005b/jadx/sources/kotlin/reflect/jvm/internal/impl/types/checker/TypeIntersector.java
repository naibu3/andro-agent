    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo1495getSupertypes = simpleType.getConstructor().mo1495getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1495getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo1495getSupertypes;
