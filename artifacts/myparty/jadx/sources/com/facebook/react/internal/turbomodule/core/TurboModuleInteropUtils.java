...
public final class TurboModuleInteropUtils {
    ...
    @JvmStatic
    public static final List<MethodDescriptor> getMethodDescriptorsFromModule(NativeModule module) throws SecurityException {
    ...
    private final Method[] getMethodsFromModule(NativeModule module) throws SecurityException {
