...
@DebugMetadata(c = "androidx.compose.foundation.gestures.DragGestureDetectorKt$awaitLongPressOrCancellation$2", f = "DragGestureDetector.kt", i = {0, 0, 1, 1, 1}, l = {TypedValues.Custom.TYPE_FLOAT, 918}, m = "invokeSuspend", n = {"$this$withTimeout", "finished", "$this$withTimeout", "event", "finished"}, s = {"L$0", "I$0", "L$0", "L$1", "I$0"})
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            if (!DragGestureDetectorKt.m763isPointerUpDmW0f2w(pointerEvent2, this.$currentDown.element.getId())) {
                    ...
                    if (i == 0) {
                        ...
                        if (objAwaitPointerEvent != coroutine_suspended) {
                            ...
                            for (i3 = 0; i3 < size2; i3++) {
                                ...
                                if (pointerInputChange3.isConsumed() || PointerEventKt.m4809isOutOfBoundsjwHxaWs(pointerInputChange3, awaitPointerEventScope.mo4775getSizeYbymL2g(), awaitPointerEventScope.mo4774getExtendedTouchPaddingNHjbRc())) {
                                    break;
                                }
                            }
                            this.L$0 = awaitPointerEventScope;
                            ...
                            if (objAwaitPointerEvent2 != coroutine_suspended) {
                                ...
                                if (!DragGestureDetectorKt.m763isPointerUpDmW0f2w(pointerEvent2, this.$currentDown.element.getId())) {
                                    ...
                                    while (true) {
                                        ...
                                        if (PointerId.m4846equalsimpl0(((PointerInputChange) t).getId(), objectRef2.element.getId())) {
                                            break;
                                        }
                                        i8++;
