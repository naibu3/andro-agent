...
public final class MetadataItem extends Table {
    ...
    public static int createMetadataItem(FlatBufferBuilder builder, int id2, boolean emojiStyle, short sdkAdded, short compatAdded, short width, short height, int codepointsOffset) {
    ...
    public static void addId(FlatBufferBuilder builder, int id2) {
        builder.addInt(0, id2, 0);
    }
