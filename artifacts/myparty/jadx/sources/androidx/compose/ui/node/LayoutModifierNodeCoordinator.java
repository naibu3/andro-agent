...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet() & NodeKind.m5228constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & NodeKind.m5228constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final void m5140setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4993measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m5056setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.m5140setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m6058boximpl(constraints));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo430measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    */
    public Placeable mo4993measureBRTryo0(long constraints) {
        final MeasureResult measureResultMo430measure3p2s80s;
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            boolean z = false;
            approachMeasureScopeImpl.setApproachMeasureRequired$ui_release(approachNode.mo443isMeasurementApproachInProgressozmzZPI(approachMeasureScopeImpl.mo4968getLookaheadSizeYbymL2g()) || !Constraints.m6062equalsimpl(constraints, getLookaheadConstraints()));
            ...
            measureResultMo430measure3p2s80s = approachNode.mo442approachMeasure3p2s80s(approachMeasureScopeImpl, getWrappedNonNull(), constraints);
            getWrappedNonNull().setForceMeasureWithLookaheadConstraints$ui_release(false);
            int i = measureResultMo430measure3p2s80s.getWidth();
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            if (i == lookaheadDelegate.getWidth()) {
                int i2 = measureResultMo430measure3p2s80s.getHeight();
            ...
            if (!approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long jMo5001getSizeYbymL2g = getWrappedNonNull().mo5001getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                if (IntSize.m6284equalsimpl(jMo5001getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m6279boximpl(lookaheadDelegate3.m5175getSizeYbymL2g$ui_release()) : null) && !z) {
                    measureResultMo430measure3p2s80s = new MeasureResult(this) { // from class: androidx.compose.ui.node.LayoutModifierNodeCoordinator$measure$1$1$1$1
            ...
            if (measureResultMo430measure3p2s80s == null) {
                measureResultMo430measure3p2s80s = getLayoutModifierNode().mo430measure3p2s80s(this, getWrappedNonNull(), constraints);
            }
        }
        setMeasureResult$ui_release(measureResultMo430measure3p2s80s);
    ...
    public void mo5054placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo5054placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    public void mo4994placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo4994placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    */
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long j = mo5001getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m6284equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m6279boximpl(lookaheadDelegate2.m5175getSizeYbymL2g$ui_release()) : null)) {
                    long jMo5001getSizeYbymL2g = getWrappedNonNull().mo5001getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                    if (IntSize.m6284equalsimpl(jMo5001getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m6279boximpl(lookaheadDelegate3.m5175getSizeYbymL2g$ui_release()) : null)) {
                        z = true;
                    }
    ...
    static {
        ...
        Paint.mo3536setColor8_81llA(Color.INSTANCE.m3684getBlue0d7_KjU());
