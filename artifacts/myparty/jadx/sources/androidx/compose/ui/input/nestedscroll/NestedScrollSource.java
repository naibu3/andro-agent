...
public final class NestedScrollSource {
    ...
    public static final /* synthetic */ NestedScrollSource m4744boximpl(int i) {
    ...
    public static String m4749toStringimpl(int i) {
        if (m4747equalsimpl0(i, UserInput)) {
            return "UserInput";
        }
        if (m4747equalsimpl0(i, SideEffect)) {
            return "SideEffect";
        }
        if (m4747equalsimpl0(i, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4751getDragWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m4752getFlingWNlRxjI$annotations() {
        }

        @Deprecated(message = "Do not use. Will be removed in the future.")
        /* renamed from: getRelocate-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m4753getRelocateWNlRxjI$annotations() {
        }

        @Deprecated(message = "This has been replaced by UserInput.", replaceWith = @ReplaceWith(expression = "NestedScrollSource.UserInput", imports = {"import androidx.compose.ui.input.nestedscroll.NestedScrollSource.Companion.UserInput"}))
        /* renamed from: getWheel-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m4754getWheelWNlRxjI$annotations() {
        }
        ...
        public final int m4759getUserInputWNlRxjI() {
            return NestedScrollSource.UserInput;
        }

        /* renamed from: getSideEffect-WNlRxjI, reason: not valid java name */
        public final int m4758getSideEffectWNlRxjI() {
            return NestedScrollSource.SideEffect;
        }

        /* renamed from: getDrag-WNlRxjI, reason: not valid java name */
        public final int m4755getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI, reason: not valid java name */
        public final int m4756getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI, reason: not valid java name */
        public final int m4757getRelocateWNlRxjI() {
            return NestedScrollSource.Relocate;
        }

        /* renamed from: getWheel-WNlRxjI, reason: not valid java name */
        public final int m4760getWheelWNlRxjI() {
            return NestedScrollSource.Wheel;
        }
    }

    static {
        int iM4745constructorimpl = m4745constructorimpl(1);
        UserInput = iM4745constructorimpl;
        int iM4745constructorimpl2 = m4745constructorimpl(2);
        SideEffect = iM4745constructorimpl2;
        Drag = iM4745constructorimpl;
        Fling = iM4745constructorimpl2;
        Relocate = m4745constructorimpl(3);
        Wheel = iM4745constructorimpl;
    }
}
