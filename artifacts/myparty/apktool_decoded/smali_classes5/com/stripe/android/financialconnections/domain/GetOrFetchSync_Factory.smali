...
.method public static create(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)Lcom/stripe/android/financialconnections/domain/GetOrFetchSync_Factory;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public get()Lcom/stripe/android/financialconnections/domain/GetOrFetchSync;
    ...
    iget-object v2, p0, Lcom/stripe/android/financialconnections/domain/GetOrFetchSync_Factory;->applicationIdProvider:Ldagger/internal/Provider;
