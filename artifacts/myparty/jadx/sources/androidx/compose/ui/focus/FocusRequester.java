...
public final class FocusRequester {
    ...
    */
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        boolean zM3377findChildCorrespondingToFocusEnterOMvw8;
        Companion companion = INSTANCE;
        if (this == companion.getDefault()) {
            throw new IllegalStateException("\n    Please check whether the focusRequester is FocusRequester.Cancel or FocusRequester.Default\n    before invoking any functions on the focusRequester.\n".toString());
        }
                            ...
                            while (nodePop != null) {
                                if (nodePop instanceof FocusTargetNode) {
                                    ...
                                    if (focusTargetNode.fetchFocusProperties$ui_release().getCanFocus()) {
                                        zM3377findChildCorrespondingToFocusEnterOMvw8 = onFound.invoke(focusTargetNode).booleanValue();
                                    } else {
                                        zM3377findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3377findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m3335getEnterdhqQ8s(), onFound);
                                    }
                                    if (zM3377findChildCorrespondingToFocusEnterOMvw8) {
                                        z = true;
                                        break;
                                    }
                                } else if ((nodePop.getKindSet() & iM5228constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
