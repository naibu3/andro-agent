...
public final class ComposableSingletons$ErrorTextKt {
    ...
    private static Function2<Composer, Integer, Unit> f154lambda1 = ComposableLambdaKt.composableLambdaInstance(851973599, false, new Function2<Composer, Integer, Unit>() { // from class: com.stripe.android.link.ui.ComposableSingletons$ErrorTextKt$lambda-1$1
        ...
        public final void invoke(Composer composer, int i) {
            if ((i & 3) != 2 || !composer.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(851973599, i, -1, "com.stripe.android.link.ui.ComposableSingletons$ErrorTextKt.lambda-1.<anonymous> (ErrorText.kt:93)");
                }
                ...
                ErrorTextKt.ErrorText("Test error message", SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), ErrorTextStyle.Small.INSTANCE, composer, 438, 0);
                ErrorTextKt.ErrorText("Test error message", SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), ErrorTextStyle.Medium.INSTANCE, composer, 438, 0);
    ...
    public final Function2<Composer, Integer, Unit> m7819getLambda1$paymentsheet_release() {
        return f154lambda1;
    }
}
