        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    mutableList = SequencesKt.toMutableList(c00421.$this_shuffled);
                    break;
                case 1:
                    c00421 = this;
                    mutableList = (List) c00421.L$1;
                    sequenceScope = (SequenceScope) c00421.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (!mutableList.isEmpty()) {
                ...
                c00421.label = 1;
                if (sequenceScope.yield(t, c00421) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00371 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00371.L$0;
                    $this$sequence = $this$sequence2;
                    index = 0;
                    it = c00371.$source.iterator();
                    break;
                case 1:
                    c00371 = this;
                    index = c00371.I$0;
                    it = (Iterator) c00371.L$1;
                    $this$sequence = (SequenceScope) c00371.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            while (it.hasNext()) {
                ...
                c00371.L$0 = $this$sequence;
                c00371.L$1 = it;
                c00371.I$0 = index2;
                c00371.label = 1;
                if ($this$sequence.yieldAll(c00371.$iterator.invoke(result), c00371) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                index = index2;
            }
