...
public final class BlikConfig implements TextFieldConfig {
    ...
    private final Lazy blikPattern = LazyKt.lazy(new Function0() { // from class: com.stripe.android.ui.core.elements.BlikConfig$$ExternalSyntheticLambda0
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return BlikConfig.blikPattern_delegate$lambda$0();
        }
    });
    private final ResolvableString label = ResolvableStringUtilsKt.resolvableString$default(R.string.stripe_blik_code, new Object[0], null, 4, null);
    ...
    private final Regex getBlikPattern() {
        return (Regex) this.blikPattern.getValue();
    }
    ...
    public TextFieldState determineState(String input) {
        ...
        String str = input;
        boolean zMatches = getBlikPattern().matches(str);
        if (str.length() == 0) {
