...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            ...
            tInvoke = function1.invoke(financialConnectionsGenericInfoScreen);
        } while (!mutableStateFlow.compareAndSet(financialConnectionsGenericInfoScreen, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            financialConnectionsGenericInfoScreen = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(financialConnectionsGenericInfoScreen, function1.invoke(financialConnectionsGenericInfoScreen)));
    }
