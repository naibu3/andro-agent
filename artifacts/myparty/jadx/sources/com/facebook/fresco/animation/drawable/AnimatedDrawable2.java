...
public class AnimatedDrawable2 extends Drawable implements Animatable, DrawableWithCaches {
    ...
    public void draw(Canvas canvas) {
        ...
        long jNow = now();
        long jMax = this._isRunning ? (jNow - this.startTimeMs) + this.frameSchedulingOffsetMs : (long) Math.max(this.lastFrameAnimationTimeMs, AudioStats.AUDIO_AMPLITUDE_NONE);
