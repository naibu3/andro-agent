...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1571delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1572toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1572toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1412compareToLRDsOJo($this$toDelayMillis, Duration.INSTANCE.m1515getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1431getInWholeMillisecondsimpl($this$toDelayMillis), 1L);
        }
        return 0L;
    }
}
