...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4382getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4010getButtKaPHkGw();
        }
        return m4381getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4381getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4010getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4012getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4011getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m4384getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4021getMiterLxFBmk8();
        }
        return m4383getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4383getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m4021getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m4020getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m4022getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM3693getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
        ...
        if (i == -1) {
            iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3597getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3599getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3597getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3596getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3588getModulate0nO6VwU();
                    break;
                case 15:
                    iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3593getScreen0nO6VwU();
                    break;
                case 16:
                    iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3591getPlus0nO6VwU();
                    break;
                default:
                    iM3597getSrcIn0nO6VwU = BlendMode.INSTANCE.m3597getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM3597getSrcIn0nO6VwU;
        float fM6117constructorimpl = Dp.m6117constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM6117constructorimpl2 = Dp.m6117constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM6117constructorimpl, fM6117constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM4381getStrokeLineCapCSYIeUk = m4381getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4010getButtKaPHkGw());
        int iM4383getStrokeLineJoinkLtJ_vA = m4383getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m4020getBevelLxFBmk8());
        ...
        typedArrayObtainAttributes.recycle();
        builder.m4349addPathoIyEayM(list, namedInt == 0 ? PathFillType.INSTANCE.m3940getNonZeroRgk1Os() : PathFillType.INSTANCE.m3939getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, iM4381getStrokeLineCapCSYIeUk, iM4383getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
