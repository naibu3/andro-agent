...
public final class zzbua extends zzbuj {
    ...
    public final void zzc() throws JSONException {
        ...
        builderZzK.setPositiveButton(resourcesZze != null ? resourcesZze.getString(R.string.s3) : HttpHeaders.ACCEPT, new zzbty(this));
        builderZzK.setNegativeButton(resourcesZze != null ? resourcesZze.getString(R.string.s4) : "Decline", new zzbtz(this));
