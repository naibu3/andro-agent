...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m6255getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        String str = null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m6236boximpl(IntOffset.INSTANCE.m6255getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, str, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m6236boximpl(IntOffset.INSTANCE.m6255getZeronOccac()), null, 2, null);
    ...
    public final void m1183setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m1181setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m1175setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m6236boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m1179getPlacementDeltanOccac() {
    ...
    static final class C03941 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03941(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (LazyLayoutItemAnimation.this.placementDeltaAnimation.snapTo(IntOffset.m6236boximpl(IntOffset.INSTANCE.m6255getZeronOccac()), this) == coroutine_suspended) {
            ...
            LazyLayoutItemAnimation.this.m1175setPlacementDeltagyyYBs(IntOffset.INSTANCE.m6255getZeronOccac());
    ...
    public final void cancelPlacementAnimation() {
        if (isPlacementAnimationInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03941(null), 3, null);
        }
    }
    ...
    public final void m1182setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m1176animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long jM6248minusqkQi6aY = IntOffset.m6248minusqkQi6aY(m1179getPlacementDeltanOccac(), delta);
        m1175setPlacementDeltagyyYBs(jM6248minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, jM6248minusqkQi6aY, null), 3, null);
    }
    ...
    public final void animateAppearance() {
        ...
        if (isAppearanceAnimationInProgress() || finiteAnimationSpec == null || graphicsLayer == null) {
            if (isDisappearanceAnimationInProgress()) {
                ...
                BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03921(null), 3, null);
                return;
            }
            return;
        }
    ...
    static final class C03921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03921(continuation);
        }
    ...
    public final void animateDisappearance() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03931(finiteAnimationSpec, graphicsLayer, null), 3, null);
    }
    ...
    static final class C03931 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03931(FiniteAnimationSpec<Float> finiteAnimationSpec, GraphicsLayer graphicsLayer, Continuation<? super C03931> continuation) {
            super(2, continuation);
            this.$spec = finiteAnimationSpec;
            this.$layer = graphicsLayer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03931(this.$spec, this.$layer, continuation);
        }
    ...
    public final void release() {
        ...
        if (isPlacementAnimationInProgress()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03951(null), 3, null);
        }
        if (isAppearanceAnimationInProgress()) {
            setAppearanceAnimationInProgress(false);
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C03962(null), 3, null);
        }
        if (isDisappearanceAnimationInProgress()) {
        ...
        m1175setPlacementDeltagyyYBs(IntOffset.INSTANCE.m6255getZeronOccac());
    ...
    static final class C03951 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03951(continuation);
        }
    ...
    static final class C03962 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C03962(continuation);
        }
    ...
    public static final class Companion {
        ...
        public final long m1184getNotInitializednOccac() {
