...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo10410getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = typeConstructor.mo10409getDeclarationDescriptor(); classifierDescriptorMo10409getDeclarationDescriptor != null; classifierDescriptorMo10409getDeclarationDescriptor = classifierDescriptorMo10409getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo10409getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo10409getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
        return sb.toString();
    }
