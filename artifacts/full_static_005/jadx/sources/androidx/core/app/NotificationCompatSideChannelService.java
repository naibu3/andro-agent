...
public abstract class NotificationCompatSideChannelService extends Service {
    ...
    private class NotificationSideChannelStub extends INotificationSideChannel.Stub {
        ...
        public void notify(String packageName, int id2, String tag, Notification notification) throws RemoteException {
            NotificationCompatSideChannelService.this.checkPermission(getCallingUid(), packageName);
            long idToken = clearCallingIdentity();
            try {
                NotificationCompatSideChannelService.this.notify(packageName, id2, tag, notification);
            } finally {
        ...
        @Override // android.support.v4.app.INotificationSideChannel
        public void cancel(String packageName, int id2, String tag) throws RemoteException {
            NotificationCompatSideChannelService.this.checkPermission(getCallingUid(), packageName);
            long idToken = clearCallingIdentity();
            try {
                NotificationCompatSideChannelService.this.cancel(packageName, id2, tag);
            } finally {
                restoreCallingIdentity(idToken);
            }
        }
