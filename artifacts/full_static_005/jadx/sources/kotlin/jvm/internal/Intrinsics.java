...
public class Intrinsics {
    ...
    public static void reifiedOperationMarker(int id2, String typeParameterIdentifier) {
        throwUndefinedForReified();
    }

    public static void reifiedOperationMarker(int id2, String typeParameterIdentifier, String message) {
