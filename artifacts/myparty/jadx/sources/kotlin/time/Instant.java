...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m10580minusLRDsOJo(long duration) {
        return m10582plusLRDsOJo(Duration.m10526unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m10581minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m10511plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m10582plusLRDsOJo(long duration) {
        long jM10496getInWholeSecondsimpl = Duration.m10496getInWholeSecondsimpl(duration);
        int iM10498getNanosecondsComponentimpl = Duration.m10498getNanosecondsComponentimpl(duration);
        if (jM10496getInWholeSecondsimpl == 0 && iM10498getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM10496getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM10496getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM10498getNanosecondsComponentimpl);
        }
        return Duration.m10509isPositiveimpl(duration) ? MAX : MIN;
    }
}
