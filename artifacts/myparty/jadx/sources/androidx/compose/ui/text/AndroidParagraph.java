...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m6071getMinHeightimpl(j) != 0 || Constraints.m6072getMinWidthimpl(j) != 0) {
        ...
        int iM5447toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m5447toLayoutAlignaXe7zB0(style.m5643getTextAligne0LSkKk());
        boolean zM6002equalsimpl0 = TextAlign.m6002equalsimpl0(style.m5643getTextAligne0LSkKk(), TextAlign.INSTANCE.m6008getJustifye0LSkKk());
        int iM5449toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m5449toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int iM5448toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m5448toLayoutBreakStrategyxImikfE(LineBreak.m5926getStrategyfcGXIks(style.m5640getLineBreakrAG3T2k()));
        int iM5450toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m5450toLayoutLineBreakStylehpcqdu8(LineBreak.m5927getStrictnessusljTpc(style.m5640getLineBreakrAG3T2k()));
        int iM5451toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m5451toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5928getWordBreakjp8hJ3c(style.m5640getLineBreakrAG3T2k()));
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM5447toLayoutAlignaXe7zB0, zM6002equalsimpl0 ? 1 : 0, truncateAt, i, iM5449toLayoutHyphenationFrequency3fSNIE, iM5448toLayoutBreakStrategyxImikfE, iM5450toLayoutLineBreakStylehpcqdu8, iM5451toLayoutLineBreakWordStylewPN0Rpw);
        if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m6069getMaxHeightimpl(j) && i > 1) {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m6069getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight < 0 || iNumberOfLinesThatFitMaxHeight == i) {
                ...
                androidParagraph = this;
                textLayoutConstructTextLayout = androidParagraph.constructTextLayout(iM5447toLayoutAlignaXe7zB0, zM6002equalsimpl0 ? 1 : 0, truncateAt, iCoerceAtLeast, iM5449toLayoutHyphenationFrequency3fSNIE, iM5448toLayoutBreakStrategyxImikfE, iM5450toLayoutLineBreakStylehpcqdu8, iM5451toLayoutLineBreakWordStylewPN0Rpw);
            }
        ...
        androidParagraph.getTextPaint$ui_text_release().m5869setBrush12SF9DM(style.getBrush(), SizeKt.Size(androidParagraph.getWidth(), androidParagraph.getHeight()), style.getAlpha());
        ...
        if (shaderBrushSpans != null) {
            ...
            while (it.hasNext()) {
                ((ShaderBrushSpan) it.next()).m5889setSizeuvyYCjk(SizeKt.Size(androidParagraph.getWidth(), androidParagraph.getHeight()));
            }
        }
    ...
    public float getWidth() {
        return Constraints.m6070getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5435getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3417getYimpl(position)), Offset.m3416getXimpl(position));
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public long mo5436getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m5452toLayoutTextGranularityduNsdkg(granularity), new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
    ...
    public void mo5433fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5600getMinimpl(range), TextRange.m5599getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5437getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5439paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5871setColor8_81llA(color);
    ...
    public void mo5438paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text_release.m5868setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5868setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5440painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5869setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5868setBlendModes9anfk8(blendMode);
