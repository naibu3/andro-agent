...
final /* data */ class BorderCache {
    ...
    */
    public final ImageBitmap m583drawBorderCacheEMwLDEs(CacheDrawScope cacheDrawScope, long j, int i, Function1<? super DrawScope, Unit> function1) {
        int i2;
        CanvasDrawScope canvasDrawScope;
        ImageBitmap imageBitmapM3883ImageBitmapx__hDU$default = this.imageBitmap;
        Canvas Canvas = this.canvas;
        ImageBitmapConfig imageBitmapConfigM3870boximpl = imageBitmapM3883ImageBitmapx__hDU$default != null ? ImageBitmapConfig.m3870boximpl(imageBitmapM3883ImageBitmapx__hDU$default.mo3524getConfig_sVssgQ()) : null;
        boolean z = false;
        if (!(imageBitmapConfigM3870boximpl == null ? false : ImageBitmapConfig.m3873equalsimpl0(imageBitmapConfigM3870boximpl.m3876unboximpl(), ImageBitmapConfig.INSTANCE.m3878getArgb8888_sVssgQ()))) {
            i2 = i;
            if (ImageBitmapConfig.m3872equalsimpl(i2, imageBitmapM3883ImageBitmapx__hDU$default != null ? ImageBitmapConfig.m3870boximpl(imageBitmapM3883ImageBitmapx__hDU$default.mo3524getConfig_sVssgQ()) : null)) {
            }
            if (imageBitmapM3883ImageBitmapx__hDU$default != null || Canvas == null || Size.m3485getWidthimpl(cacheDrawScope.m3306getSizeNHjbRc()) > imageBitmapM3883ImageBitmapx__hDU$default.getWidth() || Size.m3482getHeightimpl(cacheDrawScope.m3306getSizeNHjbRc()) > imageBitmapM3883ImageBitmapx__hDU$default.getHeight() || !z) {
                imageBitmapM3883ImageBitmapx__hDU$default = ImageBitmapKt.m3883ImageBitmapx__hDU$default(IntSize.m6287getWidthimpl(j), IntSize.m6286getHeightimpl(j), i2, false, null, 24, null);
                this.imageBitmap = imageBitmapM3883ImageBitmapx__hDU$default;
                Canvas = androidx.compose.ui.graphics.CanvasKt.Canvas(imageBitmapM3883ImageBitmapx__hDU$default);
                this.canvas = Canvas;
            }
            ...
            long jM6299toSizeozmzZPI = IntSizeKt.m6299toSizeozmzZPI(j);
            ...
            ImageBitmap imageBitmap = imageBitmapM3883ImageBitmapx__hDU$default;
            DrawScope.m4207drawRectnJ9OG0$default(canvasDrawScope2, Color.INSTANCE.m3683getBlack0d7_KjU(), 0L, jM6299toSizeozmzZPI, 0.0f, null, null, BlendMode.INSTANCE.m3572getClear0nO6VwU(), 58, null);
        ...
        i2 = i;
        z = true;
        if (imageBitmapM3883ImageBitmapx__hDU$default != null) {
            imageBitmapM3883ImageBitmapx__hDU$default = ImageBitmapKt.m3883ImageBitmapx__hDU$default(IntSize.m6287getWidthimpl(j), IntSize.m6286getHeightimpl(j), i2, false, null, 24, null);
            this.imageBitmap = imageBitmapM3883ImageBitmapx__hDU$default;
            Canvas = androidx.compose.ui.graphics.CanvasKt.Canvas(imageBitmapM3883ImageBitmapx__hDU$default);
            this.canvas = Canvas;
        ...
        long jM6299toSizeozmzZPI2 = IntSizeKt.m6299toSizeozmzZPI(j);
        ...
        drawParams22.m4133setSizeuvyYCjk(jM6299toSizeozmzZPI2);
        Canvas.save();
        CanvasDrawScope canvasDrawScope22 = canvasDrawScope;
        ImageBitmap imageBitmap2 = imageBitmapM3883ImageBitmapx__hDU$default;
        DrawScope.m4207drawRectnJ9OG0$default(canvasDrawScope22, Color.INSTANCE.m3683getBlack0d7_KjU(), 0L, jM6299toSizeozmzZPI2, 0.0f, null, null, BlendMode.INSTANCE.m3572getClear0nO6VwU(), 58, null);
        ...
        drawParams32.m4133setSizeuvyYCjk(size2);
