...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m3416getXimpl(targetCoordinates.mo5002localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(coordinate, IntSize.m6286getHeightimpl(sourceCoordinates.mo5001getSizeYbymL2g()) / 2.0f)));
    }
}
