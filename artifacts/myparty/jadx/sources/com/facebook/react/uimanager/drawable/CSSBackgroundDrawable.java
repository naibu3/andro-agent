    ...
    private void drawRectangularBackgroundWithBorders(Canvas canvas) {
        ...
        if (iRound > 0 || iRound3 > 0 || iRound2 > 0 || iRound4 > 0) {
            ...
            if (iRound2 > 0) {
                float f7 = i5;
                float f8 = i5 + iRound2;
                drawQuadrilateral(canvas, i6, i4, f7, i4 + i, f8, r0 - iRound3, f8, i4 + iWidth, f7);
            }
            if (iRound3 > 0) {
                int i12 = i4 + iWidth;
                float f9 = i12;
                float f10 = i12 - iRound3;
                drawQuadrilateral(canvas, i7, f9, i5, f9, i5 + iHeight, f10, r1 - iRound4, f10, i5 + iRound2);
            }
            if (iRound4 > 0) {
                int i13 = i5 + iHeight;
                float f11 = i13;
                float f12 = i13 - iRound4;
                cSSBackgroundDrawable = this;
                cSSBackgroundDrawable.drawQuadrilateral(canvas, i8, i4, f11, iWidth + i4, f11, r14 - iRound3, f12, i4 + i, f12);
            } else {
                cSSBackgroundDrawable = this;
            }
