...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m3381twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m3377findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
                ...
                return Boolean.valueOf(m3380searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
        ...
        if (i3 == 1) {
            Boolean boolM3381twoDimensionalFocusSearchsMXa3k8 = m3381twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) boolM3381twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return boolM3381twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m3378generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m3378generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3380searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3324searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m3380searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
    ...
    private static final FocusTargetNode m3376findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3337getLeftdhqQ8s())) {
            rectTranslate = rect.translate(rect.getWidth() + 1, 0.0f);
        } else if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s())) {
            rectTranslate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3341getUpdhqQ8s())) {
            rectTranslate = rect.translate(0.0f, rect.getHeight() + 1);
        } else {
            if (!FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3334getDowndhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m3379isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final boolean isBetterCandidate_I7lrPNg$isCandidate(Rect rect, int i, Rect rect2) {
        ...
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s())) {
            return (rect2.getLeft() < rect.getLeft() || rect2.getRight() <= rect.getLeft()) && rect2.getRight() < rect.getRight();
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3341getUpdhqQ8s())) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3337getLeftdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3341getUpdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3334getDowndhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m3379isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m3375beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
            return !m3375beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
        }
        return true;
    }
    ...
    private static final boolean m3375beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3337getLeftdhqQ8s()) || FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m3377findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3335getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m3340getRightdhqQ8s();
        }
        if (FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3340getRightdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3334getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!(FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3337getLeftdhqQ8s()) ? true : FocusDirection.m3328equalsimpl0(i, FocusDirection.INSTANCE.m3341getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode focusTargetNodeM3376findBestCandidate4WY_MpI = m3376findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM3376findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM3376findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m3380searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM3376findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        FocusTargetNode focusTargetNode2 = focusTargetNode;
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(1024);
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((nodePop.getAggregateChildKindSet() & iM5228constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((nodePop.getKindSet() & iM5228constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            } else if ((nodePop.getKindSet() & iM5228constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                int i2 = 0;
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM3376findBestCandidate4WY_MpI = m3376findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM3376findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM3376findBestCandidate4WY_MpI).booleanValue();
            }
            if (m3378generateAndSearchChildren4C6V_qg(focusTargetNodeM3376findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM3376findBestCandidate4WY_MpI);
        }
        return false;
    }
