...
final class UpiUiDefinitionFactory implements UiDefinitionFactory.Simple {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod() {
        return new SupportedPaymentMethod((PaymentMethodDefinition) UpiDefinition.INSTANCE, (SharedDataSpec) null, R.string.stripe_paymentsheet_payment_method_upi, R.drawable.stripe_ic_paymentsheet_pm_upi, (Integer) null, false, (ResolvableString) null, (Integer) null, 226, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, UiDefinitionFactory.Arguments arguments) {
        ...
        return new FormElementsBuilder(arguments).element(SectionElement.INSTANCE.wrap(new UpiElement(null, 1, null), ResolvableStringUtilsKt.resolvableString$default(R.string.stripe_paymentsheet_buy_using_upi_id, new Object[0], null, 4, null))).build();
    }
}
