...
public final class TransformGestureDetectorKt {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i5 == 0) {
                ...
                if (TapGestureDetectorKt.awaitFirstDown$default(awaitPointerEventScope2, false, null, this, 2, null) != coroutine_suspended) {
                    ...
                    f2 = 0.0f;
                    i = 0;
                    jM3421plusMKHz9U = jM3432getZeroF1C5BW0;
            ...
            if (i5 != 1) {
                ...
                if (z) {
                    ...
                    if (i == 0) {
                        ...
                        jM3421plusMKHz9U = Offset.m3421plusMKHz9U(jM3421plusMKHz9U, jCalculatePan);
                        ...
                        if (fAbs > f5 || fAbs2 > f5 || fM3414getDistanceimpl > f5) {
                    ...
                    if (i != 0) {
                        ...
                        if (fCalculateRotation == f8 && fCalculateZoom == f4) {
                            i3 = i2;
                            if (!Offset.m3413equalsimpl0(jCalculatePan, Offset.INSTANCE.m3432getZeroF1C5BW0())) {
                            }
                        ...
                        this.$onGesture.invoke(Offset.m3405boximpl(jCalculateCentroid), Offset.m3405boximpl(jCalculatePan), Boxing.boxFloat(fCalculateZoom), Boxing.boxFloat(fCalculateRotation));
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM3420minusMKHz9U = Offset.m3420minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM3420minusMKHz9U2 = Offset.m3420minusMKHz9U(position, jCalculateCentroid);
                float fM847anglek4lQ0M = m847anglek4lQ0M(jM3420minusMKHz9U2) - m847anglek4lQ0M(jM3420minusMKHz9U);
                float fM3414getDistanceimpl = Offset.m3414getDistanceimpl(Offset.m3421plusMKHz9U(jM3420minusMKHz9U2, jM3420minusMKHz9U)) / 2.0f;
                if (fM847anglek4lQ0M > 180.0f) {
                    fM847anglek4lQ0M -= 360.0f;
                } else if (fM847anglek4lQ0M < -180.0f) {
                    fM847anglek4lQ0M += 360.0f;
                }
                f2 += fM847anglek4lQ0M * fM3414getDistanceimpl;
                f += fM3414getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m847anglek4lQ0M(long j) {
        if (Offset.m3416getXimpl(j) == 0.0f && Offset.m3417getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m3416getXimpl(j), Offset.m3417getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m3413equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3431getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m3432getZeroF1C5BW0();
        }
        return Offset.m3420minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM3414getDistanceimpl = 0.0f;
        if (Offset.m3413equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3431getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM3414getDistanceimpl += Offset.m3414getDistanceimpl(Offset.m3420minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM3414getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM3432getZeroF1C5BW0 = Offset.m3421plusMKHz9U(jM3432getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m3411divtuRUvjQ(jM3432getZeroF1C5BW0, i);
    }
}
