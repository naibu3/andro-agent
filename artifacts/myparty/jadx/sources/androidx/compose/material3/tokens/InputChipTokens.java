...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m6117constructorimpl((float) AudioStats.AUDIO_AMPLITUDE_NONE);
    ...
    private static final float UnselectedOutlineWidth = Dp.m6117constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m6117constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m6117constructorimpl(f);
        TrailingIconSize = Dp.m6117constructorimpl(f);
    }
    ...
    public final float m2847getContainerHeightD9Ej5fM() {
    ...
    public final float m2850getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2852getUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2845getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
