...
public final class LazyStaggeredGridDslKt {
    ...
    */
    public static final void m1216LazyVerticalStaggeredGridzadm560(final StaggeredGridCells staggeredGridCells, Modifier modifier, LazyStaggeredGridState lazyStaggeredGridState, PaddingValues paddingValues, boolean z, float f, Arrangement.Horizontal horizontal, FlingBehavior flingBehavior, boolean z2, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer composer, final int i, final int i2) {
        ...
        int i8;
        int i9;
        Arrangement.HorizontalOrVertical horizontalOrVerticalM900spacedBy0680j_4;
                            ...
                            if ((i2 & 512) != 0) {
                                ...
                                if ((i3 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
                                    ...
                                    if ((i & 1) != 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        horizontalOrVerticalM900spacedBy0680j_4 = i7 == 0 ? Arrangement.INSTANCE.m900spacedBy0680j_4(Dp.m6117constructorimpl(0)) : horizontal;
                                        if ((i2 & 128) == 0) {
                                        ...
                                        if (i9 == 0) {
                                            ...
                                            LazyStaggeredGridKt.m1221LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(staggeredGridCells, horizontalOrVerticalM900spacedBy0680j_4, paddingValuesM1013PaddingValues0680j_4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i12 & 896)), modifier4, paddingValues3, z7, flingBehavior3, z4, f3, horizontalOrVerticalM900spacedBy0680j_4.getSpacing(), function1, composer2, ((i3 >> 6) & 14) | 48 | ((i3 << 6) & 7168) | (57344 & i13) | (i13 & 458752) | (3670016 & i12) | (i12 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                            horizontal2 = horizontalOrVerticalM900spacedBy0680j_4;
                                        ...
                                        horizontalOrVerticalM900spacedBy0680j_4 = horizontal;
                                    ...
                                    LazyStaggeredGridKt.m1221LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Vertical, rememberColumnSlots(staggeredGridCells, horizontalOrVerticalM900spacedBy0680j_4, paddingValuesM1013PaddingValues0680j_4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 15) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i122 & 896)), modifier42, paddingValues32, z72, flingBehavior3, z4, f32, horizontalOrVerticalM900spacedBy0680j_4.getSpacing(), function1, composer2, ((i3 >> 6) & 14) | 48 | ((i3 << 6) & 7168) | (57344 & i132) | (i132 & 458752) | (3670016 & i122) | (i122 & 29360128) | ((i3 << 9) & 234881024), (i3 >> 27) & 14, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                    }
                                    horizontal2 = horizontalOrVerticalM900spacedBy0680j_4;
                                    lazyStaggeredGridState3 = lazyStaggeredGridState2;
                                ...
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyVerticalStaggeredGrid$1
                                        ...
                                        public final void invoke(Composer composer3, int i14) {
                                            LazyStaggeredGridDslKt.m1216LazyVerticalStaggeredGridzadm560(staggeredGridCells, modifier3, lazyStaggeredGridState3, paddingValues2, z5, f2, horizontal2, flingBehavior4, z6, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                        }
                                    });
                                    return;
                                }
        ...
        if (z || lazyStaggeredGridSlotCacheRememberedValue == Composer.INSTANCE.getEmpty()) {
            lazyStaggeredGridSlotCacheRememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberColumnSlots$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
                    return m1217invoke0kLqBqw(density, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridSlots m1217invoke0kLqBqw(Density density, long j) {
                    ...
                    int[] iArrCalculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes(density, iM6070getMaxWidthimpl, density.mo706roundToPx0680j_4(horizontal2.getSpacing()));
                    int[] iArr = new int[iArrCalculateCrossAxisCellSizes.length];
                    horizontal2.arrange(density, iM6070getMaxWidthimpl, iArrCalculateCrossAxisCellSizes, LayoutDirection.Ltr, iArr);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1215LazyHorizontalStaggeredGridcJHQLPU(final StaggeredGridCells staggeredGridCells, Modifier modifier, LazyStaggeredGridState lazyStaggeredGridState, PaddingValues paddingValues, boolean z, Arrangement.Vertical vertical, float f, FlingBehavior flingBehavior, boolean z2, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer composer, final int i, final int i2) {
        int i3;
        Modifier modifier2;
        LazyStaggeredGridState lazyStaggeredGridStateRememberLazyStaggeredGridState;
        int i4;
        ...
        boolean z3;
        int i6;
        Arrangement.Vertical verticalM900spacedBy0680j_4;
        int i7;
        int i8;
        int i9;
        FlingBehavior flingBehavior2;
            ...
            if (i4 == 0) {
                ...
                if (i5 != 0) {
                    ...
                    if (i6 == 0) {
                        ...
                        if ((196608 & i) == 0) {
                            verticalM900spacedBy0680j_4 = vertical;
                            i3 |= composerStartRestartGroup.changed(verticalM900spacedBy0680j_4) ? 131072 : 65536;
                        }
                        i7 = i2 & 64;
                        if (i7 != 0) {
                            i3 |= 1572864;
                            ...
                            if ((i2 & 512) != 0) {
                                ...
                                if ((i3 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
                                    ...
                                    if ((i & 1) == 0 && !composerStartRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        if (i6 != 0) {
                                            verticalM900spacedBy0680j_4 = Arrangement.INSTANCE.m900spacedBy0680j_4(Dp.m6117constructorimpl(0));
                                        }
                                        float fM6117constructorimpl = i7 == 0 ? Dp.m6117constructorimpl(0) : f;
                                        if ((i2 & 128) == 0) {
                                            flingBehavior2 = ScrollableDefaults.INSTANCE.flingBehavior(composerStartRestartGroup, 6);
                                            i3 &= -29360129;
                                        } else {
                                        ...
                                        if (i9 == 0) {
                                            ...
                                            z4 = true;
                                            boolean z7 = z3;
                                            Arrangement.Vertical vertical3 = verticalM900spacedBy0680j_4;
                                            composerStartRestartGroup.endDefaults();
                                            if (ComposerKt.isTraceInProgress()) {
                                            ...
                                            Modifier modifier4 = modifier2;
                                            PaddingValues paddingValues3 = paddingValuesM1013PaddingValues0680j_4;
                                            LazyStaggeredGridKt.m1221LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(staggeredGridCells, vertical3, paddingValuesM1013PaddingValues0680j_4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i12 & 896)), modifier4, paddingValues3, z7, flingBehavior3, z4, f2, vertical3.getSpacing(), function1, composer2, ((i3 >> 6) & 14) | 48 | (i13 & 7168) | (57344 & i14) | (i14 & 458752) | (3670016 & i12) | (i12 & 29360128) | (234881024 & i13), (i3 >> 27) & 14, 0);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                            vertical2 = vertical3;
                                    ...
                                    lazyStaggeredGridState2 = lazyStaggeredGridStateRememberLazyStaggeredGridState;
                                    boolean z72 = z3;
                                    Arrangement.Vertical vertical32 = verticalM900spacedBy0680j_4;
                                    composerStartRestartGroup.endDefaults();
                                    if (ComposerKt.isTraceInProgress()) {
                                    }
                                    int i122 = i3 >> 3;
                                    ...
                                    Modifier modifier42 = modifier2;
                                    PaddingValues paddingValues32 = paddingValuesM1013PaddingValues0680j_4;
                                    LazyStaggeredGridKt.m1221LazyStaggeredGridLJWHXA8(lazyStaggeredGridState2, Orientation.Horizontal, rememberRowSlots(staggeredGridCells, vertical32, paddingValuesM1013PaddingValues0680j_4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 12) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i122 & 896)), modifier42, paddingValues32, z72, flingBehavior3, z4, f2, vertical32.getSpacing(), function1, composer2, ((i3 >> 6) & 14) | 48 | (i132 & 7168) | (57344 & i142) | (i142 & 458752) | (3670016 & i122) | (i122 & 29360128) | (234881024 & i132), (i3 >> 27) & 14, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                    }
                                    ...
                                    paddingValues2 = paddingValuesM1013PaddingValues0680j_4;
                                    z5 = z3;
                                    vertical2 = verticalM900spacedBy0680j_4;
                                    flingBehavior4 = flingBehavior;
                                }
                                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$LazyHorizontalStaggeredGrid$1
                                        ...
                                        public final void invoke(Composer composer3, int i15) {
                                            LazyStaggeredGridDslKt.m1215LazyHorizontalStaggeredGridcJHQLPU(staggeredGridCells, modifier3, lazyStaggeredGridState3, paddingValues2, z5, vertical2, f3, flingBehavior4, z6, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                        }
                                    });
                                    return;
                                }
    ...
    private static final LazyGridStaggeredGridSlotsProvider rememberRowSlots(final StaggeredGridCells staggeredGridCells, final Arrangement.Vertical vertical, final PaddingValues paddingValues, Composer composer, int i) {
        ...
        if (z || lazyStaggeredGridSlotCacheRememberedValue == Composer.INSTANCE.getEmpty()) {
            lazyStaggeredGridSlotCacheRememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberRowSlots$1$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
                    return m1218invoke0kLqBqw(density, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridSlots m1218invoke0kLqBqw(Density density, long j) {
                    ...
                    int[] iArrCalculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes(density, iM6069getMaxHeightimpl, density.mo706roundToPx0680j_4(vertical2.getSpacing()));
                    int[] iArr = new int[iArrCalculateCrossAxisCellSizes.length];
                    vertical2.arrange(density, iM6069getMaxHeightimpl, iArrCalculateCrossAxisCellSizes, iArr);
                    return new LazyStaggeredGridSlots(iArr, iArrCalculateCrossAxisCellSizes);
                }
            });
            composer.updateRememberedValue(lazyStaggeredGridSlotCacheRememberedValue);
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyStaggeredGridScope lazyStaggeredGridScope, List list, Function2 function2, Function2 function22, Function2 function23, Function5 function5, int i, Object obj) {
        ...
        lazyStaggeredGridScope.items(list.size(), function2 != null ? new LazyStaggeredGridDslKt$itemsIndexed$2$1(function2, list) : null, new C04003(function22, list), function23 != null ? new LazyStaggeredGridDslKt$itemsIndexed$4$1(function23, list) : null, ComposableLambdaKt.composableLambdaInstance(284833944, true, new C04015(function5, list)));
    }
    ...
    public static final class C04003 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C04003(Function2<? super Integer, ? super T, ? extends Object> function2, List<? extends T> list) {
            super(1);
    ...
    public static final class C04015 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ List<T> $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C04015(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, List<? extends T> list) {
            super(4);
    ...
    public static final class C04038 extends Lambda implements Function1<Integer, Object> {
        final /* synthetic */ Function2<Integer, T, Object> $contentType;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C04038(Function2<? super Integer, ? super T, ? extends Object> function2, T[] tArr) {
            super(1);
            this.$contentType = function2;
            this.$items = tArr;
        }
    ...
    public static final <T> void itemsIndexed(LazyStaggeredGridScope lazyStaggeredGridScope, T[] tArr, Function2<? super Integer, ? super T, ? extends Object> function2, Function2<? super Integer, ? super T, ? extends Object> function22, Function2<? super Integer, ? super T, StaggeredGridItemSpan> function23, Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5) {
        lazyStaggeredGridScope.items(tArr.length, function2 != null ? new LazyStaggeredGridDslKt$itemsIndexed$7$1(function2, tArr) : null, new C04038(function22, tArr), function23 != null ? new LazyStaggeredGridDslKt$itemsIndexed$9$1(function23, tArr) : null, ComposableLambdaKt.composableLambdaInstance(-804487775, true, new C039910(function5, tArr)));
    }
    ...
    public static final class C039910 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
        final /* synthetic */ Function5<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
        final /* synthetic */ T[] $items;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C039910(Function5<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
            super(4);
            this.$itemContent = function5;
            this.$items = tArr;
        }
