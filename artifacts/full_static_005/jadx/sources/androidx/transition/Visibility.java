...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(final ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            ...
            if (needOverlayForStartView) {
                if (startView.getParent() == null) {
                    ...
                    if (!parentVisibilityInfo.mVisibilityChange) {
                        ...
                        int id2 = startParent.getId();
                        if (startParent.getParent() == null && id2 != -1 && sceneRoot.findViewById(id2) != null && this.mCanRemoveViews) {
                            overlayView = startView;
                        }
                    }
                }
    ...
    private static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        public void onAnimationPause(Animator animation) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            if (!this.mCanceled) {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorPauseListener, androidx.transition.AnimatorUtils.AnimatorPauseListenerCompat
        public void onAnimationResume(Animator animation) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            if (!this.mCanceled) {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
