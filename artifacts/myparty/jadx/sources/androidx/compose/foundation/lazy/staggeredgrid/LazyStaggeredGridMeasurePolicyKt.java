                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    ...
                    objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                        ...
                        public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                            return m1233invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                        }

                        /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                        public final LazyStaggeredGridMeasureResult m1233invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                            long jIntOffset;
                            ObservableScopeInvalidator.m1194attachToScopeimpl(lazyStaggeredGridState.m1238getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                            CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, orientation3);
                            LazyStaggeredGridSlots lazyStaggeredGridSlotsMo1214invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider3.mo1214invoke0kLqBqw(lazyLayoutMeasureScope, j);
                            ...
                            int i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation3, z, lazyLayoutMeasureScope.getLayoutDirection()));
                            int i3 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation3, z, lazyLayoutMeasureScope.getLayoutDirection()));
                            int i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation3, lazyLayoutMeasureScope.getLayoutDirection()));
                            int iM6069getMaxHeightimpl = ((z7 ? Constraints.m6069getMaxHeightimpl(j) : Constraints.m6070getMaxWidthimpl(j)) - i2) - i3;
                            if (z7) {
                            ...
                            int i5 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(Dp.m6117constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                            PaddingValues paddingValues3 = paddingValues;
                            boolean z8 = z7;
                            LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM1231measureStaggeredGridXtK8cYQ = LazyStaggeredGridMeasureKt.m1231measureStaggeredGridXtK8cYQ(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo1214invoke0kLqBqw, Constraints.m6061copyZbe2FdA$default(j, ConstraintsKt.m6087constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m6086constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo706roundToPx0680j_4(Dp.m6117constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()))), 0, 10, null), z8, z, j2, iM6069getMaxHeightimpl, lazyLayoutMeasureScope.mo706roundToPx0680j_4(f), i2, i3, coroutineScope, graphicsContext);
                            LazyStaggeredGridState.applyMeasureResult$foundation_release$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM1231measureStaggeredGridXtK8cYQ, false, 2, null);
                            return lazyStaggeredGridMeasureResultM1231measureStaggeredGridXtK8cYQ;
                        }
                    };
            ...
            if (zChanged) {
                ...
                objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                    ...
                    public final LazyStaggeredGridMeasureResult m1233invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                        long jIntOffset;
                        ObservableScopeInvalidator.m1194attachToScopeimpl(lazyStaggeredGridState.m1238getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                        CheckScrollableContainerConstraintsKt.m603checkScrollableContainerConstraintsK40F9xA(j, orientation32);
                        LazyStaggeredGridSlots lazyStaggeredGridSlotsMo1214invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider32.mo1214invoke0kLqBqw(lazyLayoutMeasureScope, j);
                        boolean z7 = orientation32 == Orientation.Vertical;
                        LazyStaggeredGridItemProvider lazyStaggeredGridItemProviderInvoke = function0.invoke();
                        int i2 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation32, z, lazyLayoutMeasureScope.getLayoutDirection()));
                        int i3 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation32, z, lazyLayoutMeasureScope.getLayoutDirection()));
                        int i4 = lazyLayoutMeasureScope.mo706roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation32, lazyLayoutMeasureScope.getLayoutDirection()));
                        int iM6069getMaxHeightimpl = ((z7 ? Constraints.m6069getMaxHeightimpl(j) : Constraints.m6070getMaxWidthimpl(j)) - i2) - i3;
                        if (z7) {
                            jIntOffset = IntOffsetKt.IntOffset(i4, i2);
                        } else {
