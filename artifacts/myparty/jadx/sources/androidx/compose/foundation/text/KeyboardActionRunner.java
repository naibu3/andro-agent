...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1338runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        Unit unit = null;
        if (ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5781getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5780getDefaulteUduSuo()) ? true : ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5784getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1337defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo1337defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5783getNexteUduSuo())) {
            getFocusManager().mo3343moveFocus3ESFkO8(FocusDirection.INSTANCE.m3338getNextdhqQ8s());
            return;
        }
        if (ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5785getPreviouseUduSuo())) {
            getFocusManager().mo3343moveFocus3ESFkO8(FocusDirection.INSTANCE.m3339getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5781getDoneeUduSuo())) {
            if (ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5782getGoeUduSuo()) ? true : ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5786getSearcheUduSuo()) ? true : ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5787getSendeUduSuo()) ? true : ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5780getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m5767equalsimpl0(imeAction, ImeAction.INSTANCE.m5784getNoneeUduSuo());
        } else {
