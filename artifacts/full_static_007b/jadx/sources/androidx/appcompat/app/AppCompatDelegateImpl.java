    ...
    */
    final int updateStatusGuard(WindowInsetsCompat insets, Rect rectInsets) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (view != null) {
                view.setVisibility(showStatusGuard ? systemWindowInsetTop : 8);
            }
        ...
        if (this.mActionModeView.isShown()) {
            ...
            int systemWindowInsetTop7 = systemWindowInsetTop5;
            if (mlp.topMargin == 0) {
                systemWindowInsetTop = 0;
                systemWindowInsetTop2 = systemWindowInsetTop7;
            } else {
                mlpChanged = true;
                systemWindowInsetTop = 0;
                mlp.topMargin = 0;
    ...
    private boolean applyApplicationSpecificConfig(boolean allowRecreation, boolean isLocalesApplicationRequired) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private boolean updateAppConfiguration(int nightMode, LocaleListCompat locales, boolean allowRecreation) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
    ...
    private void updateResourcesConfiguration(int uiModeNightModeValue, LocaleListCompat locales, boolean callOnConfigChange, Configuration configOverlay) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
