...
public final class UserSettingsManager {
    ...
    public static final void initializeCodelessSetupEnabledAsync$lambda$0(long j) {
        ...
        try {
            if (advertiserIDCollectionEnabled.m6561getValue() && (fetchedAppSettingsQueryAppSettings = FetchedAppSettingsManager.queryAppSettings(FacebookSdk.getApplicationId(), false)) != null && fetchedAppSettingsQueryAppSettings.getCodelessEventsEnabled()) {
                ...
                if (androidAdvertiserId != null) {
                    ...
                    GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(null, Stripe3ds2AuthParams.FIELD_APP, null);
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = (autoInitEnabled.m6561getValue() ? 1 : 0) | ((autoLogAppEventsEnabledLocally.m6561getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m6561getValue() ? 1 : 0) << 2) | ((monitorEnabled.m6561getValue() ? 1 : 0) << 3);
                SharedPreferences sharedPreferences = userSettingPref;
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m6561getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private final boolean checkAutoLogAppEventsEnabled() {
        ...
        try {
            ...
            return autoLogAppEventsEnabledLocally.m6561getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return false;
        }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m6561getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m6561getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m6561getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private static final class UserSetting {
        ...
        public final boolean m6561getValue() {
