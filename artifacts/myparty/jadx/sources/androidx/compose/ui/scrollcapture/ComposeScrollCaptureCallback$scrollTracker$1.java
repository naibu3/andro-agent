    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset offsetM3405boximpl = Offset.m3405boximpl(OffsetKt.Offset(0.0f, f));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(offsetM3405boximpl, this);
        ...
        float fM3417getYimpl = Offset.m3417getYimpl(((Offset) obj).getPackedValue());
        if (z) {
            fM3417getYimpl = -fM3417getYimpl;
        }
        return Boxing.boxFloat(fM3417getYimpl);
    }
}
