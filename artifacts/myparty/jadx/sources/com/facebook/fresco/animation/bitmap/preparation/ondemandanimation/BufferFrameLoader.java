...
public final class BufferFrameLoader implements FrameLoader {
    ...
    public FrameResult getFrame(int frameNumber, int width, int height) {
        ...
        if (bufferFrame != null) {
            ...
            return new FrameResult(bufferFrame.getBitmapRef().mo6624clone(), FrameResult.FrameType.SUCCESS);
        }
        loadNextFrames(width, height);
    ...
    private final FrameResult findNearestToRender(int targetFrame) {
        ...
        if (animationBitmapFrameFindNearestFrame != null) {
            CloseableReference<Bitmap> closeableReferenceMo6624clone = animationBitmapFrameFindNearestFrame.getBitmap().mo6624clone();
            ...
            return new FrameResult(closeableReferenceMo6624clone, FrameResult.FrameType.NEAREST);
        }
        ...
        while (it.hasNext()) {
            ...
            if (this.bufferFramesHash.get(Integer.valueOf(iIntValue2)) == null) {
                ...
                if (closeableReferenceCloneOrNull == null) {
                    ...
                    closeableReferenceCloneOrNull = bufferFrame.getBitmapRef().mo6624clone();
                }
