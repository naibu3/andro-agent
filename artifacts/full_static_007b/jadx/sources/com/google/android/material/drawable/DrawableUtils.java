...
public final class DrawableUtils {
    ...
    public static AttributeSet parseDrawableXml(Context context, int id2, CharSequence startTag) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int type;
        try {
            XmlPullParser parser = context.getResources().getXml(id2);
            do {
                type = parser.next();
                if (type == 2) {
                    break;
