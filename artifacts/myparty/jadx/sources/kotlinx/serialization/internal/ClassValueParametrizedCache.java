...
final class ClassValueParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo10727getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM9118constructorimpl = Result.m9118constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
