...
public final class InputMode {
    ...
    private static final int Touch = m4398constructorimpl(1);
    private static final int Keyboard = m4398constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputMode m4397boximpl(int i) {
        return new InputMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4398constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4402toStringimpl(int i) {
        return m4400equalsimpl0(i, Touch) ? "Touch" : m4400equalsimpl0(i, Keyboard) ? "Keyboard" : "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m4405getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU, reason: not valid java name */
        public final int m4404getKeyboardaOaMEAU() {
