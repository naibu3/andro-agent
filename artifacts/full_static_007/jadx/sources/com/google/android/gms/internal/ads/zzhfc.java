...
abstract class zzhfc {
        ...
        while (i < i4) {
            ...
            if (zzhfb.zzd(b2)) {
                ...
                if (zzhfb.zzf(b2)) {
                    ...
                    i3 = i6 + 1;
                    i += 2;
                    zzhfb.zzc(b2, byteBuffer.get(i7), cArr, i6);
                    ...
                    int i8 = i + 2;
                    i += 3;
                    zzhfb.zzb(b2, byteBuffer.get(i7), byteBuffer.get(i8), cArr, i6);
                } else {
                    if (i7 >= i4 - 2) {
                        throw zzhcd.zzd();
                    }
                    ...
                    i += 4;
                    zzhfb.zza(b2, b4, b5, byteBuffer.get(i9), cArr, i6);
                    i6 += 2;
                }
                i6 = i3;
            }
    ...
    abstract String zzb(byte[] bArr, int i, int i2) throws zzhcd;
