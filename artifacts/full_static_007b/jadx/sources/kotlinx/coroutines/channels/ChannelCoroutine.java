...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1587receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1587receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1588tryReceivePtdJZtk() {
        return this._channel.mo1588tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1589trySendJP2dKIU(E element) {
        return this._channel.mo1589trySendJP2dKIU(element);
    }
