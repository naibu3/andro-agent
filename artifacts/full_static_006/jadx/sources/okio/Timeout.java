...
public class Timeout {
    ...
    public static final class Companion {
        ...
        public final Timeout m1834timeoutHG0u8IE(Timeout timeout, long j) {
            Intrinsics.checkNotNullParameter(timeout, "$this$timeout");
            return timeout.timeout(Duration.m1576getInWholeNanosecondsimpl(j), TimeUnit.NANOSECONDS);
        }
    }
}
