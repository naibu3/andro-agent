                        ...
                        if (i7 != 0) {
                            ...
                            if ((i2 & 64) != 0) {
                                ...
                                if ((i3 & 599187) != 599186 || !composerStartRestartGroup.getSkipping()) {
                                    ...
                                    if (i4 != 0) {
                                        function13 = new Function1<AnimatedContentTransitionScope<S>, ContentTransform>() { // from class: androidx.compose.animation.AnimatedContentKt.AnimatedContent.1
                                            ...
                                            public final ContentTransform invoke(AnimatedContentTransitionScope<S> animatedContentTransitionScope) {
                                                return AnimatedContentKt.togetherWith(EnterExitTransitionKt.fadeIn$default(AnimationSpecKt.tween$default(220, 90, null, 4, null), 0.0f, 2, null).plus(EnterExitTransitionKt.m413scaleInL8ZKhE$default(AnimationSpecKt.tween$default(220, 90, null, 4, null), 0.92f, 0L, 4, null)), EnterExitTransitionKt.fadeOut$default(AnimationSpecKt.tween$default(90, 0, null, 6, null), 0.0f, 2, null));
                                            }
                                        };
                                    }
                                    if (i5 != 0) {
                                    ...
                                    Transition transitionUpdateTransition = androidx.compose.animation.core.TransitionKt.updateTransition(s, str4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 9) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0);
                                    int i9 = i3 & 8176;
                                    int i10 = i3 >> 3;
                            ...
                            if ((i3 & 599187) != 599186) {
                                ...
                                Transition transitionUpdateTransition2 = androidx.compose.animation.core.TransitionKt.updateTransition(s, str4, composerStartRestartGroup, (i3 & 14) | ((i3 >> 9) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS), 0);
                                int i92 = i3 & 8176;
                                int i102 = i3 >> 3;
        ...
        if ((i & 2) != 0) {
            function2 = new Function2<IntSize, IntSize, SpringSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentKt.SizeTransform.1
                ...
                public /* bridge */ /* synthetic */ SpringSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
                    return m376invokeTemP2vQ(intSize.getPackedValue(), intSize2.getPackedValue());
                }

                /* renamed from: invoke-TemP2vQ, reason: not valid java name */
                public final SpringSpec<IntSize> m376invokeTemP2vQ(long j, long j2) {
                    return AnimationSpecKt.spring$default(0.0f, 400.0f, IntSize.m6279boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.INSTANCE)), 1, null);
                }
            };
        }
                    ...
                    if (i6 == 0) {
                        ...
                        if ((i2 & 16) == 0) {
                            ...
                            if ((74899 & i3) == 74898 || !composerStartRestartGroup.getSkipping()) {
                                ...
                                anonymousClass4 = i4 == 0 ? new Function1<AnimatedContentTransitionScope<S>, ContentTransform>() { // from class: androidx.compose.animation.AnimatedContentKt.AnimatedContent.4
                                    @Override // kotlin.jvm.functions.Function1
                                    public final ContentTransform invoke(AnimatedContentTransitionScope<S> animatedContentTransitionScope) {
                                        return AnimatedContentKt.togetherWith(EnterExitTransitionKt.fadeIn$default(AnimationSpecKt.tween$default(220, 90, null, 4, null), 0.0f, 2, null).plus(EnterExitTransitionKt.m413scaleInL8ZKhE$default(AnimationSpecKt.tween$default(220, 90, null, 4, null), 0.92f, 0L, 4, null)), EnterExitTransitionKt.fadeOut$default(AnimationSpecKt.tween$default(90, 0, null, 6, null), 0.0f, 2, null));
                                    }
                                    ...
                                    while (i7 < size) {
                                        ...
                                        mutableScatterMap3.set(t, ComposableLambdaKt.rememberComposableLambda(885640742, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1
                                            ...
                                            public final void invoke(Composer composer2, int i12) {
                                                ...
                                                Function1<AnimatedContentTransitionScope<S>, ContentTransform> function15 = anonymousClass4;
                                                ...
                                                S s = t;
                                                Function1<AnimatedContentTransitionScope<S>, ContentTransform> function16 = anonymousClass4;
                                                ...
                                                if (zChangedInstance || objRememberedValue7 == Composer.INSTANCE.getEmpty()) {
                                                    objRememberedValue7 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$1$1
                                                        ...
                                                        public final MeasureResult m375invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                                                            ...
                                                            int width = placeableMo4993measureBRTryo0.getWidth();
                                                            int height = placeableMo4993measureBRTryo0.getHeight();
                                                            ...
                                                            return MeasureScope.layout$default(measureScope, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt$AnimatedContent$6$1$1$1.1
                                                                ...
                                                                public final void invoke2(Placeable.PlacementScope placementScope) {
                                                                    placementScope.place(placeableMo4993measureBRTryo0, 0, 0, contentTransform2.getTargetContentZIndex());
                                                                }
                                                            }, 4, null);
                                                        }
                                                    };
                                ...
                                Updater.m3157setimpl(composerM3150constructorimpl, animatedContentMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                                ...
                                for (i8 = 0; i8 < size2; i8++) {
                                    FinancialConnectionsGenericInfoScreen financialConnectionsGenericInfoScreen = (Object) snapshotStateList4.get(i8);
                                    composerStartRestartGroup.startMovableGroup(1908315325, function14.invoke(financialConnectionsGenericInfoScreen));
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "");
                                    Function2 function2 = (Function2) mutableScatterMap2.get(financialConnectionsGenericInfoScreen);
                                    if (function2 == null) {
                            ...
                            if (scopeUpdateScopeEndRestartGroup == null) {
                                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedContentKt.AnimatedContent.9
                                    ...
                                    public final void invoke(Composer composer2, int i12) {
                                        AnimatedContentKt.AnimatedContent(transition, modifier3, anonymousClass4, alignment2, function15, function4, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                    }
                                });
                                return;
                            }
                                    ...
                                    if (!z3) {
                                        ...
                                        if (mutableScatterMap.containsKey(transition2.getTargetState())) {
                                            ...
                                            if (!zChanged) {
                                                ...
                                                composerM3150constructorimpl = Updater.m3150constructorimpl(composerStartRestartGroup);
                                                Updater.m3157setimpl(composerM3150constructorimpl, animatedContentMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
