...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = getConstructor().mo10409getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo10409getDeclarationDescriptor()).toString());
        }
