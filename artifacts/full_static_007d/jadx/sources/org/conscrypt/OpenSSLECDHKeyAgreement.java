...
public final class OpenSSLECDHKeyAgreement extends KeyAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z2) throws InvalidKeyException {
        ...
        if (iECDH_compute_key == -1) {
            throw new RuntimeException(e.a("Engine returned ", iECDH_compute_key));
        }
        int i2 = this.mExpectedResultLength;
        if (iECDH_compute_key != i2) {
            if (iECDH_compute_key >= i2) {
    ...
    @Override // javax.crypto.KeyAgreementSpi
    public int engineGenerateSecret(byte[] bArr, int i2) throws ShortBufferWithoutStackTraceException {
        checkCompleted();
