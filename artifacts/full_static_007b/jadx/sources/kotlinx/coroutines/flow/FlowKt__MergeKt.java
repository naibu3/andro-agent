...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C01141<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01141(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C01141> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C01141 c01141 = new C01141(this.$transform, continuation);
            c01141.L$0 = flowCollector;
            c01141.L$1 = t;
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c01141.L$0 = null;
                    c01141.label = 2;
                    return flowCollector.emit(obj, c01141) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                case 1:
                    FlowCollector flowCollector3 = (FlowCollector) this.L$0;
                    ResultKt.throwOnFailure(obj);
                    flowCollector = flowCollector3;
                    ...
                    c01141.L$0 = null;
                    c01141.label = 2;
                    if (flowCollector.emit(obj, c01141) != coroutine_suspended) {
                    }
                    break;
                case 2:
                    ResultKt.throwOnFailure(obj);
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C01141(function2, null));
    }
}
