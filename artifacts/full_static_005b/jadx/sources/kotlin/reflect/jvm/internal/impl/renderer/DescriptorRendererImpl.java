...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = typeConstructor.mo1494getDeclarationDescriptor();
        if (classifierDescriptorMo1494getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo1494getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo1494getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo1494getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo1494getDeclarationDescriptor.getClass()).toString());
    }
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1<TypeProjection, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.appendTypeProjections.1
            {
                super(1);
            }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1494getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor = annotationClass.mo1488getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo1488getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor.getValueParameters();
            ...
            if (!arrayList2.isEmpty()) {
                ...
                sb.append(CollectionsKt.joinToString$default(arrayList2, ", ", "(", ")", 0, null, new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderConstructor.1
                    @Override // kotlin.jvm.functions.Function1
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1490getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo1490getCompileTimeInitializer = variableDescriptor.mo1490getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo1490getCompileTimeInitializer)) == null) {
            return;
        }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor = classDescriptor.mo1488getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo1488getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo1495getSupertypes = classDescriptor.getTypeConstructor().mo1495getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1495getSupertypes, "getSupertypes(...)");
        if (collectionMo1495getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1495getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1495getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(collectionMo1495getSupertypes, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
