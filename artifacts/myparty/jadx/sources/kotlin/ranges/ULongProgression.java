...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m10336getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM9296constructorimpl = ((int) ULong.m9296constructorimpl(j ^ ULong.m9296constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM9296constructorimpl2 = (iM9296constructorimpl + ((int) ULong.m9296constructorimpl(j2 ^ ULong.m9296constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM9296constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m9342toStringimpl(this.first)).append("..").append((Object) ULong.m9342toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m9342toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m9342toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m10364fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
