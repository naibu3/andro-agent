...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARN: Removed duplicated region for block: B:8:0x0017 A[Catch: IOException -> 0x0057, PHI: r3
      0x0017: PHI (r3v5 android.graphics.fonts.FontFamily$Builder) = (r3v3 android.graphics.fonts.FontFamily$Builder), (r3v1 android.graphics.fonts.FontFamily$Builder) binds: [B:14:0x0048, B:7:0x0015] A[DONT_GENERATE, DONT_INLINE], TRY_LEAVE, TryCatch #1 {IOException -> 0x0057, blocks: (B:5:0x0008, B:8:0x0017, B:22:0x0056, B:21:0x0053, B:18:0x004e, B:10:0x001b, B:12:0x003e, B:13:0x0045), top: B:32:0x0008, inners: #0, #2 }] */
    /*
    ...
    */
    private static FontFamily getFontFamily(CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, ContentResolver contentResolver) throws IOException {
        ...
        for (FontsContractCompat.FontInfo fontInfo : fontInfoArr) {
            try {
                ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(fontInfo.getUri(), JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR, cancellationSignal);
