...
public class DoubleMetaphone implements StringEncoder {
    ...
    private int handleC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (!contains(str, i, 2, "CI", "CE", "CY")) {
            doubleMetaphoneResult.append('K');
            return contains(str, i2, 2, " C", " Q", " G") ? i + 3 : (!contains(str, i2, 1, Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE, "K", "Q") || contains(str, i2, 2, "CE", "CI")) ? i2 : i + 2;
        }
    ...
    private int handleD(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (!contains(str, i, 2, "DG")) {
            if (contains(str, i, 2, "DT", DefaultAuthenticationRequestParametersFactory.KEY_DEVICE_DATA)) {
        ...
        int i2 = i + 2;
        if (contains(str, i2, 1, "I", ExifInterface.LONGITUDE_EAST, ChallengeRequestData.YES_VALUE)) {
    ...
    private int handleG(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (!contains(str, i2, 1, ExifInterface.LONGITUDE_EAST, "I", ChallengeRequestData.YES_VALUE) && !contains(str, i - 1, 4, "AGGI", "OGGI")) {
            if (charAt(str, i2) == 'G') {
                int i4 = i + 2;
                doubleMetaphoneResult.append('K');
                return i4;
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (i > 2 && charAt(str, i - 1) == 'U' && contains(str, i - 3, 1, Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE, "G", "L", "R", ExifInterface.GPS_DIRECTION_TRUE)) {
            doubleMetaphoneResult.append('F');
    ...
    */
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i == 0 && !contains(str, i, 4, "JOSE")) {
            ...
            if (isVowel(charAt(str, i2)) && !z) {
                ...
                doubleMetaphoneResult.append('J', CardNumberConfig.SEPARATOR);
    ...
    private int handleSC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        } else if (contains(str, i2, 1, "I", ExifInterface.LONGITUDE_EAST, ChallengeRequestData.YES_VALUE)) {
            doubleMetaphoneResult.append('S');
        } else {
            doubleMetaphoneResult.append("SK");
        }
    ...
    private int handleX(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        int i2 = i + 1;
        return contains(str, i2, 1, Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE, "X") ? i + 2 : i2;
    }
