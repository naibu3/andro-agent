...
public final class zzayz extends zzazs {
    ...
    public zzayz(zzaye zzayeVar, String str, String str2, zzatp zzatpVar, int i, int i2, Map map, View view, Context context) {
        super(zzayeVar, "SKSJAjN3UKeguXyEasCGg04d/yJuUN8XZYgactMp4rfMtHcIJcD0mydl5RKvI49M", "lnMUlT0qopStslq/RfZHkyvg0xAUTVuMPsMot4SEaYA=", zzatpVar, i, 85);
        this.zzi = map;
        this.zzj = view;
        this.zzk = context;
    }
