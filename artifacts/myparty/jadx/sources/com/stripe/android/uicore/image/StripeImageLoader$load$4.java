...
@DebugMetadata(c = "com.stripe.android.uicore.image.StripeImageLoader$load$4", f = "StripeImageLoader.kt", i = {}, l = {59}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class StripeImageLoader$load$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Bitmap>>, Object> {
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ StripeImageLoader this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    StripeImageLoader$load$4(StripeImageLoader stripeImageLoader, String str, Continuation<? super StripeImageLoader$load$4> continuation) {
    ...
    @DebugMetadata(c = "com.stripe.android.uicore.image.StripeImageLoader$load$4$1", f = "StripeImageLoader.kt", i = {}, l = {60}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function1<Continuation<? super Result<? extends Bitmap>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            Object objM8885loadFromNetworkgIAlus;
            ...
            if (i == 0) {
                ...
                if (resultM8883loadFromMemoryCmtIpJM == null && (resultM8883loadFromMemoryCmtIpJM = this.this$0.m8882loadFromDiskCmtIpJM(this.$url)) == null) {
                    this.label = 1;
                    objM8885loadFromNetworkgIAlus = this.this$0.m8885loadFromNetworkgIAlus(this.$url, this);
                    if (objM8885loadFromNetworkgIAlus == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    objM8885loadFromNetworkgIAlus = resultM8883loadFromMemoryCmtIpJM.getValue();
                }
            } else {
                if (i != 1) {
                ...
                ResultKt.throwOnFailure(obj);
                objM8885loadFromNetworkgIAlus = ((Result) obj).getValue();
            }
            return Result.m9117boximpl(objM8885loadFromNetworkgIAlus);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        ResultKt.throwOnFailure(obj);
        this.label = 1;
        Object objWithMutexByUrlLock = this.this$0.withMutexByUrlLock(this.$url, new AnonymousClass1(this.this$0, this.$url, null), this);
