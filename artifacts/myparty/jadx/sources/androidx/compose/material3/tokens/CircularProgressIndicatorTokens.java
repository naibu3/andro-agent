...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6117constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m6117constructorimpl((float) 48.0d);
    ...
    public final float m2647getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2648getSizeD9Ej5fM() {
        return Size;
    }
}
