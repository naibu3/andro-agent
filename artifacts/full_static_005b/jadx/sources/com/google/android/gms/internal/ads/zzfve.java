...
class zzfve {
    ...
    final zzfvd zzb(String str, String str2, long j, boolean z) throws IOException {
        if (str != null) {
            try {
                UUID.fromString(str);
                if (!str.equals(zza)) {
        ...
        return (strZze2 != null || z) ? new zzfvd(strZze2, zza(z2)) : zzc(str, str2);
    }

    final zzfvd zzc(String str, String str2) throws IOException {
        if (str == null) {
    ...
    final zzfvd zzd(String str, boolean z) throws IOException {
        long jCurrentTimeMillis = System.currentTimeMillis();
        if (jCurrentTimeMillis < 0) {
            throw new IllegalStateException(this.zzg.concat(": Invalid negative current timestamp. Updating PAID failed"));
        }
        ...
        return new zzfvd(str, jCurrentTimeMillis);
    }
