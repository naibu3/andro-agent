...
public final class ScrollingLogic {
    ...
    private int latestScrollSource = NestedScrollSource.INSTANCE.m4759getUserInputWNlRxjI();
    ...
    private final ScrollingLogic$nestedScrollScope$1 nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$nestedScrollScope$1
        ...
        public long mo793scrollByOzD1aCk(long offset, int source) {
            return this.this$0.m828performScroll3eAAhYA(this.this$0.outerStateScope, offset, source);
        }

        @Override // androidx.compose.foundation.gestures.NestedScrollScope
        /* renamed from: scrollByWithOverscroll-OzD1aCk */
        public long mo794scrollByWithOverscrollOzD1aCk(long offset, int source) {
            ...
            return overscrollEffect.mo557applyToScrollRhakbz0(offset, this.this$0.latestScrollSource, this.this$0.performScrollForOverscroll);
        }
    };
    private final Function1<Offset, Offset> performScrollForOverscroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$performScrollForOverscroll$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
            return Offset.m3405boximpl(m840invokeMKHz9U(offset.getPackedValue()));
        }

        /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
        public final long m840invokeMKHz9U(long j) {
            ScrollScope scrollScope = this.this$0.outerStateScope;
            ScrollingLogic scrollingLogic = this.this$0;
            return scrollingLogic.m828performScroll3eAAhYA(scrollScope, j, scrollingLogic.latestScrollSource);
        }
    };
    ...
    public final long m838toOffsettuRUvjQ(float f) {
        if (f == 0.0f) {
    ...
    public final long m836singleAxisOffsetMKHz9U(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m3410copydBAh8RU$default(j, 0.0f, 0.0f, 1, null) : Offset.m3410copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
    }

    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m837toFloatk4lQ0M(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m3416getXimpl(j) : Offset.m3417getYimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-TH1AsA0, reason: not valid java name */
    public final float m830toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6354getXimpl(j) : Velocity.m6355getYimpl(j);
    }

    /* renamed from: singleAxisVelocity-AH228Gc, reason: not valid java name */
    private final long m829singleAxisVelocityAH228Gc(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6350copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null) : Velocity.m6350copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: update-QWom1Mo, reason: not valid java name */
    public final long m831updateQWom1Mo(long j, float f) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6350copyOhffZ5M$default(j, f, 0.0f, 2, null) : Velocity.m6350copyOhffZ5M$default(j, 0.0f, f, 1, null);
    }
    ...
    public final long m835reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m3423timestuRUvjQ(j, -1.0f) : j;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: performScroll-3eAAhYA, reason: not valid java name */
    public final long m828performScroll3eAAhYA(ScrollScope scrollScope, long j, int i) {
        long jM4743dispatchPreScrollOzD1aCk = this.nestedScrollDispatcher.m4743dispatchPreScrollOzD1aCk(j, i);
        long jM3420minusMKHz9U = Offset.m3420minusMKHz9U(j, jM4743dispatchPreScrollOzD1aCk);
        long jM835reverseIfNeededMKHz9U = m835reverseIfNeededMKHz9U(m838toOffsettuRUvjQ(scrollScope.scrollBy(m837toFloatk4lQ0M(m835reverseIfNeededMKHz9U(m836singleAxisOffsetMKHz9U(jM3420minusMKHz9U))))));
        return Offset.m3421plusMKHz9U(Offset.m3421plusMKHz9U(jM4743dispatchPreScrollOzD1aCk, jM835reverseIfNeededMKHz9U), this.nestedScrollDispatcher.m4741dispatchPostScrollDzOQY0M(jM835reverseIfNeededMKHz9U, Offset.m3420minusMKHz9U(jM3420minusMKHz9U, jM835reverseIfNeededMKHz9U), i));
    }
    ...
    public final long m834performRawScrollMKHz9U(long scroll) {
        if (this.scrollableState.isScrollInProgress()) {
            return Offset.INSTANCE.m3432getZeroF1C5BW0();
        }
        return m838toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m837toFloatk4lQ0M(scroll)))));
    }

    /* renamed from: onDragStopped-sF-c-tU, reason: not valid java name */
    public final Object m833onDragStoppedsFctU(long j, Continuation<? super Unit> continuation) {
        long jM829singleAxisVelocityAH228Gc = m829singleAxisVelocityAH228Gc(j);
        ...
        if (overscrollEffect != null && getShouldDispatchOverscroll()) {
            Object objMo556applyToFlingBMRW4eQ = overscrollEffect.mo556applyToFlingBMRW4eQ(jM829singleAxisVelocityAH228Gc, scrollingLogic$onDragStopped$performFling$1, continuation);
            return objMo556applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo556applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = scrollingLogic$onDragStopped$performFling$1.invoke(Velocity.m6345boximpl(jM829singleAxisVelocityAH228Gc), continuation);
    ...
    */
    public final Object m832doFlingAnimationQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        return Velocity.m6345boximpl(longRef.element);
    }
