...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m5887toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m5886toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m5887toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m4016equalsimpl0(i, StrokeJoin.INSTANCE.m4021getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m4016equalsimpl0(i, StrokeJoin.INSTANCE.m4022getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m4016equalsimpl0(i, StrokeJoin.INSTANCE.m4020getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m5886toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m4006equalsimpl0(i, StrokeCap.INSTANCE.m4010getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m4006equalsimpl0(i, StrokeCap.INSTANCE.m4011getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m4006equalsimpl0(i, StrokeCap.INSTANCE.m4012getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
