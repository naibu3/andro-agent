...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1286createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3485getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m3485getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m3485getWidthimpl(size), Size.m3482getHeightimpl(size) - f2);
        Path.lineTo(Size.m3485getWidthimpl(size) - f2, Size.m3482getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m3482getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3482getHeightimpl(size) - bottomEnd);
        Path.close();
