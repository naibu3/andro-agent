...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo733calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3405boximpl = Offset.m3405boximpl(Offset.INSTANCE.m3432getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM3405boximpl = Offset.m3405boximpl(Offset.m3421plusMKHz9U(offsetM3405boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m3423timestuRUvjQ(offsetM3405boximpl.getPackedValue(), -density.mo712toPx0680j_4(Dp.m6117constructorimpl(64)));
    }
}
