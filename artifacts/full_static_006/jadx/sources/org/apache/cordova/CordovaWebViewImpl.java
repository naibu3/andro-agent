...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    public void init(CordovaInterface cordovaInterface, List<PluginEntry> list, CordovaPreferences cordovaPreferences) {
        ...
        this.pluginManager = new PluginManager(this, this.f10cordova, list);
    ...
    public void loadUrlIntoView(final String str, boolean z) {
        ...
        final Runnable runnable2 = new Runnable() { // from class: org.apache.cordova.CordovaWebViewImpl.2
            ...
            public void run() {
                ...
                if (CordovaWebViewImpl.this.loadUrlTimeout == i && CordovaWebViewImpl.this.f10cordova.getActivity() != null) {
                    CordovaWebViewImpl.this.f10cordova.getActivity().runOnUiThread(runnable);
                } else if (CordovaWebViewImpl.this.f10cordova.getActivity() == null) {
                    LOG.d(CordovaWebViewImpl.TAG, "Cordova activity does not exist.");
                }
            }
        };
        if (this.f10cordova.getActivity() != null) {
            this.f10cordova.getActivity().runOnUiThread(new Runnable() { // from class: org.apache.cordova.CordovaWebViewImpl.3
                @Override // java.lang.Runnable
                public void run() {
                    if (integer > 0) {
                        CordovaWebViewImpl.this.f10cordova.getThreadPool().execute(runnable2);
                    }
    ...
    public void showWebPage(String str, boolean z, boolean z2, Map<String, Object> map) throws URISyntaxException {
        ...
        try {
            try {
                ...
                if (this.f10cordova.getActivity() != null) {
                    this.f10cordova.getActivity().startActivity(intent3);
                } else {
                    LOG.d(TAG, "Cordova activity does not exist.");
                }
            ...
            if (CordovaWebViewImpl.this.engine.getView().getVisibility() != 0) {
                new Thread(new Runnable() { // from class: org.apache.cordova.CordovaWebViewImpl.EngineClient.1
                    ...
                    public void run() throws InterruptedException {
                        try {
                            Thread.sleep(2000L);
                            if (CordovaWebViewImpl.this.f10cordova.getActivity() != null) {
                                CordovaWebViewImpl.this.f10cordova.getActivity().runOnUiThread(new Runnable() { // from class: org.apache.cordova.CordovaWebViewImpl.EngineClient.1.1
                                    @Override // java.lang.Runnable
                                    public void run() {
