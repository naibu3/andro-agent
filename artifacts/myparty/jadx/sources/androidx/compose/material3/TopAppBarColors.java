...
public final class TopAppBarColors {
    ...
    public final long m2598containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long jM3708lerpjxsXWHM = ColorKt.m3708lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM3708lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m3658equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m3658equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m3658equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m3658equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m3664hashCodeimpl(this.containerColor) * 31) + Color.m3664hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3664hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3664hashCodeimpl(this.titleContentColor)) * 31) + Color.m3664hashCodeimpl(this.actionIconContentColor);
    }
}
