...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m948ellipsisSizeF35zmw$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m950setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long jM989constructorimpl = OrientationIndependentConstraints.m989constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int iMainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6069getMaxHeightimpl(jM989constructorimpl));
            this.seeMoreSize = IntIntPair.m360boximpl(IntIntPair.m363constructorimpl(iMainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, iMainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int iMainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6069getMaxHeightimpl(jM989constructorimpl));
            this.collapseSize = IntIntPair.m360boximpl(IntIntPair.m363constructorimpl(iMainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, iMainAxisMin2)));
    ...
    /* renamed from: setOverflowMeasurables--hBUhpc$foundation_layout_release, reason: not valid java name */
    public final void m949setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        LayoutOrientation layoutOrientation = measurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM1002toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m1002toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m991copyyUG9Ft0$default(OrientationIndependentConstraints.m989constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m946measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, jM1002toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.seeMoreSize = IntIntPair.m360boximpl(IntIntPair.m363constructorimpl(iMainAxisSize, iCrossAxisSize));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m946measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, jM1002toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.collapseSize = IntIntPair.m360boximpl(IntIntPair.m363constructorimpl(iMainAxisSize, iCrossAxisSize));
    ...
    public final void m951setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        this.getOverflowMeasurable = getOverflowMeasurable;
        m949setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, getOverflowMeasurable.invoke(true, 0), getOverflowMeasurable.invoke(false, 0), constraints);
    }
}
