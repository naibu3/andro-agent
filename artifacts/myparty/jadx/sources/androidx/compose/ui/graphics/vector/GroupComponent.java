...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3693getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4342markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4342markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j = this.tintColor;
            if (j == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m4365rgbEqualOWjLjI(j, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m4342markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM3888constructorimpl$default = this.groupMatrix;
        if (fArrM3888constructorimpl$default == null) {
            fArrM3888constructorimpl$default = Matrix.m3888constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM3888constructorimpl$default;
        } else {
            Matrix.m3897resetimpl(fArrM3888constructorimpl$default);
        }
        float[] fArr = fArrM3888constructorimpl$default;
        Matrix.m3908translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3900rotateZimpl(fArr, this.rotation);
        Matrix.m3901scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3908translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.mo4142transform58bKbWc((fArr != null ? Matrix.m3886boximpl(fArr) : null).m3909unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.m4269clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
