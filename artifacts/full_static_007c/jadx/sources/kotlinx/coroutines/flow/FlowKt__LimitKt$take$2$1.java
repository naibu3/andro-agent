        ...
        switch (flowKt__LimitKt$take$2$1$emit$1.label) {
            case 0:
                ...
                if (this.$consumed.element < this.$count) {
                    ...
                    Object value = flowCollector.emit(t, flowKt__LimitKt$take$2$1$emit$1);
                    ...
                    Object value2 = FlowKt__LimitKt.emitAbort$FlowKt__LimitKt(flowCollector2, t, flowKt__LimitKt$take$2$1$emit$1);
