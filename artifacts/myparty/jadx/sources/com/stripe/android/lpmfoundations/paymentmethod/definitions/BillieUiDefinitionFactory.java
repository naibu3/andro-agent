...
final class BillieUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) BillieDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_billie, R.drawable.stripe_ic_paymentsheet_pm_billie_day, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_billie_night), false, (ResolvableString) null, (Integer) null, 224, (DefaultConstructorMarker) null);
    }
}
