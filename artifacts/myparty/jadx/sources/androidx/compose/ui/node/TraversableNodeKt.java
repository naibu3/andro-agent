...
public final class TraversableNodeKt {
    ...
    public static final <T extends TraversableNode> T findNearestAncestor(T t) {
        NodeChain nodes;
        T t2 = t;
        int iM5228constructorimpl = NodeKind.m5228constructorimpl(262144);
    ...
    */
    public static final <T extends TraversableNode> void traverseChildren(T t, Function1<? super T, Boolean> function1) {
        ...
        while (mutableVector.isNotEmpty()) {
            ...
            if ((delegatingNodePop.getAggregateChildKindSet() & iM5228constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((delegatingNodePop.getKindSet() & iM5228constructorimpl) != 0) {
