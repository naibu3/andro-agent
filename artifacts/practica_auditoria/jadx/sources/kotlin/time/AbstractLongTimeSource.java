...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1446minusLRDsOJo(long duration) {
        ...
        public ComparableTimeMark mo1448plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1492plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1447minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1461equalsimpl0(this.offset, ((LongTimeMark) other).offset) && Duration.m1488isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1558getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1491minusLRDsOJo(this.offset, ((LongTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((LongTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1461equalsimpl0(startedAtDiff, Duration.m1508unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1558getZEROUwyO8pc() : Duration.m1492plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m1461equalsimpl0(mo1447minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1558getZEROUwyO8pc());
        }
        ...
        public final long m1449effectiveDurationUwyO8pc$kotlin_stdlib() {
            ...
            long offsetSeconds = Duration.m1477getInWholeSecondsimpl(arg0$iv);
            int offsetNanoseconds = Duration.m1479getNanosecondsComponentimpl(arg0$iv);
            ...
            long jM1492plusLRDsOJo = Duration.m1492plusLRDsOJo(scale2, startedAtMillis2);
            Duration.Companion companion2 = Duration.INSTANCE;
            long jM1492plusLRDsOJo2 = Duration.m1492plusLRDsOJo(jM1492plusLRDsOJo, DurationKt.toDuration(startedAtMillis + offsetMillis, DurationUnit.MILLISECONDS));
            Duration.Companion companion3 = Duration.INSTANCE;
            return Duration.m1492plusLRDsOJo(jM1492plusLRDsOJo2, DurationKt.toDuration(offsetSeconds, DurationUnit.SECONDS));
        }
    ...
    public ComparableTimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.INSTANCE.m1558getZEROUwyO8pc(), null);
    }
}
