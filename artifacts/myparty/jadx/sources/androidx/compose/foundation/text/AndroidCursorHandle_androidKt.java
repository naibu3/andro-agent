...
public final class AndroidCursorHandle_androidKt {
    ...
    */
    public static final void m1306CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, final long j, Composer composer, final int i, final int i2) {
        int i3;
        boolean z;
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                if ((i2 & 4) != 0) {
                    j = DpSize.INSTANCE.m6224getUnspecifiedMYxV2XQ();
                    i3 &= -897;
                }
                ...
                if (!z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$finalModifier$1$1
                        ...
                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                            semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, offsetProvider.mo1310provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
                        }
                    };
                    ...
                    public final void invoke(Composer composer2, int i5) {
                        ...
                        if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                            ...
                            if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                ...
                                Modifier modifierM1061requiredSizeInqDBjuR0$default = SizeKt.m1061requiredSizeInqDBjuR0$default(modifierSemantics$default, DpSize.m6215getWidthD9Ej5fM(j), DpSize.m6213getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
                                ...
                                Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composer2, modifierM1061requiredSizeInqDBjuR0$default);
                            ...
                            public final void invoke(Composer composer2, int i5) {
                                ...
                                if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                                    ...
                                    if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                                        composer2.startReplaceGroup(1828881000);
                                        ComposerKt.sourceInformation(composer2, "65@2611L318");
                                        Modifier modifierM1061requiredSizeInqDBjuR0$default = SizeKt.m1061requiredSizeInqDBjuR0$default(modifierSemantics$default2, DpSize.m6215getWidthD9Ej5fM(j), DpSize.m6213getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
                                        Alignment topCenter = Alignment.INSTANCE.getTopCenter();
                                        ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                                        MeasurePolicy measurePolicyMaybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(topCenter, false);
                                        ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)79@3208L23,82@3359L411:Layout.kt#80mrfh");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    AndroidCursorHandle_androidKt.m1306CursorHandleUSBMPiE(offsetProvider, modifier, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m1067sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final float fM3485getWidthimpl = Size.m3485getWidthimpl(cacheDrawScope.m3306getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, fM3485getWidthimpl);
                            ...
                            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    try {
                                        ...
                                        transform.mo4140rotateUv8p0NA(45.0f, Offset.INSTANCE.m3432getZeroF1C5BW0());
    ...
    static {
        float fM6117constructorimpl = Dp.m6117constructorimpl(25);
        CursorHandleHeight = fM6117constructorimpl;
        CursorHandleWidth = Dp.m6117constructorimpl(Dp.m6117constructorimpl(fM6117constructorimpl * 2.0f) / 2.4142137f);
    }
}
