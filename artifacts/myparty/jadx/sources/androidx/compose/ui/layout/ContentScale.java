...
public interface ContentScale {
    ...
    long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4990computeFillMaxDimensioniLBOSCw = ContentScaleKt.m4990computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4990computeFillMaxDimensioniLBOSCw, fM4990computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4991computeFillMinDimensioniLBOSCw = ContentScaleKt.m4991computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4991computeFillMinDimensioniLBOSCw, fM4991computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4989computeFillHeightiLBOSCw = ContentScaleKt.m4989computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4989computeFillHeightiLBOSCw, fM4989computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4992computeFillWidthiLBOSCw = ContentScaleKt.m4992computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4992computeFillWidthiLBOSCw, fM4992computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m3485getWidthimpl(srcSize) > Size.m3485getWidthimpl(dstSize) || Size.m3482getHeightimpl(srcSize) > Size.m3482getHeightimpl(dstSize)) {
                    float fM4991computeFillMinDimensioniLBOSCw = ContentScaleKt.m4991computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(fM4991computeFillMinDimensioniLBOSCw, fM4991computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4984computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m4992computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m4989computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
