...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1894copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1896copyrOJDEFc(j, density, function2);
    }
    ...
    public final DropdownMenuPositionProvider m1896copyrOJDEFc(long contentOffset, Density density, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public final long m1897getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public long mo684calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int iMo706roundToPx0680j_42 = this.density.mo706roundToPx0680j_4(DpOffset.m6178getXD9Ej5fM(this.contentOffset)) * (layoutDirection == LayoutDirection.Ltr ? 1 : -1);
        ...
        int right = (anchorBounds.getRight() - IntSize.m6287getWidthimpl(popupContentSize)) + iMo706roundToPx0680j_42;
        ...
        int top = (anchorBounds.getTop() - IntSize.m6286getHeightimpl(popupContentSize)) + iMo706roundToPx0680j_43;
        Iterator it2 = SequencesKt.sequenceOf(Integer.valueOf(iMax), Integer.valueOf(top), Integer.valueOf((anchorBounds.getTop() - (IntSize.m6286getHeightimpl(popupContentSize) / 2)) + iMo706roundToPx0680j_43), Integer.valueOf((IntSize.m6286getHeightimpl(windowSize) - IntSize.m6286getHeightimpl(popupContentSize)) - iMo706roundToPx0680j_4)).iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
