...
final class DrawGlowOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final boolean drawLeftGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m629drawWithRotationAndOffsetubNVwUQ(270.0f, OffsetKt.Offset(-Size.m3482getHeightimpl(drawScope.mo4213getSizeNHjbRc()), drawScope.mo712toPx0680j_4(this.overscrollConfig.getDrawPadding().mo971calculateLeftPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawTopGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m629drawWithRotationAndOffsetubNVwUQ(0.0f, OffsetKt.Offset(0.0f, drawScope.mo712toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop())), edgeEffect, canvas);
    }

    private final boolean drawRightGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m629drawWithRotationAndOffsetubNVwUQ(90.0f, OffsetKt.Offset(0.0f, (-MathKt.roundToInt(Size.m3485getWidthimpl(drawScope.mo4213getSizeNHjbRc()))) + drawScope.mo712toPx0680j_4(this.overscrollConfig.getDrawPadding().mo972calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawBottomGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m629drawWithRotationAndOffsetubNVwUQ(180.0f, OffsetKt.Offset(-Size.m3485getWidthimpl(drawScope.mo4213getSizeNHjbRc()), (-Size.m3482getHeightimpl(drawScope.mo4213getSizeNHjbRc())) + drawScope.mo712toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom())), edgeEffect, canvas);
    }

    /* renamed from: drawWithRotationAndOffset-ubNVwUQ, reason: not valid java name */
    private final boolean m629drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
        int iSave = canvas.save();
        canvas.rotate(rotationDegrees);
        canvas.translate(Offset.m3416getXimpl(offset), Offset.m3417getYimpl(offset));
