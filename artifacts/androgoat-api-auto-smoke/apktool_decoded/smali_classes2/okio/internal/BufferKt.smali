...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1267
    .local v21, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    if-eqz v6, :cond_6
    ...
    invoke-static {v2, v4, v7, v8, v1}, Lokio/internal/BufferKt;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .local v4, "fromIndex":J
    iget-object v8, v2, Lokio/Segment;->next:Lokio/Segment;
    ...
    .end local v14    # "offset$iv":J
    .end local v21    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    :cond_7
    move/from16 v26, v0
    ...
    .local v29, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    int-to-long v2, v0
    ...
    .end local v29    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    .local v2, "s":Lokio/Segment;
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1301
    .local v13, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    if-eqz v3, :cond_16
    ...
    .line 1601
    .end local v3    # "s":Lokio/Segment;
    .end local v13    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    .local v8, "nextOffset$iv":J
    :cond_17
    move-wide/from16 v21, v1
