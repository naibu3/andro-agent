...
public final class RetrieveAuthorizationSession {
    ...
    /* renamed from: com.stripe.android.financialconnections.domain.RetrieveAuthorizationSession$invoke$1, reason: invalid class name */
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return RetrieveAuthorizationSession.this.invoke(null, this);
        }
    }

    @Inject
    public RetrieveAuthorizationSession(NativeAuthFlowCoordinator coordinator, FinancialConnectionsManifestRepository repository, FinancialConnectionsSheetConfiguration configuration) {
    ...
    */
    public final Object invoke(String str, Continuation<? super FinancialConnectionsAuthorizationSession> continuation) {
        ...
        Object objRetrieveAuthorizationSession = anonymousClass1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = anonymousClass1.label;
        if (i == 0) {
            ResultKt.throwOnFailure(objRetrieveAuthorizationSession);
            ...
            objRetrieveAuthorizationSession = financialConnectionsManifestRepository.retrieveAuthorizationSession(financialConnectionsSessionClientSecret, str, anonymousClass1);
            if (objRetrieveAuthorizationSession != coroutine_suspended) {
                retrieveAuthorizationSession = this;
            }
        }
        if (i != 1) {
            if (i != 2) {
        ...
        retrieveAuthorizationSession = (RetrieveAuthorizationSession) anonymousClass1.L$0;
        ResultKt.throwOnFailure(objRetrieveAuthorizationSession);
        MutableSharedFlow<NativeAuthFlowCoordinator.Message> mutableSharedFlowInvoke = retrieveAuthorizationSession.coordinator.invoke();
        ...
        anonymousClass1.L$0 = objRetrieveAuthorizationSession;
        anonymousClass1.label = 2;
        return mutableSharedFlowInvoke.emit(clearPartnerWebAuth, anonymousClass1) == coroutine_suspended ? coroutine_suspended : objRetrieveAuthorizationSession;
    }
}
