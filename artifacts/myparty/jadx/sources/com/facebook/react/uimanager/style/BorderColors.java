...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m6951boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m6952constructorimpl(Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6954equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m6959unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6955equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6956hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6958toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m6954equalsimpl(this.edgeColors, obj);
    }

    public int hashCode() {
        return m6956hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m6958toStringimpl(this.edgeColors);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m6959unboximpl() {
    ...
    public static /* synthetic */ Integer[] m6953constructorimpl$default(Integer[] numArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m6952constructorimpl(numArr);
    }
    ...
    public static final ColorEdges m6957resolveimpl(Integer[] numArr, int i, Context context) {
