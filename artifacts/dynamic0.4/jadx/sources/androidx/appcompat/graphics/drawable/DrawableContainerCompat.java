...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    void setCurrentIndex(int index) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    boolean selectDrawable(int index) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        private Drawable prepareDrawable(Drawable child) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (Build.VERSION.SDK_INT >= 23) {
        ...
        public final Drawable getChild(int index) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            int keyIndex;
        ...
        final boolean setLayoutDirection(int layoutDirection, int currentIndex) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            boolean changed = false;
            int count = this.mNumChildren;
