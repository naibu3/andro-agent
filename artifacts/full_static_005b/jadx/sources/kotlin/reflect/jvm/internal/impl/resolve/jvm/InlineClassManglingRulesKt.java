...
public final class InlineClassManglingRulesKt {
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType, boolean z) {
        ClassifierDescriptor classifierDescriptorMo1494getDeclarationDescriptor = kotlinType.getConstructor().mo1494getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = classifierDescriptorMo1494getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo1494getDeclarationDescriptor : null;
