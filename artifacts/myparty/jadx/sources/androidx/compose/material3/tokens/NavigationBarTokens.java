...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6117constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2726getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m6117constructorimpl((float) 80.0d);
    ...
    public final float m2870getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2871getActiveIndicatorWidthD9Ej5fM() {
