...
public final /* data */ class LegalDetailsBody implements Parcelable {
    ...
    private static final KSerializer<Object>[] $childSerializers = {new ArrayListSerializer(ServerLink$$serializer.INSTANCE)};
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LegalDetailsBody) && Intrinsics.areEqual(this.links, ((LegalDetailsBody) other).links);
    }
    ...
    /* compiled from: TextUpdate.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/stripe/android/financialconnections/model/LegalDetailsBody$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/stripe/android/financialconnections/model/LegalDetailsBody;", "financial-connections_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<LegalDetailsBody> serializer() {
            return LegalDetailsBody$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ LegalDetailsBody(int i, List list, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            PluginExceptionsKt.throwMissingFieldException(i, 1, LegalDetailsBody$$serializer.INSTANCE.getDescriptor());
        }
        this.links = list;
    }
