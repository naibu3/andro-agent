    ...
    public static final Object fixedPeriodTicker(long delayMillis, long initialDelayMillis, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (c01101.label) {
            case 0:
                ...
                c01101.L$0 = sendChannel;
                c01101.J$0 = delayMillis;
                c01101.J$1 = deadline3;
                c01101.label = 1;
                if (DelayKt.delay(initialDelayMillis, c01101) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                ...
                unit = Unit.INSTANCE;
                c01101.L$0 = sendChannel;
                c01101.J$0 = deadline4;
                c01101.J$1 = delayNs2;
                c01101.label = 2;
                if (sendChannel.send(unit, c01101) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                deadline2 = deadline4;
                deadline = delayNs2;
                ...
                if (nextDelay == 0 || deadline == 0) {
                    ...
                    c01101.L$0 = sendChannel;
                    c01101.J$0 = deadline2;
                    c01101.J$1 = deadline;
                    c01101.label = 4;
                    if (DelayKt.delay(delayNs3, c01101) != coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    delayNs2 = deadline;
                    delayNs = deadline2;
                    ...
                    c01101.L$0 = sendChannel;
                    c01101.J$0 = deadline5;
                    c01101.J$1 = deadline;
                    c01101.label = 3;
                    if (DelayKt.delay(now2, c01101) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    delayNs2 = deadline;
                    delayNs = deadline5;
            ...
            case 1:
                delayNs = c01101.J$1;
                delayMillis2 = c01101.J$0;
                sendChannel = (SendChannel) c01101.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = EventLoop_commonKt.delayToNanos(delayMillis2);
                long deadline422 = delayNs + delayNs2;
                unit = Unit.INSTANCE;
                c01101.L$0 = sendChannel;
                c01101.J$0 = deadline422;
                c01101.J$1 = delayNs2;
                c01101.label = 2;
                if (sendChannel.send(unit, c01101) == coroutine_suspended) {
                }
            ...
            case 2:
                ...
                break;
            case 3:
                long delayNs4 = c01101.J$1;
                long deadline6 = c01101.J$0;
                sendChannel = (SendChannel) c01101.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs4;
                delayNs = deadline6;
                ...
                break;
            case 4:
                long delayNs5 = c01101.J$1;
                long deadline7 = c01101.J$0;
                sendChannel = (SendChannel) c01101.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs5;
                delayNs = deadline7;
