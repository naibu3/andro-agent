            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if (name.equals(TypedValues.AttributesType.S_TARGET)) {
                        ...
                        int id2 = TypedArrayUtils.getNamedResourceId(a, parser, "targetId", 1, 0);
                        if (id2 == 0) {
                            int id3 = TypedArrayUtils.getNamedResourceId(a, parser, "excludeId", 2, 0);
                            if (id3 != 0) {
                                transition.excludeTarget(id3, true);
                            } else {
