...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m6224getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m6137getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m6137getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    public final void m638setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m636setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }
    ...
    public final void m637setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
    }
    ...
    private final long m632getAnchorPositionInRootF1C5BW0() {
    ...
    public final void m639update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        if (this.magnifier != null && ((!Magnifier_androidKt.equalsIncludingNaN(zoom, f) && !platformMagnifierFactory.getCanUpdateZoom()) || !DpSize.m6212equalsimpl0(size, j) || !Dp.m6122equalsimpl0(cornerRadius, f2) || !Dp.m6122equalsimpl0(elevation, f3) || useTextDefault != z || clippingEnabled != z2 || !Intrinsics.areEqual(platformMagnifierFactory, platformMagnifierFactory2) || !Intrinsics.areEqual(viewRequireView, view) || !Intrinsics.areEqual(densityRequireDensity, density))) {
            recreateMagnifier();
        }
        updateMagnifier();
    }
    ...
    public void onAttach() {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03061(null), 3, null);
    }
    ...
    static final class C03061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return MagnifierNode.this.new C03061(continuation);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:19:0x004a, code lost:
            ...
            if (androidx.compose.runtime.MonotonicFrameClockKt.withFrameMillis(androidx.compose.foundation.MagnifierNode.C03061.C00151.INSTANCE, r4) == r0) goto L20;
         */
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo666createnHHXs2Y(view, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        long jM3431getUnspecifiedF1C5BW0;
        Density densityRequireDensity = this.density;
        if (densityRequireDensity == null) {
            densityRequireDensity = DelegatableNodeKt.requireDensity(this);
        ...
        if (OffsetKt.m3435isSpecifiedk4lQ0M(packedValue) && OffsetKt.m3435isSpecifiedk4lQ0M(m632getAnchorPositionInRootF1C5BW0())) {
            this.sourceCenterInRoot = Offset.m3421plusMKHz9U(m632getAnchorPositionInRootF1C5BW0(), packedValue);
            Function1<? super Density, Offset> function1 = this.magnifierCenter;
            if (function1 != null) {
                Offset offsetM3405boximpl = Offset.m3405boximpl(function1.invoke(densityRequireDensity).getPackedValue());
                if (!OffsetKt.m3435isSpecifiedk4lQ0M(offsetM3405boximpl.getPackedValue())) {
                    offsetM3405boximpl = null;
                }
                if (offsetM3405boximpl != null) {
                    jM3431getUnspecifiedF1C5BW0 = Offset.m3421plusMKHz9U(m632getAnchorPositionInRootF1C5BW0(), offsetM3405boximpl.getPackedValue());
                } else {
                    jM3431getUnspecifiedF1C5BW0 = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
                }
            }
            long j = jM3431getUnspecifiedF1C5BW0;
            if (this.magnifier == null) {
                recreateMagnifier();
            }
            PlatformMagnifier platformMagnifier = this.magnifier;
            if (platformMagnifier != null) {
                platformMagnifier.mo665updateWko1d7g(this.sourceCenterInRoot, j, this.zoom);
            }
            updateSizeIfNecessary();
            return;
        }
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m6284equalsimpl(platformMagnifier.mo664getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m6203boximpl(density.mo710toDpSizekrfVVM(IntSizeKt.m6299toSizeozmzZPI(platformMagnifier.mo664getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m6279boximpl(platformMagnifier.mo664getSizeYbymL2g());
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m10654boximpl(channel.mo10639trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode.applySemantics.1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m3405boximpl(m641invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0, reason: not valid java name */
            public final long m641invokeF1C5BW0() {
