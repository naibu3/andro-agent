...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m3994constructorimpl(0);
    private static final int Rotate = m3994constructorimpl(1);
    private static final int Morph = m3994constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3993boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3994constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3995equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3996equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3997hashCodeimpl(int i) {
    ...
    public static String m3998toStringimpl(int i) {
        return m3996equalsimpl0(i, Translate) ? "Translate" : m3996equalsimpl0(i, Rotate) ? "Rotate" : m3996equalsimpl0(i, Morph) ? "Morph" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
