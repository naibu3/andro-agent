...
public final class TextFieldSelectionState {
    ...
    private final MutableState startTextLayoutPositionInWindow = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3405boximpl(Offset.INSTANCE.m3431getUnspecifiedF1C5BW0()), null, 2, null);

    /* renamed from: rawHandleDragPosition$delegate, reason: from kotlin metadata */
    private final MutableState rawHandleDragPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3405boximpl(Offset.INSTANCE.m3431getUnspecifiedF1C5BW0()), null, 2, null);
    ...
    static final class C04311 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
    ...
    private final long m1602getStartTextLayoutPositionInWindowF1C5BW0() {
    ...
    private final void m1606setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        this.startTextLayoutPositionInWindow.setValue(Offset.m3405boximpl(j));
    }

    /* renamed from: getCurrentTextLayoutPositionInWindow-F1C5BW0, reason: not valid java name */
    private final long m1599getCurrentTextLayoutPositionInWindowF1C5BW0() {
        LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getRawHandleDragPosition-F1C5BW0, reason: not valid java name */
    private final long m1601getRawHandleDragPositionF1C5BW0() {
    ...
    private final void m1605setRawHandleDragPositionk4lQ0M(long j) {
        this.rawHandleDragPosition.setValue(Offset.m3405boximpl(j));
    }

    /* renamed from: getHandleDragPosition-F1C5BW0, reason: not valid java name */
    public final long m1609getHandleDragPositionF1C5BW0() {
        if (OffsetKt.m3437isUnspecifiedk4lQ0M(m1601getRawHandleDragPositionF1C5BW0())) {
            return Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        }
        if (OffsetKt.m3437isUnspecifiedk4lQ0M(m1602getStartTextLayoutPositionInWindowF1C5BW0())) {
            return TextLayoutStateKt.m1561fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, m1601getRawHandleDragPositionF1C5BW0());
        }
        return Offset.m3421plusMKHz9U(m1601getRawHandleDragPositionF1C5BW0(), Offset.m3420minusMKHz9U(m1602getStartTextLayoutPositionInWindowF1C5BW0(), m1599getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    public final TextFieldHandleState getCursorHandleState$foundation_release(boolean includePosition) {
        ...
        if (!showCursorHandle || !z || !TextRange.m5596getCollapsedimpl(visualText.getSelection()) || !visualText.shouldShowSelection() || visualText.length() <= 0 || (draggingHandle != Handle.Cursor && !isCursorHandleInVisibleBounds())) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        return new TextFieldHandleState(true, includePosition ? getCursorRect().m3443getBottomCenterF1C5BW0() : Offset.INSTANCE.m3431getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    }
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long jM3443getBottomCenterF1C5BW0 = getCursorRect().m3443getBottomCenterF1C5BW0();
            ...
            return SelectionManagerKt.m1720containsInclusiveUv8p0NA(rectVisibleBounds, jM3443getBottomCenterF1C5BW0);
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final Rect getCursorRect() {
        ...
        TextFieldCharSequence visualText = this.textFieldState.getVisualText();
        if (!TextRange.m5596getCollapsedimpl(visualText.getSelection())) {
            return Rect.INSTANCE.getZero();
        }
        Rect cursorRect = layoutResult.getCursorRect(TextRange.m5602getStartimpl(visualText.getSelection()));
        float fMo712toPx0680j_4 = this.density.mo712toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (layoutResult.getLayoutInput().getLayoutDirection() == LayoutDirection.Ltr) {
            right = cursorRect.getLeft() + (fMo712toPx0680j_4 / 2);
        } else {
            right = cursorRect.getRight() - (fMo712toPx0680j_4 / 2);
        }
        float f = fMo712toPx0680j_4 / 2;
        float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(right, IntSize.m6287getWidthimpl(layoutResult.getSize()) - f), f);
                ...
                if (i == 0) {
                    ...
                    if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.cursorHandleGestures.2.3.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m1616invokek4lQ0M(offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m1616invokek4lQ0M(long j) {
    ...
    static final class C04472 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04472(PointerInputScope pointerInputScope, boolean z, Continuation<? super C04472> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04472 c04472 = TextFieldSelectionState.this.new C04472(this.$this_selectionHandleGestures, this.$isStartHandle, continuation);
            c04472.L$0 = obj;
            return c04472;
        }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                        ...
                        public final void mo1580onEventk4lQ0M(long j) {
                            Handle handle;
                            ...
                            textFieldSelectionState2.m1610updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1683getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1600getHandlePositiontuRUvjQ(z)));
                        }
                    };
    ...
    public final Object selectionHandleGestures(PointerInputScope pointerInputScope, boolean z, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04472(pointerInputScope, z, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    public final Object observeChanges(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C04401) {
            c04401 = (C04401) continuation;
            if ((c04401.label & Integer.MIN_VALUE) != 0) {
                c04401.label -= Integer.MIN_VALUE;
            } else {
                c04401 = new C04401(continuation);
            }
        }
        Object obj = c04401.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c04401.label;
        if (i != 0) {
            if (i != 1) {
            ...
            textFieldSelectionState = (TextFieldSelectionState) c04401.L$0;
            try {
                ResultKt.throwOnFailure(obj);
        ...
        ResultKt.throwOnFailure(obj);
        try {
            C04412 c04412 = new C04412(null);
            c04401.L$0 = this;
            c04401.label = 1;
            if (CoroutineScopeKt.coroutineScope(c04412, c04401) == coroutine_suspended) {
                return coroutine_suspended;
            }
    ...
    static final class C04412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04412 c04412 = TextFieldSelectionState.this.new C04412(continuation);
            c04412.L$0 = obj;
            return c04412;
        }
    ...
    static final class C04382 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04382 c04382 = TextFieldSelectionState.this.new C04382(continuation);
            c04382.L$0 = obj;
            return c04382;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04382) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L33:
                ...
                goto L23
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C04382.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public final Object detectTouchMode(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object objAwaitPointerEventScope = pointerInputScope.awaitPointerEventScope(new C04382(null), continuation);
    ...
    public final Object detectTextFieldTapGestures(PointerInputScope pointerInputScope, MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0, final Function0<Unit> function02, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new C04362(mutableInteractionSource, this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectTextFieldTapGestures.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1622invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1622invokek4lQ0M(long j) {
                ...
                if (this.enabled && this.getIsFocused()) {
                    ...
                    long jM1554coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release = this.textLayoutState.m1554coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j);
                    TextFieldSelectionState textFieldSelectionState = this;
                    textFieldSelectionState.m1604placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1561fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.textLayoutState, jM1554coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release));
                }
            }
        }, continuation);
    ...
    static final class C04362 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04362(MutableInteractionSource mutableInteractionSource, TextFieldSelectionState textFieldSelectionState, Continuation<? super C04362> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1621invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m1621invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            C04362 c04362 = new C04362(this.$interactionSource, this.this$0, continuation);
            c04362.L$0 = pressGestureScope;
            c04362.J$0 = j;
    ...
    public final boolean m1604placeCursorAtNearestOffsetk4lQ0M(long offset) {
        int iM5574getOffsetForPositionk4lQ0M;
        IndexTransformationType indexTransformationType;
        int iM5602getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (iM5574getOffsetForPositionk4lQ0M = layoutResult.m5574getOffsetForPositionk4lQ0M(offset)) == -1) {
            return false;
        }
        TransformedTextFieldState transformedTextFieldState = this.textFieldState;
        long jM1568mapFromTransformedjx7JFs = transformedTextFieldState.m1568mapFromTransformedjx7JFs(iM5574getOffsetForPositionk4lQ0M);
        ...
        if (i == 1 || i == 2) {
            iM5602getStartimpl = TextRange.m5602getStartimpl(jM1568mapFromTransformedjx7JFs);
        } else if (i == 3) {
            if (MathUtilsKt.m1516findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m5602getStartimpl(jM1571mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m5597getEndimpl(jM1571mapToTransformedGEjPoXI))) < 0) {
            ...
            if (MathUtilsKt.m1516findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m5602getStartimpl(jM1571mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m5597getEndimpl(jM1571mapToTransformedGEjPoXI))) < 0) {
                ...
                iM5602getStartimpl = TextRange.m5597getEndimpl(jM1568mapFromTransformedjx7JFs);
            }
        }
        long jTextRange = TextRangeKt.TextRange(iM5602getStartimpl);
        if (TextRange.m5595equalsimpl0(jTextRange, this.textFieldState.getUntransformedText().getSelection()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1574selectUntransformedCharsIn5zctL8(jTextRange);
    ...
    */
    public final Object detectCursorHandleDragGestures(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i != 0) {
            ...
            longRef2 = (Ref.LongRef) anonymousClass12.L$2;
            longRef = (Ref.LongRef) anonymousClass12.L$1;
            textFieldSelectionState = (TextFieldSelectionState) anonymousClass12.L$0;
            try {
                ResultKt.throwOnFailure(obj);
        ...
        longRef3.element = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        final Ref.LongRef longRef4 = new Ref.LongRef();
        longRef4.element = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        try {
            Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectCursorHandleDragGestures.2
                ...
                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1617invokek4lQ0M(long j) {
                    longRef3.element = SelectionHandlesKt.m1683getAdjustedCoordinatesk4lQ0M(this.getCursorRect().m3443getBottomCenterF1C5BW0());
                    longRef4.element = Offset.INSTANCE.m3432getZeroF1C5BW0();
                    this.setInTouchMode(true);
                    this.markStartContentVisibleOffset();
                    this.m1610updateHandleDraggingUv8p0NA(Handle.Cursor, longRef3.element);
                }
            };
            ...
            Function2<PointerInputChange, Offset, Unit> function2 = new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectCursorHandleDragGestures.5
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m1618invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                public final void m1618invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    Ref.LongRef longRef5 = longRef4;
                    longRef5.element = Offset.m3421plusMKHz9U(longRef5.element, j);
                    this.m1610updateHandleDraggingUv8p0NA(Handle.Cursor, Offset.m3421plusMKHz9U(longRef3.element, longRef4.element));
                    TextFieldSelectionState textFieldSelectionState2 = this;
                    if (textFieldSelectionState2.m1604placeCursorAtNearestOffsetk4lQ0M(textFieldSelectionState2.m1609getHandleDragPositionF1C5BW0())) {
                        pointerInputChange.consume();
                        HapticFeedback hapticFeedback = this.hapticFeedBack;
                        if (hapticFeedback != null) {
                            hapticFeedback.mo4385performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4394getTextHandleMove5zf0vsI());
                        }
                    }
                }
            };
            anonymousClass12.L$0 = this;
            anonymousClass12.L$1 = longRef3;
            anonymousClass12.L$2 = longRef4;
    ...
    public static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef longRef, Ref.LongRef longRef2, TextFieldSelectionState textFieldSelectionState) {
        if (OffsetKt.m3435isSpecifiedk4lQ0M(longRef.element)) {
            longRef.element = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        private long dragBeginPosition = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        ...
        public boolean mo1615onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
            ...
            this.dragBeginOffsetInText = TextRange.m5602getStartimpl(m1611updateSelectionr1Wruf4(downPosition, adjustment, true));
            return true;
        }

        @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
        /* renamed from: onDrag-3MmeM6k, reason: not valid java name */
        public boolean mo1612onDrag3MmeM6k(final long dragPosition, SelectionAdjustment adjustment) {
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return false;
            }
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldMouseSelectionObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Mouse.onDrag " + ((Object) Offset.m3424toStringimpl(dragPosition));
                }
            });
            m1611updateSelectionr1Wruf4(dragPosition, adjustment, false);
            return true;
        }

        /* renamed from: updateSelection-r1Wruf4, reason: not valid java name */
        private final long m1611updateSelectionr1Wruf4(long dragPosition, SelectionAdjustment adjustment, boolean isStartOfSelection) {
            Integer numValueOf = Integer.valueOf(this.dragBeginOffsetInText);
            if (numValueOf.intValue() < 0) {
                numValueOf = null;
            }
            int iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1556getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            int iM1556getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1556getOffsetForPosition3MmeM6k(dragPosition, false);
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1607updateSelectionSsLRf8 = textFieldSelectionState.m1607updateSelectionSsLRf8(textFieldSelectionState.textFieldState.getVisualText(), iIntValue, iM1556getOffsetForPosition3MmeM6k, false, adjustment, false, isStartOfSelection);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m5596getCollapsedimpl(jM1607updateSelectionSsLRf8)) {
                this.dragBeginOffsetInText = TextRange.m5602getStartimpl(jM1607updateSelectionSsLRf8);
            }
            if (TextRange.m5601getReversedimpl(jM1607updateSelectionSsLRf8)) {
                jM1607updateSelectionSsLRf8 = TextFieldSelectionStateKt.m1624reverse5zctL8(jM1607updateSelectionSsLRf8);
            }
            TextFieldSelectionState.this.textFieldState.m1573selectCharsIn5zctL8(jM1607updateSelectionSsLRf8);
            TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            return jM1607updateSelectionSsLRf8;
        }
        ...
        public boolean mo1613onExtendk4lQ0M(long downPosition) {
        ...
        public boolean mo1614onExtendDragk4lQ0M(long dragPosition) {
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.INSTANCE.m3432getZeroF1C5BW0();
        private Handle actingHandle = Handle.SelectionEnd;

        @Override // androidx.compose.foundation.text.TextDragObserver
        /* renamed from: onDown-k-4lQ0M */
        public void mo1397onDownk4lQ0M(long point) {
        }
        ...
        private final void onDragStop() {
            if (OffsetKt.m3435isSpecifiedk4lQ0M(this.dragBeginPosition)) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.INSTANCE.m3432getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                TextFieldSelectionState.this.setDirectDragGestureInitiator(InputType.None);
                this.requestFocus.invoke();
            }
        ...
        public void mo1399onStartk4lQ0M(final long startPoint) {
            if (TextFieldSelectionState.this.enabled) {
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onStart$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDragStart after longPress at " + ((Object) Offset.m3424toStringimpl(startPoint));
                    }
                });
                TextFieldSelectionState.this.m1610updateHandleDraggingUv8p0NA(this.actingHandle, startPoint);
                ...
                this.dragTotalDistance = Offset.INSTANCE.m3432getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                if (!TextFieldSelectionState.this.textLayoutState.m1557isPositionOnTextk4lQ0M(startPoint)) {
                    int iM1553getOffsetForPosition3MmeM6k$default = TextLayoutState.m1553getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                    HapticFeedback hapticFeedback = TextFieldSelectionState.this.hapticFeedBack;
                    if (hapticFeedback != null) {
                        hapticFeedback.mo4385performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4394getTextHandleMove5zf0vsI());
                    }
                    TextFieldSelectionState.this.textFieldState.placeCursorBeforeCharAt(iM1553getOffsetForPosition3MmeM6k$default);
                ...
                int iM1553getOffsetForPosition3MmeM6k$default2 = TextLayoutState.m1553getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                long jM1608updateSelectionSsLRf8$default = TextFieldSelectionState.m1608updateSelectionSsLRf8$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.textFieldState.getVisualText(), TextRange.INSTANCE.m5607getZerod9O1mEE(), null, null, 12, null), iM1553getOffsetForPosition3MmeM6k$default2, iM1553getOffsetForPosition3MmeM6k$default2, false, SelectionAdjustment.INSTANCE.getWord(), false, false, 96, null);
                TextFieldSelectionState.this.textFieldState.m1573selectCharsIn5zctL8(jM1608updateSelectionSsLRf8$default);
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                this.dragBeginOffsetInText = TextRange.m5602getStartimpl(jM1608updateSelectionSsLRf8$default);
            }
        }

        @Override // androidx.compose.foundation.text.TextDragObserver
        /* renamed from: onDrag-k-4lQ0M */
        public void mo1398onDragk4lQ0M(long delta) {
            int iIntValue;
            int iM1556getOffsetForPosition3MmeM6k;
            SelectionAdjustment word;
            Handle handle;
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return;
            }
            long jM3421plusMKHz9U = Offset.m3421plusMKHz9U(this.dragTotalDistance, delta);
            this.dragTotalDistance = jM3421plusMKHz9U;
            final long jM3421plusMKHz9U2 = Offset.m3421plusMKHz9U(this.dragBeginPosition, jM3421plusMKHz9U);
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Touch.onDrag at " + ((Object) Offset.m3424toStringimpl(jM3421plusMKHz9U2));
                }
            });
            if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.textLayoutState.m1557isPositionOnTextk4lQ0M(jM3421plusMKHz9U2)) {
                iIntValue = TextLayoutState.m1553getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, this.dragBeginPosition, false, 2, null);
                iM1556getOffsetForPosition3MmeM6k = TextLayoutState.m1553getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, jM3421plusMKHz9U2, false, 2, null);
                if (iIntValue == iM1556getOffsetForPosition3MmeM6k) {
                ...
                iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1556getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                iM1556getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1556getOffsetForPosition3MmeM6k(jM3421plusMKHz9U2, false);
                if (this.dragBeginOffsetInText < 0 && iIntValue == iM1556getOffsetForPosition3MmeM6k) {
                    return;
                }
                word = SelectionAdjustment.INSTANCE.getWord();
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            ...
            int i = iIntValue;
            int i2 = iM1556getOffsetForPosition3MmeM6k;
            ...
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1608updateSelectionSsLRf8$default = TextFieldSelectionState.m1608updateSelectionSsLRf8$default(textFieldSelectionState, textFieldSelectionState.textFieldState.getVisualText(), i, i2, false, selectionAdjustment, false, false, 64, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m5596getCollapsedimpl(jM1608updateSelectionSsLRf8$default)) {
                this.dragBeginOffsetInText = TextRange.m5602getStartimpl(jM1608updateSelectionSsLRf8$default);
            }
            if (TextRange.m5601getReversedimpl(jM1608updateSelectionSsLRf8$default)) {
                jM1608updateSelectionSsLRf8$default = TextFieldSelectionStateKt.m1624reverse5zctL8(jM1608updateSelectionSsLRf8$default);
            }
            if (!TextRange.m5595equalsimpl0(jM1608updateSelectionSsLRf8$default, selection)) {
                if (TextRange.m5602getStartimpl(jM1608updateSelectionSsLRf8$default) != TextRange.m5602getStartimpl(selection) && TextRange.m5597getEndimpl(jM1608updateSelectionSsLRf8$default) == TextRange.m5597getEndimpl(selection)) {
                    handle = Handle.SelectionStart;
                } else if ((TextRange.m5602getStartimpl(jM1608updateSelectionSsLRf8$default) == TextRange.m5602getStartimpl(selection) && TextRange.m5597getEndimpl(jM1608updateSelectionSsLRf8$default) != TextRange.m5597getEndimpl(selection)) || (TextRange.m5602getStartimpl(jM1608updateSelectionSsLRf8$default) + TextRange.m5597getEndimpl(jM1608updateSelectionSsLRf8$default)) / 2.0f > (TextRange.m5602getStartimpl(selection) + TextRange.m5597getEndimpl(selection)) / 2.0f) {
                    handle = Handle.SelectionEnd;
                } else {
                    handle = Handle.SelectionStart;
                }
            ...
            if (TextRange.m5596getCollapsedimpl(selection) || !TextRange.m5596getCollapsedimpl(jM1608updateSelectionSsLRf8$default)) {
                TextFieldSelectionState.this.textFieldState.m1573selectCharsIn5zctL8(jM1608updateSelectionSsLRf8$default);
            }
            TextFieldSelectionState.this.m1610updateHandleDraggingUv8p0NA(this.actingHandle, jM3421plusMKHz9U2);
        }
    }
    ...
    */
    public final Object detectSelectionHandleDragGestures(PointerInputScope pointerInputScope, final boolean z, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Ref.LongRef longRef;
        Ref.LongRef longRef2;
        if (continuation instanceof C04311) {
            c04311 = (C04311) continuation;
            if ((c04311.label & Integer.MIN_VALUE) != 0) {
                c04311.label -= Integer.MIN_VALUE;
            } else {
                c04311 = new C04311(continuation);
            }
        }
        C04311 c043112 = c04311;
        Object obj = c043112.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c043112.label;
        if (i != 0) {
            if (i != 1) {
            ...
            handle = (Handle) c043112.L$3;
            longRef2 = (Ref.LongRef) c043112.L$2;
            longRef = (Ref.LongRef) c043112.L$1;
            textFieldSelectionState = (TextFieldSelectionState) c043112.L$0;
            try {
                ResultKt.throwOnFailure(obj);
        ...
        try {
            try {
                Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectSelectionHandleDragGestures.2
                    ...
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1619invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1619invokek4lQ0M(long j) {
                        longRef3.element = SelectionHandlesKt.m1683getAdjustedCoordinatesk4lQ0M(this.m1600getHandlePositiontuRUvjQ(z));
                        this.m1610updateHandleDraggingUv8p0NA(handle2, longRef3.element);
                        longRef4.element = Offset.INSTANCE.m3432getZeroF1C5BW0();
                ...
                try {
                    Function2<PointerInputChange, Offset, Unit> function2 = new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectSelectionHandleDragGestures.5
                        ...
                        @Override // kotlin.jvm.functions.Function2
                        public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                            m1620invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                        public final void m1620invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                            int iM5602getStartimpl;
                            int iM5574getOffsetForPositionk4lQ0M;
                            Ref.LongRef longRef5 = longRef4;
                            longRef5.element = Offset.m3421plusMKHz9U(longRef5.element, j);
                            ...
                            this.m1610updateHandleDraggingUv8p0NA(handle2, Offset.m3421plusMKHz9U(longRef3.element, longRef4.element));
                            if (!z) {
                                iM5602getStartimpl = TextRange.m5602getStartimpl(this.textFieldState.getVisualText().getSelection());
                            } else {
                                iM5602getStartimpl = layoutResult.m5574getOffsetForPositionk4lQ0M(this.m1609getHandleDragPositionF1C5BW0());
                            }
                            int i2 = iM5602getStartimpl;
                            if (z) {
                                iM5574getOffsetForPositionk4lQ0M = TextRange.m5597getEndimpl(this.textFieldState.getVisualText().getSelection());
                            } else {
                                iM5574getOffsetForPositionk4lQ0M = layoutResult.m5574getOffsetForPositionk4lQ0M(this.m1609getHandleDragPositionF1C5BW0());
                            }
                            int i3 = iM5574getOffsetForPositionk4lQ0M;
                            long selection = this.textFieldState.getVisualText().getSelection();
                            TextFieldSelectionState textFieldSelectionState2 = this;
                            long jM1608updateSelectionSsLRf8$default = TextFieldSelectionState.m1608updateSelectionSsLRf8$default(textFieldSelectionState2, textFieldSelectionState2.textFieldState.getVisualText(), i2, i3, z, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), false, false, 96, null);
                            if (TextRange.m5596getCollapsedimpl(selection) || !TextRange.m5596getCollapsedimpl(jM1608updateSelectionSsLRf8$default)) {
                                this.textFieldState.m1573selectCharsIn5zctL8(jM1608updateSelectionSsLRf8$default);
                            }
                        }
                    };
                    longRef4 = longRef4;
                    c043112.L$0 = this;
                    c043112.L$1 = longRef3;
                    c043112.L$2 = longRef4;
                    c043112.L$3 = handle2;
                    c043112.label = 1;
                    if (DragGestureDetectorKt.detectDragGestures(pointerInputScope, function12, function0, function02, function2, c043112) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    textFieldSelectionState = this;
                    handle = handle2;
    ...
    public static final void detectSelectionHandleDragGestures$onDragStop$5(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2) {
        if (OffsetKt.m3435isSpecifiedk4lQ0M(longRef.element)) {
            textFieldSelectionState.clearHandleDragging();
            longRef.element = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m3432getZeroF1C5BW0();
    ...
    /* synthetic */ class C04433 extends FunctionReferenceImpl implements Function2<TextFieldCharSequence, CharSequence, Boolean> {
        public static final C04433 INSTANCE = new C04433();
    ...
    public final Object observeTextChanges(Continuation<? super Unit> continuation) {
        ...
        }), C04433.INSTANCE), 1).collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextChanges.4
    ...
    public final Object observeTextToolbarVisibility(Continuation<? super Unit> continuation) {
        Object objCollect = SnapshotStateKt.snapshotFlow(new Function0<Rect>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextToolbarVisibility.2
            ...
            public final Rect invoke() {
                Rect rectIntersect;
                boolean zM5596getCollapsedimpl = TextRange.m5596getCollapsedimpl(TextFieldSelectionState.this.textFieldState.getVisualText().getSelection());
                if (((zM5596getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Cursor) || (!zM5596getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Selection)) && TextFieldSelectionState.this.getDraggingHandle() == null && TextFieldSelectionState.this.isInTouchMode()) {
                    ...
                    if (rectVisibleBounds != null) {
                        ...
                        Offset offsetM3405boximpl = textLayoutCoordinates2 != null ? Offset.m3405boximpl(textLayoutCoordinates2.mo5004localToRootMKHz9U(rectVisibleBounds.m3451getTopLeftF1C5BW0())) : null;
                        Intrinsics.checkNotNull(offsetM3405boximpl);
                        Rect rectM3456Recttz77jQw = RectKt.m3456Recttz77jQw(offsetM3405boximpl.getPackedValue(), rectVisibleBounds.m3449getSizeNHjbRc());
                        Rect contentRect = TextFieldSelectionState.this.getContentRect();
                        Rect rect = rectM3456Recttz77jQw.overlaps(contentRect) ? contentRect : null;
                        return (rect == null || (rectIntersect = rect.intersect(rectM3456Recttz77jQw)) == null) ? Rect.INSTANCE.getZero() : rectIntersect;
                    }
                    return Rect.INSTANCE.getZero();
                }
                return Rect.INSTANCE.getZero();
    ...
    public final Rect getContentRect() {
        ...
        if (TextRange.m5596getCollapsedimpl(visualText.getSelection())) {
            ...
            LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            return RectKt.m3456Recttz77jQw(textLayoutCoordinates != null ? textLayoutCoordinates.mo5004localToRootMKHz9U(cursorRect3.m3451getTopLeftF1C5BW0()) : Offset.INSTANCE.m3432getZeroF1C5BW0(), cursorRect3.m3449getSizeNHjbRc());
        }
        LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
        long jMo5004localToRootMKHz9U = textLayoutCoordinates2 != null ? textLayoutCoordinates2.mo5004localToRootMKHz9U(m1600getHandlePositiontuRUvjQ(true)) : Offset.INSTANCE.m3432getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates3 = getTextLayoutCoordinates();
        long jMo5004localToRootMKHz9U2 = textLayoutCoordinates3 != null ? textLayoutCoordinates3.mo5004localToRootMKHz9U(m1600getHandlePositiontuRUvjQ(false)) : Offset.INSTANCE.m3432getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates4 = getTextLayoutCoordinates();
        float fM3417getYimpl2 = 0.0f;
        if (textLayoutCoordinates4 != null) {
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            fM3417getYimpl = Offset.m3417getYimpl(textLayoutCoordinates4.mo5004localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (cursorRect2 = layoutResult.getCursorRect(TextRange.m5602getStartimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect2.getTop())));
        } else {
            fM3417getYimpl = 0.0f;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            fM3417getYimpl2 = Offset.m3417getYimpl(textLayoutCoordinates5.mo5004localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (cursorRect = layoutResult2.getCursorRect(TextRange.m5597getEndimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect.getTop())));
        }
        return new Rect(Math.min(Offset.m3416getXimpl(jMo5004localToRootMKHz9U), Offset.m3416getXimpl(jMo5004localToRootMKHz9U2)), Math.min(fM3417getYimpl, fM3417getYimpl2), Math.max(Offset.m3416getXimpl(jMo5004localToRootMKHz9U), Offset.m3416getXimpl(jMo5004localToRootMKHz9U2)), Math.max(Offset.m3417getYimpl(jMo5004localToRootMKHz9U), Offset.m3417getYimpl(jMo5004localToRootMKHz9U2)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:23:0x0052, code lost:
    
        if (((r0 == null || (r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r0)) == null) ? false : androidx.compose.foundation.text.selection.SelectionManagerKt.m1720containsInclusiveUv8p0NA(r0, r4)) != false) goto L24;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final TextFieldHandleState getSelectionHandleState$foundation_release(boolean isStartHandle, boolean includePosition) {
        ...
        long selection = this.textFieldState.getVisualText().getSelection();
        if (TextRange.m5596getCollapsedimpl(selection)) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        long jM1600getHandlePositiontuRUvjQ = m1600getHandlePositiontuRUvjQ(isStartHandle);
        if (getDirectDragGestureInitiator() == InputType.None) {
            ...
            ResolvedTextDirection bidiRunDirection = layoutResult.getBidiRunDirection(isStartHandle ? TextRange.m5602getStartimpl(selection) : Math.max(TextRange.m5597getEndimpl(selection) - 1, 0));
            boolean zM5601getReversedimpl = TextRange.m5601getReversedimpl(selection);
            if (includePosition) {
                LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
                if (textLayoutCoordinates2 != null && (rectVisibleBounds = SelectionManagerKt.visibleBounds(textLayoutCoordinates2)) != null) {
                    jM1600getHandlePositiontuRUvjQ = TextLayoutStateKt.m1560coerceIn3MmeM6k(jM1600getHandlePositiontuRUvjQ, rectVisibleBounds);
                }
            } else {
                jM1600getHandlePositiontuRUvjQ = Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
            }
            return new TextFieldHandleState(true, jM1600getHandlePositiontuRUvjQ, bidiRunDirection, zM5601getReversedimpl, null);
        }
        return TextFieldHandleState.INSTANCE.getHidden();
    }
    ...
    public final long m1600getHandlePositiontuRUvjQ(boolean isStartHandle) {
        int iM5597getEndimpl;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
        ...
        long selection = this.textFieldState.getVisualText().getSelection();
        if (isStartHandle) {
            iM5597getEndimpl = TextRange.m5602getStartimpl(selection);
        } else {
            iM5597getEndimpl = TextRange.m5597getEndimpl(selection);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, iM5597getEndimpl, isStartHandle, TextRange.m5601getReversedimpl(selection));
    }

    /* renamed from: updateHandleDragging-Uv8p0NA, reason: not valid java name */
    public final void m1610updateHandleDraggingUv8p0NA(Handle handle, long position) {
        setDraggingHandle(handle);
        m1605setRawHandleDragPositionk4lQ0M(position);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void markStartContentVisibleOffset() {
        m1606setStartTextLayoutPositionInWindowk4lQ0M(m1599getCurrentTextLayoutPositionInWindowF1C5BW0());
    }

    public final void clearHandleDragging() {
        setDraggingHandle(null);
        m1605setRawHandleDragPositionk4lQ0M(Offset.INSTANCE.m3431getUnspecifiedF1C5BW0());
        m1606setStartTextLayoutPositionInWindowk4lQ0M(Offset.INSTANCE.m3431getUnspecifiedF1C5BW0());
    }

    public final boolean canCut() {
        return (TextRange.m5596getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || !getEditable() || this.isPassword) ? false : true;
    }
    ...
    public final boolean canCopy() {
        return (TextRange.m5596getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || this.isPassword) ? false : true;
    }
    ...
    public final void paste() {
        ...
        TransferableContent transferableContentOnReceive = receiveContentConfigurationInvoke.getReceiveContentListener().onReceive(new TransferableContent(clip, clip.getClipMetadata(), TransferableContent.Source.INSTANCE.m675getClipboardkB6V9T0(), null, 8, null));
    ...
    public final boolean canSelectAll() {
        return TextRange.m5598getLengthimpl(this.textFieldState.getVisualText().getSelection()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final void deselect() {
        if (!TextRange.m5596getCollapsedimpl(this.textFieldState.getVisualText().getSelection())) {
    ...
    static /* synthetic */ long m1608updateSelectionSsLRf8$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            z2 = false;
        }
        if ((i3 & 64) != 0) {
        ...
        return textFieldSelectionState.m1607updateSelectionSsLRf8(textFieldCharSequence, i, i2, z, selectionAdjustment, z2, z3);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: updateSelection-SsL-Rf8, reason: not valid java name */
    public final long m1607updateSelectionSsLRf8(TextFieldCharSequence textFieldCharSequence, int startOffset, int endOffset, boolean isStartHandle, SelectionAdjustment adjustment, boolean allowPreviousSelectionCollapsed, boolean isStartOfSelection) {
        HapticFeedback hapticFeedback;
        TextRange textRangeM5590boximpl = TextRange.m5590boximpl(textFieldCharSequence.getSelection());
        long packedValue = textRangeM5590boximpl.getPackedValue();
        if (isStartOfSelection || (!allowPreviousSelectionCollapsed && TextRange.m5596getCollapsedimpl(packedValue))) {
            textRangeM5590boximpl = null;
        }
        long jM1603getTextFieldSelectionqeG_v_k = m1603getTextFieldSelectionqeG_v_k(startOffset, endOffset, textRangeM5590boximpl, isStartHandle, adjustment);
        if (!TextRange.m5595equalsimpl0(jM1603getTextFieldSelectionqeG_v_k, textFieldCharSequence.getSelection())) {
            boolean z = TextRange.m5601getReversedimpl(jM1603getTextFieldSelectionqeG_v_k) != TextRange.m5601getReversedimpl(textFieldCharSequence.getSelection()) && TextRange.m5595equalsimpl0(TextRangeKt.TextRange(TextRange.m5597getEndimpl(jM1603getTextFieldSelectionqeG_v_k), TextRange.m5602getStartimpl(jM1603getTextFieldSelectionqeG_v_k)), textFieldCharSequence.getSelection());
            if (isInTouchMode() && !z && (hapticFeedback = this.hapticFeedBack) != null) {
                hapticFeedback.mo4385performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m4394getTextHandleMove5zf0vsI());
            }
        }
        return jM1603getTextFieldSelectionqeG_v_k;
    }

    /* renamed from: getTextFieldSelection-qeG_v_k, reason: not valid java name */
    private final long m1603getTextFieldSelectionqeG_v_k(int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return TextRange.INSTANCE.m5607getZerod9O1mEE();
        }
        ...
        SelectionLayout selectionLayoutM1686getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1686getTextFieldSelectionLayoutRcvTLA(layoutResult, rawStartOffset, rawEndOffset, this.previousRawDragOffset, previousSelection != null ? previousSelection.getPackedValue() : TextRange.INSTANCE.m5607getZerod9O1mEE(), previousSelection == null, isStartHandle);
        if (previousSelection != null && !selectionLayoutM1686getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return previousSelection.getPackedValue();
        }
        long jM1674toTextRanged9O1mEE = adjustment.adjust(selectionLayoutM1686getTextFieldSelectionLayoutRcvTLA).m1674toTextRanged9O1mEE();
        this.previousSelectionLayout = selectionLayoutM1686getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = isStartHandle ? rawStartOffset : rawEndOffset;
        return jM1674toTextRanged9O1mEE;
    }
}
