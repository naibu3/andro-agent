...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM214constructorimpl = Result.m214constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM214constructorimpl = Result.m214constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m217exceptionOrNullimpl(objM214constructorimpl) == null) {
            obj2 = objM214constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM214constructorimpl2 = Result.m214constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM214constructorimpl2 = Result.m214constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m217exceptionOrNullimpl(objM214constructorimpl2) == null) {
            obj = objM214constructorimpl2;
        }
