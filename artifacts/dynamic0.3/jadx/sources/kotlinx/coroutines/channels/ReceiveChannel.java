...
public interface ReceiveChannel<E> {
    ...
    Object mo1633receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1634tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1634tryReceivePtdJZtk = receiveChannel.mo1634tryReceivePtdJZtk();
            if (ChannelResult.m1650isSuccessimpl(objMo1634tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1646getOrThrowimpl(objMo1634tryReceivePtdJZtk);
            }
            Throwable thM1644exceptionOrNullimpl = ChannelResult.m1644exceptionOrNullimpl(objMo1634tryReceivePtdJZtk);
            if (thM1644exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1644exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass1.label) {
                case 0:
                    ...
                    objMo1633receiveCatchingJP2dKIU = receiveChannel.mo1633receiveCatchingJP2dKIU(anonymousClass1);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1633receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1645getOrNullimpl(objMo1633receiveCatchingJP2dKIU);
        }
