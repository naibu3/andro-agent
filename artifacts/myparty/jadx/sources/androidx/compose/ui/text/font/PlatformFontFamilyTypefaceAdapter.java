...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo5854getNativeTypefacePYhJU0U;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            typefaceMo5854getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5739createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5757getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo5854getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5740createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5757getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo5854getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo5854getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5757getFontStyle_LCdwA(), typefaceRequest.m5758getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo5854getNativeTypefacePYhJU0U, false, 2, null);
    }
}
