...
final class BacsDebitUiDefinitionFactory implements UiDefinitionFactory.RequiresSharedDataSpec {
    ...
    public SupportedPaymentMethod createSupportedPaymentMethod(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec) {
        ...
        return new SupportedPaymentMethod((PaymentMethodDefinition) BacsDebitDefinition.INSTANCE, sharedDataSpec, R.string.stripe_paymentsheet_payment_method_bacs_debit, R.drawable.stripe_ic_paymentsheet_pm_bank, (Integer) null, true, (ResolvableString) null, Integer.valueOf(R.drawable.stripe_ic_paymentsheet_pm_bank_outlined), 64, (DefaultConstructorMarker) null);
    }
    ...
    public List<FormElement> createFormElements(PaymentMethodMetadata metadata, SharedDataSpec sharedDataSpec, TransformSpecToElements transformSpecToElements) {
        ...
        return transformSpecToElements.transform(metadata, CollectionsKt.plus((Collection) sharedDataSpec.getFields(), (Iterable) CollectionsKt.listOfNotNull((Object[]) new FormItemSpec[]{new PlaceholderSpec(IdentifierSpec.INSTANCE.getName(), PlaceholderSpec.PlaceholderField.Name), new PlaceholderSpec(IdentifierSpec.INSTANCE.getEmail(), PlaceholderSpec.PlaceholderField.Email), new PlaceholderSpec(IdentifierSpec.INSTANCE.getPhone(), PlaceholderSpec.PlaceholderField.Phone), new BacsDebitBankAccountSpec(), new PlaceholderSpec(IdentifierSpec.INSTANCE.getBillingAddress(), PlaceholderSpec.PlaceholderField.BillingAddress), new BacsDebitConfirmSpec()})), CollectionsKt.listOf((Object[]) new IdentifierSpec[]{IdentifierSpec.INSTANCE.getName(), IdentifierSpec.INSTANCE.getEmail(), IdentifierSpec.INSTANCE.getBillingAddress()}));
    }
}
