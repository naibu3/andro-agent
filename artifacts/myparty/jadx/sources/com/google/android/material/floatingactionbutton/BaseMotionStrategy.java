...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(PaymentSheetAppearanceKeys.SCALE)) {
            arrayList.add(motionSpec.getAnimator(PaymentSheetAppearanceKeys.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(PaymentSheetAppearanceKeys.SCALE, this.fab, View.SCALE_X));
        }
