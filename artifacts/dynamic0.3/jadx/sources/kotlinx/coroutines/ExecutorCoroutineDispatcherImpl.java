...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1681dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo1681dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo1682scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long timeMillis2;
        Executor executor = getExecutor();
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1682scheduleResumeAfterDelay(timeMillis2, continuation);
        }
    }
