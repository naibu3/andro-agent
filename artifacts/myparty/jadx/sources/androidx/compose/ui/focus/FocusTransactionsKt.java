...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        Boolean boolM3367requestFocusMxy_nc0 = m3367requestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m3335getEnterdhqQ8s());
        if (boolM3367requestFocusMxy_nc0 != null) {
            return boolM3367requestFocusMxy_nc0.booleanValue();
        }
        return false;
    }

    /* renamed from: requestFocus-Mxy_nc0, reason: not valid java name */
    public static final Boolean m3367requestFocusMxy_nc0(final FocusTargetNode focusTargetNode, int i) {
        Boolean boolValueOf;
        ...
        try {
            ...
            int i2 = WhenMappings.$EnumSwitchMapping$0[m3366performCustomRequestFocusMxy_nc0(focusTargetNode, i).ordinal()];
            if (i2 == 1) {
    ...
    */
                ...
                if (i == 4) {
                    ...
                    loop0: while (true) {
                        ...
                        if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl) != 0) {
                            while (parent != null) {
                                if ((parent.getKindSet() & iM5228constructorimpl) != 0) {
                                    ...
                                    while (nodePop != null) {
                                        ...
                                        if ((nodePop.getKindSet() & iM5228constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                            int i2 = 0;
        ...
        if (i2 != 2) {
            if (i2 != 3) {
                if (i2 == 4) {
                    ...
                    int iM5228constructorimpl2 = NodeKind.m5228constructorimpl(1024);
                    ...
                    loop4: while (true) {
                        ...
                        if ((layoutNodeRequireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & iM5228constructorimpl2) != 0) {
                            while (parent2 != null) {
                                if ((parent2.getKindSet() & iM5228constructorimpl2) != 0) {
                                    ...
                                    while (nodePop2 != null) {
                                        ...
                                        if ((nodePop2.getKindSet() & iM5228constructorimpl2) != 0 && (nodePop2 instanceof DelegatingNode)) {
                                            int i3 = 0;
    ...
    private static final boolean requestFocusForOwner(FocusTargetNode focusTargetNode) {
        return DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().mo3349requestFocusForOwner7o62pno(null, null);
    }
    ...
    public static final CustomDestinationResult m3366performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        Modifier.Node nodePop;
        NodeChain nodes;
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 == 1 || i2 == 2) {
        ...
        if (i2 == 3) {
            return m3363performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
        }
        if (i2 == 4) {
            FocusTargetNode focusTargetNode2 = focusTargetNode;
            int iM5228constructorimpl = NodeKind.m5228constructorimpl(1024);
            ...
            if (i4 == 1) {
                return m3364performCustomEnterMxy_nc0(focusTargetNode3, i);
            }
            if (i4 == 2) {
                return CustomDestinationResult.Cancelled;
            }
            if (i4 == 3) {
                return m3366performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            }
            if (i4 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            CustomDestinationResult customDestinationResultM3366performCustomRequestFocusMxy_nc0 = m3366performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            CustomDestinationResult customDestinationResult = customDestinationResultM3366performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? customDestinationResultM3366performCustomRequestFocusMxy_nc0 : null;
            return customDestinationResult == null ? m3364performCustomEnterMxy_nc0(focusTargetNode3, i) : customDestinationResult;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: performCustomClearFocus-Mxy_nc0, reason: not valid java name */
    public static final CustomDestinationResult m3363performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                return CustomDestinationResult.Cancelled;
            ...
            if (i2 == 3) {
                CustomDestinationResult customDestinationResultM3363performCustomClearFocusMxy_nc0 = m3363performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
                if (customDestinationResultM3363performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    customDestinationResultM3363performCustomClearFocusMxy_nc0 = null;
                }
                return customDestinationResultM3363performCustomClearFocusMxy_nc0 == null ? m3365performCustomExitMxy_nc0(focusTargetNode, i) : customDestinationResultM3363performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m3364performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3325boximpl(i));
    ...
    private static final CustomDestinationResult m3365performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3325boximpl(i));
                if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                    if (focusRequesterInvoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
