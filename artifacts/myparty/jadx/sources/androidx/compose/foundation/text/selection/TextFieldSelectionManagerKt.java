...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean z, ResolvedTextDirection resolvedTextDirection, final TextFieldSelectionManager textFieldSelectionManager, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (zChangedInstance || offsetProviderRememberedValue == Composer.INSTANCE.getEmpty()) {
                offsetProviderRememberedValue = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo1310provideF1C5BW0() {
                        return textFieldSelectionManager.m1742getHandlePositiontuRUvjQ$foundation_release(z);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            boolean zM5601getReversedimpl = TextRange.m5601getReversedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
            ...
            AndroidSelectionHandles_androidKt.m1663SelectionHandlepzduO1o(offsetProvider, z2, resolvedTextDirection2, zM5601getReversedimpl, 0L, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) textFieldSelectionManagerKt$TextFieldSelectionHandle$2$1RememberedValue), composerStartRestartGroup, (i2 << 3) & PointerIconCompat.TYPE_TEXT, 16);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m1720containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m1742getHandlePositiontuRUvjQ$foundation_release(z));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m1745calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        int iM5602getStartimpl;
        TextLayoutResultProxy layoutResult;
        TextDelegate textDelegate;
        AnnotatedString text;
        Offset offsetM1740getCurrentDragPosition_m7T9E = textFieldSelectionManager.m1740getCurrentDragPosition_m7T9E();
        if (offsetM1740getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m3431getUnspecifiedF1C5BW0();
        }
        long packedValue = offsetM1740getCurrentDragPosition_m7T9E.getPackedValue();
        ...
        if (i == 1 || i == 2) {
            iM5602getStartimpl = TextRange.m5602getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM5602getStartimpl = TextRange.m5597getEndimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        }
        LegacyTextFieldState state = textFieldSelectionManager.getState();
        ...
        int iCoerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping().originalToTransformed(iM5602getStartimpl), 0, text.length());
        float fM3416getXimpl = Offset.m3416getXimpl(layoutResult.m1432translateDecorationToInnerCoordinatesMKHz9U$foundation_release(packedValue));
        ...
        float fCoerceIn = RangesKt.coerceIn(fM3416getXimpl, Math.min(lineLeft, lineRight), Math.max(lineLeft, lineRight));
