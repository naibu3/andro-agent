...
public class MotionSpec {
    ...
    public static MotionSpec createFromResource(Context context, int id2) throws Resources.NotFoundException {
        try {
            Animator animator = AnimatorInflater.loadAnimator(context, id2);
            ...
            Log.w(TAG, "Can't load animation resource ID #0x" + Integer.toHexString(id2), e);
            return null;
        }
    }
