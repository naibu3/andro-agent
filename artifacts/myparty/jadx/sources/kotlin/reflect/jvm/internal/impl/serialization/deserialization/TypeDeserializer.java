...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo10409getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo10409getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo10409getDeclarationDescriptor, list);
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo10409getDeclarationDescriptor = type.getConstructor().mo10409getDeclarationDescriptor();
        FqName fqNameSafe = classifierDescriptorMo10409getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo10409getDeclarationDescriptor) : null;
