...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0088 A[PHI: r15
    ...
    */
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    int iMax3 = Math.max(iMax2 - (layoutParams.leftMargin + layoutParams.rightMargin), (int) r8);
        ...
        if (z || f > 0.0f) {
            ...
            while (i9 < childCount) {
                ...
                if (childAt2.getVisibility() != i3) {
                    ...
                    if (z) {
                        iMax = iMax2 - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, 1073741824);
                    } else if (layoutParams2.weight > 0.0f) {
                        iMax = measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f));
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, 1073741824);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(iMax2 - i11, 1073741824), iMakeMeasureSpec3);
                        if (i10 != 0) {
        ...
        setMeasuredDimension(i7, iMin + getPaddingTop() + getPaddingBottom());
        this.mCanSlide = z;
