...
public class ConstraintLayoutStatistics {
    ...
    private static final String WORD_PAD = new String(new char[MAX_WORD]).replace((char) 0, CardNumberConfig.SEPARATOR);
    ...
    public ConstraintLayoutStatistics m6383clone() {
        return new ConstraintLayoutStatistics(this);
    }

    private String fmt(DecimalFormat decimalFormat, float f, int i) {
        String str = new String(new char[i]).replace((char) 0, CardNumberConfig.SEPARATOR) + decimalFormat.format(f);
