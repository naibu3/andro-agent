...
final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo377measure3p2s80s(final MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        long j2;
        int iM6072getMinWidthimpl;
        int iM6071getMinHeightimpl;
        Placeable placeableMo4993measureBRTryo0;
        if (list.isEmpty()) {
            return MeasureScope.layout$default(measureScope, Constraints.m6072getMinWidthimpl(j), Constraints.m6071getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$1
        ...
        if (this.propagateMinConstraints) {
            ...
            j2 = j;
            j = Constraints.m6061copyZbe2FdA$default(j2, 0, 0, 0, 0, 10, null);
        }
        if (list.size() == 1) {
            ...
            if (!BoxKt.getMatchesParentSize(measurable)) {
                ...
                iM6072getMinWidthimpl = Math.max(Constraints.m6072getMinWidthimpl(j2), placeableMo4993measureBRTryo0.getWidth());
                iM6071getMinHeightimpl = Math.max(Constraints.m6071getMinHeightimpl(j2), placeableMo4993measureBRTryo0.getHeight());
            } else {
                iM6072getMinWidthimpl = Constraints.m6072getMinWidthimpl(j2);
                iM6071getMinHeightimpl = Constraints.m6071getMinHeightimpl(j2);
                placeableMo4993measureBRTryo0 = measurable.mo4993measureBRTryo0(Constraints.INSTANCE.m6080fixedJhjzzOo(Constraints.m6072getMinWidthimpl(j2), Constraints.m6071getMinHeightimpl(j2)));
            }
            final Placeable placeable = placeableMo4993measureBRTryo0;
            final int i = iM6072getMinWidthimpl;
            final int i2 = iM6071getMinHeightimpl;
        ...
        intRef.element = Constraints.m6072getMinWidthimpl(j2);
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = Constraints.m6071getMinHeightimpl(j2);
        int size = list.size();
        boolean z = false;
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (BoxKt.getMatchesParentSize(measurable2)) {
                ...
                Placeable placeableMo4993measureBRTryo02 = measurable2.mo4993measureBRTryo0(j);
                placeableArr[i3] = placeableMo4993measureBRTryo02;
                intRef.element = Math.max(intRef.element, placeableMo4993measureBRTryo02.getWidth());
                intRef2.element = Math.max(intRef2.element, placeableMo4993measureBRTryo02.getHeight());
            }
        }
        if (z) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (BoxKt.getMatchesParentSize(measurable3)) {
                    placeableArr[i4] = measurable3.mo4993measureBRTryo0(jConstraints);
                }
            }
        }
