        ...
        switch (prop.hashCode()) {
            ...
            case 741115130:
                if (prop.equals("borderWidth")) {
                    return map.isNull("borderWidth") || map.getDouble("borderWidth") == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
            case 762983977:
            ...
            case 1349188574:
                if (prop.equals("borderRadius")) {
                    if (!map.hasKey(BACKGROUND_COLOR) || (((type = map.getType(BACKGROUND_COLOR)) != ReadableType.Number || map.getInt(BACKGROUND_COLOR) == 0) && type == ReadableType.Null)) {
                        return !map.hasKey("borderWidth") || map.isNull("borderWidth") || map.getDouble("borderWidth") == AudioStats.AUDIO_AMPLITUDE_NONE;
                    }
                    return false;
                }
        }
