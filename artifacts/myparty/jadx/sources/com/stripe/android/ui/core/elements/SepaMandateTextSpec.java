...
public final /* data */ class SepaMandateTextSpec extends FormItemSpec {
    ...
    public static final class Creator implements Parcelable.Creator<SepaMandateTextSpec> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SepaMandateTextSpec[] newArray(int i) {
    ...
    public final SepaMandateTextSpec copy(IdentifierSpec apiPath, int stringResId) {
        Intrinsics.checkNotNullParameter(apiPath, "apiPath");
        return new SepaMandateTextSpec(apiPath, stringResId);
    }
    ...
    /* compiled from: SepaMandateTextSpec.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/stripe/android/ui/core/elements/SepaMandateTextSpec$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/stripe/android/ui/core/elements/SepaMandateTextSpec;", "payments-ui-core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public /* synthetic */ SepaMandateTextSpec(int i, IdentifierSpec identifierSpec, int i2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        this.apiPath = (i & 1) == 0 ? IdentifierSpec.INSTANCE.Generic("sepa_mandate") : identifierSpec;
        if ((i & 2) == 0) {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$payments_ui_core_release(SepaMandateTextSpec self, CompositeEncoder output, SerialDescriptor serialDesc) {
        if (output.shouldEncodeElementDefault(serialDesc, 0) || !Intrinsics.areEqual(self.getApiPath(), IdentifierSpec.INSTANCE.Generic("sepa_mandate"))) {
            output.encodeSerializableElement(serialDesc, 0, IdentifierSpec$$serializer.INSTANCE, self.getApiPath());
        }
        if (!output.shouldEncodeElementDefault(serialDesc, 1) && self.stringResId == R.string.stripe_sepa_mandate) {
            return;
        }
    ...
    public /* synthetic */ SepaMandateTextSpec(IdentifierSpec identifierSpec, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? IdentifierSpec.INSTANCE.Generic("sepa_mandate") : identifierSpec, (i2 & 2) != 0 ? R.string.stripe_sepa_mandate : i);
    }
