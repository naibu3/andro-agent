...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        NativeStorage.AnonymousClass2 anonymousClass2;
        T tInvoke;
        do {
            anonymousClass2 = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(anonymousClass2);
        } while (!mutableStateFlow.compareAndSet(anonymousClass2, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            anonymousClass2 = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(anonymousClass2, function1.invoke(anonymousClass2)));
    }
