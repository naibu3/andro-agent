...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m5608coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    public final TextRange m1449getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m5605toStringimpl(m1450getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM5595equalsimpl0 = true ^ TextRange.m5595equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1482getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1451syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM5595equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1482getSelectiond9O1mEE(), getMainBuffer().m1481getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m5595equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1482getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.getComposition(), this.mainBuffer.m1481getCompositionMzsxiRA()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight())) {
                return;
            }
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1482getSelectiond9O1mEE(), this.mainBuffer.m1481getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1482getSelectiond9O1mEE(), this.mainBuffer.m1481getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean zM5595equalsimpl0 = TextRange.m5595equalsimpl0(textFieldBuffer.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !zM5595equalsimpl0;
        if (!zContentEquals || !zM5595equalsimpl0) {
            m1451syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        } else {
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1440toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1451syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String string = this.mainBuffer.toString();
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(string, this.mainBuffer.m1482getSelectiond9O1mEE(), this.mainBuffer.m1481getCompositionMzsxiRA(), null, 8, null);
        boolean zAreEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1481getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m5602getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m5597getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m5596getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m5600getMinimpl(newComposition.getPackedValue()), TextRange.m5599getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(string, this.mainBuffer.m1482getSelectiond9O1mEE(), this.mainBuffer.m1481getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m5602getStartimpl(textFieldState.m1450getSelectiond9O1mEE())), Integer.valueOf(TextRange.m5597getEndimpl(textFieldState.m1450getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
