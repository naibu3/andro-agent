...
public class ChipGroup extends FlowLayout {
    ...
    public void setChipSpacingResource(int id2) {
        setChipSpacing(getResources().getDimensionPixelOffset(id2));
    }
    ...
    public void setChipSpacingHorizontalResource(int id2) {
        setChipSpacingHorizontal(getResources().getDimensionPixelOffset(id2));
    }
    ...
    public void setChipSpacingVerticalResource(int id2) {
        setChipSpacingVertical(getResources().getDimensionPixelOffset(id2));
    }
    ...
    public void setSingleLine(int id2) {
        setSingleLine(getResources().getBoolean(id2));
    }
    ...
    public void setSingleSelection(int id2) {
    ...
    private class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == ChipGroup.this && (child instanceof Chip)) {
                int id2 = child.getId();
                if (id2 == -1) {
                    int id3 = ViewCompat.generateViewId();
                    child.setId(id3);
                }
