...
public final class PDF417Writer implements Writer {
    ...
    public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints) throws NumberFormatException, WriterException {
        int margin;
