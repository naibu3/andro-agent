...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateM452animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m452animateColorAsStateKTwxG1Y(z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateM452animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m452animateColorAsStateKTwxG1Y(z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3658equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m3658equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m3658equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m3658equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m3658equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor);
    }
